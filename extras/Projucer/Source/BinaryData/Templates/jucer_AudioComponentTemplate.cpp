...
//==============================================================================
z0 %%content_component_class%%::prepareToPlay (i32 samplesPerBlockExpected, f64 sampleRate)
{
...
z0 %%content_component_class%%::getNextAudioBlock (const drx::AudioSourceChannelInfo& bufferToFill)
{
...
z0 %%content_component_class%%::releaseResources()
{
