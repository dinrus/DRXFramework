...
z0 ProjectContentComponent::paint (Graphics& g)
{
    g.fillAll (findColor (backgroundColorId));
}

z0 ProjectContentComponent::resized()
{
...
z0 ProjectContentComponent::lookAndFeelChanged()
{
    repaint();
...
z0 ProjectContentComponent::childBoundsChanged (Component* child)
{
    if (child == sidebar.get())
        resized();
}

z0 ProjectContentComponent::setProject (Project* newProject)
{
...
z0 ProjectContentComponent::saveOpenDocumentList()
{
    if (project != nullptr)
    {
...
z0 ProjectContentComponent::reloadLastOpenDocuments()
{
    if (project != nullptr)
    {
...
b8 ProjectContentComponent::documentAboutToClose (OpenDocumentManager::Document* document)
{
    hideDocument (document);
    return true;
}

z0 ProjectContentComponent::changeListenerCallback (ChangeBroadcaster* broadcaster)
{
    if (broadcaster == project)
        updateMissingFileStatuses();
}

z0 ProjectContentComponent::refreshProjectTreeFileStatuses()
{
    if (sidebar != nullptr)
...
z0 ProjectContentComponent::updateMissingFileStatuses()
{
    if (sidebar != nullptr)
...
b8 ProjectContentComponent::showEditorForFile (const File& fileToShow, b8 grabFocus)
{
...
b8 ProjectContentComponent::hasFileInRecentList (const File& f) const
{
...
b8 ProjectContentComponent::showDocument (OpenDocumentManager::Document* doc, b8 grabFocus)
{
    if (doc == nullptr)
        return false;
...
z0 ProjectContentComponent::hideEditor()
{
...
z0 ProjectContentComponent::hideDocument (OpenDocumentManager::Document* doc)
{
...
z0 ProjectContentComponent::setScrollableEditorComponent (std::unique_ptr<Component> component)
{
...
z0 ProjectContentComponent::setEditorDocument (std::unique_ptr<Component> component, OpenDocumentManager::Document* doc)
{
    currentDocument = doc;
...
z0 ProjectContentComponent::closeDocument()
{
...
z0 ProjectContentComponent::saveDocumentAsync()
{
    if (currentDocument != nullptr)
    {
        currentDocument->saveAsync ([parent = SafePointer { this }] (b8 savedSuccessfully)
        {
            if (parent == nullptr)
                return;
...
z0 ProjectContentComponent::saveAsAsync()
{
    if (currentDocument != nullptr)
    {
        currentDocument->saveAsAsync ([parent = SafePointer { this }] (b8 savedSuccessfully)
        {
            if (parent == nullptr)
                return;
...
b8 ProjectContentComponent::goToPreviousFile()
{
...
b8 ProjectContentComponent::goToNextFile()
{
    return showDocument (recentDocumentList.getNext(), true);
}

b8 ProjectContentComponent::canGoToCounterpart() const
{
    return currentDocument != nullptr
            && currentDocument->getCounterpartFile().exists();
}

b8 ProjectContentComponent::goToCounterpart()
{
    if (currentDocument != nullptr)
    {
...
z0 ProjectContentComponent::saveProjectAsync()
{
    if (project == nullptr)
        return;
...
z0 ProjectContentComponent::showModule (const Txt& moduleID)
{
    showModulesPanel();
...
z0 ProjectContentComponent::openInSelectedIDE (b8 saveFirst)
{
    if (project == nullptr)
        return;
...
z0 ProjectContentComponent::showNewExporterMenu()
{
    if (project != nullptr)
    {
        PopupMenu menu;
...
z0 ProjectContentComponent::deleteSelectedTreeItems()
{
    if (sidebar != nullptr)
...
z0 ProjectContentComponent::showBubbleMessage (Rectangle<i32> pos, const Txt& text)
{
...
//==============================================================================
z0 ProjectContentComponent::showTranslationTool()
{
    if (translationTool != nullptr)
    {
...
struct AsyncCommandRetrier final : public Timer
{
    ...
    DRX_DECLARE_NON_COPYABLE (AsyncCommandRetrier)
};

static b8 reinvokeCommandAfterCancellingModalComps (const ApplicationCommandTarget::InvocationInfo& info)
{
...
z0 ProjectContentComponent::getAllCommands (Array <CommandID>& commands)
{
...
z0 ProjectContentComponent::getCommandInfo (const CommandID commandID, ApplicationCommandInfo& result)
{
    Txt documentName;
    if (currentDocument != nullptr)
...
b8 ProjectContentComponent::perform (const InvocationInfo& info)
{
...
b8 ProjectContentComponent::isSaveCommand (const CommandID id)
{
    return (id == CommandIDs::saveProject || id == CommandIDs::saveDocument || id == CommandIDs::saveAndOpenInIDE);
}

z0 ProjectContentComponent::getSelectedProjectItemsBeingDragged (const DragAndDropTarget::SourceDetails& dragSourceDetails,
...
//==============================================================================
z0 ProjectContentComponent::showProjectPanel (i32k index)
{
    if (sidebar != nullptr)
