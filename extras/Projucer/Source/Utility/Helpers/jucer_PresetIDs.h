...
namespace Ids
{
    ...
    DECLARE_ID (addUsingNamespaceToDrxHeader);
    ...
    DECLARE_ID (jucePath);
    DECLARE_ID (defaultDrxModulePath);
...
//    DECLARE_ID (androidActivityBaseClassName); // DEPRECATED!
    ...
    DECLARE_ID (includeBinaryInDrxHeader);
    DECLARE_ID (binaryDataNamespace);
    DECLARE_ID (characterSet);
    DECLARE_ID (DRXRPROJECT);
    ...
    DECLARE_ID (dontAskAboutDRXPath);
