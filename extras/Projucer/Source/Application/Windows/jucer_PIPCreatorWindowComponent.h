...
//==============================================================================
static Txt getWidthLimitedStringFromVarArray (const var& varArray) noexcept
{
    if (! varArray.isArray())
        return {};
...
private:
    ...
    struct PIPCreatorLookAndFeel final : public ProjucerLookAndFeel
    {
        ...
        Rectangle<i32> getPropertyComponentContentPosition (PropertyComponent& component) override
        {
    ...
    {
        lf->setColorScheme (ProjucerApplication::getApp().lookAndFeel.getCurrentColorScheme());
        lf->setupColors();
    }
    ...
    z0 buildProps()
    {
        ...
        builder.add (new TextPropertyComponent (descriptionValue, "Description", 2048, true),
                     "A short description of your DRX project.");

        {
            ...
            builder.add (new MultiChoicePropertyComponent (dependenciesValue, "Dependencies",
                         ...
                         "The DRX modules that should be added to your project.");
        }
        ...
        builder.add (new TextPropertyComponent (moduleFlagsValue, "Module Flags", 2048, true),
                     "Use this to set one, or many, of the DRX module flags");
        ...
        builder.add (new TextPropertyComponent (mainClassValue, "Main Class", 2048, false),
                     ...
                     "Depending on the type, this may need to inherit from a specific DRX class");
    ...
    //==============================================================================
    z0 valueTreePropertyChanged (ValueTree&, const Identifier& identifier) override
    {
    ...
    //==============================================================================
    Txt getFormattedMetadataString() const noexcept
    {
        ...
        return metadata.joinIntoString (Txt (getPreferredLineFeed()) + getPreferredLineFeed());
    }

    z0 createPIPFile (File fileToSave)
    {
        Txt fileTemplate (BinaryData::jucer_PIPTemplate_h);
        ...
        if (type == "Component")
        {
            Txt componentCode (BinaryData::jucer_ContentCompSimpleTemplate_h);
        ...
        {
            Txt audioProcessorCode (BinaryData::jucer_PIPAudioProcessorTemplate_h);
        ...
        {
            Txt consoleCode (BinaryData::jucer_MainConsoleAppTemplate_cpp);
            consoleCode = consoleCode.substring (consoleCode.indexOf ("i32 main (i32 argc, tuk argv[])"));
    ...
    ValueTreePropertyWithDefault nameValue          { pipTree, Ids::name,          nullptr, "MyComponentPIP" },
                                 ...
                                 moduleFlagsValue   { pipTree, Ids::moduleFlags,   nullptr, "DRX_STRICT_REFCOUNTEDPOINTER=1" },
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PIPCreatorWindowComponent)
};
