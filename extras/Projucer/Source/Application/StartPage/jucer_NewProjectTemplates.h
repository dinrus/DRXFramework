...
namespace NewProjectTemplates
{
    ...
    inline Txt getProjectCategoryString (ProjectCategory category)
    {
    ...
    using FilenameAndContent = std::pair<Txt, Txt>;
    ...
    struct ProjectTemplate
    {
        ...
        Txt displayName, description, projectTypeString;
    ...
    inline b8 isApplication (const ProjectTemplate& t) noexcept  { return t.category == ProjectCategory::application; }
    inline b8 isPlugin (const ProjectTemplate& t) noexcept       { return t.category == ProjectCategory::plugin; }
    inline b8 isLibrary (const ProjectTemplate& t) noexcept      { return t.category == ProjectCategory::library; }
    ...
    inline Txt getStringForFileOption (FileCreationOptions opt)
    {
    ...
    inline std::vector<ProjectTemplate> getAllTemplates()
    {
        return
        {
            { ProjectCategory::application,
              "Blank", "Creates a blank DRX GUI application.",
            ...
            { ProjectCategory::application,
              "GUI", "Creates a blank DRX GUI application with a single window component.",
              build_tools::ProjectType_GUIApp::getTypeName(),
              BinaryData::wizard_GUI_svg,
              getModulesRequiredForComponent(),
              {
            ...
            { ProjectCategory::application,
              "Audio", "Creates a blank DRX GUI application with a single window component and audio and MIDI in/out functions.",
              build_tools::ProjectType_GUIApp::getTypeName(),
              BinaryData::wizard_AudioApp_svg,
              addAndReturn (getModulesRequiredForComponent(), "drx_audio_basics", "drx_audio_devices", "drx_audio_formats",
                                                              "drx_audio_processors", "drx_audio_utils", "drx_gui_extra"),
              {
                { FileCreationOptions::header, { { "Main.cpp", "jucer_MainTemplate_Window_cpp" },
            ...
            { ProjectCategory::application,
              "Animated", "Creates a DRX GUI application which draws an animated graphical display.",
              build_tools::ProjectType_GUIApp::getTypeName(),
              BinaryData::wizard_AnimatedApp_svg,
              addAndReturn (getModulesRequiredForComponent(), "drx_gui_extra"),
              {
                { FileCreationOptions::header, { { "Main.cpp", "jucer_MainTemplate_Window_cpp" },
                                                 { "MainComponent.h", "jucer_AudioComponentSimpleTemplate_h" } } },
                { FileCreationOptions::headerAndCpp, { { "Main.cpp", "jucer_MainTemplate_Window_cpp" },
            ...
            { ProjectCategory::application,
              "OpenGL", "Creates a blank DRX application with a single window component. "
                        "This component supports openGL drawing features including 3D model import and GLSL shaders.",
              build_tools::ProjectType_GUIApp::getTypeName(),
              BinaryData::wizard_OpenGL_svg,
              addAndReturn (getModulesRequiredForComponent(), "drx_gui_extra", "drx_opengl"),
              {
                { FileCreationOptions::header, { { "Main.cpp", "jucer_MainTemplate_Window_cpp" },
                                                 { "MainComponent.h", "jucer_AudioComponentSimpleTemplate_h" } } },
                { FileCreationOptions::headerAndCpp, { { "Main.cpp", "jucer_MainTemplate_Window_cpp" },
