...
namespace drx::build_tools
{
    ...
    public:
        ...
        const Txt& getType() const noexcept          { return type; }
        const Txt& getDescription() const noexcept   { return desc; }

        //==============================================================================
        static Array<ProjectType*> getAllTypes();
        static const ProjectType* findType (const Txt& typeCode)
        {
        ...
        //==============================================================================
        virtual b8 isStaticLibrary() const        { return false; }
        virtual b8 isDynamicLibrary() const       { return false; }
        virtual b8 isGUIApplication() const       { return false; }
        virtual b8 isCommandLineApp() const       { return false; }
        virtual b8 isAudioPlugin() const          { return false; }
        virtual b8 isARAAudioPlugin() const       { return false; }
        ...
        struct Target
        {
            ...
            static Type typeFromName (const Txt& name)
            {
        ...
        virtual b8 supportsTargetType (Target::Type /*targetType*/) const     { return false; }

    protected:
        ProjectType (const Txt& t, const Txt& d)
            : type (t), desc (d)
        {}
    ...
    private:
        ...
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ProjectType)
    };
    ...
    struct ProjectType_GUIApp final : public ProjectType
    {
        ...
        static tukk getTypeName() noexcept                          { return "guiapp"; }
        b8 isGUIApplication() const  override                            { return true; }
        b8 supportsTargetType (Target::Type targetType) const override   { return (targetType == Target::GUIApp); }
    };
    ...
    struct ProjectType_ConsoleApp final : public ProjectType
    {
        ...
        static tukk getTypeName() noexcept                          { return "consoleapp"; }
        b8 isCommandLineApp() const  override                            { return true; }
        b8 supportsTargetType (Target::Type targetType) const override   { return (targetType == Target::ConsoleApp); }
    };
    ...
    struct ProjectType_StaticLibrary final : public ProjectType
    {
        ...
        static tukk getTypeName() noexcept                          { return "library"; }
        b8 isStaticLibrary() const  override                             { return true; }
        b8 supportsTargetType (Target::Type targetType) const override   { return (targetType == Target::StaticLibrary); }
    };
    ...
    struct ProjectType_DLL  : public ProjectType
    {
        ...
        static tukk getTypeName() noexcept                          { return "dll"; }
        b8 isDynamicLibrary() const override                             { return true; }
        b8 supportsTargetType (Target::Type targetType) const override   { return (targetType == Target::DynamicLibrary); }
    };
    ...
    struct ProjectType_AudioPlugin final : public ProjectType
    {
        ...
        static tukk getTypeName() noexcept   { return "audioplug"; }
        b8 isAudioPlugin() const override         { return true; }

        b8 supportsTargetType (Target::Type targetType) const override
        {
            switch (targetType)
            {
    ...
    struct ProjectType_ARAAudioPlugin final : public ProjectType
    {
        ...
        static tukk getTypeName() noexcept { return "araaudioplug"; }
        b8 isAudioPlugin() const override { return true; }
        b8 isARAAudioPlugin() const override { return true; }
