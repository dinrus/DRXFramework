...
function(_drx_create_atomic_target target_name)
    ...
    set(test_atomic_with_is_lock_free_file_contents
            ...
            {
                std::atomic<z64> ll { static_cast<z64> (argc) };
                ll ^= static_cast<z64> (ll.is_lock_free());
                return static_cast<i32> (ll);
            }
        ]])
...
_drx_create_atomic_target(drx_atomic_wrapper)
