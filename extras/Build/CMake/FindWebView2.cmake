...
if(WebView2_FOUND)
    ...
    if(NOT TARGET drx_webview2)
        add_library(drx_webview2 INTERFACE)
        add_library(juce::drx_webview2 ALIAS drx_webview2)
        target_include_directories(drx_webview2 INTERFACE ${WebView2_INCLUDE_DIRS})
        target_link_libraries(drx_webview2 INTERFACE ${WebView2_LIBRARIES})
    endif()
endif()
