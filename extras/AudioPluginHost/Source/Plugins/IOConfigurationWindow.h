...
private:
    ...
    InputOutputConfig* getConfig (b8 isInput) noexcept    { return isInput ? inConfig.get() : outConfig.get(); }
    z0 update();
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (IOConfigurationWindow)
};
