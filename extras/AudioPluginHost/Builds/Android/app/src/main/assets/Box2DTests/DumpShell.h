...
b2Joint** joints = (b2Joint**)b2Alloc(2 * sizeof(b2Joint*));
{
...

  {
    ...
    fd.isSensor = b8(0);
    fd.filter.categoryBits = u16(1);
    fd.filter.maskBits = u16(65535);
    fd.filter.groupIndex = i16(0);
...

{
...

  {
    ...
    shape.m_hasVertex0 = b8(0);
    shape.m_hasVertex3 = b8(0);
