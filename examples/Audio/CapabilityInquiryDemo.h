...
/*******************************************************************************
 ...
 dependencies:     drx_audio_basics, drx_audio_devices, drx_core,
                   drx_data_structures, drx_events, drx_graphics,
                   drx_gui_basics, drx_midi_ci
...
public:
    ...
    ErasedScopeGuard observe (std::function<z0 (const Value&)> onChange)
    {
...
private:
    ...
    public:
        ...
        virtual z0 set (const Value&) = 0;
        virtual z0 set (Value&&) = 0;
        virtual const Value& get() const = 0;

        ErasedScopeGuard observe (std::function<z0 (const Value&)> fn)
        {
    ...
    private:
        using List = std::list<std::function<z0 (const Value&)>>;
        List list;
    };
    ...
    public:
        ...
        z0 set (const Value& m) override { setImpl (m); }
        z0 set (Value&& m)      override { setImpl (std::move (m)); }
...
struct Model
{
    ...
    {
        Array<var> result;
        result.resize ((i32) std::size (range));
    ...
    #define DRX_TUPLE_RELATIONAL_OP(classname, op)                                         \
        b8 operator op (const classname& other) const                                     \
        {                                                                                   \
            return tie() op other.tie();                                                    \
        }

    #define DRX_TUPLE_RELATIONAL_OPS(classname) \
        DRX_TUPLE_RELATIONAL_OP(classname, ==)  \
        DRX_TUPLE_RELATIONAL_OP(classname, !=)
    ...
    struct ListWithSelection
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (ListWithSelection)
    ...
    public:
        ...
        auto* get (i32 index)       { return get (*this, index); }
        auto* get (i32 index) const { return get (*this, index); }
    };
    ...
    struct Profiles
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (Profiles)
    };
    ...
    #define DRX_CAN_SET X(none) X(full) X(partial)
    ...
    struct CanSetUtils
    {
        ...
        static std::optional<CanSet> fromString (tukk str)
        {
    ...
    struct PropertyValue
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (PropertyValue)
    };

    struct ReadableDeviceInfo
    {
        Txt manufacturer, family, model, version;
    };
    ...
    struct Property
    {
        ...
        std::vector<Txt> mediaTypes { "application/json" };
        var columns;
        CanSet canSet = CanSet::none;
        b8 canGet = true, canSubscribe = false, requireResId = false, canPaginate = false;
        PropertyValue value;
        ...
        static Property fromResourceListEntry (var entry)
        {
            ...
            const auto stringToEncoding = [] (Txt str)
            {
        ...
        DRX_TUPLE_RELATIONAL_OPS (Property)
    };
    ...
    struct Properties
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (Properties)
    };
    ...
    struct IOSelection
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (IOSelection)
    };
    ...
    struct DeviceInfo
    {
        ...
        u8 numPropertyExchangeTransactions { 127 };
        b8 profilesSupported { false }, propertiesSupported { false };
        ...
        DRX_TUPLE_RELATIONAL_OPS (DeviceInfo)
    };
    ...
    struct LogView
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (LogView)
    };
    ...
    */
    struct Saved
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (Saved)
    };
    ...
    struct Device
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (Device)
    };
    ...
    struct LogEntry
    {
        ...
        DRX_TUPLE_RELATIONAL_OPS (LogEntry)
    };
    ...
    */
    struct Transient
    {
        ...
        std::map<Txt, std::map<ci::MUID, std::set<Txt>>> subscribers;
        ...
        DRX_TUPLE_RELATIONAL_OPS (Transient)
    };
    ...
    struct App
    {
        ...
        */
        ...
        DRX_TUPLE_RELATIONAL_OPS (App)
    };

    #undef DRX_TUPLE_RELATIONAL_OPS
    #undef DRX_TUPLE_RELATIONAL_OP
};

template <>
struct drx::SerialisationTraits<MidiDeviceInfo>
{
    static constexpr auto marshallingVersion = std::nullopt;
...
template <>
struct drx::SerialisationTraits<ci::ChannelAddress>
{
    static constexpr auto marshallingVersion = std::nullopt;
...
template <>
struct drx::SerialisationTraits<ci::ProfileAtAddress>
{
    static constexpr auto marshallingVersion = std::nullopt;
...
template <>
struct drx::SerialisationTraits<ci::SupportedAndActive>
{
    static constexpr auto marshallingVersion = std::nullopt;
...
public:
    ...
    z0 onCommit (std::function<z0()> fn)
    {
        onEscapeKey = onReturnKey = onFocusLost = std::move (fn);
    }

    z0 set (const Txt& str)
    {
        setText (str, false);
    }
};
...
struct Utils
{
    ...
    static std::unique_ptr<Label> makeListRowLabel (StringRef text, b8 selected)
    {
        ...
        if (selected)
        {
            const auto fg = label->findColor (TextEditor::ColorIds::highlightedTextColorId);
            label->setColor (Label::ColorIds::textColorId, fg);

            const auto bg = label->findColor (TextEditor::ColorIds::highlightColorId);
            label->setColor (Label::ColorIds::backgroundColorId, bg);
        }

        return label;
    }

    static SparseSet<i32> setWithSingleIndex (i32 i)
    {
        SparseSet<i32> result;
        result.addRange ({ i, i + 1 });
        return result;
    }

    template <typename... Items>
    static z0 doTwoColumnLayout (Rectangle<i32> bounds, Items&&... items)
    {
        Grid grid;
    ...
    template <typename... Items>
    static z0 doColumnLayout (Rectangle<i32> bounds, Items&&... items)
    {
        Grid grid;
    ...
    template <size_t N>
    static z0 stringToByteArray (const Txt& str, std::array<std::byte, N>& a)
    {
    ...
    static z0 forAllChannelAddresses (Callback&& callback)
    {
        for (u8 group = 0; group < 16; ++group)
        {
            for (u8 channel = 0; channel < 17; ++channel)
            {
    ...
    static std::tuple<Model::Property, Txt> attemptSetPartial (Model::Property prop,
                                                                  const Request& request)
    {
        ...
        if (prop.mediaTypes != std::vector<Txt> { "application/json" })
        {
            return std::tuple (std::move (prop),
        ...
        const auto pointers = JSON::parse (Txt::fromUTF8 (
            reinterpret_cast<tukk> (request.body.data()),
            (i32) request.body.size()));
        ...
        {
            std::optional result { JSON::parse (Txt::fromUTF8 (
                reinterpret_cast<tukk> (prop.value.bytes.data()),
                (i32) prop.value.bytes.size())) };
        ...
        return std::tuple (std::move (prop), Txt());
    }

    template <typename... Args>
    static auto forwardFunction (std::function<z0 (Args...)>& fn)
    {
        return [&fn] (auto&&... args)
        {
...
public:
    ...
    Component* refreshComponentForRow (i32 rowNumber,
                                       b8 rowIsSelected,
    ...
    z0 selectedRowsChanged (i32 newSelection) override
    {
        state = getInfoForRow (newSelection);
    }

    std::optional<MidiDeviceInfo> getInfoForRow (i32 row) const
    {
...
private:
    z0 setSelected (std::optional<MidiDeviceInfo> selected)
    {
    ...
    static Txt getLabel (std::in_place_type_t<MidiInput>)  { return "Input"; }
    static Txt getLabel (std::in_place_type_t<MidiOutput>) { return "Output"; }
...
{
public:
    explicit SectionHeader (Txt text)
        : label ("", text)
    {
        addAndMakeVisible (label);
        setInterceptsMouseClicks (false, false);
    ...
    {
        g.setColor (findColor (TextEditor::ColorIds::highlightColorId));
...
{
public:
    ToggleSectionHeader (Txt text, State<b8> s)
        : state (s),
          button (text)
    {
...
public:
        ...
        : state (s)
    {
        ...
        {
            const auto clamped = (u8) jlimit (1, 127, numConcurrent.getText().getIntValue());
...
private:
    z0 refresh()
    {
        numConcurrent.set (Txt (state->numPropertyExchangeTransactions));
    }
...
public:
        ...
        : state (s)
    {
        ...
        for (auto& b : buttons)
        {
            ...
            addAndMakeVisible (b);
            b.setButtonText ("Group " + Txt (group) + " Channel " + Txt (channel));
    ...
    z0 resized() override
    {
        ...
        const Rectangle<i32> gridBounds { maxButtonSize * numChannelColumns,
    ...
    z0 paint (Graphics& g) override
    {
        g.setColor (findColor (Label::ColorIds::textColorId));
        ...
        g.fillPath (groupPath,
                    AffineTransform().rotated (-MathConstants<f32>::halfPi, groupWidth / 2, 0)
        ...
        for (auto i = 0; i < 17; ++i)
        {
            ...
            const auto transform = AffineTransform()
                                       .rotated (-MathConstants<f32>::halfPi * 0.8, 0, 0)
    ...
    public:
        Button()
            : ShapeButton ("",
                           ...
                           Colors::black.withAlpha (0.4f).brighter(),
                           Colors::black.withAlpha (0.4f).darker())
        {
            setDimensions ({ 1.0f, 1.0f });

            const auto onColor = findColor (TextEditor::ColorIds::highlightColorId);
            setOnColors (onColor, onColor.brighter(), onColor.darker());
            shouldUseOnColors (true);
            setClickingTogglesState (true);
        }

        z0 setDimensions (Rectangle<f32> dimensions)
        {
            Path s;
...
public:
    ...
    i32 getNumRows() override
    {
        return (i32) state->profiles.items.size();
    }
                                       ...
                                       Component* existingComponentToUpdate) override
    {
        ...
        {
            const auto name = Txt::toHexString (item->data(), (i32) item->size());
        ...
        : state (s)
    {
        ...
        if constexpr (editable == Editable::yes)
        {
            ...
            add.onClick = [this]
            {
                ...
                updated.profiles.selection = (i32) updated.profiles.items.size() - 1;
...
private:
    z0 refresh()
    {
        if (auto* item = state->profiles.getSelected())
            field.set (Txt::toHexString (item->data(), (i32) item->size()));
    }
...
public:
        ...
        : state (s)
    {
        ...
        field.onCommit ([this]
        {
            NullCheckedInvocation::invoke (onChannelsRequested,
                                           (u16_t) field.getText().getIntValue());
            refresh();
        });
    }
    ...
    std::function<z0 (u16_t)> onChannelsRequested;
        ...
        if constexpr (editable == Editable::yes)
        {
            ...
            channels.onChannelsRequested = [this] (auto numChannels)
            {
                ...
                if (updated.profileMode == Model::ProfileMode::edit)
                    value.supported = jmax ((u16_t) 0, numChannels);
                else
                    value.active = jlimit ((u16_t) 0, value.supported, numChannels);
...
private:
    ...
    z0 refresh()
    {
        maxSysExSize.set (Txt (state->maxSysExSize));
    ...
    static Txt byteArrayToString (Span<const std::byte> bytes)
    {
        return Txt::toHexString (bytes.data(), (i32) bytes.size());
    }
    ...
    (
        ...
        {
            muid.set (Txt::toHexString (muidState->get()));
        }),
...
public:
    ...
    i32 getNumRows() override
    {
        return (i32) state->properties.items.size();
    }
        ...
        : state (s)
    {
        ...
        if constexpr (editable == Editable::yes)
        {
            ...
            add.onClick = [this]
            {
                ...
                updated.properties.selection = (i32) updated.properties.items.size() - 1;
                state = std::move (updated);
            };
...
public:
    ...
    i32 getNumRows() override { return (i32) entries.size(); }
            ...
            if (auto* item = props.properties.getSelected())
            {
                ...
                for (const auto& [device, subscriptions] : iter->second)
                    for (const auto& s : subscriptions)
                        result.push_back (Txt::toHexString (device.get()) + " (" + s + ")");
...
public:
    ...
    std::function<z0()> onGetRequested, onSubscribeRequested;
    std::function<z0 (Span<const std::byte>)> onSetFullRequested, onSetPartialRequested;
            ...
            if (auto* item = currentState.properties.getSelected())
            {
                ...
                switch (mode)
                {
                    case Model::DataViewMode::hex:
                        value.setColor (TextEditor::ColorIds::textColorId,
                                         findColor (TextEditor::ColorIds::textColorId));
                        value.setText (Txt::toHexString (item->value.bytes.data(),
                                                            (i32) item->value.bytes.size()),
                                       false);
                        break;
...
private:
    ...
    Model::Property getInfoFromUI() const
    {
        ...
        result.mediaTypes = std::vector<Txt> (lines.begin(), lines.end());
    ...
    z0 updateUIFromState()
    {
        ...
        if (auto* item = state->properties.getSelected())
        {
            ...
            mediaTypes.setText (StringArray (item->mediaTypes.data(),
                                             (i32) item->mediaTypes.size()).joinIntoString ("\n"),
                                false);

            columns.setText (JSON::toString (item->columns), false);

            canSetField.set (Model::CanSetUtils::toString (item->canSet));
            canSet.setSelectedItemIndex ((i32) item->canSet, dontSendNotification);
...
public:
        ...
        : state (s)
    {
        ...
        tabs.addTab ("Info",
                      findColor (DocumentWindow::backgroundColorId),
                      &info,
                      false);
        tabs.addTab ("Value",
                     findColor (DocumentWindow::backgroundColorId),
...
public:
    ...
    std::function<z0 (u16_t)> onChannelsRequested;
    std::function<z0()> onPropertyGetRequested, onPropertySubscribeRequested;
    std::function<z0 (Span<const std::byte>)> onPropertySetFullRequested,
...
private:
    ...
    {
        const auto transactions = (i32) getDeviceState()->info.numPropertyExchangeTransactions;
...
public:
    ...
    std::function<z0 (u16_t)> onChannelsRequested;
    std::function<z0()> onDiscover, onPropertyGetRequested, onPropertySubscribeRequested;
    std::function<z0 (Span<const std::byte>)> onPropertySetFullRequested,
                                                onPropertySetPartialRequested;
                                     ...
                                     [&Model::Transient::devices].observe ([this] (const auto& old)
    {
        if (old.items != state->transient.devices.items)
        {
            ...
            for (auto& dev : state->transient.devices.items)
            {
                ...
                item.text = Txt::toHexString (dev.muid.get()) + suffix;
                item.itemID = index;
...
public:
                                        ...
                                        Component* existingComponentToUpdate) override
    {
        ...
        const auto text = [&]() -> Txt
        {
            ...
            switch (columnId)
            {
                ...
                case group:
                    return Txt (row.group);

                case direction:
                    return row.kind == Model::MessageKind::incoming ? "in" : "out";

                case from:
                    return Txt::toHexString (parsed->header.source.get());

                case to:
                    return Txt::toHexString (parsed->header.destination.get());

                case version:
                    return Txt::toHexString (parsed->header.version);
                ...
                case description:
                    return state->saved.logView.mode == Model::DataViewMode::ascii
                         ...
                         : Txt::toHexString (row.message.data(), (i32) row.message.size());
            }
    ...
    i32 getNumRows() override { return (i32) getFiltered().size(); }
...
private:
    ...
    std::optional<std::tuple<ci::MUID, Txt>> getPropertyRequestInfo() const
    {
    ...
    z0 setProfileChannels (u16_t numChannels)
    {
        if (! device.has_value())
            return;
    ...
    z0 setPropertyFull (Span<const std::byte> bytes)
    {
        if (! device.has_value())
            return;
    ...
    z0 setPropertyPartial (Span<const std::byte> bytes)
    {
        if (! device.has_value())
            return;
    ...
    static auto findDeviceResourceImpl (Transient& transient, ci::MUID device, Txt resource)
    ...
    z0 requestPropertyData (ci::MUID target, Txt propertyName)
    {
    ...
    static b8 isStillConnected (const MidiInput& x)
    {
    ...
    static b8 isStillConnected (const MidiOutput& x)
    {
    ...
    [[nodiscard]] static b8 isStillConnected (const std::unique_ptr<MidiInput>& x)
    {
        if (x == nullptr)
            return false;
    ...
    [[nodiscard]] static b8 isStillConnected (const std::unique_ptr<MidiOutput>& x)
    {
        if (x == nullptr)
            return false;
    ...
    z0 setDeviceProfileState (ci::ProfileAtAddress profileAtAddress,
    ...
    z0 notifySubscribersForProperty (StringRef propertyName)
    {
        if (! device.has_value())
            return;
    ...
    z0 addLogEntry (ump::BytesOnGroup entry,
    ...
    public:
        ...
        z0 deviceAdded (ci::MUID added) override
        {
            ...
            if (devices.getSelected() == nullptr)
                devices.selection = (i32) std::distance (deviceVec.begin(), iterForMuid (added));
        ...
        z0 deviceRemoved (ci::MUID gone) override
        {
            auto updated = *demo.appState;
            ...
            devices.selection = iter != devices.items.end()
                                ? (i32) std::distance (devices.items.begin(), iter)
                                : -1;

            demo.appState = updated;
        }

        z0 endpointReceived (ci::MUID, ci::Message::EndpointInquiryResponse) override
        {
            // No special handling
        }

        z0 messageNotAcknowledged (ci::MUID, ci::Message::NAK) override
        {
            // No special handling
        }

        z0 profileStateReceived (ci::MUID muid,
                                   ci::ChannelInGroup) override
        {
            updateProfilesForMuid (muid);
        }

        z0 profilePresenceChanged (ci::MUID muid,
                                     ci::ChannelInGroup,
                                     ci::Profile,
                                     b8) override
        {
        ...
        z0 profileEnablementChanged (ci::MUID muid,
                                       ci::ChannelInGroup,
                                       ci::Profile,
                                       i32) override
        {
        ...
        z0 profileDetailsReceived (ci::MUID,
                                     ci::ChannelInGroup,
                                     ci::Profile,
                                     std::byte,
        ...
        z0 profileSpecificDataReceived (ci::MUID,
                                          ci::ChannelInGroup,
                                          ci::Profile,
                                          Span<const std::byte>) override
        {
        ...
        z0 propertyExchangeCapabilitiesReceived (ci::MUID muid) override
        {
            auto updated = *demo.appState;
            ...
            iter->info.numPropertyExchangeTransactions = (u8) *transactions;
        ...
        z0 propertySubscriptionDataReceived (ci::MUID muid,
            ...
            const auto resource = [&]
            {
                ...
                for (const auto& o : ongoing)
                {
                    if (subscription.header.subscribeId == demo.device->getSubscribeIdForKey (o))
                        return demo.device->getResourceForKey (o).value_or (Txt{});
                }
        ...
        z0 propertySubscriptionChanged (ci::SubscriptionKey key, const std::optional<Txt>&) override
        {
            propertySubscriptionChanged (key);
        }

        z0 propertySubscriptionChanged (ci::SubscriptionKey key)
        {
            auto updated = *demo.appState;
            ...
            if (const auto resource = demo.device->getResourceForKey (key))
                deviceIter->subscriptions.emplace (key, ci::Subscription { demo.device->getSubscribeIdForKey (key).value_or (Txt{}), *resource });
            else
    ...
    private:
        z0 updateProfilesForMuid (ci::MUID muid)
        {
            if (! demo.device.has_value())
                return;
            ...
            profiles.profiles.selection = [&]
            {
                ...
                return (i32) std::distance (profiles.profiles.items.begin(), foundMuid);
            }();
            profiles.channels = [&]
            {
    ...
    public:
        ...
        z0 processMessage (ump::BytesOnGroup msg) override
        {
    ...
    public:
        ...
        z0 profileEnablementRequested (ci::MUID,
                                         ...
                                         b8 enabled) override
        {
            ...
            if (auto* host = demo.getProfileHost())
            {
                ...
                profiles.channels[profileAtAddress].active = (u16_t) count;
    ...
    public:
        ...
        u8 getNumSimultaneousRequestsSupported() const override
        {
        ...
        {
            const auto makeErrorHeader = [] (auto str, i32 code = 400)
            {
        ...
        b8 subscriptionStartRequested (ci::MUID, const ci::PropertySubscriptionHeader& header) override
        {
        ...
        z0 subscriptionDidStart (ci::MUID initiator,
                                   const Txt& token,
        ...
        z0 subscriptionWillEnd (ci::MUID initiator, const ci::Subscription& subscription) override
        {
            auto transient = demo.appState[&Model::App::transient];
            auto updated = *transient;
    ...
    private:
        Model::Property getDeviceInfo() const
        {
            ...
            {
                return Model::toVarArray (r, [] (auto b) { return (i32) b; });
            };
    ...
    (
                ...
                [&Model::Properties::properties].observe ([this] (const auto& oldProperties)
        {
            ...
            {
                std::map<Txt, Model::PropertyValue> result;
