...
public:
    ...
    {
        g.fillCheckerBoard (getLocalBounds().toFloat(), 48.0f, 48.0f, Colors::lightgrey, Colors::white);
...
private:
        ...
        {
            {
                ...
                "z0 main()\n"
                "{\n"
                "    " DRX_MEDIUMP " vec4 colour1 = vec4 (1.0, 0.4, 0.6, 1.0);\n"
                "    " DRX_MEDIUMP " vec4 colour2 = vec4 (0.0, 0.8, 0.6, 1.0);\n"
                "    " DRX_MEDIUMP " f32 alpha = pixelPos.x / 1000.0;\n"
...

            {
                ...
                "{\n"
                "    " DRX_MEDIUMP " vec4 colour1 = vec4 (1.0, 0.4, 0.6, 1.0);\n"
                "    " DRX_MEDIUMP " vec4 colour2 = vec4 (0.3, 0.4, 0.4, 1.0);\n"
                "    " DRX_MEDIUMP " f32 alpha = distance (pixelPos, vec2 (600.0, 500.0)) / 400.0;\n"
                "    gl_FragColor = pixelAlpha * mix (colour1, colour2, alpha);\n"
                "}\n"
            },

            {
                ...
                "z0 main()\n"
                "{\n"
                "    " DRX_MEDIUMP " vec4 colour1 = vec4 (0.1, 0.1, 0.9, 1.0);\n"
                "    " DRX_MEDIUMP " vec4 colour2 = vec4 (0.0, 0.8, 0.6, 1.0);\n"
                "    " DRX_MEDIUMP " f32 distance = distance (pixelPos, vec2 (600.0, 500.0));\n"
                "\n"
                "    " DRX_MEDIUMP " f32 innerRadius = 200.0;\n"
                "    " DRX_MEDIUMP " f32 outerRadius = 210.0;\n"
                "\n"
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OpenGLDemo2D)
};
