...
{
public:
    ContentComponent (const Txt& title, const Txt& info, Component& contentToDisplay)
         : titleLabel ({}, title),
...
//==============================================================================
/**
    The top-level component containing the accessible DRX widget examples.

    Most DRX UI elements have built-in accessibility support and will be
...
*/
class DRXWidgetsComponent final : public Component
{
public:
    DRXWidgetsComponent()
    {
        setTitle ("DRX Widgets");
        setDescription ("A demo of a few of the accessible built-in DRX widgets.");
        setFocusContainerType (FocusContainerType::focusContainer);
...
private:
    ...
    public:
        ButtonsComponent()
        {
            ...
            shapeButton.setShape (getDRXLogoPath(), false, true, false);
    ...
    private:
        ...
        struct RadioButtonsGroupComponent final : public Component
        {
            RadioButtonsGroupComponent()
            {
                ...
                {
                    b.setRadioGroupId (1);
                    b.setButtonText ("Button " + Txt (n));
                    b.setHasFocusOutline (true);
                    addAndMakeVisible (b);
                }

                radioButtons[(size_t) Random::getSystemRandom().nextInt ((i32) radioButtons.size())].setToggleState (true, dontSendNotification);
            ...
            {
                auto bounds = getLocalBounds();
                const auto height = bounds.getHeight() / (i32) radioButtons.size();
        ...
        ShapeButton shapeButton { "Pressable DRX Logo",
                                  Colors::darkorange,
                                  Colors::darkorange.brighter (0.5f),
                                  Colors::darkorange.brighter (0.75f) };
        ScopedMessageBox messageBox;

        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ButtonsComponent)
    };
    ...
    public:
        SlidersComponent()
        {
            auto setUpSlider = [this] (Slider& slider, Slider::SliderStyle style,
                                       f64 start, f64 end, f64 interval)
            {
    ...
    private:
        ...
        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SlidersComponent)
    };
    ...
    private:
        ...
        struct RootItem final : public TreeViewItem
        {
            RootItem()
            {
                ...
                {
                    Item (i32 index, i32 depth, i32 numSubItems)
                        : textToDisplay ("Item " + Txt (index)
                                         + ". Depth: " + Txt (depth)
                                         + ". Num sub-items: " + Txt (numSubItems))
                    {
                    ...
                    z0 paintItem (Graphics& g, i32 width, i32 height) override
                    {
                        if (isSelected())
                        {
                            g.setColor (Colors::yellow.withAlpha (0.3f));
                    ...
                    Txt getAccessibilityName() override  { return textToDisplay; }

                    const Txt textToDisplay;
                };
        ...
        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TreeViewComponent)
    };

    //==============================================================================
    Label descriptionLabel { {}, "This is a demo of a few of the accessible built-in DRX widgets.\n\n"
    ...
    ContentComponent buttons { "Buttons",
                               "Examples of some DRX buttons.",
                               buttonsComponent };
    ContentComponent sliders { "Sliders",
                               "Examples of some DRX sliders.",
                               slidersComponent };
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DRXWidgetsComponent)
};
...
/**
    ...
    The AccessibleComponent class just draws a DRX logo and overrides the
...
private:
    ...
    public:
        ...
        {
            /**
                The AccessibilityHandler class is the interface between DRX components
            ...
            */
            struct CustomAccessibilityHandler final : public AccessibilityHandler
            {
                ...
                Txt getTitle() const override                  { return customWidgetComponent.infoComponent.getTitle(); }
                Txt getDescription() const override            { return customWidgetComponent.infoComponent.getDescription(); }
                Txt getHelp() const override                   { return customWidgetComponent.infoComponent.getHelp(); }
    ...
    private:
        CustomWidgetComponent& customWidgetComponent;
        Path juceLogoPath { getDRXLogoPath() };

        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AccessibleComponent)
    };
    ...
    public:
        ...
        Txt getTitle() const noexcept            { return titleEditor.getText(); }
        Txt getDescription() const noexcept      { return descriptionEditor.getText(); }
        Txt getHelp() const noexcept             { return helpEditor.getText(); }

    private:
        z0 setUpAccessibilityRoleSelector (CustomWidgetComponent& owner)
        {
            i32 itemId = 1;
        ...
        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (InfoComponent)
    };
    ...
    private:
        ...
        public:
            ...
            b8 isActionEnabled() const noexcept  { return enabledToggle.getToggleState(); }
        ...
        private:
            z0 timerCallback() override
            {
                ...
                {
                    const auto progress =  static_cast<f32> (Time::getMillisecondCounter() - startTime) / (flashTimeMs / 2);
                ...
                flashColor = defaultColor.overlaidWith (Colors::yellow.withAlpha (alpha));
                repaint();
            }
            ...
            //==============================================================================
            static constexpr i32 flashTimeMs = 500;

            ToggleButton enabledToggle;
            Rectangle<i32> flashArea;
            u32 startTime = 0;
            Color defaultColor = Colors::lightgrey, flashColor = defaultColor;

            //==============================================================================
            DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AccessibilityActionComponent)
        };
        ...
        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ActionsComponent)
    };
    ...
    public:
        ...
        std::unique_ptr<AccessibilityValueInterface> getValueInterface()
        {
            struct Numeric final : public AccessibilityNumericValueInterface
            {
                ...
                b8 isReadOnly() const override          { return owner.readOnlyToggle.getToggleState(); }
                f64 getCurrentValue() const override   { return owner.numericValueEditor.getText().getDoubleValue(); }
                z0 setValue (f64 newValue) override  { owner.numericValueEditor.setText (Txt (newValue)); }
            ...
            struct Ranged final : public AccessibilityRangedNumericValueInterface
            {
                ...
                b8 isReadOnly() const override                { return owner.readOnlyToggle.getToggleState(); }
                f64 getCurrentValue() const override         { return owner.rangedValueComponent.valueSlider.getValue(); }
                z0 setValue (f64 newValue) override        { owner.rangedValueComponent.valueSlider.setValue (newValue); }
            ...
            struct Text final : public AccessibilityTextValueInterface
            {
                ...
                b8 isReadOnly() const override                         { return owner.readOnlyToggle.getToggleState(); }
                Txt getCurrentValueAsString() const override          { return owner.textValueEditor.getText(); }
                z0 setValueAsString (const Txt& newValue) override  { owner.textValueEditor.setText (newValue); }
    ...
    private:
        ...
        struct RangedValueComponent final : public Component
        {
            ...
            {
                const auto setUpNumericTextEditor = [this] (TextEditor& ed, f64 initialValue)
                {
                    ed.setInputRestrictions (10, "0123456789.");
                    ed.setText (Txt (initialValue));
            ...
            z0 updateSliderRange()
            {
                ...
                if (maxValue <= minValue)
                {
                    ...
                    maxValueEditor.setText (Txt (maxValue));
                }
                else if (minValue >= maxValue)
                {
                    minValue = maxValue - intervalValue;
                    minValueEditor.setText (Txt (minValue));
                }
        ...
        static ValueType indexToValueType (i32 index) noexcept
        {
        ...
        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ValueInterfaceComponent)
    };
    ...
    private:
        ...
        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StateComponent)
    };

    //==============================================================================
    Label descriptionLabel { {}, "This is a demo of a custom accessible widget.\n\n"
                                 "The DRX logo component at the bottom of the page will use the settable properties when queried by "
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CustomWidgetComponent)
};
...
private:
    ...
    public:
        NavigableComponentsHolder()
        {
            ...
            constexpr i32 numChildren = 12;

            for (i32 i = 1; i <= numChildren; ++i)
            {
    ...
    private:
        ...
        {
            NavigableComponent (i32 index, i32 total, NavigableComponentsHolder& owner)
            {
                const auto textColor = Colors::black.withAlpha (0.8f);

                titleLabel.setColor (Label::textColorId, textColor);
                orderLabel.setColor (Label::textColorId, textColor);

                const auto setToggleButtonColors = [textColor] (ToggleButton& b)
                {
                    b.setColor (ToggleButton::textColorId, textColor);
                    b.setColor (ToggleButton::tickDisabledColorId, textColor);
                    b.setColor (ToggleButton::tickColorId, textColor);
                };

                setToggleButtonColors (focusableToggle);
                setToggleButtonColors (defaultToggle);

                const auto title = "Component " + Txt (index);
                setTitle (title);
            ...
            z0 paint (Graphics& g) override
            {
                g.fillAll (backgroundColor.withAlpha (focusableToggle.getToggleState() ? 1.0f : 0.5f));
            }
            ...
            Color backgroundColor = getRandomBrightColor();
            Label titleLabel;
        ...
        z0 orderChanged (const NavigableComponent& changedChild)
        {
        ...
        z0 defaultChanged (const NavigableComponent& newDefault)
        {
            for (auto& child : children)
        ...
        //==============================================================================
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NavigableComponentsHolder)
    };
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CustomNavigationComponent)
};
...
private:
    struct AnnouncementsComponent  : public Component
    {
        ...
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AnnouncementsComponent)
    };
    ...
    struct NotificationsComponent  : public Component
    {
        ...
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NotificationsComponent)
    };
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AnnouncementsAndNotificationsComponent)
};
...
public:
    AccessibilityDemo()
    {
        ...
        setDescription ("A demo of DRX's accessibility features.");
        setFocusContainerType (FocusContainerType::focusContainer);

        tabs.setTitle ("Demo tabs");

        const auto tabColor = getLookAndFeel().findColor (ResizableWindow::backgroundColorId).darker (0.1f);

        tabs.addTab ("DRX Widgets",                    tabColor, &juceWidgetsComponent,                   false);
        tabs.addTab ("Custom Widget",                   tabColor, &customWidgetComponent,                  false);
        tabs.addTab ("Custom Navigation",               tabColor, &customNavigationComponent,              false);
        tabs.addTab ("Announcements and Notifications", tabColor, &announcementsAndNotificationsComponent, false);
...
private:
    ...
    DRXWidgetsComponent juceWidgetsComponent;
    CustomWidgetComponent customWidgetComponent;
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AccessibilityDemo)
};
