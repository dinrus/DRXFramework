...
public:
    ...
    z0 Launch()
    {
        ...
        extern i32 b2_gjkCalls, b2_gjkIters, b2_gjkMaxIters;
        extern i32 b2_toiCalls, b2_toiIters, b2_toiMaxIters;
        extern i32 b2_toiRootIters, b2_toiMaxRootIters;
    ...
    z0 Step(Settings* settings)
    {
        ...
        extern i32 b2_gjkCalls, b2_gjkIters, b2_gjkMaxIters;
        extern i32 b2_toiCalls, b2_toiIters;
        extern i32 b2_toiRootIters, b2_toiMaxRootIters;
