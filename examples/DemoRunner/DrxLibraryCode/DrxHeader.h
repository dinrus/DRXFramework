...
#include <drx_analytics/drx_analytics.h>
#include <drx_animation/drx_animation.h>
...
#include <drx_javascript/drx_javascript.h>
#include <drx_opengl/drx_opengl.h>
#include <drx_osc/drx_osc.h>
#include <drx_product_unlocking/drx_product_unlocking.h>
#include <drx_video/drx_video.h>
...
{
    tukk const  projectName    = "DemoRunner";
    tukk const  companyName    = "DinrusPro";
    tukk const  versionString  = "8.0.7";
    i32k          versionNumber  = 0x80007;
}
#endif
