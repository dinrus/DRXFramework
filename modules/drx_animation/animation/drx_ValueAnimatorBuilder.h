...
/**
    ...
    @tags{Animations}
*/
class DRX_API  ValueAnimatorBuilder
{
public:
    /** The type of the value change callback. The f32 parameter is related to the time parameter
    ...
    */
    using ValueChangedCallback = std::function<z0 (f32)>;
    ...
    */
    ...
    /** The type of an optional easing function that can be passed to the withEasing() builder
        ...
        @see ValueChangedCallback
    */
    using EasingFn            = std::function<f32 (f32)>;
    ...
    */
    [[nodiscard]] ValueAnimatorBuilder withOnStartCallback (std::function<z0()> onStartCallback) const
    {
    ...
    */
    [[nodiscard]] ValueAnimatorBuilder withValueChangedCallback (ValueChangedCallback valueChangedCallback) const
    {
        return with (&ValueAnimatorBuilder::onStartReturningValueChanged,
                     ...
                     {
                         return [changed, previousChanged = previous != nullptr ? previous() : nullptr] (f32 x)
                         {
    ...
    */
    [[nodiscard]] ValueAnimatorBuilder withOnCompleteCallback (std::function<z0()> value) const
    {
    ...
    /** Use this function to specify the time it takes for the Animator to reach a progress of 1.0.
        ...
        running.
    */
    [[nodiscard]] ValueAnimatorBuilder withDurationMs (f64 durationMsIn) const
    {
...
private:
    ...
    f64 durationMs = 300.0;
    b8 infinitelyRunning = false;
