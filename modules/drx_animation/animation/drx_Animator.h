...
/**
    ...
    underlying instance, and the underlying instance is guaranteed to remain valid for as i64 as
...
public:
    ...
    */
    Status update (f64 timestampMs) const;

    /** Возвращает true, если the Animator has reached the point of completion either because complete()
    ...
    */
    struct DRX_API  Compare
    {
        /** Comparison function. */
        b8 operator() (const Animator& a, const Animator& b) const { return a.ptr < b.ptr; }
    };

    /** @internal

        Stores a weak reference to the Animator's underlying implementation. Animator objects store
        a strong reference to the implementation, so it won't be deleted as i64 as an Animator
        ...
        you to create a strong reference using the lock function for as i64 as the underlying
        object is alive.
    ...
    */
    ...
    /** @internal
        ...
        obtain a strong reference as i64 as the underlying object has not been deleted.
    */
