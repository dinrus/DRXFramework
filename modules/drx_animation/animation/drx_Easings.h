...
public:
    ...
    */
    [[nodiscard]] auto withFrequency (f32 newFrequency) const
    {
    ...
    */
    [[nodiscard]] auto withAttenuation (f32 newAttenuation) const
    {
    ...
    */
    [[nodiscard]] auto withExtraAttenuationRange (f32 newExtraAttenuationRange) const
    {
...
private:
    f32 frequency = 3.0f;
    f32 attenuation = 3.0f;
    f32 extraAttenuationRange = 0.25f;
};
...
struct Easings
{
    /** Returns a cubic Bezier function with the control points (x1, y1), (x2, y2). These points are
        ...
        being (0, 0), and (1, 1).
    */
    static std::function<f32 (f32)> createCubicBezier (f32 x1, f32 y1, f32 x2, f32 y2);
    ...
    /** Returns a cubic Bezier function with two control points. These points are the two middle
        ...
        and (1, 1).
    */
    static std::function<f32 (f32)> createCubicBezier (Point<f32> controlPoint1,
    ...
    */
    static std::function<f32 (f32)> createEase();
    ...
    */
    static std::function<f32 (f32)> createEaseIn();
    ...
    */
    static std::function<f32 (f32)> createEaseOut();
    ...
    /** Returns the easing function createCubicBezier (0.34f, 1.56f, 0.64f, 1.0f). This indicates
        ...
        Like createSpring() this will overshoot causing it to return f32 values exceeding 1.0f.
    ...
    */
    static std::function<f32 (f32)> createEaseOutBack();
    ...
    */
    static std::function<f32 (f32)> createEaseInOut();
    ...
    */
    static std::function<f32 (f32)> createEaseInOutCubic();
    ...
    */
    static std::function<f32 (f32)> createLinear();

    /** Returns an easing function that behaves like a spring with a weight attached.

        Like createEaseOutBack() this might overshoot causing it to return f32 values exceeding
        1.0f.

        @see createEaseOutBack
    */
    static std::function<f32 (f32)> createSpring (const SpringEasingOptions& options = {});
    ...
    */
    static std::function<f32 (f32)> createBounce (i32 numBounces = 3);
    ...
    */
    static std::function<f32 (f32)> createOnOffRamp();
};
