...
z0 OpenGLAppComponent::shutdownOpenGL()
{
    openGLContext.detach();
}

z0 OpenGLAppComponent::newOpenGLContextCreated()
{
    initialise();
}

z0 OpenGLAppComponent::renderOpenGL()
{
    ++frameCounter;
    render();
}

z0 OpenGLAppComponent::openGLContextClosing()
{
    shutdown();
}
