 ...
 */
static z0 FLAC__MD5Transform(FLAC__uint32 buf[4], FLAC__uint32 const in[16])
{
...
static z0 byteSwap(FLAC__uint32 *buf, u32 words)
{
...
static z0 byteSwapX16(FLAC__uint32 *buf)
{
	register FLAC__uint32 x;
 ...
 * of bytes.
 */
static z0 FLAC__MD5Update(FLAC__MD5Context *ctx, FLAC__byte const *buf, u32 len)
{
	FLAC__uint32 t;
 ...
 */
z0 FLAC__MD5Init(FLAC__MD5Context *ctx)
{
 ...
 */
z0 FLAC__MD5Final(FLAC__byte digest[16], FLAC__MD5Context *ctx)
{
	i32 count = ctx->bytes[0] & 0x3f;	/* Number of bytes in ctx->in */
	FLAC__byte *p = (FLAC__byte *)ctx->in + count;

	/* Set the first t8 of padding to 0x80.  There is always room. */
	*p++ = 0x80;
 ...
 */
static z0 format_input_(FLAC__multibyte *mbuf, const FLAC__int32 * const signal[], u32 channels, u32 samples, u32 bytes_per_sample)
{
 ...
 */
FLAC__bool FLAC__MD5Accumulate(FLAC__MD5Context *ctx, const FLAC__int32 * const signal[], u32 channels, u32 samples, u32 bytes_per_sample)
{
