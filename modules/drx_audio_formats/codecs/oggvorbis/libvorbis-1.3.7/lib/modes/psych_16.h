...
static const f64 _psy_lowpass_16[4]={6.5,8,30.,99.};
...
static const f64 _noise_thresh_16[4]={ .3,.5,.5,.5 };

static i32k _noise_start_16[3]={ 256,256,9999 };
static i32k _noise_part_16[4]={ 8,8,8,8 };

static i32k _psy_ath_floater_16[4]={
  -100,-100,-100,-105,
};

static i32k _psy_ath_abs_16[4]={
  -130,-130,-130,-140,
};
