...
static const f64 _psy_lowpass_8[3]={3.,4.,4.};
static i32k _noise_start_8[2]={
  64,64,
};
static i32k _noise_part_8[2]={
  8,8,
};

static i32k _psy_ath_floater_8[3]={
  -100,-100,-105,
};

static i32k _psy_ath_abs_8[3]={
  -130,-130,-140,
};
