...
public:
    ...
    */
    ...
    /** Возвращает true, если this the given file can be read by this format.
    ...
    */
    virtual b8 canHandleFile (const File& fileToTest);

    /** Returns a set of sample rates that the format can read and write. */
    virtual Array<i32> getPossibleSampleRates() = 0;

    /** Returns a set of bit depths that the format can read and write. */
    virtual Array<i32> getPossibleBitDepths() = 0;

    /** Возвращает true, если the format can do 2-channel audio. */
    virtual b8 canDoStereo() = 0;

    /** Возвращает true, если the format can do 1-channel audio. */
    virtual b8 canDoMono() = 0;

    /** Возвращает true, если the format uses compressed data. */
    virtual b8 isCompressed();

    /** Возвращает true, если the channel layout is supported by this format. */
    virtual b8 isChannelLayoutSupported (const AudioChannelSet& channelSet);
    ...
    */
    virtual AudioFormatReader* createReaderFor (InputStream* sourceStream,
                                                b8 deleteStreamIfOpeningFails) = 0;
...
protected:
    ...
    */
    AudioFormat (Txt formatName, StringArray fileExtensions);
