...
/** Base class used by the DRX ARA model objects to provide listenable interfaces.

    @tags{ARA}
*/
template <class ListenerType>
class DRX_API  ARAListenableModelClass
{
public:
    /** Constructor. */
    ...
    */
    z0 addListener (ListenerType* l) { listeners.add (l); }

    /** Unsubscribe \p l from object notifications.
        @param l The listener instance.
    */
    z0 removeListener (ListenerType* l) { listeners.remove (l); }

    /** Call the provided callback for each of the added listeners. */
    template <typename Callback>
    z0 notifyListeners (Callback&& callback)
    {
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ARAListenableModelClass)
};
...
public:
    ...
    virtual z0 visitDocument (drx::ARADocument&) {}

    /** Called when visiting an ARAMusicalContext object. */
    virtual z0 visitMusicalContext (drx::ARAMusicalContext&) {}

    /** Called when visiting an ARARegionSequence object. */
    virtual z0 visitRegionSequence (drx::ARARegionSequence&) {}

    /** Called when visiting an ARAPlaybackRegion object. */
    virtual z0 visitPlaybackRegion (drx::ARAPlaybackRegion&) {}

    /** Called when visiting an ARAAudioModification object. */
    virtual z0 visitAudioModification (drx::ARAAudioModification&) {}

    /** Called when visiting an ARAAudioSource object. */
    virtual z0 visitAudioSource (drx::ARAAudioSource&) {}
};

/** Common base class for all DRX ARA model objects to aid with the discovery and traversal of the
...
public:
    ...
    */
    virtual z0 visit (ARAObjectVisitor& visitor) = 0;
};
...
/** A base class for listeners that want to know about changes to an ARADocument object.
    ...
    @tags{ARA}
*/
class DRX_API  ARADocumentListener
{
public:
    /** Destructor */
    ...
    */
    virtual z0 willUpdateDocumentProperties (ARADocument* document,
    ...
    */
    virtual z0 didUpdateDocumentProperties (ARADocument* document);
    ...
    */
    virtual z0 didAddMusicalContextToDocument (ARADocument* document, ARAMusicalContext* musicalContext);
    ...
    */
    virtual z0 willRemoveMusicalContextFromDocument (ARADocument* document, ARAMusicalContext* musicalContext);
    ...
    */
    virtual z0 didReorderMusicalContextsInDocument (ARADocument* document);
    ...
    */
    virtual z0 didAddRegionSequenceToDocument (ARADocument* document, ARARegionSequence* regionSequence);
    ...
    */
    virtual z0 willRemoveRegionSequenceFromDocument (ARADocument* document, ARARegionSequence* regionSequence);
    ...
    */
    virtual z0 didReorderRegionSequencesInDocument (ARADocument* document);
    ...
    */
    virtual z0 didAddAudioSourceToDocument (ARADocument* document, ARAAudioSource* audioSource);
    ...
    */
    virtual z0 willRemoveAudioSourceFromDocument (ARADocument* document, ARAAudioSource* audioSource);

    /** Called before the document is destroyed by the ARA host.
        @param document The document that will be destroyed.
    */
    virtual z0 willDestroyDocument (ARADocument* document);
};
...
/** Base class representing an ARA document.
    ...
    @tags{ARA}
*/
class DRX_API  ARADocument   : public ARA::PlugIn::Document,
...
public:
    ...
    */
    ...
    z0 visit (ARAObjectVisitor& visitor) override { visitor.visitDocument (*this); }
};
...
/** A base class for listeners that want to know about changes to an ARAMusicalContext object.
    ...
    @tags{ARA}
*/
class DRX_API  ARAMusicalContextListener
{
public:
    ...
    */
    virtual z0 willUpdateMusicalContextProperties (ARAMusicalContext* musicalContext,
    ...
    */
    virtual z0 didUpdateMusicalContextProperties (ARAMusicalContext* musicalContext);
    ...
    */
    virtual z0 doUpdateMusicalContextContent (ARAMusicalContext* musicalContext, ARAContentUpdateScopes scopeFlags);
    ...
    */
    virtual z0 didAddRegionSequenceToMusicalContext (ARAMusicalContext* musicalContext, ARARegionSequence* regionSequence);
    ...
    */
    virtual z0 willRemoveRegionSequenceFromMusicalContext (ARAMusicalContext* musicalContext,
    ...
    */
    virtual z0 didReorderRegionSequencesInMusicalContext (ARAMusicalContext* musicalContext);

    /** Called before the musical context is destroyed.
        @param musicalContext The musical context that will be destroyed.
    */
    virtual z0 willDestroyMusicalContext (ARAMusicalContext* musicalContext);
};
...
/** Base class representing an ARA musical context.
    ...
    @tags{ARA}
*/
class DRX_API  ARAMusicalContext     : public ARA::PlugIn::MusicalContext,
...
public:
    ...
    */
    ...
    z0 visit (ARAObjectVisitor& visitor) override { visitor.visitMusicalContext (*this); }
};
...
/** A base class for listeners that want to know about changes to an ARAPlaybackRegion object.
    ...
    @tags{ARA}
*/
class DRX_API  ARAPlaybackRegionListener
{
public:
    /** Destructor. */
    ...
    */
    virtual z0 willUpdatePlaybackRegionProperties (ARAPlaybackRegion* playbackRegion,
    ...
    */
    virtual z0 didUpdatePlaybackRegionProperties (ARAPlaybackRegion* playbackRegion);
    ...
    */
    virtual z0 didUpdatePlaybackRegionContent (ARAPlaybackRegion* playbackRegion,
    ...
    */
    virtual z0 willDestroyPlaybackRegion (ARAPlaybackRegion* playbackRegion);
};
...
/** Base class representing an ARA playback region.
    ...
    @tags{ARA}
*/
class DRX_API  ARAPlaybackRegion     : public ARA::PlugIn::PlaybackRegion,
...
public:
    ...
    */
    ...
    z0 visit (ARAObjectVisitor& visitor) override { visitor.visitPlaybackRegion (*this); }
    ...
    */
    Range<f64> getTimeRange (IncludeHeadAndTail includeHeadAndTail = IncludeHeadAndTail::no) const;
    ...
    */
    z0 notifyContentChanged (ARAContentUpdateScopes scopeFlags, b8 notifyARAHost);
};
...
/** A base class for listeners that want to know about changes to an ARARegionSequence object.
    ...
    @tags{ARA}
*/
class DRX_API  ARARegionSequenceListener
{
public:
    /** Destructor. */
    ...
    */
    virtual z0 willUpdateRegionSequenceProperties (ARARegionSequence* regionSequence,
    ...
    */
    virtual z0 didUpdateRegionSequenceProperties (ARARegionSequence* regionSequence);
    ...
    */
    virtual z0 willRemovePlaybackRegionFromRegionSequence (ARARegionSequence* regionSequence,
    ...
    */
    virtual z0 didAddPlaybackRegionToRegionSequence (ARARegionSequence* regionSequence,
                                                       ARAPlaybackRegion* playbackRegion);

    /** Called before the region sequence is destroyed.
        @param regionSequence The region sequence that will be destroyed.
    */
    virtual z0 willDestroyRegionSequence (ARARegionSequence* regionSequence);
};
...
/** Base class representing an ARA region sequence.
    ...
    @tags{ARA}
*/
class DRX_API  ARARegionSequence     : public ARA::PlugIn::RegionSequence,
...
public:
    ...
    */
    ...
    z0 visit (ARAObjectVisitor& visitor) override { visitor.visitRegionSequence (*this); }
    ...
    */
    Range<f64> getTimeRange (ARAPlaybackRegion::IncludeHeadAndTail includeHeadAndTail = ARAPlaybackRegion::IncludeHeadAndTail::no) const;
...
/** A base class for listeners that want to know about changes to an ARAAudioSource object.
    ...
    @tags{ARA}
*/
class DRX_API  ARAAudioSourceListener
{
public:
    /** Destructor. */
    ...
    */
    virtual z0 willUpdateAudioSourceProperties (ARAAudioSource* audioSource,
    ...
    */
    virtual z0 didUpdateAudioSourceProperties (ARAAudioSource* audioSource);
    ...
    /** Called when the audio source's content (i.e. samples or notes) changes.
        ...
        @param scopeFlags The scope of the content update.
    */
    virtual z0 doUpdateAudioSourceContent (ARAAudioSource* audioSource, ARAContentUpdateScopes scopeFlags);
    ...
    */
    virtual z0 didUpdateAudioSourceAnalysisProgress (ARAAudioSource* audioSource,
    ...
    /** Called before access to an audio source's samples is enabled or disabled.
        ...
        @param enable A b8 indicating whether or not sample access will be enabled or disabled.
    */
    virtual z0 willEnableAudioSourceSamplesAccess (ARAAudioSource* audioSource,
                                                     b8 enable);
    ...
    /** Called after access to an audio source's samples is enabled or disabled.
        ...
        @param enable A b8 indicating whether or not sample access was enabled or disabled.
    */
    virtual z0 didEnableAudioSourceSamplesAccess (ARAAudioSource* audioSource,
                                                    b8 enable);
    ...
    /** Called before an audio source is activated or deactivated when being removed / added from the host's undo history.
        ...
        @param deactivate A b8 indicating whether \p audioSource was deactivated or activated.
    */
    virtual z0 willDeactivateAudioSourceForUndoHistory (ARAAudioSource* audioSource,
                                                          b8 deactivate);
    ...
    /** Called after an audio source is activated or deactivated when being removed / added from the host's undo history.
        ...
        @param deactivate A b8 indicating whether \p audioSource was deactivated or activated.
    */
    virtual z0 didDeactivateAudioSourceForUndoHistory (ARAAudioSource* audioSource,
                                                         b8 deactivate);
    ...
    */
    virtual z0 didAddAudioModificationToAudioSource (ARAAudioSource* audioSource,
    ...
    */
    virtual z0 willRemoveAudioModificationFromAudioSource (ARAAudioSource* audioSource,
                                                             ARAAudioModification* audioModification);

    /** Called before the audio source is destroyed.
        @param audioSource The audio source that will be destroyed.
    */
    virtual z0 willDestroyAudioSource (ARAAudioSource* audioSource);
};
...
/** Base class representing an ARA audio source.
    ...
    @tags{ARA}
*/
class DRX_API  ARAAudioSource    : public ARA::PlugIn::AudioSource,
...
public:
    ...
    */
    ...
    z0 visit (ARAObjectVisitor& visitor) override { visitor.visitAudioSource (*this); }
    ...
    */
    z0 notifyAnalysisProgressStarted();

    /** \copydoc notifyAnalysisProgressStarted
        @param progress Progress normalized to the 0..1 range.
    */
    z0 notifyAnalysisProgressUpdated (f32 progress);

    /** \copydoc notifyAnalysisProgressStarted
    */
    z0 notifyAnalysisProgressCompleted();
...
/** A base class for listeners that want to know about changes to an ARAAudioModification object.
    ...
    @tags{ARA}
*/
class DRX_API  ARAAudioModificationListener
{
public:
    /** Destructor. */
    ...
    */
    virtual z0 willUpdateAudioModificationProperties (ARAAudioModification* audioModification,
    ...
    */
    virtual z0 didUpdateAudioModificationProperties (ARAAudioModification* audioModification);
    ...
    /** Called when the audio modification's content (i.e. samples or notes) changes.
        ...
        @param scopeFlags The scope of the content update.
    */
    virtual z0 didUpdateAudioModificationContent (ARAAudioModification* audioModification,
                                                    ARAContentUpdateScopes scopeFlags);
    ...
    /** Called before an audio modification is activated or deactivated when being removed / added from the host's undo history.
        ...
        @param deactivate A b8 indicating whether \p audioModification was deactivated or activated.
    */
    virtual z0 willDeactivateAudioModificationForUndoHistory (ARAAudioModification* audioModification,
                                                                b8 deactivate);
    ...
    /** Called after an audio modification is activated or deactivated when being removed / added from the host's undo history.
        ...
        @param deactivate A b8 indicating whether \p audioModification was deactivated or activated.
    */
    virtual z0 didDeactivateAudioModificationForUndoHistory (ARAAudioModification* audioModification,
                                                               b8 deactivate);
    ...
    */
    virtual z0 didAddPlaybackRegionToAudioModification (ARAAudioModification* audioModification,
                                                          ARAPlaybackRegion* playbackRegion);
    ...
    */
    virtual z0 willRemovePlaybackRegionFromAudioModification (ARAAudioModification* audioModification,
                                                                ARAPlaybackRegion* playbackRegion);

    /** Called before the audio modification is destroyed.
        @param audioModification The audio modification that will be destroyed.
    */
    virtual z0 willDestroyAudioModification (ARAAudioModification* audioModification);
};
...
/** Base class representing an ARA audio modification.
    ...
    @tags{ARA}
*/
class DRX_API  ARAAudioModification  : public ARA::PlugIn::AudioModification,
...
public:
    ...
    */
    ...
    z0 visit (ARAObjectVisitor& visitor) override { visitor.visitAudioModification (*this); }
