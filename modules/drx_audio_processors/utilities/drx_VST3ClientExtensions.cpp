...
std::map<u32, Txt> VST3ClientExtensions::getCompatibleParameterIds (const InterfaceId&) const
{
    return {};
}

VST3ClientExtensions::InterfaceId VST3ClientExtensions::convertDrxPluginId (u32 manufacturerCode,
                                                                             u32 pluginCode,
                                                                             InterfaceType interfaceType)
{
    const auto word0 = std::invoke ([&]() -> u32
    {
    ...
    const auto word1 = std::invoke ([&]() -> u32
    {
        switch (interfaceType)
        {
    ...
    constexpr auto getByteFromLSB = [] (u32 word, i32 byteIndex)
    {
...
VST3ClientExtensions::InterfaceId VST3ClientExtensions::convertVST2PluginId (u32 pluginCode,
...
u32 VST3ClientExtensions::convertDrxParameterId (const Txt& parameterId, b8 studioOneCompatible)
{
    auto hash = (u32) (parameterId.hashCode());
...
VST3ClientExtensions::InterfaceId VST3ClientExtensions::toInterfaceId (const Txt& interfaceIdString)
{
