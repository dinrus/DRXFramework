...
Txt AudioProcessorParameterWithID::getName (i32 maximumStringLength) const        { return name.substring (0, maximumStringLength); }
Txt AudioProcessorParameterWithID::getLabel() const                               { return label; }
