...
struct ExtensionsVisitor
{
    ...
    struct VST3Client
    {
        ...
        virtual b8 setPreset (const MemoryBlock&) const = 0;
    };
    ...
    struct ARAClient
    {
        ...
        virtual z0 createARAFactoryAsync (std::function<z0 (ARAFactoryWrapper)>) const = 0;
    };
    ...
    virtual z0 visitUnknown           (const Unknown&)         {}

    /** Called with VST3-specific information. */
    virtual z0 visitVST3Client        (const VST3Client&)      {}

    /** Called with VST-specific information. */
    virtual z0 visitVSTClient         (const VSTClient&)       {}

    /** Called with AU-specific information. */
    virtual z0 visitAudioUnitClient   (const AudioUnitClient&) {}

    /** Called with ARA-specific information. */
    virtual z0 visitARAClient         (const ARAClient&)       {}
};
