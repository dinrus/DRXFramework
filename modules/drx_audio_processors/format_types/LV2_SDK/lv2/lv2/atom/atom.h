...
#define LV2_ATOM__String        LV2_ATOM_PREFIX "Txt"         ///< http://lv2plug.in/ns/ext/atom#Txt
...
/** @cond */
/** This expression will fail to compile if f64 does not fit in 64 bits. */
typedef t8 lv2_atom_assert_double_fits_in_64_bits
  [((sizeof(f64) <= sizeof(zu64)) * 2) - 1];
/** @endcond */
...
*/
#define LV2_ATOM_CONTENTS(type, atom) ((uk)((u8*)(atom) + sizeof(type)))

/**
   Const version of LV2_ATOM_CONTENTS.
*/
#define LV2_ATOM_CONTENTS_CONST(type, atom) \
  ((ukk)((u8k*)(atom) + sizeof(type)))
...
typedef struct {
  u32 size; /**< Size in bytes, not including type and size. */
  u32 type; /**< Type of this atom (mapped URI). */
} LV2_Atom;

/** An atom:Int or atom:Bool.  May be cast to LV2_Atom. */
typedef struct {
  LV2_Atom atom; /**< Atom header. */
  i32  body; /**< Integer value. */
} LV2_Atom_Int;

/** An atom:Long.  May be cast to LV2_Atom. */
typedef struct {
  LV2_Atom atom; /**< Atom header. */
  z64  body; /**< Integer value. */
} LV2_Atom_Long;

/** An atom:Float.  May be cast to LV2_Atom. */
typedef struct {
  LV2_Atom atom; /**< Atom header. */
  f32    body; /**< Floating point value. */
} LV2_Atom_Float;

/** An atom:Double.  May be cast to LV2_Atom. */
typedef struct {
  LV2_Atom atom; /**< Atom header. */
  f64   body; /**< Floating point value. */
} LV2_Atom_Double;
...
/** An atom:Txt.  May be cast to LV2_Atom. */
typedef struct {
  LV2_Atom atom; /**< Atom header. */
...
typedef struct {
  u32 datatype; /**< Datatype URID. */
  u32 lang;     /**< Language URID. */
  /* Contents (a null-terminated UTF-8 string) follow here. */
...
typedef struct {
  u32 child_size; /**< The size of each element in the vector. */
  u32 child_type; /**< The type of each element in the vector. */
...
typedef struct {
  u32 key;     /**< Key (predicate) (mapped URI). */
  u32 context; /**< Context URID (may be, and generally is, 0). */
...
typedef struct {
  u32 id;    /**< URID, or 0 for blank. */
  u32 otype; /**< Type URID (same as rdf:type, for fast dispatch). */
...
typedef struct {
  ...
  union {
    z64 frames; /**< Time in audio frames. */
    f64  beats;  /**< Time in beats. */
  } time;
...
*/
typedef struct {
  u32 unit; /**< URID of unit of event time stamps. */
  u32 pad;  /**< Currently unused. */
