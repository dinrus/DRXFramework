...
typedef struct LV2_Descriptor {
  ...
  */
  ...
  /**
     ...
     type in the plugin's RDF data (for example, an array of f32 for an
     lv2:AudioPort). This pointer must be stored by the plugin instance and
     used to read/write data when run() is called. Data present at the time
     of the connect_port() call MUST NOT be considered meaningful.
  */
  z0 (*connect_port)(LV2_Handle instance, u32 port, uk data_location);
  ...
  /**
     ...
     or after activate().
  */
  z0 (*activate)(LV2_Handle instance);
  ...
  /**
     ...
     instance must run.
  */
  z0 (*run)(LV2_Handle instance, u32 sample_count);
  ...
  /**
     ...
     deactivate().
  */
  z0 (*deactivate)(LV2_Handle instance);
  ...
  */
  z0 (*cleanup)(LV2_Handle instance);
...
lv2_descriptor(u32 index);

/**
   Type of the lv2_descriptor() function in a library (old discovery API).
*/
typedef const LV2_Descriptor* (*LV2_Descriptor_Function)(u32 index);

/**
   Handle for a library descriptor.
*/
typedef uk LV2_Lib_Handle;
...
typedef struct {
  ...
  */
  z0 (*cleanup)(LV2_Lib_Handle handle);
  ...
  */
  const LV2_Descriptor* (*get_plugin)(LV2_Lib_Handle handle, u32 index);
} LV2_Lib_Descriptor;
...
lv2_lib_descriptor(tukk bundle_path, const LV2_Feature* const* features);
