...
LV2_LOG_FUNC(2, 3)
static inline i32
lv2_log_error(LV2_Log_Logger* logger, tukk fmt, ...)
{
  va_list args;
  va_start(args, fmt);
  i32k ret = lv2_log_vprintf(logger, logger->Error, fmt, args);
  va_end(args);
  return ret;
}
...
LV2_LOG_FUNC(2, 3)
static inline i32
lv2_log_note(LV2_Log_Logger* logger, tukk fmt, ...)
{
  va_list args;
  va_start(args, fmt);
  i32k ret = lv2_log_vprintf(logger, logger->Note, fmt, args);
  va_end(args);
  return ret;
}
...
LV2_LOG_FUNC(2, 3)
static inline i32
lv2_log_trace(LV2_Log_Logger* logger, tukk fmt, ...)
{
  va_list args;
  va_start(args, fmt);
  i32k ret = lv2_log_vprintf(logger, logger->Trace, fmt, args);
  va_end(args);
  return ret;
}
...
LV2_LOG_FUNC(2, 3)
static inline i32
lv2_log_warning(LV2_Log_Logger* logger, tukk fmt, ...)
{
  va_list args;
  va_start(args, fmt);
  i32k ret = lv2_log_vprintf(logger, logger->Warning, fmt, args);
  va_end(args);
  return ret;
}
