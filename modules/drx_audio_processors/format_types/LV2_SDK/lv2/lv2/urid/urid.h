...
*/
typedef uk LV2_URID_Map_Handle;

/**
   Opaque pointer to host data for LV2_URID_Unmap.
*/
typedef uk LV2_URID_Unmap_Handle;

/**
   URI mapped to an integer.
*/
typedef u32 LV2_URID;
...
typedef struct {
  ...
  */
  LV2_URID (*map)(LV2_URID_Map_Handle handle, tukk uri);
} LV2_URID_Map;
...
typedef struct {
  ...
  */
  tukk (*unmap)(LV2_URID_Unmap_Handle handle, LV2_URID urid);
} LV2_URID_Unmap;
