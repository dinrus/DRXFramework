...
typedef uk LV2_State_Handle; ///< Opaque handle for state save/restore
typedef uk
...
/**
   ...
   memory `size` bytes i64 (this is required to make restore unambiguous).
...
*/
typedef ukk (*LV2_State_Retrieve_Function)(LV2_State_Handle handle,
                                                   u32         key,
                                                   size_t*          size,
                                                   u32*        type,
                                                   u32*        flags);
...
typedef struct {
  ...
  */
  tuk (*abstract_path)(LV2_State_Map_Path_Handle handle,
                         tukk               absolute_path);
  ...
  /**
     ...
     with LV2_State_Free_Path.free_path().
  */
  tuk (*absolute_path)(LV2_State_Map_Path_Handle handle,
                         tukk               abstract_path);
} LV2_State_Map_Path;
...
typedef struct {
  ...
  */
  tuk (*path)(LV2_State_Make_Path_Handle handle, tukk path);
} LV2_State_Make_Path;
...
typedef struct {
  ...
  */
  z0 (*free_path)(LV2_State_Free_Path_Handle handle, tuk path);
} LV2_State_Free_Path;
