...
/**
   The best Pulses Per Quarter Note for tempo-based u32 timestamps.
   Equal to 2^12 * 5 * 7 * 9 * 11 * 13 * 17, which is evenly divisble
   by all integers from 1 through 18 inclusive, and powers of 2 up to 2^12.
*/
LV2_DEPRECATED
static u32k LV2_EVENT_PPQN = 3136573440U;
...
*/
LV2_DEPRECATED
typedef uk LV2_Event_Callback_Data;
...
typedef struct {
  ...
  */
  u32 (*lv2_event_ref)(LV2_Event_Callback_Data callback_data,
                            LV2_Event*              event);
  ...
  /**
     ...
     PLUGINS THAT VIOLATE THESE RULES MAY CAUSE CRASHES AND MEMORY LEAKS.
  */
  u32 (*lv2_event_unref)(LV2_Event_Callback_Data callback_data,
                              LV2_Event*              event);
} LV2_Event_Feature;
