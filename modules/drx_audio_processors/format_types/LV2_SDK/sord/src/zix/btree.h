...
ZIX_API
ZixBTree*
zix_btree_new(ZixComparator cmp, ukk cmp_data, ZixDestroyFunc destroy);
...
ZIX_API
ZixStatus
zix_btree_insert(ZixBTree* t, uk e);
...
ZIX_API
ZixStatus
zix_btree_remove(ZixBTree* t, ukk e, uk* out, ZixBTreeIter** next);
...
ZIX_API
ZixStatus
zix_btree_find(const ZixBTree* t, ukk e, ZixBTreeIter** ti);
...
ZIX_API
ZixStatus
zix_btree_lower_bound(const ZixBTree* t, ukk e, ZixBTreeIter** ti);
