...
struct ViewRect
{
	ViewRect (i32 l = 0, i32 t = 0, i32 r = 0, i32 b = 0)
	...
	//--- ---------------------------------------------------------------------
	i32 getWidth () const { return right - left; }
	i32 getHeight () const { return bottom - top; }
};
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API attached (uk parent, FIDString type) = 0;
	...
	virtual tresult PLUGIN_API onWheel (f32 distance) = 0;
	...
	virtual tresult PLUGIN_API onKeyDown (char16 key, i16 keyCode, i16 modifiers) = 0;
	...
	virtual tresult PLUGIN_API onKeyUp (char16 key, i16 keyCode, i16 modifiers) = 0;
...
{
public:
	virtual z0 PLUGIN_API onFDIsSet (FileDescriptor fd) = 0;
//------------------------------------------------------------------------
	static const FUID iid;
};
...
{
public:
	virtual z0 PLUGIN_API onTimer () = 0;
//------------------------------------------------------------------------
	static const FUID iid;
};
