...
public:
//------------------------------------------------------------------------
	virtual z0 PLUGIN_API setText (const char8* text) = 0;    
...
//------------------------------------------------------------------------
	/** Assign ASCII string */
	virtual z0 PLUGIN_API setText8 (const char8* text) = 0;    
	/** Assign unicode string */
	virtual z0 PLUGIN_API setText16 (const char16* text) = 0;
	...
	virtual z0 PLUGIN_API take (uk s, b8 isWide) = 0;

	/** Возвращает true, если the string is in unicode format, returns false if the string is ASCII */
	virtual b8 PLUGIN_API isWideString () const = 0;
