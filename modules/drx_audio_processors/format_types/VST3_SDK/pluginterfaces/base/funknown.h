...
{ \
	(::Steinberg::i8)(((::Steinberg::u32)(l1) & 0x000000FF)      ), (::Steinberg::i8)(((::Steinberg::u32)(l1) & 0x0000FF00) >>  8), \
	(::Steinberg::i8)(((::Steinberg::u32)(l1) & 0x00FF0000) >> 16), (::Steinberg::i8)(((::Steinberg::u32)(l1) & 0xFF000000) >> 24), \
	(::Steinberg::i8)(((::Steinberg::u32)(l2) & 0x00FF0000) >> 16), (::Steinberg::i8)(((::Steinberg::u32)(l2) & 0xFF000000) >> 24), \
	(::Steinberg::i8)(((::Steinberg::u32)(l2) & 0x000000FF)      ), (::Steinberg::i8)(((::Steinberg::u32)(l2) & 0x0000FF00) >>  8), \
	(::Steinberg::i8)(((::Steinberg::u32)(l3) & 0xFF000000) >> 24), (::Steinberg::i8)(((::Steinberg::u32)(l3) & 0x00FF0000) >> 16), \
	(::Steinberg::i8)(((::Steinberg::u32)(l3) & 0x0000FF00) >>  8), (::Steinberg::i8)(((::Steinberg::u32)(l3) & 0x000000FF)      ), \
	(::Steinberg::i8)(((::Steinberg::u32)(l4) & 0xFF000000) >> 24), (::Steinberg::i8)(((::Steinberg::u32)(l4) & 0x00FF0000) >> 16), \
	(::Steinberg::i8)(((::Steinberg::u32)(l4) & 0x0000FF00) >>  8), (::Steinberg::i8)(((::Steinberg::u32)(l4) & 0x000000FF)      )  \
}
#else
#define INLINE_UID(l1, l2, l3, l4) \
{ \
	(::Steinberg::i8)(((::Steinberg::u32)(l1) & 0xFF000000) >> 24), (::Steinberg::i8)(((::Steinberg::u32)(l1) & 0x00FF0000) >> 16), \
	(::Steinberg::i8)(((::Steinberg::u32)(l1) & 0x0000FF00) >>  8), (::Steinberg::i8)(((::Steinberg::u32)(l1) & 0x000000FF)      ), \
	(::Steinberg::i8)(((::Steinberg::u32)(l2) & 0xFF000000) >> 24), (::Steinberg::i8)(((::Steinberg::u32)(l2) & 0x00FF0000) >> 16), \
	(::Steinberg::i8)(((::Steinberg::u32)(l2) & 0x0000FF00) >>  8), (::Steinberg::i8)(((::Steinberg::u32)(l2) & 0x000000FF)      ), \
	(::Steinberg::i8)(((::Steinberg::u32)(l3) & 0xFF000000) >> 24), (::Steinberg::i8)(((::Steinberg::u32)(l3) & 0x00FF0000) >> 16), \
	(::Steinberg::i8)(((::Steinberg::u32)(l3) & 0x0000FF00) >>  8), (::Steinberg::i8)(((::Steinberg::u32)(l3) & 0x000000FF)      ), \
	(::Steinberg::i8)(((::Steinberg::u32)(l4) & 0xFF000000) >> 24), (::Steinberg::i8)(((::Steinberg::u32)(l4) & 0x00FF0000) >> 16), \
	(::Steinberg::i8)(((::Steinberg::u32)(l4) & 0x0000FF00) >>  8), (::Steinberg::i8)(((::Steinberg::u32)(l4) & 0x000000FF)      )  \
...
public:	                                                                                              \
	virtual ::Steinberg::tresult PLUGIN_API queryInterface (const ::Steinberg::TUID _iid, uk* obj) SMTG_OVERRIDE; \
	virtual ::Steinberg::u32 PLUGIN_API addRef () SMTG_OVERRIDE;                                   \
	virtual ::Steinberg::u32 PLUGIN_API release () SMTG_OVERRIDE;                                  \
protected :                                                                                           \
	::Steinberg::i32 __funknownRefCount;                                                            \
public:
...
public:																			        \
	virtual ::Steinberg::u32 PLUGIN_API addRef () SMTG_OVERRIDE { return ClassName::addRef ();  } \
	virtual ::Steinberg::u32 PLUGIN_API release () SMTG_OVERRIDE { return ClassName::release (); }

//------------------------------------------------------------------------
#define IMPLEMENT_REFCOUNT(ClassName)                                          \
::Steinberg::u32 PLUGIN_API ClassName::addRef ()                            \
{                                                                              \
	return ::Steinberg::FUnknownPrivate::atomicAdd (__funknownRefCount, 1);    \
}                                                                              \
::Steinberg::u32 PLUGIN_API ClassName::release ()                           \
{                                                                              \
...
::Steinberg::tresult PLUGIN_API ClassName::queryInterface (const ::Steinberg::TUID _iid, uk* obj)\
{                                                                                                   \
...
//------------------------------------------------------------------------
typedef z64 LARGE_INT; // obsolete

//------------------------------------------------------------------------
//	FUID class declaration
//------------------------------------------------------------------------
typedef t8 TUID[16]; ///< plain UID type

#if SMTG_CPP14
//------------------------------------------------------------------------
inline SMTG_CONSTEXPR14 z0 copyTUID (tuk dst, tukk src)
{
	for (auto i = 0; i < 16; ++i)
		dst[i] = src[i];
}
...
SMTG_ALWAYS_INLINE b8 iidEqual (ukk iid1, ukk iid2)
{
	const zu64* p1 = reinterpret_cast<const zu64*> (iid1);
	const zu64* p2 = reinterpret_cast<const zu64*> (iid2);
	return p1[0] == p2[0] && p1[1] == p2[1];
}

i32 PLUGIN_API atomicAdd (i32& value, i32 amount);
}
...
//------------------------------------------------------------------------
	FUID ();
	FUID (u32 l1, u32 l2, u32 l3, u32 l4);
	FUID (const FUID&);
	virtual ~FUID () {}
	...
	b8 operator == (const FUID& f) const { return ::Steinberg::FUnknownPrivate::iidEqual (data, f.data); }
	b8 operator < (const FUID& f) const { return memcmp (data, f.data, sizeof (TUID)) < 0; }
	b8 operator != (const FUID& f) const   { return !::Steinberg::FUnknownPrivate::iidEqual (data, f.data); }
	...
	z0 from4Int (u32 d1, u32 d2, u32 d3, u32 d4);
	z0 to4Int (u32& d1, u32& d2, u32& d3, u32& d4) const;

	typedef char8 Txt[33];

	/** Converts UID to a string.
		The string will be 32 characters i64, representing the hexadecimal values
	...
	z0 print (i32 style, char8* string = nullptr, size_t stringBufferSize = 0) const;

	template <size_t N>
	inline explicit FUID (const t8 (&uid)[N])
	{
#if SMTG_CPP11_STDLIBSUPPORT
	...
	inline z0 toTUID (TUID result) const { memcpy (result, data, sizeof (TUID)); }
...
#if SMTG_CPP11_STDLIBSUPPORT
template <typename T>
inline b8 operator== (const FUID& f1, T f2)
{
	static_assert (
 ...
 */
template <typename T, typename U = z0>
...
{
	if (unknown && unknown->queryInterface (getTUID<I> (), (uk*)&this->ptr) != kResultOk)
		this->ptr = 0;
}
...
{
	I* newPtr = 0;
	if (unknown && unknown->queryInterface (getTUID<I> (), (uk*)&newPtr) == kResultOk)
	{
		OPtr<I> rel (newPtr);
