...
//------------------------------------------------------------------------
	...
	i32 flags;				///< (see FactoryFlags above)
//------------------------------------------------------------------------
...
//------------------------------------------------------------------------
	...
	SMTG_CONSTEXPR14 PClassInfo (const TUID _cid, i32 _cardinality, const char8* _category,
	                             const char8* _name)
#if SMTG_CPP14
...
//------------------------------------------------------------------------
	...
	virtual i32 PLUGIN_API countClasses () = 0;

	/** Fill a PClassInfo structure with information about the class at the specified index. */
	virtual tresult PLUGIN_API getClassInfo (i32 index, PClassInfo* info) = 0;

	/** Create a new class instance. */
	virtual tresult PLUGIN_API createInstance (FIDString cid, FIDString _iid, uk* obj) = 0;
...
//------------------------------------------------------------------------
	...
	SMTG_CONSTEXPR14 PClassInfo2 (const TUID _cid, i32 _cardinality, const char8* _category,
	                              const char8* _name, i32 _classFlags,
...
#endif
	{
		...
		classFlags = static_cast<u32> (_classFlags);
		if (_subCategories)
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API getClassInfo2 (i32 index, PClassInfo2* info) = 0;
...
//------------------------------------------------------------------------
	...
	i32 cardinality;					///< see \ref PClassInfo
...
//------------------------------------------------------------------------
	SMTG_CONSTEXPR14 PClassInfoW (const TUID _cid, i32 _cardinality, const char8* _category,
	                              const char16* _name, i32 _classFlags,
	...
	SMTG_CONSTEXPR14 z0 fromAscii (const PClassInfo2& ci2)
	{
#if SMTG_CPP14
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API getClassInfoUnicode (i32 index, PClassInfoW* info) = 0;
...
{ \
	(i8)((l1 & 0xFF000000) >> 24), (i8)((l1 & 0x00FF0000) >> 16), \
	(i8)((l1 & 0x0000FF00) >>  8), (i8)((l1 & 0x000000FF)      ), \
	(i8)((l2 & 0xFF000000) >> 24), (i8)((l2 & 0x00FF0000) >> 16), \
	(i8)((l2 & 0x0000FF00) >>  8), (i8)((l2 & 0x000000FF)      ), \
	(i8)((l3 & 0xFF000000) >> 24), (i8)((l3 & 0x00FF0000) >> 16), \
	(i8)((l3 & 0x0000FF00) >>  8), (i8)((l3 & 0x000000FF)      ), \
	(i8)((l4 & 0xFF000000) >> 24), (i8)((l4 & 0x00FF0000) >> 16), \
	(i8)((l4 & 0x0000FF00) >>  8), (i8)((l4 & 0x000000FF)      )  \
}
