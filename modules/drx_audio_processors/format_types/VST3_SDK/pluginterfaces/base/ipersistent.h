...
//------------------------------------------------------------------------
	...
	******************************************************************************************************** */
	...
	virtual tresult PLUGIN_API setBinaryData (IAttrID attrID, uk data, u32 bytes, b8 copyBytes) = 0;
	//@}
	...
	******************************************************************************************************** */
	...
	/** Get list of data previously stored to the archive. As i64 as there are queue members the method
	...
	virtual i32 PLUGIN_API getQueueItemCount (IAttrID) = 0;
	...
	virtual tresult PLUGIN_API getBinaryData (IAttrID attrID, uk data, u32 bytes) = 0;
	/** Get the size in bytes of binary data in the archive. */	
	virtual u32 PLUGIN_API getBinaryDataSize (IAttrID attrID) = 0;
	//@}
...
public:
	...
	virtual i32 PLUGIN_API countAttributes () const = 0;
	/** Returns the attribute's ID for the given index. */
	virtual IAttrID PLUGIN_API getAttributeID (i32 index) const = 0;
//------------------------------------------------------------------------
	static const FUID iid;
};
