...
class MyController : public Vst::EditController, public Vst::INoteExpressionPhysicalUIMapping
{
	...
	tresult PLUGIN_API getPhysicalUIMapping (i32 busIndex, i16 channel, PhysicalUIMapList& list) SMTG_OVERRIDE;
	// ...
...
//------------------------------------------------------------------------
tresult PLUGIN_API MyController::getPhysicalUIMapping (i32 busIndex, i16 channel, PhysicalUIMapList& list)
{
...
public:
	 ...
	 * and channel. */
	virtual tresult PLUGIN_API getPhysicalUIMapping (i32 busIndex, i16 channel,
