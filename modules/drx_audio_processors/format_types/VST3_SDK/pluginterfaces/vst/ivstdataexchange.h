...
//------------------------------------------------------------------------
typedef u32 DataExchangeQueueID;
typedef u32 DataExchangeBlockID;
typedef u32 DataExchangeUserContextID;
...
public:
	 ...
	 */
	virtual tresult PLUGIN_API openQueue (IAudioProcessor* processor, u32 blockSize,
	                                      u32 numBlocks, u32 alignment,
...
public:
	 ...
	 */
	virtual z0 PLUGIN_API queueOpened (DataExchangeUserContextID userContextID, u32 blockSize,
	 ...
	 *	@param userContextID the user context ID of the queue
	 */
	virtual z0 PLUGIN_API queueClosed (DataExchangeUserContextID userContextID) = 0;
	 ...
	 */
	virtual z0 PLUGIN_API onDataExchangeBlocksReceived (DataExchangeUserContextID userContextID,
	                                                      u32 numBlocks,
