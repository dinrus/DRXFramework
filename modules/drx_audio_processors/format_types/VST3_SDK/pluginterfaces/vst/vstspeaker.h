...
//------------------------------------------------------------------------
/** Speaker Arrangement Txt Representation.
\ingroup speakerArrangements */
/*@{*/
...
//------------------------------------------------------------------------
/** Speaker Arrangement Txt Representation with Speakers Name.
\ingroup speakerArrangements */
/*@{*/
...
\ingroup speakerArrangements */
/*@{*/
inline i32 getChannelCount (SpeakerArrangement arr)
{
	i32 count = 0;
	while (arr)
	{
 ...
 * arrangement). */
inline i32 getSpeakerIndex (Speaker speaker, SpeakerArrangement arrangement)
{
...
inline Speaker getSpeaker (const SpeakerArrangement& arr, i32 index)
{
...
//------------------------------------------------------------------------
/** Возвращает true, если arrSubSet is a subset speaker of arr (means each speaker of arrSubSet is
 * included in arr). */
inline b8 isSubsetOf (const SpeakerArrangement& arrSubSet, const SpeakerArrangement& arr)
{
	return (arrSubSet == (arrSubSet & arr));
}

//------------------------------------------------------------------------
/** Возвращает true, если arrangement is a Auro configuration. */
inline b8 isAuro (const SpeakerArrangement& arr)
{
...
//------------------------------------------------------------------------
/** Возвращает true, если arrangement contains top (upper layer) speakers */
inline b8 hasTopSpeakers (const SpeakerArrangement& arr)
{
...
//------------------------------------------------------------------------
/** Возвращает true, если arrangement contains bottom (lower layer) speakers */
inline b8 hasBottomSpeakers (const SpeakerArrangement& arr)
{
...
//------------------------------------------------------------------------
/** Возвращает true, если arrangement contains middle layer (at ears level) speakers */
inline b8 hasMiddleSpeakers (const SpeakerArrangement& arr)
{
...
//------------------------------------------------------------------------
/** Возвращает true, если arrangement contains LFE speakers */
inline b8 hasLfe (const SpeakerArrangement& arr)
{
...
//------------------------------------------------------------------------
/** Возвращает true, если arrangement is a 3D configuration ((top or bottom) and middle) */
inline b8 is3D (const SpeakerArrangement& arr)
{
	b8 top = hasTopSpeakers (arr);
	b8 bottom = hasBottomSpeakers (arr);
	b8 middle = hasMiddleSpeakers (arr);
...
//------------------------------------------------------------------------
/** Возвращает true, если arrangement is a Ambisonic configuration. */
inline b8 isAmbisonics (const SpeakerArrangement& arr)
{
...
{
	i32 idx = getSpeakerIndex (speaker_1234_order, kAmbi4thOrderACN);
	if (idx < 0)
		return 0;
...
{
	i32 idx = getSpeakerIndex (speaker_567_order, kAmbi7thOrderACN);
	if (idx < 0)
		return 0;
...
inline CString getSpeakerArrangementString (SpeakerArrangement arr, b8 withSpeakersName)
{
	switch (arr)
	{
...
inline CString getSpeakerShortName (const SpeakerArrangement& arr, i32 index)
{
	SpeakerArrangement arrTmp = arr;
