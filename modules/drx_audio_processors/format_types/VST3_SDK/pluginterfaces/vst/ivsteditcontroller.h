...
//------------------------------------------------------------------------
	...
	i32 stepCount;	///< number of discrete steps (0: continuous, 1: toggle, discrete value
	...
	i32 flags;		///< ParameterFlags (see below)

	enum ParameterFlags : i32
	{
		/** No flags wanted.
		 * [SDK 3.0.0] */
		kNoFlags = 0,
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API restartComponent (i32 flags /*in*/) = 0;
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API getParameterInfo (i32 paramIndex /*in*/,
...
class MyEditController: public EditControllerEx1, public IMidiMapping
{
    //...
    //---IMidiMapping---------------------------
    tresult PLUGIN_API getMidiControllerAssignment (i32 busIndex, i16 channel,
...
tresult PLUGIN_API MyEditController::getMidiControllerAssignment (i32 busIndex,
														          i16 midiChannel,
                                                                  CtrlNumber midiControllerNumber,
																  ParamID& tag)
{
...
public:
	 ...
	 */
	virtual tresult PLUGIN_API getMidiControllerAssignment (i32 busIndex /*in*/,
	                                                        i16 channel /*in*/,
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API getSystemTime (z64& systemTime /*out*/) = 0;
//------------------------------------------------------------------------
	static const FUID iid;
};
