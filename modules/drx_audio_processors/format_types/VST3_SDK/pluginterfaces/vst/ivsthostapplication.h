...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API createInstance (TUID cid, TUID _iid, uk* obj) = 0;
...
inline IMessage* allocateMessage (IHostApplication* host)
{
	...
	IMessage* m = nullptr;
	if (host->createInstance (iid, iid, (uk*)&m) == kResultOk)
		return m;
	return nullptr;
}
...
//------------------------------------------------------------------------
	 ...
	 *	@return kResultTrue on success */
	virtual tresult PLUGIN_API setMPEInputDeviceSettings (i32 masterChannel,
	                                                      i32 memberBeginChannel,
	                                                      i32 memberEndChannel) = 0;
