...
struct ProgramListInfo
{
	...
	i32 programCount;				///< number of programs in this list
};

//------------------------------------------------------------------------
/** Special programIndex value for IUnitHandler::notifyProgramListChange */
static const i32 kAllProgramInvalid =	-1;		///< all program information is invalid
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API notifyProgramListChange (ProgramListID listId, i32 programIndex) = 0;
...
//------------------------------------------------------------------------
	...
	virtual i32 PLUGIN_API getUnitCount () = 0;

	/** Gets UnitInfo for a given index in the flat list of unit. */
	virtual tresult PLUGIN_API getUnitInfo (i32 unitIndex, UnitInfo& info /*out*/) = 0;

	/** Component intern program structure. */
	/** Gets the count of Program List. */
	virtual i32 PLUGIN_API getProgramListCount () = 0;

	/** Gets for a given index the Program List Info. */
	virtual tresult PLUGIN_API getProgramListInfo (i32 listIndex, ProgramListInfo& info /*out*/) = 0;

	/** Gets for a given program list ID and program index its program name. */
	virtual tresult PLUGIN_API getProgramName (ProgramListID listId, i32 programIndex, String128 name /*out*/) = 0;

	/** Gets for a given program list ID, program index and attributeId the associated attribute value. */
	virtual tresult PLUGIN_API getProgramInfo (ProgramListID listId, i32 programIndex,
		CString attributeId /*in*/, String128 attributeValue /*out*/) = 0;

	/** Returns kResultTrue if the given program index of a given program list ID supports PitchNames. */
	virtual tresult PLUGIN_API hasProgramPitchNames (ProgramListID listId, i32 programIndex) = 0;

	/** Gets the PitchName for a given program list ID, program index and pitch.
		If PitchNames are changed the plug-in should inform the host with IUnitHandler::notifyProgramListChange. */
	virtual tresult PLUGIN_API getProgramPitchName (ProgramListID listId, i32 programIndex,
		i16 midiPitch, String128 name /*out*/) = 0;
	...
	virtual tresult PLUGIN_API getUnitByBus (MediaType type, BusDirection dir, i32 busIndex,
		i32 channel, UnitID& unitId /*out*/) = 0;
	...
	virtual tresult PLUGIN_API setUnitProgramData (i32 listOrUnitId, i32 programIndex, IBStream* data) = 0;
...
//------------------------------------------------------------------------
	...
	virtual tresult PLUGIN_API getProgramData (ProgramListID listId, i32 programIndex, IBStream* data) = 0;

	/** Sets for a given program list ID and program index a program Data. */
	virtual tresult PLUGIN_API setProgramData (ProgramListID listId, i32 programIndex, IBStream* data) = 0;
