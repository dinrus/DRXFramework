...
/** integer (z64) [optional]: number of characters in kChannelUIDKey */
...
/** integer (z64) [optional]: number of characters in kChannelNameKey */
...
/** integer (z64) [optional]: index of the channel in a channel index namespace, start with 1 not * 0! */
const CString kChannelIndexKey = "channel index";

/** integer (z64) [optional]: define the order of the current used index namespace, start with 1 not 0!
	For example:
...
/** integer (z64) [optional]: number of characters in kChannelIndexNamespaceKey */
...
/** integer (z64) [optional]: routing position of the plug-in in the channel (see ChannelPluginLocation) */
