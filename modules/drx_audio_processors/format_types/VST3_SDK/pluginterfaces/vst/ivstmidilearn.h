...
class MyController : public Vst::EditController, public Vst::IMidiLearn
{
	// ...
	//--- IMidiLearn ---------------------------------
	tresult PLUGIN_API onLiveMIDIControllerInput (i32 busIndex, i16 channel,
...
//------------------------------------------------------------------------
tresult PLUGIN_API MyController::onLiveMIDIControllerInput (i32 busIndex, 
							i16 channel, CtrlNumber midiCC)
{
...
public:
	...
	virtual tresult PLUGIN_API onLiveMIDIControllerInput (i32 busIndex, i16 channel,
													      CtrlNumber midiCC) = 0;
