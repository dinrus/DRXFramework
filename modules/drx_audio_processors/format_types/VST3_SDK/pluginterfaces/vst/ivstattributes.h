...
//------------------------------------------------------------------------
	...
	/** Sets integer value. */
	virtual tresult PLUGIN_API setInt (AttrID id, z64 value) = 0;

	/** Gets integer value. */
	virtual tresult PLUGIN_API getInt (AttrID id, z64& value) = 0;

	/** Sets f32 value. */
	virtual tresult PLUGIN_API setFloat (AttrID id, f64 value) = 0;

	/** Gets f32 value. */
	virtual tresult PLUGIN_API getFloat (AttrID id, f64& value) = 0;
	...
	virtual tresult PLUGIN_API getString (AttrID id, TChar* string, u32 sizeInBytes) = 0;

	/** Sets binary data. */
	virtual tresult PLUGIN_API setBinary (AttrID id, ukk data, u32 sizeInBytes) = 0;

	/** Gets binary data. */
	virtual tresult PLUGIN_API getBinary (AttrID id, ukk& data, u32& sizeInBytes) = 0;
//------------------------------------------------------------------------
