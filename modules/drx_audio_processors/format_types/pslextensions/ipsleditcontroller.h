...
{	
	...
	virtual Steinberg::i32 PLUGIN_API getParamExtraFlags (Steinberg::Vst::ParamID id) = 0;
	
	/** Set automation mode for given parameter (see AutomationMode). */
	virtual Steinberg::tresult PLUGIN_API setParamAutomationMode (Steinberg::Vst::ParamID id, Steinberg::i32 automationMode) = 0;
...
{	
	...
	*/
	virtual Steinberg::tresult PLUGIN_API addSlave (Steinberg::Vst::IEditController* slave, Steinberg::i32 slaveMode) = 0;
