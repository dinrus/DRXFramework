...
struct IHostCommandHandler: Steinberg::FUnknown
{
	...
	virtual Steinberg::tresult PLUGIN_API popupCommandMenu (ICommandList* commandList, Steinberg::i32 xPos, Steinberg::i32 yPos, Steinberg::IPlugView* view = 0) = 0;
...
struct CommandInfo
{
	...
	Steinberg::i32 flags;				///< command flags
...
struct ICommandList: Steinberg::FUnknown
{
	...
	virtual Steinberg::i32 PLUGIN_API getCommandCount () = 0;
	
	/** Get command information for a given index. */
	virtual Steinberg::tresult PLUGIN_API getCommandInfo (Steinberg::i32 index, CommandInfo& info) = 0;
	
	/** Execute command at given index. */
	virtual Steinberg::tresult PLUGIN_API executeCommand (Steinberg::i32 index) = 0;
