...
#if (DRX_PLUGINHOST_AU && (DRX_MAC || DRX_IOS)) || DOXYGEN
...
/**
    ...
    @tags{Audio}
*/
class DRX_API  AudioUnitPluginFormat   : public AudioPluginFormat
{
public:
    //==============================================================================
    ...
    //==============================================================================
    static Txt getFormatName()                   { return "AudioUnit"; }
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioUnitPluginFormat)
};
