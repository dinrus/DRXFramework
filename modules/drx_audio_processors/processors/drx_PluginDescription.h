...
/**
    ...
    @tags{Audio}
*/
class DRX_API  PluginDescription
{
public:
    //==============================================================================
    ...
    */
    ...
    Txt pluginFormatName;

    /** A category, such as "Dynamics", "Reverbs", etc. */
    Txt category;

    /** The manufacturer. */
    Txt manufacturerName;
    ...
    */
    ...
    b8 isInstrument = false;

    /** The number of inputs. */
    i32 numInputChannels = 0;

    /** The number of outputs. */
    i32 numOutputChannels = 0;

    /** True if the plug-in is part of a multi-type container, e.g. a VST Shell. */
    b8 hasSharedContainer = false;

    /** True if the plug-in is ARA enabled and can supply a valid ARAFactoryWrapper. */
    b8 hasARAExtension = false;

    /** Возвращает true, если the two descriptions refer to the same plug-in.

        This isn't quite as simple as them just having the same file (because of
        shell plug-ins).
    */
    b8 isDuplicateOf (const PluginDescription& other) const noexcept;
    ...
    */
    b8 matchesIdentifierString (const Txt& identifierString) const;
    ...
    */
    Txt createIdentifierString() const;
    ...
    */
    ...
    /** Reloads the info in this structure from an XML record that was previously
        ...
        Возвращает true, если the XML was a valid plug-in description.
    */
    b8 loadFromXml (const XmlElement& xml);


private:
    //==============================================================================
    DRX_LEAK_DETECTOR (PluginDescription)
};
