...
/** An abstract base class for parameter objects that can be added to an
    ...
    @tags{Audio}
*/
class DRX_API  AudioProcessorParameter
{
public:
    ...
    /** The version hint supplied to this constructor is used in Audio Unit plugins to aid ordering
        parameter identifiers when DRX_FORCE_USE_LEGACY_PARAM_IDS is not enabled.
        ...
        their version hint, and then by the hash of their string identifier. As i64 as the
        ...
        Note that we can't just use the DRX parameter index directly in order to preserve ordering.
    ...
    */
    explicit AudioProcessorParameter (i32 versionHint)
        : version (versionHint) {}
    ...
    */
    virtual z0 setValue (f32 newValue) = 0;
    ...
    */
    z0 setValueNotifyingHost (f32 newValue);
    ...
    */
    ...
    /** Returns a textual version of the supplied normalised parameter value.
        ...
        of value.
    */
    virtual Txt getText (f32 normalisedValue, i32 /*maximumStringLength*/) const;

    /** Should parse a string and return the appropriate value for it. */
    virtual f32 getValueForText (const Txt& text) const = 0;
    ...
    */
    virtual b8 isOrientationInverted() const;

    /** Возвращает true, если the host can automate this parameter.
        By default, this returns true.
    */
    virtual b8 isAutomatable() const;
    ...
    */
    virtual b8 isMetaParameter() const;
    ...
    i32 getParameterIndex() const noexcept              { return parameterIndex; }

    //==============================================================================
    /** Returns the current value of the parameter as a Txt.
    ...
    */
    virtual Txt getCurrentValueAsText() const;
    ...
    */
    ...
    i32 getVersionHint() const                      { return version; }
    ...
    */
    ...
    public:
        ...
        */
        virtual z0 parameterValueChanged (i32 parameterIndex, f32 newValue) = 0;
        ...
        /** Indicates that a parameter change gesture has started.
            ...
            message thread.
        */
        virtual z0 parameterGestureChanged (i32 parameterIndex, b8 gestureIsStarting) = 0;
    };
    ...
    */
    ...
    //==============================================================================
    /** @internal */
    z0 sendValueChangedMessageToListeners (f32 newValue);
...
private:
   ...
   #if DRX_DEBUG
    b8 isPerformingGesture = false;
   #endif

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioProcessorParameter)
};
