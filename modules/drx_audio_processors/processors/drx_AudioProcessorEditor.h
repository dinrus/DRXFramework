...
/**
    ...
    @tags{Audio}
*/
class DRX_API  AudioProcessorEditor  : public Component
{
protected:
    //==============================================================================
...
public:
    ...
    */
    virtual z0 setControlHighlight (ParameterControlHighlightInfo);
    ...
    /** Called by certain plug-in wrappers to find out whether a component is used
        ...
        under the mouse.
    */
    virtual i32 getControlParameterIndex (Component&);
    ...
    */
    virtual b8 supportsHostMIDIControllerPresence (b8 hostMIDIControllerIsAvailable);
    ...
    */
    virtual z0 hostMIDIControllerIsAvailable (b8 controllerIsAvailable);

    /** Can be called by a host to tell the editor that it should use a non-unity
        GUI scale.
    */
    virtual z0 setScaleFactor (f32 newScale);
    ...
    */
    z0 setResizable (b8 allowHostToResize, b8 useBottomRightCornerResizer);

    /** Возвращает true, если the host is allowed to resize the editor's parent window.

        @see setResizable
    */
    b8 isResizable() const noexcept      { return resizableByHost; }
    ...
    */
    ...
    /** Calls the window's setBounds method, after first checking these bounds
        ...
        @see setConstrainer
     */
    z0 setBoundsConstrained (Rectangle<i32> newBounds);
    ...
    */
    z0 setHostContext (AudioProcessorEditorHostContext* context) noexcept   { hostContext = context; }
    ...
    */
    ...
    /** The plugin wrapper will call this function to decide whether to use a layer-backed view to
        ...
        The default behaviour of this function is to return false if and only if the drx_opengl
    ...
    */
    virtual b8 wantsLayerBackedView() const;
...
private:
    ...
    struct AudioProcessorEditorListener : public ComponentListener
    {
        ...
        z0 componentMovedOrResized (Component&, b8, b8 wasResized) override   { ed.editorResized (wasResized); }
        z0 componentParentHierarchyChanged (Component&) override                  { ed.updatePeer(); }

        AudioProcessorEditor& ed;

        DRX_DECLARE_NON_COPYABLE (AudioProcessorEditorListener)
    };

    ComponentPeer* createNewPeer (i32 styleFlags, uk) override;

    //==============================================================================
    z0 initialise();
    z0 editorResized (b8 wasResized);
    z0 updatePeer();
    z0 attachConstrainer (ComponentBoundsConstrainer*);
    z0 attachResizableCornerComponent();

    //==============================================================================
    std::unique_ptr<AudioProcessorEditorListener> resizeListener;
    b8 resizableByHost = false;
    ComponentBoundsConstrainer defaultConstrainer;
    ComponentBoundsConstrainer* constrainer = nullptr;
    AudioProcessorEditorHostContext* hostContext = nullptr;
    AffineTransform hostScaleTransform;

    DRX_DECLARE_NON_COPYABLE (AudioProcessorEditor)
};
