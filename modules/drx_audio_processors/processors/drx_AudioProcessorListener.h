...
/**
    ...
    @tags{Audio}
*/
class DRX_API  AudioProcessorListener
{
public:
    //==============================================================================
    /** Destructor. */
    ...
    */
    virtual z0 audioProcessorParameterChanged (AudioProcessor* processor,
                                                 i32 parameterIndex,
                                                 f32 newValue) = 0;

    /** Provides details about aspects of an AudioProcessor which have changed.
    */
    struct DRX_API  ChangeDetails
    {
        /** @see withLatencyChanged */
        b8 latencyChanged           = false;
        /** @see withParameterInfoChanged */
        b8 parameterInfoChanged     = false;
        /** @see withProgramChanged */
        b8 programChanged           = false;
        /** @see withNonParameterStateChanged */
        b8 nonParameterStateChanged = false;
        ...
        /** Indicates that the AudioProcessor's latency has changed.
            ...
            @see latencyChanged
        */
        [[nodiscard]] ChangeDetails withLatencyChanged           (b8 b) const noexcept { return with (&ChangeDetails::latencyChanged,           b); }
        ...
        */
        [[nodiscard]] ChangeDetails withParameterInfoChanged     (b8 b) const noexcept { return with (&ChangeDetails::parameterInfoChanged,     b); }
        ...
        /** Indicates that the loaded program has changed.
            ...
            @see programChanged
        */
        [[nodiscard]] ChangeDetails withProgramChanged           (b8 b) const noexcept { return with (&ChangeDetails::programChanged,           b); }
        ...
        */
        [[nodiscard]] ChangeDetails withNonParameterStateChanged (b8 b) const noexcept { return with (&ChangeDetails::nonParameterStateChanged, b); }
    ...
    /** Called to indicate that something else in the plugin has changed, like its
        ...
        message thread.
    */
    virtual z0 audioProcessorChanged (AudioProcessor* processor, const ChangeDetails& details) = 0;
    ...
    */
    virtual z0 audioProcessorParameterChangeGestureBegin (AudioProcessor* processor,
                                                            i32 parameterIndex);
    ...
    */
    virtual z0 audioProcessorParameterChangeGestureEnd (AudioProcessor* processor,
                                                          i32 parameterIndex);
};
