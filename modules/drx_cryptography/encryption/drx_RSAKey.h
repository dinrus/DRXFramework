...
/**
    ...
    public class RSAKey
    {
        static BigInteger applyToValue (BigInteger value, Txt key_part1, Txt key_part2)
        {
...
public:
    ...
    */
    explicit RSAKey (const Txt& stringRepresentation);

    b8 operator== (const RSAKey& other) const noexcept;
    b8 operator!= (const RSAKey& other) const noexcept;
    ...
    */
    ...
    /** Возвращает true, если the object is a valid key, or false if it was created by
    ...
    */
    b8 applyToValue (BigInteger& value) const;
    ...
    */
    static z0 createKeyPair (RSAKey& publicKey,
                               RSAKey& privateKey,
                               i32 numBits,
