...
struct WhirlpoolProcessor
{
    ...
    z0 processStream (InputStream& input, z64 numBytesToRead, u8* result)
    {
        ...
        {
            u8 data[64];
            auto bytesRead = input.read (data, (i32) jmin (numBytesToRead, (z64) sizeof (data)));
            ...
            if (bytesRead < (i32) sizeof (data))
                break;

            numBytesToRead -= (z64) sizeof (data);
        }
    ...
    u8 bitLength[32] = {};
    u8 buffer[64] = {};
    i32 bufferBits = 0, bufferPos = 0;
    zu64 hash[8] = {};

private:
    z0 add (u8k* source, i32 numBits) noexcept
    {
        i32 sourcePos = 0;                        // index of leftmost source u8 containing data (1 to 8 bits)
        i32 sourceGap = (8 - (numBits & 7)) & 7;  // space on source[sourcePos]
        i32 bufferRem = bufferBits & 7;           // occupied bits on buffer[bufferPos]

        zu64 value = (zu64) numBits, carry = 0;

        for (i32 i = 32; --i >= 0 && (carry != 0 || value != 0);)
        {
        ...
        while (numBits > 8)
        {
            b = ((source[sourcePos] << sourceGap) & 0xff)
                  | (u32) ((source[sourcePos + 1] & 0xff) >> (8 - sourceGap));
            ...
            buffer[bufferPos] = static_cast<u8> (b << (8 - bufferRem));
        ...
        {
            b = (source[sourcePos] << sourceGap) & 0xff;
            buffer[bufferPos] = static_cast<u8> (buffer[bufferPos] | (b >> bufferRem));
        }
        else
        {
            b = 0;
    ...
    z0 finalize (u8* result) noexcept
    {
        // append a '1'-bit
        buffer[bufferPos] = static_cast<u8> (buffer[bufferPos] | (0x80u >> (bufferBits & 7)));
        bufferPos++;
    ...
    z0 processNextBuffer() noexcept
    {
        static const zu64 rc[] =
        ...
        for (i32 i = 0; i < 10; ++i)
        {
            ...
            L[0] = C0[(i32) (K[0] >> 56)] ^ C1[(i32) (K[7] >> 48) & 0xff] ^ C2[(i32) (K[6] >> 40) & 0xff] ^ C3[(i32) (K[5] >> 32) & 0xff] ^ C4[(i32) (K[4] >> 24) & 0xff] ^ C5[(i32) (K[3] >> 16) & 0xff] ^ C6[(i32) (K[2] >>  8) & 0xff] ^ C7[(i32) (K[1]) & 0xff] ^ rc[i];
            L[1] = C0[(i32) (K[1] >> 56)] ^ C1[(i32) (K[0] >> 48) & 0xff] ^ C2[(i32) (K[7] >> 40) & 0xff] ^ C3[(i32) (K[6] >> 32) & 0xff] ^ C4[(i32) (K[5] >> 24) & 0xff] ^ C5[(i32) (K[4] >> 16) & 0xff] ^ C6[(i32) (K[3] >>  8) & 0xff] ^ C7[(i32) (K[2]) & 0xff];
            L[2] = C0[(i32) (K[2] >> 56)] ^ C1[(i32) (K[1] >> 48) & 0xff] ^ C2[(i32) (K[0] >> 40) & 0xff] ^ C3[(i32) (K[7] >> 32) & 0xff] ^ C4[(i32) (K[6] >> 24) & 0xff] ^ C5[(i32) (K[5] >> 16) & 0xff] ^ C6[(i32) (K[4] >>  8) & 0xff] ^ C7[(i32) (K[3]) & 0xff];
            L[3] = C0[(i32) (K[3] >> 56)] ^ C1[(i32) (K[2] >> 48) & 0xff] ^ C2[(i32) (K[1] >> 40) & 0xff] ^ C3[(i32) (K[0] >> 32) & 0xff] ^ C4[(i32) (K[7] >> 24) & 0xff] ^ C5[(i32) (K[6] >> 16) & 0xff] ^ C6[(i32) (K[5] >>  8) & 0xff] ^ C7[(i32) (K[4]) & 0xff];
            L[4] = C0[(i32) (K[4] >> 56)] ^ C1[(i32) (K[3] >> 48) & 0xff] ^ C2[(i32) (K[2] >> 40) & 0xff] ^ C3[(i32) (K[1] >> 32) & 0xff] ^ C4[(i32) (K[0] >> 24) & 0xff] ^ C5[(i32) (K[7] >> 16) & 0xff] ^ C6[(i32) (K[6] >>  8) & 0xff] ^ C7[(i32) (K[5]) & 0xff];
            L[5] = C0[(i32) (K[5] >> 56)] ^ C1[(i32) (K[4] >> 48) & 0xff] ^ C2[(i32) (K[3] >> 40) & 0xff] ^ C3[(i32) (K[2] >> 32) & 0xff] ^ C4[(i32) (K[1] >> 24) & 0xff] ^ C5[(i32) (K[0] >> 16) & 0xff] ^ C6[(i32) (K[7] >>  8) & 0xff] ^ C7[(i32) (K[6]) & 0xff];
            L[6] = C0[(i32) (K[6] >> 56)] ^ C1[(i32) (K[5] >> 48) & 0xff] ^ C2[(i32) (K[4] >> 40) & 0xff] ^ C3[(i32) (K[3] >> 32) & 0xff] ^ C4[(i32) (K[2] >> 24) & 0xff] ^ C5[(i32) (K[1] >> 16) & 0xff] ^ C6[(i32) (K[0] >>  8) & 0xff] ^ C7[(i32) (K[7]) & 0xff];
            L[7] = C0[(i32) (K[7] >> 56)] ^ C1[(i32) (K[6] >> 48) & 0xff] ^ C2[(i32) (K[5] >> 40) & 0xff] ^ C3[(i32) (K[4] >> 32) & 0xff] ^ C4[(i32) (K[3] >> 24) & 0xff] ^ C5[(i32) (K[2] >> 16) & 0xff] ^ C6[(i32) (K[1] >>  8) & 0xff] ^ C7[(i32) (K[0]) & 0xff];
            ...
            L[0] = C0[(i32) (state[0] >> 56)] ^ C1[(i32) (state[7] >> 48) & 0xff] ^ C2[(i32) (state[6] >> 40) & 0xff] ^ C3[(i32) (state[5] >> 32) & 0xff] ^ C4[(i32) (state[4] >> 24) & 0xff] ^ C5[(i32) (state[3] >> 16) & 0xff] ^ C6[(i32) (state[2] >>  8) & 0xff] ^ C7[(i32) (state[1]) & 0xff] ^ K[0];
            L[1] = C0[(i32) (state[1] >> 56)] ^ C1[(i32) (state[0] >> 48) & 0xff] ^ C2[(i32) (state[7] >> 40) & 0xff] ^ C3[(i32) (state[6] >> 32) & 0xff] ^ C4[(i32) (state[5] >> 24) & 0xff] ^ C5[(i32) (state[4] >> 16) & 0xff] ^ C6[(i32) (state[3] >>  8) & 0xff] ^ C7[(i32) (state[2]) & 0xff] ^ K[1];
            L[2] = C0[(i32) (state[2] >> 56)] ^ C1[(i32) (state[1] >> 48) & 0xff] ^ C2[(i32) (state[0] >> 40) & 0xff] ^ C3[(i32) (state[7] >> 32) & 0xff] ^ C4[(i32) (state[6] >> 24) & 0xff] ^ C5[(i32) (state[5] >> 16) & 0xff] ^ C6[(i32) (state[4] >>  8) & 0xff] ^ C7[(i32) (state[3]) & 0xff] ^ K[2];
            L[3] = C0[(i32) (state[3] >> 56)] ^ C1[(i32) (state[2] >> 48) & 0xff] ^ C2[(i32) (state[1] >> 40) & 0xff] ^ C3[(i32) (state[0] >> 32) & 0xff] ^ C4[(i32) (state[7] >> 24) & 0xff] ^ C5[(i32) (state[6] >> 16) & 0xff] ^ C6[(i32) (state[5] >>  8) & 0xff] ^ C7[(i32) (state[4]) & 0xff] ^ K[3];
            L[4] = C0[(i32) (state[4] >> 56)] ^ C1[(i32) (state[3] >> 48) & 0xff] ^ C2[(i32) (state[2] >> 40) & 0xff] ^ C3[(i32) (state[1] >> 32) & 0xff] ^ C4[(i32) (state[0] >> 24) & 0xff] ^ C5[(i32) (state[7] >> 16) & 0xff] ^ C6[(i32) (state[6] >>  8) & 0xff] ^ C7[(i32) (state[5]) & 0xff] ^ K[4];
            L[5] = C0[(i32) (state[5] >> 56)] ^ C1[(i32) (state[4] >> 48) & 0xff] ^ C2[(i32) (state[3] >> 40) & 0xff] ^ C3[(i32) (state[2] >> 32) & 0xff] ^ C4[(i32) (state[1] >> 24) & 0xff] ^ C5[(i32) (state[0] >> 16) & 0xff] ^ C6[(i32) (state[7] >>  8) & 0xff] ^ C7[(i32) (state[6]) & 0xff] ^ K[5];
            L[6] = C0[(i32) (state[6] >> 56)] ^ C1[(i32) (state[5] >> 48) & 0xff] ^ C2[(i32) (state[4] >> 40) & 0xff] ^ C3[(i32) (state[3] >> 32) & 0xff] ^ C4[(i32) (state[2] >> 24) & 0xff] ^ C5[(i32) (state[1] >> 16) & 0xff] ^ C6[(i32) (state[0] >>  8) & 0xff] ^ C7[(i32) (state[7]) & 0xff] ^ K[6];
            L[7] = C0[(i32) (state[7] >> 56)] ^ C1[(i32) (state[6] >> 48) & 0xff] ^ C2[(i32) (state[5] >> 40) & 0xff] ^ C3[(i32) (state[4] >> 32) & 0xff] ^ C4[(i32) (state[3] >> 24) & 0xff] ^ C5[(i32) (state[2] >> 16) & 0xff] ^ C6[(i32) (state[1] >>  8) & 0xff] ^ C7[(i32) (state[0]) & 0xff] ^ K[7];
...
Whirlpool::Whirlpool (ukk data, size_t numBytes)
{
    process (data, numBytes);
}

Whirlpool::Whirlpool (InputStream& input, z64 numBytesToRead)
{
...
z0 Whirlpool::process (ukk data, size_t numBytes)
{
...
Txt Whirlpool::toHexString() const
{
    return Txt::toHexString (result, sizeof (result), 0);
}

b8 Whirlpool::operator== (const Whirlpool& other) const noexcept  { return memcmp (result, other.result, sizeof (result)) == 0; }
b8 Whirlpool::operator!= (const Whirlpool& other) const noexcept  { return ! operator== (other); }
