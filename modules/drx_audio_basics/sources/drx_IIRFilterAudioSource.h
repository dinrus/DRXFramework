...
/**
    ...
    @tags{Audio}
*/
class DRX_API  IIRFilterAudioSource  : public AudioSource
{
public:
    //==============================================================================
    ...
    */
    ...
    z0 setCoefficients (const IIRCoefficients& newCoefficients);
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (IIRFilterAudioSource)
};
