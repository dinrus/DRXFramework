...
/**
    ...
    @tags{Audio}
*/
struct DRX_API  AudioSourceChannelInfo
{
    /** Creates an uninitialised AudioSourceChannelInfo. */
    AudioSourceChannelInfo() = default;

    /** Creates an AudioSourceChannelInfo. */
    AudioSourceChannelInfo (AudioBuffer<f32>* bufferToUse,
                            i32 startSampleOffset, i32 numSamplesToUse) noexcept
        : buffer (bufferToUse),
    ...
    */
    explicit AudioSourceChannelInfo (AudioBuffer<f32>& bufferToUse) noexcept
        : buffer (&bufferToUse),
          startSample (0),
    ...
    */
    ...
    z0 clearActiveBufferRegion() const
    {
        if (buffer != nullptr)
...
public:
    ...
    */
    virtual z0 prepareToPlay (i32 samplesPerBlockExpected,
                                f64 sampleRate) = 0;
    ...
    */
    virtual z0 getNextAudioBlock (const AudioSourceChannelInfo& bufferToFill) = 0;
};
