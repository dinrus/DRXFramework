...
public:
    ...
    */
    ...
    b8 parseControllerMessage (i32 midiChannel,
    ...
    */
    std::optional<MidiRPNMessage> tryParse (i32 midiChannel,
                                            i32 controllerNumber,
                                            i32 controllerValue);
...
private:
    ...
    struct ChannelState
    {
        std::optional<MidiRPNMessage> handleController (i32 channel, i32 controllerNumber,
                                                        i32 value) noexcept;
        z0 resetValue() noexcept;
        std::optional<MidiRPNMessage> sendIfReady (i32 channel) noexcept;

        u8 parameterMSB = 0xff, parameterLSB = 0xff, valueMSB = 0xff, valueLSB = 0xff;
        b8 isNRPN = false;
    };
    ...
    DRX_LEAK_DETECTOR (MidiRPNDetector)
};
...
/**
    ...
    @tags{Audio}
*/
class DRX_API  MidiRPNGenerator
{
public:
    //==============================================================================
    ...
    */
    static MidiBuffer generate (i32 channel,
                                i32 parameterNumber,
                                i32 value,
                                b8 isNRPN = false,
                                b8 use14BitValue = true);
};
