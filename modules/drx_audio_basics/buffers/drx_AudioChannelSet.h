...
public:
    ...
    */
    ...
    /** Creates a zero-channel set which can be used to indicate that a
        bus is disabled. */
    static AudioChannelSet DRX_CALLTYPE disabled();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE mono();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE stereo();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE createLCR();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE createLRS();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE createLCRS();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create5point0();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create5point1();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create6point0();
     ...
     */
    static AudioChannelSet DRX_CALLTYPE create6point1();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create6point0Music();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create6point1Music();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point0();
     ...
     */
    static AudioChannelSet DRX_CALLTYPE create7point0SDDS();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point1();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point1SDDS();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create5point0point2();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create5point1point2();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create5point0point4();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create5point1point4();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point0point2();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point1point2();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point0point4();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point1point4();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point0point6();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create7point1point6();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point0point4();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point1point4();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point0point6();
    ...
    /** Creates a set for a 9.1.6 Atmos surround setup (left, right, centre, LFE, leftSurroundSide, rightSurroundSide, leftSurroundRear, rightSurroundRear, wideLeft, wideRight, topFrontLeft, topFrontRight, topSideLeft, topSideRight, topRearLeft, topRearRight).
        ...
        To maintain the correct relative channel ordering, DRX would perform the following mapping:
        L -> wideLeft, Lc -> left, Rc -> right, R -> wideRight

        The version of the VST3 SDK bundled with DRX now supports Atmos versions of the above
        layouts, which have the front-channel ordering "Lw L C R Rw". This order matches the
        DRX ordering, so no remapping is required.
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point1point6();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point0point4ITU();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point1point4ITU();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point0point6ITU();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE create9point1point6ITU();
     ...
     */
    static AudioChannelSet DRX_CALLTYPE quadraphonic();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE pentagonal();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE hexagonal();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE octagonal();
    ...
    */
    static AudioChannelSet DRX_CALLTYPE ambisonic (i32 order = 1);
    ...
    */
    i32 getAmbisonicOrder() const;

    //==============================================================================
    /** Creates a set of untyped discrete channels. */
    static AudioChannelSet DRX_CALLTYPE discreteChannels (i32 numChannels);

    /** Create a canonical channel set for a given number of channels.
        For example, numChannels = 1 will return mono, numChannels = 2 will return stereo, etc. */
    static AudioChannelSet DRX_CALLTYPE canonicalChannelSet (i32 numChannels);
    ...
    static AudioChannelSet DRX_CALLTYPE namedChannelSet (i32 numChannels);

    /** Return an array of channel sets which have a given number of channels */
    static Array<AudioChannelSet> DRX_CALLTYPE channelSetsWithNumberOfChannels (i32 numChannels);
    ...
    static Txt DRX_CALLTYPE getChannelTypeName (ChannelType);

    /** Returns the abbreviated name of a channel type. For example, this method may return "Ls". */
    static Txt DRX_CALLTYPE getAbbreviatedChannelTypeName (ChannelType);

    /** Returns the channel type from an abbreviated name. */
    static ChannelType DRX_CALLTYPE getChannelTypeFromAbbreviation (const Txt& abbreviation);
    ...
    z0 addChannel (ChannelType newChannelType);

    /** Removes a channel from the set. */
    z0 removeChannel (ChannelType newChannelType);

    /** Returns the number of channels in the set. */
    i32 size() const noexcept;

    /** Возвращает true, если there are no channels in the set. */
    b8 isDisabled() const noexcept                    { return size() == 0; }

    /** Returns an array of all the types in this channel set. */
    Array<ChannelType> getChannelTypes() const;

    /** Returns the type of one of the channels in the set, by index. */
    ChannelType getTypeOfChannel (i32 channelIndex) const noexcept;

    /** Returns the index for a particular channel-type.
        Will return -1 if the this set does not contain a channel of this type. */
    i32 getChannelIndexForType (ChannelType type) const noexcept;
    ...
    b8 isDiscreteLayout() const noexcept;

    /** Intersect two channel layouts. */
    z0 intersect (const AudioChannelSet& other)      { channels &= other.channels; }
    ...
    */
    static AudioChannelSet DRX_CALLTYPE channelSetWithChannels (const Array<ChannelType>&);

    //==============================================================================
    // Conversion between wave and drx channel layout identifiers

    /** Create an AudioChannelSet from a WAVEFORMATEXTENSIBLE channelMask (typically used
        in .wav files). */
    static AudioChannelSet DRX_CALLTYPE fromWaveChannelMask (i32 dwChannelMask);
    ...
    /** Returns a WAVEFORMATEXTENSIBLE channelMask representation (typically used in .wav
        ...
        representation.
    */
    i32 getWaveChannelMask() const noexcept;
    ...
    */
    static i32 getAmbisonicOrderForNumChannels (i32 numChannels, i32 maxOrderToCheck = 7);

    //==============================================================================
    b8 operator== (const AudioChannelSet&) const noexcept;
    b8 operator!= (const AudioChannelSet&) const noexcept;
    b8 operator<  (const AudioChannelSet&) const noexcept;
