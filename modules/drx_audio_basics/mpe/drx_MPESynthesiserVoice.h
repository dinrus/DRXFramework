...
/**
    ...
    @tags{Audio}
*/
class DRX_API  MPESynthesiserVoice
{
public:
    //==============================================================================
    /** Constructor. */
    ...
    */
    ...
    /** Возвращает true, если the voice is currently playing the given MPENote
        (as identified by the note's initial note number and MIDI channel).
    */
    b8 isCurrentlyPlayingNote (MPENote note) const noexcept;
    ...
    */
    virtual b8 isActive() const                       { return currentlyPlayingNote.isValid(); }
    ...
    */
    virtual z0 notePitchbendChanged() = 0;

    /** Called by the MPESynthesiser to let the voice know that its currently playing note
        has changed its timbre value.
        This will be called during the rendering callback, so must be fast and thread-safe.
    */
    virtual z0 noteTimbreChanged() = 0;
    ...
    /** Called by the MPESynthesiser to let the voice know that its currently playing note
        ...
        This will be called during the rendering callback, so must be fast and thread-safe.
    */
    virtual z0 noteKeyStateChanged() = 0;
    ...
    */
    virtual z0 setCurrentSampleRate (f64 newRate)    { currentSampleRate = newRate; }
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MPESynthesiserVoice)
};
