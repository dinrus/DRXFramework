...
namespace
{
    u8k noLSBValueReceived = 0xff;
    const Range<i32> allChannels { 1, 17 };

    template <typename Range, typename Value>
    z0 mpeInstrumentFill (Range& range, const Value& value)
    {
...
z0 MPEInstrument::resetLastReceivedValues()
{
    struct Defaults
    {
...
z0 MPEInstrument::setZoneLayout (MPEZoneLayout newLayout)
{
    releaseAllNotes();
...
//==============================================================================
z0 MPEInstrument::enableLegacyMode (i32 pitchbendRange, Range<i32> channelRange)
{
...
b8 MPEInstrument::isLegacyModeEnabled() const noexcept
{
    return legacyMode.isEnabled;
}

Range<i32> MPEInstrument::getLegacyModeChannelRange() const noexcept
{
    return legacyMode.channelRange;
}

z0 MPEInstrument::setLegacyModeChannelRange (Range<i32> channelRange)
{
...
i32 MPEInstrument::getLegacyModePitchbendRange() const noexcept
{
    return legacyMode.pitchbendRange;
}

z0 MPEInstrument::setLegacyModePitchbendRange (i32 pitchbendRange)
{
...
//==============================================================================
z0 MPEInstrument::setPressureTrackingMode (TrackingMode modeToUse)
{
    pressureDimension.trackingMode = modeToUse;
}

z0 MPEInstrument::setPitchbendTrackingMode (TrackingMode modeToUse)
{
    pitchbendDimension.trackingMode = modeToUse;
}

z0 MPEInstrument::setTimbreTrackingMode (TrackingMode modeToUse)
{
    timbreDimension.trackingMode = modeToUse;
}

//==============================================================================
z0 MPEInstrument::addListener (Listener* listenerToAdd)
{
    listeners.add (listenerToAdd);
}

z0 MPEInstrument::removeListener (Listener* listenerToRemove)
{
    listeners.remove (listenerToRemove);
}

//==============================================================================
z0 MPEInstrument::processNextMidiEvent (const MidiMessage& message)
{
...
//==============================================================================
z0 MPEInstrument::processMidiNoteOnMessage (const MidiMessage& message)
{
...
//==============================================================================
z0 MPEInstrument::processMidiNoteOffMessage (const MidiMessage& message)
{
    noteOff (message.getChannel(),
             message.getNoteNumber(),
             MPEValue::from7BitInt (message.getVelocity()));
...
//==============================================================================
z0 MPEInstrument::processMidiPitchWheelMessage (const MidiMessage& message)
{
...
//==============================================================================
z0 MPEInstrument::processMidiChannelPressureMessage (const MidiMessage& message)
{
...
//==============================================================================
z0 MPEInstrument::processMidiControllerMessage (const MidiMessage& message)
{
...
//==============================================================================
z0 MPEInstrument::processMidiResetAllControllersMessage (const MidiMessage& message)
{
...
z0 MPEInstrument::processMidiAfterTouchMessage (const MidiMessage& message)
{
...
//==============================================================================
z0 MPEInstrument::handlePressureMSB (i32 midiChannel, i32 value) noexcept
{
...
z0 MPEInstrument::handlePressureLSB (i32 midiChannel, i32 value) noexcept
{
    lastPressureLowerBitReceivedOnChannel[midiChannel - 1] = u8 (value);
}

z0 MPEInstrument::handleTimbreMSB (i32 midiChannel, i32 value) noexcept
{
...
z0 MPEInstrument::handleTimbreLSB (i32 midiChannel, i32 value) noexcept
{
    lastTimbreLowerBitReceivedOnChannel[midiChannel - 1] = u8 (value);
}

//==============================================================================
z0 MPEInstrument::noteOn (i32 midiChannel,
                            i32 midiNoteNumber,
...
//==============================================================================
z0 MPEInstrument::noteOff (i32 midiChannel,
                             i32 midiNoteNumber,
...
//==============================================================================
z0 MPEInstrument::pitchbend (i32 midiChannel, MPEValue value)
{
    const ScopedLock sl (lock);
    updateDimension (midiChannel, pitchbendDimension, value);
}

z0 MPEInstrument::pressure (i32 midiChannel, MPEValue value)
{
    const ScopedLock sl (lock);
    updateDimension (midiChannel, pressureDimension, value);
}

z0 MPEInstrument::timbre (i32 midiChannel, MPEValue value)
{
    const ScopedLock sl (lock);
    updateDimension (midiChannel, timbreDimension, value);
}

z0 MPEInstrument::polyAftertouch (i32 midiChannel, i32 midiNoteNumber, MPEValue value)
{
    const ScopedLock sl (lock);
...
MPEValue MPEInstrument::getInitialValueForNewNote (i32 midiChannel, MPEDimension& dimension) const
{
    if (! legacyMode.isEnabled && getLastNotePlayedPtr (midiChannel) != nullptr)
...
//==============================================================================
z0 MPEInstrument::updateDimension (i32 midiChannel, MPEDimension& dimension, MPEValue value)
{
...
//==============================================================================
z0 MPEInstrument::updateDimensionMaster (b8 isLowerZone, MPEDimension& dimension, MPEValue value)
{
...
//==============================================================================
z0 MPEInstrument::updateDimensionForNote (MPENote& note, MPEDimension& dimension, MPEValue value)
{
...
//==============================================================================
z0 MPEInstrument::callListenersDimensionChanged (const MPENote& note, const MPEDimension& dimension)
{
...
//==============================================================================
z0 MPEInstrument::updateNoteTotalPitchbend (MPENote& note)
{
    if (legacyMode.isEnabled)
    {
        note.totalPitchbendInSemitones = note.pitchbend.asSignedFloat() * (f32) legacyMode.pitchbendRange;
    }
    else
    {
        ...
        if (zone.isUsingChannelAsMemberChannel (note.midiChannel))
            notePitchbendInSemitones = note.pitchbend.asSignedFloat() * (f32) zone.perNotePitchbendRange;

        auto masterPitchbendInSemitones = pitchbendDimension.lastValueReceivedOnChannel[zone.getMasterChannel() - 1]
                                                            .asSignedFloat()
                                          * (f32) zone.masterPitchbendRange;
...
//==============================================================================
z0 MPEInstrument::sustainPedal (i32 midiChannel, b8 isDown)
{
    const ScopedLock sl (lock);
    handleSustainOrSostenuto (midiChannel, isDown, false);
}

z0 MPEInstrument::sostenutoPedal (i32 midiChannel, b8 isDown)
{
    const ScopedLock sl (lock);
...
//==============================================================================
z0 MPEInstrument::handleSustainOrSostenuto (i32 midiChannel, b8 isDown, b8 isSostenuto)
{
    ...
    if (! isSostenuto)
    {
        ...
        if (! legacyMode.isEnabled)
        {
            if (zone.isLowerZone())
            {
                for (i32 i = zone.getFirstMemberChannel(); i <= zone.getLastMemberChannel(); ++i)
...
//==============================================================================
b8 MPEInstrument::isMemberChannel (i32 midiChannel) const noexcept
{
    if (legacyMode.isEnabled)
...
b8 MPEInstrument::isMasterChannel (i32 midiChannel) const noexcept
{
    if (legacyMode.isEnabled)
        return false;
...
b8 MPEInstrument::isUsingChannel (i32 midiChannel) const noexcept
{
    if (legacyMode.isEnabled)
        return legacyMode.channelRange.contains (midiChannel);
...
//==============================================================================
i32 MPEInstrument::getNumPlayingNotes() const noexcept
{
    return notes.size();
}

MPENote MPEInstrument::getNote (i32 midiChannel, i32 midiNoteNumber) const noexcept
{
    if (auto* note = getNotePtr (midiChannel, midiNoteNumber))
        return *note;
...
MPENote MPEInstrument::getNote (i32 index) const noexcept
{
    return notes[index];
}

MPENote MPEInstrument::getNoteWithID (u16 noteID) const noexcept
{
    const ScopedLock sl (lock);
...
//==============================================================================
MPENote MPEInstrument::getMostRecentNote (i32 midiChannel) const noexcept
{
...
//==============================================================================
const MPENote* MPEInstrument::getNotePtr (i32 midiChannel, i32 midiNoteNumber) const noexcept
{
...
MPENote* MPEInstrument::getNotePtr (i32 midiChannel, i32 midiNoteNumber) noexcept
{
    return const_cast<MPENote*> (static_cast<const MPEInstrument&> (*this).getNotePtr (midiChannel, midiNoteNumber));
}

//==============================================================================
const MPENote* MPEInstrument::getNotePtr (i32 midiChannel, TrackingMode mode) const noexcept
{
...
MPENote* MPEInstrument::getNotePtr (i32 midiChannel, TrackingMode mode) noexcept
{
    return const_cast<MPENote*> (static_cast<const MPEInstrument&> (*this).getNotePtr (midiChannel, mode));
}

//==============================================================================
const MPENote* MPEInstrument::getLastNotePlayedPtr (i32 midiChannel) const noexcept
{
    const ScopedLock sl (lock);
...
MPENote* MPEInstrument::getLastNotePlayedPtr (i32 midiChannel) noexcept
{
    return const_cast<MPENote*> (static_cast<const MPEInstrument&> (*this).getLastNotePlayedPtr (midiChannel));
}

//==============================================================================
const MPENote* MPEInstrument::getHighestNotePtr (i32 midiChannel) const noexcept
{
    i32 initialNoteMax = -1;
...
MPENote* MPEInstrument::getHighestNotePtr (i32 midiChannel) noexcept
{
    return const_cast<MPENote*> (static_cast<const MPEInstrument&> (*this).getHighestNotePtr (midiChannel));
}

const MPENote* MPEInstrument::getLowestNotePtr (i32 midiChannel) const noexcept
{
    i32 initialNoteMin = 128;
    const MPENote* result = nullptr;
...
MPENote* MPEInstrument::getLowestNotePtr (i32 midiChannel) noexcept
{
    return const_cast<MPENote*> (static_cast<const MPEInstrument&> (*this).getLowestNotePtr (midiChannel));
}

//==============================================================================
z0 MPEInstrument::releaseAllNotes()
{
    const ScopedLock sl (lock);
...
//==============================================================================
z0 MPEInstrument::Listener::noteAdded ([[maybe_unused]] MPENote newNote)                 {}
z0 MPEInstrument::Listener::notePressureChanged  ([[maybe_unused]] MPENote changedNote)  {}
z0 MPEInstrument::Listener::notePitchbendChanged ([[maybe_unused]] MPENote changedNote)  {}
z0 MPEInstrument::Listener::noteTimbreChanged    ([[maybe_unused]] MPENote changedNote)  {}
z0 MPEInstrument::Listener::noteKeyStateChanged  ([[maybe_unused]] MPENote changedNote)  {}
z0 MPEInstrument::Listener::noteReleased ([[maybe_unused]] MPENote finishedNote)         {}
z0 MPEInstrument::Listener::zoneLayoutChanged()                                          {}
    ...
    z0 runTest() override
    {
        ...
        beginTest ("getMostRecentNote");
        {
            ...
            }
            {
                ...
                expect (note.isValid());
                expectEquals (i32 (note.midiChannel), 3);
                expectEquals (i32 (note.initialNote), 61);
            }
...

            {
                ...
                expect (note.isValid());
                expectEquals (i32 (note.midiChannel), 3);
                expectEquals (i32 (note.initialNote), 60);
            }
        ...
        beginTest ("processNextMidiEvent");
        {
            ...
            test.processNextMidiEvent (MidiMessage::noteOn (3, 42, u8 (92)));
            ...
            test.processNextMidiEvent (MidiMessage::noteOff (4, 12, u8 (33)));
            ...
            test.processNextMidiEvent (MidiMessage::noteOn (5, 11, u8 (0)));
        ...
        beginTest ("Legacy mode");
        {
            ...
            }
            {
                // constructor w/o default arguments
                 MPEInstrument test;
                test.enableLegacyMode (0, Range<i32> (1, 11));
                expectEquals (test.getLegacyModePitchbendRange(), 0);
                expect (test.getLegacyModeChannelRange() == Range<i32> (1, 11));
            }
            {
                // getters and setters
                MPEInstrument test;
                ...
                expect (test.getLegacyModeChannelRange() == Range<i32> (1, 17));

                test.setLegacyModePitchbendRange (96);
                expectEquals (test.getLegacyModePitchbendRange(), 96);

                test.setLegacyModeChannelRange (Range<i32> (10, 12));
                expect (test.getLegacyModeChannelRange() == Range<i32> (10, 12));
            }
            {
            ...
            }
            {
                ...
                UnitTestInstrument test;
                test.enableLegacyMode (2, Range<i32> (3, 8));  // channels 3-7
...
private:
    ...
    */
    ...
    public:
        ...
        z0 noteOn (i32 midiChannel, i32 midiNoteNumber, MPEValue midiNoteOnVelocity) override
        {
        ...
        z0 noteOff (i32 midiChannel, i32 midiNoteNumber, MPEValue midiNoteOffVelocity) override
        {
        ...
        z0 pitchbend (i32 midiChannel, MPEValue value) override
        {
        ...
        z0 pressure (i32 midiChannel, MPEValue value) override
        {
        ...
        z0 timbre (i32 midiChannel, MPEValue value) override
        {
        ...
        z0 sustainPedal (i32 midiChannel, b8 value) override
        {
        ...
        z0 sostenutoPedal (i32 midiChannel, b8 value) override
        {
        ...
        z0 aftertouch (i32 midiChannel, i32 midiNoteNumber, MPEValue value)
        {
            const auto message = drx::MidiMessage::aftertouchChange (midiChannel, midiNoteNumber, value.as7BitInt());
            processNextMidiEvent (message);
        }

        i32 noteOnCallCounter,  noteOffCallCounter, pitchbendCallCounter,
        ...
        b8 lastSustainPedalValueReceived, lastSostenutoPedalValueReceived;
        MPEValue lastMPEValueReceived;
        std::unique_ptr<MPENote> lastNoteFinished;

    private:
        //==============================================================================
        z0 noteAdded (MPENote) override              { noteAddedCallCounter++; }

        z0 notePressureChanged (MPENote) override    { notePressureChangedCallCounter++; }
        z0 notePitchbendChanged (MPENote) override   { notePitchbendChangedCallCounter++; }
        z0 noteTimbreChanged (MPENote) override      { noteTimbreChangedCallCounter++; }
        z0 noteKeyStateChanged (MPENote) override    { noteKeyStateChangedCallCounter++; }
    ...
    //==============================================================================
    z0 expectNote (MPENote noteToTest,
                     i32 noteOnVelocity7Bit,
                     i32 pressure7Bit,
                     i32 pitchbend14Bit,
                     i32 timbre7Bit,
    ...
    z0 expectHasFinishedNote (const UnitTestInstrument& test,
                                i32 channel, i32 noteNumber, i32 noteOffVelocity7Bit)
    {
        expect (test.lastNoteFinished != nullptr);
        expectEquals (i32 (test.lastNoteFinished->midiChannel), channel);
        expectEquals (i32 (test.lastNoteFinished->initialNote), noteNumber);
    ...
    z0 expectDoubleWithinRelativeError (f64 actual, f64 expected, f64 maxRelativeError)
    {
        const f64 maxAbsoluteError = jmax (1.0, std::abs (expected)) * maxRelativeError;
