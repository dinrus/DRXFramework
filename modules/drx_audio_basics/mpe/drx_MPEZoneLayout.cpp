...
z0 MPEZoneLayout::sendLayoutChangeMessage()
{
    listeners.call ([this] (Listener& l) { l.zoneLayoutChanged (*this); });
}

//==============================================================================
z0 MPEZoneLayout::setZone (b8 isLower, i32 numMemberChannels, i32 perNotePitchbendRange, i32 masterPitchbendRange) noexcept
{
...
z0 MPEZoneLayout::setLowerZone (i32 numMemberChannels, i32 perNotePitchbendRange, i32 masterPitchbendRange) noexcept
{
    setZone (true, numMemberChannels, perNotePitchbendRange, masterPitchbendRange);
}

z0 MPEZoneLayout::setUpperZone (i32 numMemberChannels, i32 perNotePitchbendRange, i32 masterPitchbendRange) noexcept
{
    setZone (false, numMemberChannels, perNotePitchbendRange, masterPitchbendRange);
}

z0 MPEZoneLayout::clearAllZones()
{
...
//==============================================================================
z0 MPEZoneLayout::processNextMidiEvent (const MidiMessage& message)
{
...
z0 MPEZoneLayout::processRpnMessage (MidiRPNMessage rpn)
{
...
z0 MPEZoneLayout::processZoneLayoutRpnMessage (MidiRPNMessage rpn)
{
    if (rpn.value < 16)
    {
        if (rpn.channel == 1)
...
z0 MPEZoneLayout::updateMasterPitchbend (MPEZone& zone, i32 value)
{
...
z0 MPEZoneLayout::updatePerNotePitchbendRange (MPEZone& zone, i32 value)
{
...
z0 MPEZoneLayout::processPitchbendRangeRpnMessage (MidiRPNMessage rpn)
{
    if (rpn.channel == 1)
    {
...
z0 MPEZoneLayout::processNextMidiBuffer (const MidiBuffer& buffer)
{
...
//==============================================================================
z0 MPEZoneLayout::addListener (Listener* const listenerToAdd) noexcept
{
    listeners.add (listenerToAdd);
}

z0 MPEZoneLayout::removeListener (Listener* const listenerToRemove) noexcept
{
    listeners.remove (listenerToRemove);
}

//==============================================================================
z0 MPEZoneLayout::checkAndLimitZoneParameters (i32 minValue, i32 maxValue,
                                                 i32& valueToCheckAndLimit) noexcept
{
