...
/**
    ...
    @tags{Audio}
*/
struct DRX_API  MPESynthesiserBase   : public MPEInstrument::Listener
{
public:
    //==============================================================================
    /** Constructor. */
    ...
    */
    ...
    z0 renderNextBlock (AudioBuffer<floatType>& outputAudio,
...
protected:
    ...
    /** Implement this method to render your audio inside.
        @see renderNextBlock
    */
    virtual z0 renderNextSubBlock (AudioBuffer<f32>& outputAudio,
                                     i32 startSample,
                                     i32 numSamples) = 0;
     ...
     */
    virtual z0 renderNextSubBlock (AudioBuffer<f64>& /*outputAudio*/,
                                     i32 /*startSample*/,
                                     i32 /*numSamples*/) {}
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MPESynthesiserBase)
};
