...
public:
    ...
    /** Directly constructs an object from the raw coefficients.
        ...
        filters!
    */
    IIRCoefficients (f64 c1, f64 c2, f64 c3,
    ...
    static IIRCoefficients makeLowPass (f64 sampleRate,
    ...
    static IIRCoefficients makeHighPass (f64 sampleRate,
                                         f64 frequency) noexcept;
    ...
    static IIRCoefficients makeBandPass (f64 sampleRate, f64 frequency) noexcept;

    /** Returns the coefficients for a band-pass filter with variable Q. */
    static IIRCoefficients makeBandPass (f64 sampleRate,
                                         f64 frequency,
                                         f64 Q) noexcept;

    //==============================================================================
    /** Returns the coefficients for a notch filter. */
    static IIRCoefficients makeNotchFilter (f64 sampleRate, f64 frequency) noexcept;

    /** Returns the coefficients for a notch filter with variable Q. */
    static IIRCoefficients makeNotchFilter (f64 sampleRate,
                                            f64 frequency,
                                            f64 Q) noexcept;

    //==============================================================================
    /** Returns the coefficients for an all-pass filter. */
    static IIRCoefficients makeAllPass (f64 sampleRate, f64 frequency) noexcept;

    /** Returns the coefficients for an all-pass filter with variable Q. */
    static IIRCoefficients makeAllPass (f64 sampleRate,
                                        f64 frequency,
                                        f64 Q) noexcept;
    ...
    /** Returns the coefficients for a low-pass shelf filter with variable Q and gain.
        ...
        attenuate them.
    */
    static IIRCoefficients makeLowShelf (f64 sampleRate,
                                         f64 cutOffFrequency,
                                         f64 Q,
    ...
    /** Returns the coefficients for a high-pass shelf filter with variable Q and gain.
        ...
        attenuate them.
    */
    static IIRCoefficients makeHighShelf (f64 sampleRate,
                                          f64 cutOffFrequency,
                                          f64 Q,
                                          f32 gainFactor) noexcept;
    ...
    */
    static IIRCoefficients makePeakFilter (f64 sampleRate,
                                           f64 centreFrequency,
                                           f64 Q,
                                           f32 gainFactor) noexcept;
...
public:
    ...
    */
    ...
    z0 makeInactive() noexcept;

    /** Applies a set of coefficients to this filter. */
    z0 setCoefficients (const IIRCoefficients& newCoefficients) noexcept;
    ...
    */
    ...
    z0 processSamples (f32* samples, i32 numSamples) noexcept;
    ...
    */
    f32 processSingleSampleRaw (f32 sample) noexcept;
