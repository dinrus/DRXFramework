...
public:
    ...
    */
    virtual z0 timerCallback (i32 timerID) = 0;
    ...
    /** Starts a timer and sets the length of interval required.
        ...
        @param  intervalInMilliseconds  the interval to use (any values less than 1 will be
                                        rounded up to 1)
    */
    z0 startTimer (i32 timerID, i32 intervalInMilliseconds) noexcept;
    ...
    */
    i32 getTimerInterval (i32 timerID) const noexcept;
...
private:
    ...
    Timer* getCallback (i32) const noexcept;
