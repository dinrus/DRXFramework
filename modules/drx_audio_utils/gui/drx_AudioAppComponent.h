...
/**
    ...
    @tags{Audio}
*/
class DRX_API AudioAppComponent   : public Component,
                                     public AudioSource
{
public:
    AudioAppComponent();
    ...
    z0 setAudioChannels (i32 numInputChannels, i32 numOutputChannels, const XmlElement* const storedSettings = nullptr);
    ...
    */
    z0 prepareToPlay (i32 samplesPerBlockExpected,
                        f64 sampleRate) override = 0;
    ...
    */
    z0 releaseResources() override = 0;
    ...
    */
    z0 getNextAudioBlock (const AudioSourceChannelInfo& bufferToFill) override = 0;
...
private:
    ...
    b8 usingCustomDeviceManager;

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioAppComponent)
};
