...
namespace
{
    ...
    public:
        //==============================================================================
        static b8 match (CharPtr pattern, CharPtr patternEnd, CharPtr target, CharPtr targetEnd)
        {
    ...
    private:
        //==============================================================================
        static b8 matchTerminator (CharPtr target, CharPtr targetEnd)
        {
            return target == targetEnd;
        }

        //==============================================================================
        static b8 matchChar (t32 c, CharPtr pattern, CharPtr patternEnd, CharPtr target, CharPtr targetEnd)
        {
        ...
        //==============================================================================
        static b8 matchAnyChar (CharPtr pattern, CharPtr patternEnd, CharPtr target, CharPtr targetEnd)
        {
            if (target == targetEnd)
                return false;
        ...
        //==============================================================================
        static b8 matchAnyOrNoChars (CharPtr pattern, CharPtr patternEnd, CharPtr target, CharPtr targetEnd)
        {
            if (target == targetEnd)
        ...
        //==============================================================================
        static b8 matchInsideStringSet (CharPtr pattern, CharPtr patternEnd, CharPtr target, CharPtr targetEnd)
        {
            if (pattern == patternEnd)
                return false;
            ...
            // Char template type parameter that is not the same type as Txt::Char.
            StringArray set;
            Txt currentElement;
        ...
        //==============================================================================
        static b8 matchStringSet (const StringArray& set, CharPtr pattern,
        ...
        //==============================================================================
        static b8 matchInsideCharSet (CharPtr pattern, CharPtr patternEnd,
        ...
        //==============================================================================
        static b8 matchCharSet (const Array<t32>& set, b8 setIsNegated,
        ...
        //==============================================================================
        static b8 matchCharSetNegated (const Array<t32>& set, CharPtr pattern,
                                         CharPtr patternEnd, CharPtr target, CharPtr targetEnd)
        {
            for (auto c : set)
                if (*target == c)
        ...
        //==============================================================================
        static b8 matchCharSetNotNegated (const Array<t32>& set, CharPtr pattern,
                                            CharPtr patternEnd, CharPtr target, CharPtr targetEnd)
        {
            for (auto c : set)
                if (*target == c)
        ...
        //==============================================================================
        static b8 addCharRangeToSet (Array<t32>& set, CharPtr pattern,
                                       CharPtr /*patternEnd*/, CharPtr target, CharPtr targetEnd)
        {
            if (target == targetEnd)
                return false;
    ...
    //==============================================================================
    static b8 matchOscPattern (const Txt& pattern, const Txt& target)
    {
        return OSCPatternMatcherImpl<Txt::CharPointerType>::match (pattern.getCharPointer(),
    ...
    template <> struct OSCAddressTokeniserTraits<OSCAddress>        { static tukk getDisallowedChars() { return " #*,?/[]{}"; } };
    template <> struct OSCAddressTokeniserTraits<OSCAddressPattern> { static tukk getDisallowedChars() { return " #/"; } };
    ...
    struct OSCAddressTokeniser
    {
        ...
        //==============================================================================
        static b8 isPrintableASCIIChar (t32 c) noexcept
        {
            return c >= ' ' && c <= '~';
        }

        static b8 isDisallowedChar (t32 c) noexcept
        {
            return CharPointer_ASCII (Traits::getDisallowedChars()).indexOf (c, false) >= 0;
        }

        static b8 containsOnlyAllowedPrintableASCIIChars (const Txt& string) noexcept
        {
        ...
        //==============================================================================
        static StringArray tokenise (const Txt& address)
        {
            if (address.isEmpty())
...
//==============================================================================
OSCAddress::OSCAddress (const Txt& address)
    : oscSymbols (OSCAddressTokeniser<OSCAddress>::tokenise (address)),
      asString (address.trimCharactersAtEnd ("/"))
{
}

OSCAddress::OSCAddress (tukk address)
    : oscSymbols (OSCAddressTokeniser<OSCAddress>::tokenise (Txt (address))),
      asString (Txt (address).trimCharactersAtEnd ("/"))
{
}

//==============================================================================
b8 OSCAddress::operator== (const OSCAddress& other) const noexcept
{
...
//==============================================================================
Txt OSCAddress::toString() const noexcept
{
    return asString;
}

//==============================================================================
OSCAddressPattern::OSCAddressPattern (const Txt& address)
...
OSCAddressPattern::OSCAddressPattern (tukk address)
    : oscSymbols (OSCAddressTokeniser<OSCAddressPattern>::tokenise (Txt (address))),
      asString (Txt (address).trimCharactersAtEnd ("/")),
      wasInitialisedWithWildcards (asString.containsAnyOf ("*?{}[]"))
{
}
...
//==============================================================================
b8 OSCAddressPattern::operator== (const OSCAddressPattern& other) const noexcept
{
    return asString == other.asString;
}
...
//==============================================================================
b8 OSCAddressPattern::matches (const OSCAddress& address) const noexcept
{
    ...
    for (i32 i = 0; i < oscSymbols.size(); ++i)
...
//==============================================================================
Txt OSCAddressPattern::toString() const noexcept
{
    return asString;
}
...
public:
    ...
    z0 runTest() override
    {
        beginTest ("construction and parsing");
        {
            ...
            expectThrowsType (OSCAddress (Txt::fromUTF8 ("/nonasciicharacter\xc3\xbc""blabla")), OSCFormatError);
        ...
        beginTest ("conversion to/from Txt");
        {
            OSCAddress address ("/this/is/a/very/i64/address/");
            expectEquals (address.toString(), Txt ("/this/is/a/very/i64/address"));
        }
    }
};
...
public:
    ...
    z0 runTest() override
    {
        beginTest ("construction and parsing");
        {
            ...
            expectThrowsType (OSCAddressPattern (Txt::fromUTF8 ("/nonasciicharacter\xc3\xbc""blabla")), OSCFormatError);
        ...
        {
            {
                OSCAddressPattern ap ("/this/is/a/very/i64/address/");
                expectEquals (ap.toString(), Txt ("/this/is/a/very/i64/address"));
            }
            {
                OSCAddressPattern ap ("/*/*put/{fader,slider,knob}[0-9]/ba?/");
                expectEquals (ap.toString(), Txt ("/*/*put/{fader,slider,knob}[0-9]/ba?"));
            }
        }
    }
};
...
public:
    ...
    z0 runTest() override
    {
        ...
        beginTest ("string matching with '[...]' pattern");
        {
            ...
            // special case: '!' does not have a special meaning if it is not the first t8 in the set.
