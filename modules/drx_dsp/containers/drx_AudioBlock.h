...
{
    template <typename T, b8 = std::is_floating_point_v<T>>
    struct ElementType
    {
        using Type = T;
    };
...
public:
    ...
    */
    AudioBlock (HeapBlock<t8>& heapBlockToUseForAllocation,
    ...
    */
    ...
    z0 swap (AudioBlock& other) noexcept
    {
    ...
    //==============================================================================
    template <typename OtherSampleType>
    constexpr b8 operator== (const AudioBlock<OtherSampleType>& other) const noexcept
    {
    ...
    */
    ...
    /** Returns a sample from the buffer.
        ...
        territory.
    */
    SampleType getSample (i32 channel, i32 sampleIndex) const noexcept
    {
    ...
    /** Modifies a sample in the buffer.
        ...
        territory.
    */
    z0 setSample (i32 destChannel, i32 destSample, SampleType newValue) const noexcept
    {
    ...
    /** Adds a value to a sample in the buffer.
        ...
        territory.
    */
    z0 addSample (i32 destChannel, i32 destSample, SampleType valueToAdd) const noexcept
    {
        jassert (isPositiveAndBelow (destChannel, numChannels));
        jassert (isPositiveAndBelow (destSample, numSamples));
    ...
    AudioBlock&       DRX_VECTOR_CALLTYPE fill (NumericType value)       noexcept   { fillInternal (value); return *this; }
    const AudioBlock& DRX_VECTOR_CALLTYPE fill (NumericType value) const noexcept   { fillInternal (value); return *this; }
    ...
    */
    ...
    /** Copies the values from this block to an AudioBuffer.
        ...
        in the AudioBuffer's units by a factor of SIMDRegister<SampleType>::SIMDNumElements.
    */
    z0 copyTo (AudioBuffer<std::remove_const_t<NumericType>>& dst, size_t srcPos = 0, size_t dstPos = 0,
                 size_t numElements = std::numeric_limits<size_t>::max()) const
    {
        ...
        for (size_t ch = 0; ch < maxChannels; ++ch)
            FloatVectorOperations::copy (dst.getWritePointer ((i32) ch, (i32) (dstPos * sizeFactor)),
    ...
    */
    ...
    AudioBlock&       DRX_VECTOR_CALLTYPE add (NumericType value)       noexcept   { addInternal (value); return *this; }
    const AudioBlock& DRX_VECTOR_CALLTYPE add (NumericType value) const noexcept   { addInternal (value); return *this; }
    ...
    template <typename OtherSampleType>
    AudioBlock&       DRX_VECTOR_CALLTYPE replaceWithSumOf (AudioBlock<OtherSampleType> src, NumericType value)      noexcept    { replaceWithSumOfInternal (src, value); return *this; }
    template <typename OtherSampleType>
    const AudioBlock& DRX_VECTOR_CALLTYPE replaceWithSumOf (AudioBlock<OtherSampleType> src, NumericType value) const noexcept   { replaceWithSumOfInternal (src, value); return *this; }
    ...
    AudioBlock&       DRX_VECTOR_CALLTYPE subtract (NumericType value)       noexcept   { subtractInternal (value); return *this; }
    const AudioBlock& DRX_VECTOR_CALLTYPE subtract (NumericType value) const noexcept   { subtractInternal (value); return *this; }
    ...
    template <typename OtherSampleType>
    AudioBlock&       DRX_VECTOR_CALLTYPE replaceWithDifferenceOf (AudioBlock<OtherSampleType> src, NumericType value)       noexcept   { replaceWithDifferenceOfInternal (src, value); return *this; }
    template <typename OtherSampleType>
    const AudioBlock& DRX_VECTOR_CALLTYPE replaceWithDifferenceOf (AudioBlock<OtherSampleType> src, NumericType value) const noexcept   { replaceWithDifferenceOfInternal (src, value); return *this; }
    ...
    AudioBlock&       DRX_VECTOR_CALLTYPE multiplyBy (NumericType value)       noexcept   { multiplyByInternal (value); return *this; }
    const AudioBlock& DRX_VECTOR_CALLTYPE multiplyBy (NumericType value) const noexcept   { multiplyByInternal (value); return *this; }
    ...
    template <typename OtherSampleType>
    AudioBlock&       DRX_VECTOR_CALLTYPE replaceWithProductOf (AudioBlock<OtherSampleType> src, NumericType value)       noexcept   { replaceWithProductOfInternal (src, value); return *this; }
    template <typename OtherSampleType>
    const AudioBlock& DRX_VECTOR_CALLTYPE replaceWithProductOf (AudioBlock<OtherSampleType> src, NumericType value) const noexcept   { replaceWithProductOfInternal (src, value); return *this; }
    ...
    template <typename OtherSampleType>
    AudioBlock&       DRX_VECTOR_CALLTYPE addProductOf (AudioBlock<OtherSampleType> src, NumericType factor)       noexcept   { addProductOfInternal (src, factor); return *this; }
    template <typename OtherSampleType>
    const AudioBlock& DRX_VECTOR_CALLTYPE addProductOf (AudioBlock<OtherSampleType> src, NumericType factor) const noexcept   { addProductOfInternal (src, factor); return *this; }
    ...
    AudioBlock&       DRX_VECTOR_CALLTYPE operator+= (NumericType value)       noexcept   { return add (value); }
    const AudioBlock& DRX_VECTOR_CALLTYPE operator+= (NumericType value) const noexcept   { return add (value); }
    ...
    AudioBlock&       DRX_VECTOR_CALLTYPE operator-= (NumericType value)       noexcept   { return subtract (value); }
    const AudioBlock& DRX_VECTOR_CALLTYPE operator-= (NumericType value) const noexcept   { return subtract (value); }
    ...
    AudioBlock&       DRX_VECTOR_CALLTYPE operator*= (NumericType value)       noexcept   { return multiplyBy (value); }
    const AudioBlock& DRX_VECTOR_CALLTYPE operator*= (NumericType value) const noexcept   { return multiplyBy (value); }
    ...
    static_assert (std::is_same_v<std::remove_const_t<SampleType>, f32>
                    || std::is_same_v<std::remove_const_t<SampleType>, f64>
                  #if DRX_USE_SIMD
                    || std::is_same_v<std::remove_const_t<SampleType>, SIMDRegister<f32>>
                    || std::is_same_v<std::remove_const_t<SampleType>, SIMDRegister<f64>>
                  #endif
                   , "AudioBlock only supports single or f64 precision floating point types");
    ...
    */
    ...
    static z0 process (AudioBlock<Src1SampleType> inBlock, AudioBlock<Src2SampleType> outBlock, FunctionType&& function)
    {
...
private:
    ...
    //==============================================================================
    z0 DRX_VECTOR_CALLTYPE clearInternal() const noexcept
    {
        auto n = numSamples * sizeFactor;
    ...
    z0 DRX_VECTOR_CALLTYPE fillInternal (NumericType value) const noexcept
    {
        auto n = numSamples * sizeFactor;
    ...
    template <typename OtherSampleType>
    z0 copyFromInternal (const AudioBlock<OtherSampleType>& src) const noexcept
    {
    ...
    template <typename OtherNumericType>
    z0 copyFromInternal (const AudioBuffer<OtherNumericType>& src, size_t srcPos, size_t dstPos, size_t numElements) const
    {
        ...
        for (size_t ch = 0; ch < maxChannels; ++ch)
            FloatVectorOperations::copy (getDataPointer (ch) + (dstPos * sizeFactor),
                                         src.getReadPointer ((i32) ch, (i32) (srcPos * sizeFactor)),
                                         n);
    }

    z0 moveInternal (size_t srcPos, size_t dstPos,
    ...
    //==============================================================================
    z0 DRX_VECTOR_CALLTYPE addInternal (NumericType value) const noexcept
    {
        auto n = numSamples * sizeFactor;
    ...
    template <typename OtherSampleType>
    z0 addInternal (AudioBlock<OtherSampleType> src) const noexcept
    {
    ...
    template <typename OtherSampleType>
    z0 DRX_VECTOR_CALLTYPE replaceWithSumOfInternal (AudioBlock<OtherSampleType> src, NumericType value) const noexcept
    {
        jassert (numChannels == src.numChannels);
        auto n = jmin (numSamples, src.numSamples) * sizeFactor;
    ...
    template <typename Src1SampleType, typename Src2SampleType>
    z0 replaceWithSumOfInternal (AudioBlock<Src1SampleType> src1, AudioBlock<Src2SampleType> src2) const noexcept
    {
    ...
    //==============================================================================
    constexpr z0 DRX_VECTOR_CALLTYPE subtractInternal (NumericType value) const noexcept
    {
        addInternal (value * static_cast<NumericType> (-1.0));
    }

    template <typename OtherSampleType>
    z0 subtractInternal (AudioBlock<OtherSampleType> src) const noexcept
    {
        jassert (numChannels == src.numChannels);
        auto n = jmin (numSamples, src.numSamples) * sizeFactor;
    ...
    template <typename OtherSampleType>
    z0 DRX_VECTOR_CALLTYPE replaceWithDifferenceOfInternal (AudioBlock<OtherSampleType> src, NumericType value) const noexcept
    {
        replaceWithSumOfInternal (src, static_cast<NumericType> (-1.0) * value);
    }

    template <typename Src1SampleType, typename Src2SampleType>
    z0 replaceWithDifferenceOfInternal (AudioBlock<Src1SampleType> src1, AudioBlock<Src2SampleType> src2) const noexcept
    {
        jassert (numChannels == src1.numChannels && src1.numChannels == src2.numChannels);
        auto n = jmin (numSamples, src1.numSamples, src2.numSamples) * sizeFactor;
    ...
    //==============================================================================
    z0 DRX_VECTOR_CALLTYPE multiplyByInternal (NumericType value) const noexcept
    {
        auto n = numSamples * sizeFactor;
    ...
    template <typename OtherSampleType>
    z0 multiplyByInternal (AudioBlock<OtherSampleType> src) const noexcept
    {
        jassert (numChannels == src.numChannels);
        auto n = jmin (numSamples, src.numSamples) * sizeFactor;
    ...
    template <typename OtherSampleType>
    z0 DRX_VECTOR_CALLTYPE replaceWithProductOfInternal (AudioBlock<OtherSampleType> src, NumericType value) const noexcept
    {
        jassert (numChannels == src.numChannels);
        auto n = jmin (numSamples, src.numSamples) * sizeFactor;
    ...
    template <typename Src1SampleType, typename Src2SampleType>
    z0 replaceWithProductOfInternal (AudioBlock<Src1SampleType> src1, AudioBlock<Src2SampleType> src2) const noexcept
    {
        jassert (numChannels == src1.numChannels && src1.numChannels == src2.numChannels);
        auto n = jmin (numSamples, src1.numSamples, src2.numSamples) * sizeFactor;
    ...
    template <typename OtherSampleType, typename SmoothingType>
    z0 multiplyByInternal (SmoothedValue<OtherSampleType, SmoothingType>& value) const noexcept
    {
    ...
    template <typename BlockSampleType, typename SmootherSampleType, typename SmoothingType>
    z0 replaceWithProductOfInternal (AudioBlock<BlockSampleType> src, SmoothedValue<SmootherSampleType, SmoothingType>& value) const noexcept
    {
        jassert (numChannels == src.numChannels);
    ...
    //==============================================================================
    template <typename OtherSampleType>
    z0 DRX_VECTOR_CALLTYPE addProductOfInternal (AudioBlock<OtherSampleType> src, NumericType factor) const noexcept
    {
        jassert (numChannels == src.numChannels);
        auto n = jmin (numSamples, src.numSamples) * sizeFactor;
    ...
    template <typename Src1SampleType, typename Src2SampleType>
    z0 addProductOfInternal (AudioBlock<Src1SampleType> src1, AudioBlock<Src2SampleType> src2) const noexcept
    {
        jassert (numChannels == src1.numChannels && src1.numChannels == src2.numChannels);
        auto n = jmin (numSamples, src1.numSamples, src2.numSamples) * sizeFactor;
    ...
    //==============================================================================
    constexpr z0 negateInternal() const noexcept
    {
        multiplyByInternal (static_cast<NumericType> (-1.0));
    }

    template <typename OtherSampleType>
    z0 replaceWithNegativeOfInternal (AudioBlock<OtherSampleType> src) const noexcept
    {
        jassert (numChannels == src.numChannels);
        auto n = jmin (numSamples, src.numSamples) * sizeFactor;
    ...
    template <typename OtherSampleType>
    z0 replaceWithAbsoluteValueOfInternal (AudioBlock<OtherSampleType> src) const noexcept
    {
        jassert (numChannels == src.numChannels);
        auto n = jmin (numSamples, src.numSamples) * sizeFactor;
    ...
    //==============================================================================
    template <typename Src1SampleType, typename Src2SampleType>
    z0 replaceWithMinOfInternal (AudioBlock<Src1SampleType> src1, AudioBlock<Src2SampleType> src2) const noexcept
    {
        jassert (numChannels == src1.numChannels && src1.numChannels == src2.numChannels);
    ...
    template <typename Src1SampleType, typename Src2SampleType>
    z0 replaceWithMaxOfInternal (AudioBlock<Src1SampleType> src1, AudioBlock<Src2SampleType> src2) const noexcept
    {
        jassert (numChannels == src1.numChannels && src1.numChannels == src2.numChannels);
        auto n = jmin (src1.numSamples, src2.numSamples, numSamples) * sizeFactor;
