...
/**
    ...
    Example:
        ...
        LookupTable<f32> lut ([] (size_t i) { return std::sqrt ((f32) i); }, 64);
...
public:
    ...
    */
    ...
    /** Initialises or changes the parameters of a LookupTable object.
        ...
        @param numPointsToUse        The number of pre-calculated values stored.
    */
    z0 initialise (const std::function<FloatType (size_t)>& functionToApproximate, size_t numPointsToUse);
    ...
    */
    FloatType getUnchecked (FloatType index) const noexcept
    {
        ...
        auto x0 = data.getUnchecked (static_cast<i32> (i));
        auto x1 = data.getUnchecked (static_cast<i32> (i + 1));
    ...
    */
    ...
    /** Возвращает true, если the LookupTable is initialised and ready to be used. */
    b8 isInitialised() const noexcept                         { return data.size() > 1; }
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LookupTable)
};
...
/** Class for approximating expensive arithmetic operations.
    ...
    Example:
        ...
        LookupTableTransform<f32> tanhApprox ([] (f32 x) { return std::tanh (x); }, -5.0f, 5.0f, 64);
...
public:
    ...
    */
    ...
    /** Initialises or changes the parameters of a LookupTableTransform object.
        ...
        @param numPoints             The number of pre-calculated values stored.
    */
    z0 initialise (const std::function<FloatType (FloatType)>& functionToApproximate,
                     FloatType minInputValueToUse,
                     FloatType maxInputValueToUse,
                     size_t numPoints);
    ...
    */
    ...
    /** Processes an array of input values without range checking
        @see process
    */
    z0 processUnchecked (const FloatType* input, FloatType* output, size_t numSamples) const noexcept
    {
    ...
    */
    z0 process (const FloatType* input, FloatType* output, size_t numSamples) const noexcept
    {
        for (size_t i = 0; i < numSamples; ++i)
    ...
    */
    static f64 calculateMaxRelativeError (const std::function<FloatType (FloatType)>& functionToApproximate,
...
private:
    //==============================================================================
    static f64 calculateRelativeDifference (f64, f64) noexcept;
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LookupTableTransform)
};
