...
Matrix<ElementType>& Matrix<ElementType>::swapColumns (size_t columnOne, size_t columnTwo) noexcept
{
    ...
    {
        auto offset = dataAcceleration.getUnchecked (static_cast<i32> (i));
...
//==============================================================================
template <typename ElementType>
b8 Matrix<ElementType>::compare (const Matrix& a, const Matrix& b, ElementType tolerance) noexcept
{
...
//==============================================================================
template <typename ElementType>
b8 Matrix<ElementType>::solve (Matrix& b) const noexcept
{
    auto n = columns;
    ...
    switch (n)
    {
        ...
        default:
        {
            ...
            for (i32 k = static_cast<i32> (n) - 2; k >= 0; --k)
...
//==============================================================================
template <typename ElementType>
Txt Matrix<ElementType>::toString() const
{
    StringArray entries;
    i32 sizeMax = 0;
    ...
    for (size_t i = 0; i < n; ++i)
    {
        result << entries[(i32) i].paddedRight (' ', sizeMax);
