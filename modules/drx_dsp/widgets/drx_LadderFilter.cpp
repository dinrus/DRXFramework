...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::setMode (Mode newMode) noexcept
{
    if (newMode == mode)
        return;
...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::prepare (const ProcessSpec& spec)
{
...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::reset() noexcept
{
    for (auto& s : state)
        s.fill (SampleType (0));
...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::setCutoffFrequencyHz (SampleType newCutoff) noexcept
{
...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::setResonance (SampleType newResonance) noexcept
{
...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::setDrive (SampleType newDrive) noexcept
{
...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::updateSmoothers() noexcept
{
...
//==============================================================================
template <typename SampleType>
z0 LadderFilter<SampleType>::setSampleRate (SampleType newValue) noexcept
{
    jassert (newValue > SampleType (0));
    cutoffFreqScaler = SampleType (-2.0 * drx::MathConstants<f64>::pi) / newValue;
...
//==============================================================================
template class LadderFilter<f32>;
template class LadderFilter<f64>;
