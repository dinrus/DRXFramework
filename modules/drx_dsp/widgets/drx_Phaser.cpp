...
template <typename SampleType>
z0 Phaser<SampleType>::setRate (SampleType newRateHz)
{
...
template <typename SampleType>
z0 Phaser<SampleType>::setDepth (SampleType newDepth)
{
...
template <typename SampleType>
z0 Phaser<SampleType>::setCentreFrequency (SampleType newCentreHz)
{
...
template <typename SampleType>
z0 Phaser<SampleType>::setFeedback (SampleType newFeedback)
{
...
template <typename SampleType>
z0 Phaser<SampleType>::setMix (SampleType newMix)
{
...
//==============================================================================
template <typename SampleType>
z0 Phaser<SampleType>::prepare (const ProcessSpec& spec)
{
    ...
    auto specDown = spec;
    specDown.sampleRate /= (f64) maxUpdateCounter;
    specDown.maximumBlockSize = specDown.maximumBlockSize / (u32) maxUpdateCounter + 1;

    osc.prepare (specDown);
    bufferFrequency.setSize (1, (i32) specDown.maximumBlockSize, false, false, true);
...
z0 Phaser<SampleType>::reset()
{
    ...
    oscVolume.reset (sampleRate / (f64) maxUpdateCounter, 0.05);
...
//==============================================================================
template class Phaser<f32>;
template class Phaser<f64>;
