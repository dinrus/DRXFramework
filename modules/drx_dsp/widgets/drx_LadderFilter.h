...
public:
    ...
    z0 setEnabled (b8 isEnabled) noexcept    { enabled = isEnabled; }

    /** Sets filter mode. */
    z0 setMode (Mode newMode) noexcept;
    ...
    */
    z0 setDrive (SampleType newDrive) noexcept;
...
protected:
    ...
    z0 updateSmoothers() noexcept;

private:
    //==============================================================================
    z0 setSampleRate (SampleType newValue) noexcept;
    z0 setNumChannels (size_t newValue)   { state.resize (newValue); }
    z0 updateCutoffFreq() noexcept        { cutoffTransformSmoother.setTargetValue (std::exp (cutoffFreqHz * cutoffFreqScaler)); }
    z0 updateResonance() noexcept         { scaledResonanceSmoother.setTargetValue (jmap (resonance, SampleType (0.1), SampleType (1.0))); }
