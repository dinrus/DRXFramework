...
public:
    ...
    /** Constructor. */
    explicit DelayLine (i32 maximumDelayInSamples);

    //==============================================================================
    /** Sets the delay in samples. */
    z0 setDelay (SampleType newDelayInSamples);
    ...
    */
    z0 setMaximumDelayInSamples (i32 maxDelayInSamples);
    ...
    */
    i32 getMaximumDelayInSamples() const noexcept       { return totalSize - 2; }
    ...
    */
    z0 pushSample (i32 channel, SampleType sample);
    ...
    */
    SampleType popSample (i32 channel, SampleType delayInSamples = -1, b8 updateReadPointer = true);
    ...
    */
    ...
    z0 process (const ProcessContext& context) noexcept
    {
        ...
        for (size_t channel = 0; channel < numChannels; ++channel)
        {
            ...
            {
                pushSample ((i32) channel, inputSamples[i]);
                outputSamples[i] = popSample ((i32) channel);
            }
        }
    }
...
private:
    //==============================================================================
    SampleType interpolateSample (i32 channel)
    {
    ...
    std::vector<i32> writePos, readPos;
    SampleType delay = 0.0, delayFrac = 0.0;
    i32 delayInt = 0, totalSize = 4;
