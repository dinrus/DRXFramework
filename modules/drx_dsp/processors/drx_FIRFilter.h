...
namespace drx::dsp::FIR
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        inline z0 prepare ([[maybe_unused]] const ProcessSpec& spec) noexcept
        {
    ...
    private:
        ...
        static SampleType DRX_VECTOR_CALLTYPE processSingleSample (SampleType sample, SampleType* buf,
    ...
    */
    ...
    struct Coefficients  : public ProcessorState
    {
        ...
        Coefficients (size_t size)    { coefficients.resize ((i32) size); }

        /** Creates a set of coefficients from an array of samples. */
        Coefficients (const NumericType* samples, size_t numSamples)   : coefficients (samples, (i32) numSamples) {}
        ...
        */
        ...
        /** Returns the magnitude frequency response of the filter for a given frequency array
            and sample rate.
        */
        z0 getMagnitudeForFrequencyArray (f64* frequencies, f64* magnitudes,
