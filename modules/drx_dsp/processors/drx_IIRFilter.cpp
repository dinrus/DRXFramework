...
std::array<NumericType, 4> ArrayCoefficients<NumericType>::makeFirstOrderLowPass (f64 sampleRate,
                                                                                  NumericType frequency)
{
    jassert (sampleRate > 0.0);
    jassert (frequency > 0 && frequency <= static_cast<f32> (sampleRate * 0.5));
...
template <typename NumericType>
std::array<NumericType, 4> ArrayCoefficients<NumericType>::makeFirstOrderHighPass (f64 sampleRate,
                                                                                   NumericType frequency)
{
    jassert (sampleRate > 0.0);
    jassert (frequency > 0 && frequency <= static_cast<f32> (sampleRate * 0.5));
...
template <typename NumericType>
std::array<NumericType, 4> ArrayCoefficients<NumericType>::makeFirstOrderAllPass (f64 sampleRate,
                                                                                  NumericType frequency)
{
    jassert (sampleRate > 0.0);
    jassert (frequency > 0 && frequency <= static_cast<f32> (sampleRate * 0.5));
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makeLowPass (f64 sampleRate,
                                                                        NumericType frequency)
{
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makeHighPass (f64 sampleRate,
                                                                         NumericType frequency)
{
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makeBandPass (f64 sampleRate,
                                                                         NumericType frequency)
{
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makeNotch (f64 sampleRate,
                                                                      NumericType frequency)
{
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makeAllPass (f64 sampleRate,
                                                                        NumericType frequency)
{
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makeLowShelf (f64 sampleRate,
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makeHighShelf (f64 sampleRate,
                                                                          NumericType cutOffFrequency,
                                                                          NumericType Q,
                                                                          NumericType gainFactor)
{
...
template <typename NumericType>
std::array<NumericType, 6> ArrayCoefficients<NumericType>::makePeakFilter (f64 sampleRate,
                                                                           NumericType frequency,
                                                                           NumericType Q,
                                                                           NumericType gainFactor)
{
...
template struct ArrayCoefficients<f32>;
template struct ArrayCoefficients<f64>;
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeFirstOrderLowPass (f64 sampleRate,
                                                                                          NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeFirstOrderHighPass (f64 sampleRate,
                                                                                           NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeFirstOrderAllPass (f64 sampleRate,
                                                                                          NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeLowPass (f64 sampleRate,
                                                                                NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeHighPass (f64 sampleRate,
                                                                                 NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeBandPass (f64 sampleRate,
                                                                                 NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeNotch (f64 sampleRate,
                                                                              NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeAllPass (f64 sampleRate,
                                                                                NumericType frequency)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeLowShelf (f64 sampleRate,
                                                                                 NumericType cutOffFrequency,
                                                                                 NumericType Q,
                                                                                 NumericType gainFactor)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makeHighShelf (f64 sampleRate,
                                                                                  NumericType cutOffFrequency,
                                                                                  NumericType Q,
                                                                                  NumericType gainFactor)
{
...
template <typename NumericType>
typename Coefficients<NumericType>::Ptr Coefficients<NumericType>::makePeakFilter (f64 sampleRate,
                                                                                   NumericType frequency,
                                                                                   NumericType Q,
                                                                                   NumericType gainFactor)
{
...
template <typename NumericType>
f64 Coefficients<NumericType>::getMagnitudeForFrequency (f64 frequency, f64 sampleRate) const noexcept
{
    ...
    Complex<f64> numerator = 0.0, denominator = 0.0, factor = 1.0;
    Complex<f64> jw = std::exp (-MathConstants<f64>::twoPi * frequency * j / sampleRate);
    ...
    {
        denominator += static_cast<f64> (coefs[n]) * factor;
        factor *= jw;
    }
...
template <typename NumericType>
z0 Coefficients<NumericType>::getMagnitudeForFrequencyArray (const f64* frequencies, f64* magnitudes,
                                                               size_t numSamples, f64 sampleRate) const noexcept
{
    ...
    for (size_t i = 0; i < numSamples; ++i)
    {
        ...
        Complex<f64> numerator = 0.0, denominator = 0.0, factor = 1.0;
        Complex<f64> jw = std::exp (-MathConstants<f64>::twoPi * frequencies[i] * j / sampleRate);
...
template <typename NumericType>
f64 Coefficients<NumericType>::getPhaseForFrequency (f64 frequency, f64 sampleRate) const noexcept
{
    constexpr Complex<f64> j (0, 1);
    const auto order = getFilterOrder();
    const auto* coefs = coefficients.begin();
...
template <typename NumericType>
z0 Coefficients<NumericType>::getPhaseForFrequencyArray (f64* frequencies, f64* phases,
                                                           size_t numSamples, f64 sampleRate) const noexcept
{
    jassert (sampleRate > 0);
    ...
    for (size_t i = 0; i < numSamples; ++i)
    {
        ...
        Complex<f64> numerator = 0.0, denominator = 0.0, factor = 1.0;
        Complex<f64> jw = std::exp (-MathConstants<f64>::twoPi * frequencies[i] * j * invSampleRate);
...
template struct Coefficients<f32>;
template struct Coefficients<f64>;
