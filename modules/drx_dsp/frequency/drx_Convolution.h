...
/**
    ...
    @tags{DSP}
*/
class DRX_API ConvolutionMessageQueue
{
public:
    ...
    */
    explicit ConvolutionMessageQueue (i32 numEntries);
...
/**
    ...
    impulse response in the frequency domain, using the DRX FFT class.
...
public:
    ...
    */
    ...
    struct Latency { i32 latencyInSamples; };
    ...
    */
    ...
    struct NonUniform { i32 headSizeInSamples; };
    ...
    */
    template <typename ProcessContext,
              std::enable_if_t<std::is_same_v<typename ProcessContext::SampleType, f32>, i32> = 0>
    ...
    /** This function loads an impulse response audio file from memory, added in a
        DRX project with the Projucer as binary data. It can load any of the audio
        formats registered in DRX, and performs some resampling and pre-processing
        as well if needed.

        Note: Don't try to use this function on f32 samples, since the data is
    ...
    */
    z0 loadImpulseResponse (ukk sourceData, size_t sourceDataSize,
    ...
    /** This function loads an impulse response from an audio file. It can load any
        of the audio formats registered in DRX, and performs some resampling and
    ...
    */
    ...
    /** This function loads an impulse response from an audio buffer.
        ...
        @param requiresNormalisation    optionally normalise the impulse response amplitude
    */
    z0 loadImpulseResponse (AudioBuffer<f32>&& buffer, f64 bufferSampleRate,
...
private:
    ...
    z0 processSamples (const AudioBlock<const f32>&, AudioBlock<f32>&, b8 isBypassed) noexcept;
    ...
    public:
        ...
        z0 processSamples (const AudioBlock<const f32>&,
                             AudioBlock<f32>&,
                             b8 isBypassed,
                             ProcessWet&&) noexcept;
    ...
    private:
        std::array<SmoothedValue<f32>, 2> volumeDry, volumeWet;
        AudioBlock<f32> dryBlock;
        HeapBlock<t8> dryBlockStorage;
        f64 sampleRate = 0;
        b8 currentIsBypassed = false;
    };
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Convolution)
};
