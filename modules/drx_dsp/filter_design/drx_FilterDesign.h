...
struct FilterDesign
{
    ...
    */
    ...
    static FIRCoefficientsPtr designFIRLowpassWindowMethod (FloatType frequency, f64 sampleRate,
    ...
    */
    ...
    static FIRCoefficientsPtr designFIRLowpassKaiserMethod (FloatType frequency, f64 sampleRate,
    ...
    */
    static FIRCoefficientsPtr designFIRLowpassTransitionMethod (FloatType frequency, f64 sampleRate,
                                                                size_t order,
                                                                FloatType normalisedTransitionWidth,
                                                                FloatType spline);
    ...
    /** This method generates a FIR::Coefficients for a low-pass filter, by
        ...
        @param stopBandWeight               between 1.0 and 100.0, indicates how much we want
                                            ...
                                            in the pass band
    */
    static FIRCoefficientsPtr designFIRLowpassLeastSquaresMethod (FloatType frequency, f64 sampleRate, size_t order,
                                                                  FloatType normalisedTransitionWidth,
    ...
    */
    ...
    static ReferenceCountedArray<IIRCoefficients> designIIRLowpassHighOrderButterworthMethod (FloatType frequency, f64 sampleRate,
                                                                                              FloatType normalisedTransitionWidth,
    ...
    */
    ...
    static ReferenceCountedArray<IIRCoefficients> designIIRHighpassHighOrderButterworthMethod (FloatType frequency, f64 sampleRate,
                                                                                               i32 order);
    ...
    */
    static ReferenceCountedArray<IIRCoefficients> designIIRLowpassHighOrderChebyshev1Method (FloatType frequency, f64 sampleRate,
                                                                                             FloatType normalisedTransitionWidth,
                                                                                             FloatType passbandAmplitudedB,
                                                                                             FloatType stopbandAmplitudedB);
    ...
    /** This method returns an array of IIR::Coefficients, made to be used in
        ...
        @param stopbandAmplitudedB          the lowest amplitude in dB expected in the stop band (must be negative)
    */
    static ReferenceCountedArray<IIRCoefficients> designIIRLowpassHighOrderChebyshev2Method (FloatType frequency, f64 sampleRate,
                                                                                             FloatType normalisedTransitionWidth,
                                                                                             FloatType passbandAmplitudedB,
                                                                                             FloatType stopbandAmplitudedB);
    ...
    /** This method returns an array of IIR::Coefficients, made to be used in
        ...
        @param stopbandAmplitudedB          the lowest amplitude in dB expected in the stop band (must be negative)
    */
    static ReferenceCountedArray<IIRCoefficients> designIIRLowpassHighOrderEllipticMethod (FloatType frequency, f64 sampleRate,
                                                                                           FloatType normalisedTransitionWidth,
                                                                                           FloatType passbandAmplitudedB,
                                                                                           FloatType stopbandAmplitudedB);
...
private:
    //==============================================================================
    static Array<f64> getPartialImpulseResponseHn (i32 n, f64 kp);

    static ReferenceCountedArray<IIRCoefficients> designIIRLowpassHighOrderGeneralMethod (i32 type, FloatType frequency, f64 sampleRate,
                                                                                          FloatType normalisedTransitionWidth,
                                                                                          FloatType passbandAmplitudedB,
                                                                                          FloatType stopbandAmplitudedB);
    FilterDesign() = delete;
