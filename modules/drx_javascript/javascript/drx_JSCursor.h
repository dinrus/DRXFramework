...
/**
    ...
    Javascript Object graph. A cursor only maintains ownership of the root Object. So as i64 as a
...
public:
    ...
    */
    ...
    /** Returns a new cursor that has the same root Object as the parent and has the index parameter
        ...
        object will be invalid. This however can change due to subsequent script executions.
    */
    JSCursor getChild (z64 index) const;
    ...
    /** Returns a new cursor that has the same root Object as the parent and has the index parameter
        ...
        Shorthand for getChild.
    */
    JSCursor operator[] (z64 index) const;

    /** Возвращает true, если the location of the cursor is reachable from the cursor's JSObject root.
    ...
    */
    ...
    /** Возвращает true, если there is an Array under the cursor's location.
...
private:
    using Property = std::variant<Identifier, z64>;
