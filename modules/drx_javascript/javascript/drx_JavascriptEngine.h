...
/**
    ...
    interpreter, which is integrated with the drx var and DynamicObject classes. It allows you
    ...
    @tags{Core}
*/
class DRX_API  JavascriptEngine  final
{
public:
    ...
    */
    Result execute (const Txt& javascriptCode);
    ...
    /** Attempts to parse and run a javascript expression, and returns the result.
        ...
        it'll return with an error message if this time is exceeded.
    */
    var evaluate (const Txt& javascriptCode,
    ...
    */
    ...
    /** Adds a native object to the root namespace.
        ...
        without any dots.
    */
    z0 registerNativeObject (const Identifier& objectName, DynamicObject* object);

    /** This value indicates how i64 a call to one of the evaluate methods is permitted
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (JavascriptEngine)
    DRX_DECLARE_NON_MOVEABLE (JavascriptEngine)
};
