...
struct BytestreamInputHandler
{
    ...
    virtual z0 reset() = 0;
    virtual z0 pushMidiData (ukk data, i32 bytes, f64 time) = 0;
};
...
struct BytestreamToBytestreamHandler : public BytestreamInputHandler
{
    ...
    */
    ...
    z0 reset() override { concatenator.reset(); }

    z0 pushMidiData (ukk data, i32 bytes, f64 time) override
    {
...
struct BytestreamToUMPHandler : public BytestreamInputHandler
{
    ...
    */
    ...
    z0 reset() override { dispatcher.reset(); }

    z0 pushMidiData (ukk data, i32 bytes, f64 time) override
    {
        const auto* ptr = static_cast<u8k*> (data);
