...
struct U32InputHandler
{
    ...
    virtual z0 reset() = 0;
    virtual z0 pushMidiData (u32k* begin, u32k* end, f64 time) = 0;
};
...
struct U32ToBytestreamHandler : public U32InputHandler
{
    ...
    */
    ...
    z0 pushMidiData (u32k* begin, u32k* end, f64 time) override
    {
...
struct U32ToUMPHandler : public U32InputHandler
{
    ...
    */
    ...
    z0 pushMidiData (u32k* begin, u32k* end, f64 time) override
    {
        dispatcher.dispatch (begin, end, time, [this] (const View& view, f64 thisTime)
        {
