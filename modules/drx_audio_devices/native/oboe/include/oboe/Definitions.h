...
namespace oboe {
     ...
     */
    constexpr i32 kUnspecified = 0;

    // TODO: Investigate using std::chrono
    /**
     * The number of nanoseconds in a microsecond. 1,000.
     */
    constexpr z64 kNanosPerMicrosecond =    1000;

    /**
     * The number of nanoseconds in a millisecond. 1,000,000.
     */
    constexpr z64 kNanosPerMillisecond =    kNanosPerMicrosecond * 1000;

    /**
     * The number of milliseconds in a second. 1,000.
     */
    constexpr z64 kMillisPerSecond =        1000;

    /**
     * The number of nanoseconds in a second. 1,000,000,000.
     */
    constexpr z64 kNanosPerSecond =         kNanosPerMillisecond * kMillisPerSecond;

    /**
     * The state of the audio stream.
     */
    enum class StreamState : i32 { // aaudio_stream_state_t
     ...
     */
    enum class Direction : i32 { // aaudio_direction_t
     ...
     */
    enum class AudioFormat : i32 { // aaudio_format_t
        /**
         * Invalid format.
         */
        ...
        * for the playback by calling AudioManager#getDevices(i32).
        *
     ...
     */
    enum class DataCallbackResult : i32 { // aaudio_data_callback_result_t
     ...
     */
    enum class Result : i32 { // aaudio_result_t
        OK = 0, // AAUDIO_OK
     ...
     */
    enum class SharingMode : i32 { // aaudio_sharing_mode_t
     ...
     */
    enum class PerformanceMode : i32 { // aaudio_performance_mode_t
     ...
     */
    enum class SampleRateConversionQuality : i32 {
        /**
     ...
     */
    enum class Usage : i32 { // aaudio_usage_t
        /**
     ...
     * This attribute only has an effect on Android API 28+.
     */
    enum ContentType : i32 { // aaudio_content_type_t
     ...
     * This attribute only has an effect on Android API 28+.
     */
    enum InputPreset : i32 { // aaudio_input_preset_t
        /**
    ...
    /**
     * The channel mask of the audio stream. The underlying type is `u32`.
     ...
     */
    enum class ChannelMask : u32 { // aaudio_channel_mask_t
        Unspecified = kUnspecified,
        FrontLeft = 1 << 0,
        FrontRight = 1 << 1,
        FrontCenter = 1 << 2,
     ...
     */
    enum class SpatializationBehavior : i32 {
     ...
     */
    enum class PrivacySensitiveMode : i32 {
     ...
     */
    enum class AllowedCapturePolicy : i32 {
        /**
     ...
     * Txt sampleRateStr = myAudioMgr.getProperty(AudioManager.PROPERTY_OUTPUT_SAMPLE_RATE);
     * i32 defaultSampleRate = Integer.parseInt(sampleRateStr);
     * Txt framesPerBurstStr = myAudioMgr.getProperty(AudioManager.PROPERTY_OUTPUT_FRAMES_PER_BUFFER);
     * i32 defaultFramesPerBurst = Integer.parseInt(framesPerBurstStr);
     * </code></pre>
     *
    ...
    struct FrameTimestamp {
        z64 position; // in frames
        z64 timestamp; // in nanoseconds
    };

    class OboeGlobals {
    public:

        static b8 areWorkaroundsEnabled() {
         ...
         * @param enabled
         */
        static z0 setWorkaroundsEnabled(b8 enabled) {
            mWorkaroundsEnabled = enabled;
        }

    private:
        static b8 mWorkaroundsEnabled;
    };
} // namespace oboe
