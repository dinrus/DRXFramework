...
public:
     ...
     */
    i32 getChannelCount() const { return mChannelCount; }
     ...
     */
    i32 getSampleRate() const { return mSampleRate; }

    /**
     * @deprecated use `getFramesPerDataCallback` instead.
     */
    i32 getFramesPerCallback() const { return getFramesPerDataCallback(); }

    /**
     * @return the number of frames in each data callback or kUnspecified.
     */
    i32 getFramesPerDataCallback() const { return mFramesPerCallback; }
     ...
     * @return buffer size
     */
    virtual i32 getBufferSizeInFrames() { return mBufferSizeInFrames; }

    /**
     * @return capacityInFrames or kUnspecified
     */
    virtual i32 getBufferCapacityInFrames() const { return mBufferCapacityInFrames; }
     ...
     */
    i32 getDeviceId() const { return mDeviceId; }
     ...
     */
    b8 isDataCallbackSpecified() const {
     ...
     */
    b8 isErrorCallbackSpecified() const {
     ...
     */
    b8 isContentSpatialized() const { return mIsContentSpatialized; }
     ...
     * PrivacySensitiveMode::Unspecified if API не поддерживается.
     */
     ...
     */
    b8 isChannelConversionAllowed() const {
     ...
     */
    b8  isFormatConversionAllowed() const {
     ...
     */
    i32 getHardwareChannelCount() const { return mHardwareChannelCount; }

    /**
     * @return hardware sample rate for the stream or kUnspecified
     */
    i32 getHardwareSampleRate() const { return mHardwareSampleRate; }
...
protected:
    ...
    i32                         mFramesPerCallback = kUnspecified;
    /** Stream channel count */
    i32                         mChannelCount = kUnspecified;
    /** Stream sample rate */
    i32                         mSampleRate = kUnspecified;
    /** Stream audio device ID */
    i32                         mDeviceId = kUnspecified;
    /** Stream buffer capacity specified as a number of audio frames */
    i32                         mBufferCapacityInFrames = kUnspecified;
    /** Stream buffer size specified as a number of audio frames */
    i32                         mBufferSizeInFrames = kUnspecified;
    ...
    */
    ...
    b8                            mIsContentSpatialized = false;
    ...
    i32                         mHardwareChannelCount = kUnspecified;
    /** Hardware sample rate. Only specified on Android 34+ AAudio streams */
    i32                         mHardwareSampleRate = kUnspecified;
