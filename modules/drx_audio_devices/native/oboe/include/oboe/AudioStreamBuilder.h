...
public:
     ...
     */
    AudioStreamBuilder *setChannelCount(i32 channelCount) {
     ...
     *
     */
    AudioStreamBuilder *setSampleRate(i32 sampleRate) {
     ...
     */
    AudioStreamBuilder *setFramesPerCallback(i32 framesPerCallback) {
     ...
     */
    AudioStreamBuilder *setFramesPerDataCallback(i32 framesPerCallback) {
     ...
     * @return pointer to the builder so calls can be chained
     */
    AudioStreamBuilder *setBufferCapacityInFrames(i32 bufferCapacityInFrames) {
     ...
     * @return pointer to the builder so calls can be chained
     */
    AudioStreamBuilder *setDeviceId(i32 deviceId) {
        mDeviceId = deviceId;
        return this;
    }
     ...
     * f64-processing on platforms that will spatialize audio data.
     *
     ...
     * @return pointer to the builder so calls can be chained
     */
    AudioStreamBuilder *setIsContentSpatialized(b8 isContentSpatialized) {
    ...
    */
     ...
     * Default is false.
     */
    AudioStreamBuilder *setChannelConversionAllowed(b8 allowed) {
     ...
     * On some versions of Android, for example, a f32 stream could not get a
     * low latency data path. So an I16 stream might be opened and converted to f32.
     *
     * Default is false.
     */
    AudioStreamBuilder *setFormatConversionAllowed(b8 allowed) {
...
private:
     ...
     */
    b8 isCompatible(AudioStreamBase &other);
