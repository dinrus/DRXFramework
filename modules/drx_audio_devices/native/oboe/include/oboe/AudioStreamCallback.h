...
public:
     ...
     */
    virtual b8 onError(AudioStream* /* audioStream */, Result /* error */) {
        return false;
    }
     ...
     * @param error
     */
    virtual z0 onErrorBeforeClose(AudioStream* /* audioStream */, Result /* error */) {}
     ...
     * @param error
     */
    virtual z0 onErrorAfterClose(AudioStream* /* audioStream */, Result /* error */) {}
