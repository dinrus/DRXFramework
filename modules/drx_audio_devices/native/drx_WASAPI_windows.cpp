...
#ifndef DRX_WASAPI_LOGGING
 #define DRX_WASAPI_LOGGING 0
#endif
...
static z0 logFailure ([[maybe_unused]] HRESULT hr)
{
    ...
    if (FAILED (hr))
    {
        ...
        switch (hr)
        {
            ...
            #define DRX_WASAPI_ERR(desc, n) \
                case MAKE_HRESULT(1, 0x889, n): m = #desc; break;

            DRX_WASAPI_ERR (AUDCLNT_E_NOT_INITIALIZED, 0x001)
            DRX_WASAPI_ERR (AUDCLNT_E_ALREADY_INITIALIZED, 0x002)
            DRX_WASAPI_ERR (AUDCLNT_E_WRONG_ENDPOINT_TYPE, 0x003)
            DRX_WASAPI_ERR (AUDCLNT_E_DEVICE_INVALIDATED, 0x004)
            DRX_WASAPI_ERR (AUDCLNT_E_NOT_STOPPED, 0x005)
            DRX_WASAPI_ERR (AUDCLNT_E_BUFFER_TOO_LARGE, 0x006)
            DRX_WASAPI_ERR (AUDCLNT_E_OUT_OF_ORDER, 0x007)
            DRX_WASAPI_ERR (AUDCLNT_E_UNSUPPORTED_FORMAT, 0x008)
            DRX_WASAPI_ERR (AUDCLNT_E_INVALID_SIZE, 0x009)
            DRX_WASAPI_ERR (AUDCLNT_E_DEVICE_IN_USE, 0x00a)
            DRX_WASAPI_ERR (AUDCLNT_E_BUFFER_OPERATION_PENDING, 0x00b)
            DRX_WASAPI_ERR (AUDCLNT_E_THREAD_NOT_REGISTERED, 0x00c)
            DRX_WASAPI_ERR (AUDCLNT_E_EXCLUSIVE_MODE_NOT_ALLOWED, 0x00e)
            DRX_WASAPI_ERR (AUDCLNT_E_ENDPOINT_CREATE_FAILED, 0x00f)
            DRX_WASAPI_ERR (AUDCLNT_E_SERVICE_NOT_RUNNING, 0x010)
            DRX_WASAPI_ERR (AUDCLNT_E_EVENTHANDLE_NOT_EXPECTED, 0x011)
            DRX_WASAPI_ERR (AUDCLNT_E_EXCLUSIVE_MODE_ONLY, 0x012)
            DRX_WASAPI_ERR (AUDCLNT_E_BUFDURATION_PERIOD_NOT_EQUAL, 0x013)
            DRX_WASAPI_ERR (AUDCLNT_E_EVENTHANDLE_NOT_SET, 0x014)
            DRX_WASAPI_ERR (AUDCLNT_E_INCORRECT_BUFFER_SIZE, 0x015)
            DRX_WASAPI_ERR (AUDCLNT_E_BUFFER_SIZE_ERROR, 0x016)
            DRX_WASAPI_ERR (AUDCLNT_E_CPUUSAGE_EXCEEDED, 0x017)
            DRX_WASAPI_ERR (AUDCLNT_E_BUFFER_ERROR, 0x018)
            DRX_WASAPI_ERR (AUDCLNT_E_BUFFER_SIZE_NOT_ALIGNED, 0x019)
            DRX_WASAPI_ERR (AUDCLNT_E_INVALID_DEVICE_PERIOD, 0x020)
            default: break;
        }

        Logger::writeToLog ("WASAPI error: " + (m != nullptr ? Txt (m)
                                                             : Txt::toHexString ((i32) hr)));
    }
   #endif
}
...
DRX_IUNKNOWNCLASS (IPropertyStore, "886d8eeb-8cf2-4446-8d02-cdba1dbdcf99")
{
    DRX_COMCALL GetCount (DWORD*) = 0;
    DRX_COMCALL GetAt (DWORD, PROPERTYKEY*) = 0;
    DRX_COMCALL GetValue (const PROPERTYKEY&, PROPVARIANT*) = 0;
    DRX_COMCALL SetValue (const PROPERTYKEY&, const PROPVARIANT&) = 0;
    DRX_COMCALL Commit() = 0;
};

DRX_IUNKNOWNCLASS (IMMDevice, "D666063F-1587-4E43-81F1-B948E807363F")
{
    DRX_COMCALL Activate (REFIID, DWORD, PROPVARIANT*, uk*) = 0;
    DRX_COMCALL OpenPropertyStore (DWORD, IPropertyStore**) = 0;
    DRX_COMCALL GetId (LPWSTR*) = 0;
    DRX_COMCALL GetState (DWORD*) = 0;
};

DRX_IUNKNOWNCLASS (IMMEndpoint, "1BE09788-6894-4089-8586-9A2A6C265AC5")
{
    DRX_COMCALL GetDataFlow (EDataFlow*) = 0;
};

struct IMMDeviceCollection : public IUnknown
{
    DRX_COMCALL GetCount (UINT*) = 0;
    DRX_COMCALL Item (UINT, IMMDevice**) = 0;
};
...
DRX_IUNKNOWNCLASS (IMMNotificationClient, "7991EEC9-7E89-4D85-8390-6C703CEC60C0")
{
    DRX_COMCALL OnDeviceStateChanged (LPCWSTR, DWORD) = 0;
    DRX_COMCALL OnDeviceAdded (LPCWSTR) = 0;
    DRX_COMCALL OnDeviceRemoved (LPCWSTR) = 0;
    DRX_COMCALL OnDefaultDeviceChanged (EDataFlow, ERole, LPCWSTR) = 0;
    DRX_COMCALL OnPropertyValueChanged (LPCWSTR, const PROPERTYKEY) = 0;
};

DRX_IUNKNOWNCLASS (IMMDeviceEnumerator, "A95664D2-9614-4F35-A746-DE8DB63617E6")
{
    DRX_COMCALL EnumAudioEndpoints (EDataFlow, DWORD, IMMDeviceCollection**) = 0;
    DRX_COMCALL GetDefaultAudioEndpoint (EDataFlow, ERole, IMMDevice**) = 0;
    DRX_COMCALL GetDevice (LPCWSTR, IMMDevice**) = 0;
    DRX_COMCALL RegisterEndpointNotificationCallback (IMMNotificationClient*) = 0;
    DRX_COMCALL UnregisterEndpointNotificationCallback (IMMNotificationClient*) = 0;
};

DRX_COMCLASS (MMDeviceEnumerator, "BCDE0395-E52F-467C-8E3D-C4579291692E");
...
DRX_IUNKNOWNCLASS (IAudioClient, "1CB9AD4C-DBFA-4c32-B178-C2F568A703B2")
{
    DRX_COMCALL Initialize (AUDCLNT_SHAREMODE, DWORD, REFERENCE_TIME, REFERENCE_TIME, const WAVEFORMATEX*, LPCGUID) = 0;
    DRX_COMCALL GetBufferSize (UINT32*) = 0;
    DRX_COMCALL GetStreamLatency (REFERENCE_TIME*) = 0;
    DRX_COMCALL GetCurrentPadding (UINT32*) = 0;
    DRX_COMCALL IsFormatSupported (AUDCLNT_SHAREMODE, const WAVEFORMATEX*, WAVEFORMATEX**) = 0;
    DRX_COMCALL GetMixFormat (WAVEFORMATEX**) = 0;
    DRX_COMCALL GetDevicePeriod (REFERENCE_TIME*, REFERENCE_TIME*) = 0;
    DRX_COMCALL Start() = 0;
    DRX_COMCALL Stop() = 0;
    DRX_COMCALL Reset() = 0;
    DRX_COMCALL SetEventHandle (HANDLE) = 0;
    DRX_COMCALL GetService (REFIID, uk*) = 0;
};

DRX_COMCLASS (IAudioClient2, "726778CD-F60A-4eda-82DE-E47610CD78AA") : public IAudioClient
{
    DRX_COMCALL IsOffloadCapable (AUDIO_STREAM_CATEGORY, BOOL*) = 0;
    DRX_COMCALL SetClientProperties (const AudioClientProperties*) = 0;
    DRX_COMCALL GetBufferSizeLimits (const WAVEFORMATEX*, BOOL, REFERENCE_TIME*, REFERENCE_TIME*) = 0;
};

DRX_COMCLASS (IAudioClient3, "1CB9AD4C-DBFA-4c32-B178-C2F568A703B2") : public IAudioClient2
{
    DRX_COMCALL GetSharedModeEnginePeriod (const WAVEFORMATEX*, UINT32*, UINT32*, UINT32*, UINT32*) = 0;
    DRX_COMCALL GetCurrentSharedModeEnginePeriod (WAVEFORMATEX**, UINT32*) = 0;
    DRX_COMCALL InitializeSharedAudioStream (DWORD, UINT32, const WAVEFORMATEX*, LPCGUID) = 0;
};

DRX_IUNKNOWNCLASS (IAudioCaptureClient, "C8ADBD64-E71E-48a0-A4DE-185C395CD317")
{
    DRX_COMCALL GetBuffer (BYTE**, UINT32*, DWORD*, UINT64*, UINT64*) = 0;
    DRX_COMCALL ReleaseBuffer (UINT32) = 0;
    DRX_COMCALL GetNextPacketSize (UINT32*) = 0;
};

DRX_IUNKNOWNCLASS (IAudioRenderClient, "F294ACFC-3146-4483-A7BF-ADDCA7C260E2")
{
    DRX_COMCALL GetBuffer (UINT32, BYTE**) = 0;
    DRX_COMCALL ReleaseBuffer (UINT32, DWORD) = 0;
};

DRX_IUNKNOWNCLASS (IAudioEndpointVolume, "5CDF2C82-841E-4546-9722-0CF74078229A")
{
    DRX_COMCALL RegisterControlChangeNotify (uk) = 0;
    DRX_COMCALL UnregisterControlChangeNotify (uk) = 0;
    DRX_COMCALL GetChannelCount (UINT*) = 0;
    DRX_COMCALL SetMasterVolumeLevel (f32, LPCGUID) = 0;
    DRX_COMCALL SetMasterVolumeLevelScalar (f32, LPCGUID) = 0;
    DRX_COMCALL GetMasterVolumeLevel (f32*) = 0;
    DRX_COMCALL GetMasterVolumeLevelScalar (f32*) = 0;
    DRX_COMCALL SetChannelVolumeLevel (UINT, f32, LPCGUID) = 0;
    DRX_COMCALL SetChannelVolumeLevelScalar (UINT, f32, LPCGUID) = 0;
    DRX_COMCALL GetChannelVolumeLevel (UINT, f32*) = 0;
    DRX_COMCALL GetChannelVolumeLevelScalar (UINT, f32*) = 0;
    DRX_COMCALL SetMute (BOOL, LPCGUID) = 0;
    DRX_COMCALL GetMute (BOOL*) = 0;
    DRX_COMCALL GetVolumeStepInfo (UINT*, UINT*) = 0;
    DRX_COMCALL VolumeStepUp (LPCGUID) = 0;
    DRX_COMCALL VolumeStepDown (LPCGUID) = 0;
    DRX_COMCALL QueryHardwareSupport (DWORD*) = 0;
    DRX_COMCALL GetVolumeRange (f32*, f32*, f32*) = 0;
};
...
DRX_IUNKNOWNCLASS (IAudioSessionEvents, "24918ACC-64B3-37C1-8CA9-74A66E9957A8")
{
    DRX_COMCALL OnDisplayNameChanged (LPCWSTR, LPCGUID) = 0;
    DRX_COMCALL OnIconPathChanged (LPCWSTR, LPCGUID) = 0;
    DRX_COMCALL OnSimpleVolumeChanged (f32, BOOL, LPCGUID) = 0;
    DRX_COMCALL OnChannelVolumeChanged (DWORD, f32*, DWORD, LPCGUID) = 0;
    DRX_COMCALL OnGroupingParamChanged (LPCGUID, LPCGUID) = 0;
    DRX_COMCALL OnStateChanged (AudioSessionState) = 0;
    DRX_COMCALL OnSessionDisconnected (AudioSessionDisconnectReason) = 0;
};

DRX_IUNKNOWNCLASS (IAudioSessionControl, "F4B1A599-7266-4319-A8CA-E70ACB11E8CD")
{
    DRX_COMCALL GetState (AudioSessionState*) = 0;
    DRX_COMCALL GetDisplayName (LPWSTR*) = 0;
    DRX_COMCALL SetDisplayName (LPCWSTR, LPCGUID) = 0;
    DRX_COMCALL GetIconPath (LPWSTR*) = 0;
    DRX_COMCALL SetIconPath (LPCWSTR, LPCGUID) = 0;
    DRX_COMCALL GetGroupingParam (GUID*) = 0;
    DRX_COMCALL SetGroupingParam (LPCGUID, LPCGUID) = 0;
    DRX_COMCALL RegisterAudioSessionNotification (IAudioSessionEvents*) = 0;
    DRX_COMCALL UnregisterAudioSessionNotification (IAudioSessionEvents*) = 0;
};

} // namespace drx

#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL (drx::IPropertyStore,        0x886d8eeb, 0x8cf2, 0x4446, 0x8d, 0x02, 0xcd, 0xba, 0x1d, 0xbd, 0xcf, 0x99)
__CRT_UUID_DECL (drx::IMMDevice,             0xD666063F, 0x1587, 0x4E43, 0x81, 0xF1, 0xB9, 0x48, 0xE8, 0x07, 0x36, 0x3F)
__CRT_UUID_DECL (drx::IMMEndpoint,           0x1BE09788, 0x6894, 0x4089, 0x85, 0x86, 0x9A, 0x2A, 0x6C, 0x26, 0x5A, 0xC5)
__CRT_UUID_DECL (drx::IMMNotificationClient, 0x7991EEC9, 0x7E89, 0x4D85, 0x83, 0x90, 0x6C, 0x70, 0x3C, 0xEC, 0x60, 0xC0)
__CRT_UUID_DECL (drx::IMMDeviceEnumerator,   0xA95664D2, 0x9614, 0x4F35, 0xA7, 0x46, 0xDE, 0x8D, 0xB6, 0x36, 0x17, 0xE6)
__CRT_UUID_DECL (drx::MMDeviceEnumerator,    0xBCDE0395, 0xE52F, 0x467C, 0x8E, 0x3D, 0xC4, 0x57, 0x92, 0x91, 0x69, 0x2E)
__CRT_UUID_DECL (drx::IAudioClient,          0x1CB9AD4C, 0xDBFA, 0x4c32, 0xB1, 0x78, 0xC2, 0xF5, 0x68, 0xA7, 0x03, 0xB2)
__CRT_UUID_DECL (drx::IAudioClient2,         0x726778CD, 0xF60A, 0x4eda, 0x82, 0xDE, 0xE4, 0x76, 0x10, 0xCD, 0x78, 0xAA)
__CRT_UUID_DECL (drx::IAudioClient3,         0x1CB9AD4C, 0xDBFA, 0x4c32, 0xB1, 0x78, 0xC2, 0xF5, 0x68, 0xA7, 0x03, 0xB2)
__CRT_UUID_DECL (drx::IAudioCaptureClient,   0xC8ADBD64, 0xE71E, 0x48a0, 0xA4, 0xDE, 0x18, 0x5C, 0x39, 0x5C, 0xD3, 0x17)
__CRT_UUID_DECL (drx::IAudioRenderClient,    0xF294ACFC, 0x3146, 0x4483, 0xA7, 0xBF, 0xAD, 0xDC, 0xA7, 0xC2, 0x60, 0xE2)
__CRT_UUID_DECL (drx::IAudioEndpointVolume,  0x5CDF2C82, 0x841E, 0x4546, 0x97, 0x22, 0x0C, 0xF7, 0x40, 0x78, 0x22, 0x9A)
__CRT_UUID_DECL (drx::IAudioSessionEvents,   0x24918ACC, 0x64B3, 0x37C1, 0x8C, 0xA9, 0x74, 0xA6, 0x6E, 0x99, 0x57, 0xA8)
__CRT_UUID_DECL (drx::IAudioSessionControl,  0xF4B1A599, 0x7266, 0x4319, 0xA8, 0xCA, 0xE7, 0x0A, 0xCB, 0x11, 0xE8, 0xCD)
#endif
...
static Txt getDeviceID (IMMDevice* device)
{
    Txt s;
...
static EDataFlow getDataFlow (const ComSmartPtr<IMMDevice>& device)
{
    ...
    if (auto endpoint = device.getInterface<IMMEndpoint>())
        (z0) check (endpoint->GetDataFlow (&flow));

    return flow;
}

static i32 refTimeToSamples (const REFERENCE_TIME& t, f64 sampleRate) noexcept
{
    return roundToInt (sampleRate * ((f64) t) * 0.0000001);
}

static REFERENCE_TIME samplesToRefTime (i32 numSamples, f64 sampleRate) noexcept
{
    return (REFERENCE_TIME) ((numSamples * 10000.0 * 1000.0 / sampleRate) + 0.5);
}

static z0 copyWavFormat (WAVEFORMATEXTENSIBLE& dest, const WAVEFORMATEX* src) noexcept
{
    memcpy (&dest, src, src->wFormatTag == WAVE_FORMAT_EXTENSIBLE ? sizeof (WAVEFORMATEXTENSIBLE)
                                                                  : sizeof (WAVEFORMATEX));
}

static b8 isExclusiveMode (WASAPIDeviceMode deviceMode) noexcept
{
    return deviceMode == WASAPIDeviceMode::exclusive;
}

static b8 isLowLatencyMode (WASAPIDeviceMode deviceMode) noexcept
{
    return deviceMode == WASAPIDeviceMode::sharedLowLatency;
}

static b8 supportsSampleRateConversion (WASAPIDeviceMode deviceMode) noexcept
{
...
public:
    ...
    b8 isOk() const noexcept   { return defaultBufferSize > 0 && defaultSampleRate > 0; }

    b8 openClient (const f64 newSampleRate, const BigInteger& newChannels, i32k bufferSizeSamples)
    {
             ...
             && tryInitialisingWithBufferSize (bufferSizeSamples))
        {
            ...
            for (i32 i = 0; i <= channels.getHighestBit(); ++i)
                if (channels[i])
                    channelMaps.add (i);
            ...
            (z0) check (client->GetBufferSize (&actualBufferSize));
    ...
    z0 closeClient()
    {
        ...
        // N.B. this is needed to prevent a f64-deletion of the IAudioSessionEvents object
    ...
    z0 deviceSampleRateChanged()
    {
        sampleRateHasChanged = true;
    }

    z0 deviceSessionBecameInactive()
    {
        isActive = false;
    }

    z0 deviceSessionExpired()
    {
        shouldShutdown = true;
    }

    z0 deviceSessionBecameActive()
    {
        isActive = true;
    }
    ...
    {
        if (countNumberOfBits ((zu64) defaultFormatChannelMask) == defaultNumChannels)
            return BigInteger ((z64) defaultFormatChannelMask);
    ...
    f64 sampleRate = 0, defaultSampleRate = 0;
    i32 numChannels = 0, actualNumChannels = 0, maxNumChannels = 0, defaultNumChannels = 0;
    i32 minBufferSize = 0, defaultBufferSize = 0, latencySamples = 0;
    i32 lowLatencyBufferSizeMultiple = 0, lowLatencyMaxBufferSize = 0;
    DWORD defaultFormatChannelMask = 0;
    Array<f64> rates;
    HANDLE clientEvent = {};
    BigInteger channels;
    Array<i32> channelMaps;
    UINT32 actualBufferSize = 0;
    i32 bytesPerSample = 0, bytesPerFrame = 0;
    std::atomic<b8> sampleRateHasChanged { false }, shouldShutdown { false }, isActive { true };

    virtual z0 updateFormat (b8 isFloat) = 0;
...
private:
    ...
    struct SessionEventCallback final : public ComBaseClassHelper<IAudioSessionEvents>
    {
        ...
        DRX_COMRESULT OnDisplayNameChanged (LPCWSTR, LPCGUID)                 override { return S_OK; }
        DRX_COMRESULT OnIconPathChanged (LPCWSTR, LPCGUID)                    override { return S_OK; }
        DRX_COMRESULT OnSimpleVolumeChanged (f32, BOOL, LPCGUID)            override { return S_OK; }
        DRX_COMRESULT OnChannelVolumeChanged (DWORD, f32*, DWORD, LPCGUID)  override { return S_OK; }
        DRX_COMRESULT OnGroupingParamChanged (LPCGUID, LPCGUID)               override { return S_OK; }

        DRX_COMRESULT OnStateChanged (AudioSessionState state) override
        {
            switch (state)
            {
        ...
        DRX_COMRESULT OnSessionDisconnected (AudioSessionDisconnectReason reason) override
        {
    ...
    ComSmartPtr<IAudioClient> createClient()
    {
        ...
        if (device != nullptr)
            logFailure (device->Activate (__uuidof (IAudioClient), CLSCTX_INPROC_SERVER,
                                          nullptr, (uk*) newClient.resetAndGetPointerAddress()));
    ...
    //==============================================================================
    z0 querySupportedBufferSizes (WAVEFORMATEXTENSIBLE format, ComSmartPtr<IAudioClient>& audioClient)
    {
        if (isLowLatencyMode (deviceMode))
        {
            if (auto audioClient3 = audioClient.getInterface<IAudioClient3>())
            {
                ...
                if (check (audioClient3->GetSharedModeEnginePeriod ((WAVEFORMATEX*) &format,
                                                                    ...
                                                                    &maxPeriod)))
                {
                    minBufferSize = (i32) minPeriod;
                    defaultBufferSize = (i32) defaultPeriod;
                    lowLatencyMaxBufferSize = (i32) maxPeriod;
                    lowLatencyBufferSizeMultiple = (i32) fundamentalPeriod;
                }
            }
        }
        else
    ...
    z0 querySupportedSampleRates (WAVEFORMATEXTENSIBLE format, ComSmartPtr<IAudioClient>& audioClient)
    {
        for (auto rate : SampleRateHelpers::getAllSampleRates())
        {
                                                                                        ...
                                                                                        : &nearestFormat)))
            {
                if (nearestFormat != nullptr)
                    rate = (f64) nearestFormat->nSamplesPerSec;
    ...
    {
        b8 useFloat;
        i32  bitsPerSampleToTry;
        i32  bytesPerSampleContainer;
    };
    ...
    static std::optional<WAVEFORMATEXTENSIBLE> tryFormat (const AudioSampleFormat sampleFormat, IAudioClient* clientToUse,
                                                          WASAPIDeviceMode mode, i32 newNumChannels, f64 newSampleRate,
    ...
    std::optional<WAVEFORMATEXTENSIBLE> findSupportedFormat (IAudioClient* clientToUse, i32 newNumChannels, f64 newSampleRate) const
    {
    ...
    i32 queryMaxNumChannels (IAudioClient* clientToUse) const
    {
        static constexpr auto maxNumChannelsToQuery = static_cast<i32> (AudioChannelSet::maxChannelsOfNamedLayout);
            ...
            for (auto rate : rates)
                for (auto const& sampleFormat: formatsToTry)
                    if (auto format = tryFormat (sampleFormat, clientToUse, deviceMode, ch, rate, channelMask))
                        result = jmax (static_cast<i32> (format->Format.nChannels), result);
        }
    ...
    b8 initialiseLowLatencyClient (i32 bufferSizeSamples, WAVEFORMATEXTENSIBLE format)
    {
    ...
    b8 initialiseStandardClient (i32 bufferSizeSamples, WAVEFORMATEXTENSIBLE format)
    {
        ...
        for (;;)
        {
            ...
            defaultPeriod = samplesToRefTime ((i32) numFrames, format.Format.nSamplesPerSec);
        }

        return false;
    }

    b8 tryInitialisingWithBufferSize (i32 bufferSizeSamples)
    {
        if (auto format = findSupportedFormat (client, numChannels, sampleRate))
        {
            ...
            if (isInitialised)
            {
                ...
                const b8 isFloat = format->Format.wFormatTag == WAVE_FORMAT_EXTENSIBLE && format->SubFormat == KSDATAFORMAT_SUBTYPE_IEEE_FLOAT;
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WASAPIDeviceBase)
};
...
public:
    ...
    b8 open (f64 newSampleRate, const BigInteger& newChannels, i32 bufferSizeSamples)
    {
        return openClient (newSampleRate, newChannels, bufferSizeSamples)
                && (numChannels == 0 || check (client->GetService (__uuidof (IAudioCaptureClient),
                                                                   (uk*) captureClient.resetAndGetPointerAddress())));
    }
    ...
    z0 updateFormatWithType (SourceType*) noexcept
    {
    ...
    z0 updateFormat (b8 isFloat) override
    {
    ...
    b8 start (i32 userBufferSizeIn)
    {
        const auto reservoirSize = nextPowerOfTwo ((i32) (actualBufferSize + (UINT32) userBufferSizeIn));
    ...
    i32 getNumSamplesInReservoir() const noexcept    { return queue.getNumReadable(); }

    z0 handleDeviceBuffer()
    {
        if (numChannels <= 0)
            return;

        u8* inputData = nullptr;
        ...
        while (check (captureClient->GetBuffer (&inputData, &numSamplesAvailable, &flags, nullptr, nullptr)) && numSamplesAvailable > 0)
        {
            ...
            for (const auto& block : queue.write ((i32) numSamplesAvailable))
            {
    ...
    z0 copyBuffersFromReservoir (f32* const* destBuffers, i32k numDestBuffers, i32k bufferSize)
    {
        ...
        if (offset > 0)
            for (i32 i = 0; i < numDestBuffers; ++i)
                zeromem (destBuffers[i], (size_t) offset * sizeof (f32));
...
private:
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WASAPIInputDevice)
};
...
public:
    ...
    b8 open (f64 newSampleRate, const BigInteger& newChannels, i32 bufferSizeSamples)
    {
        return openClient (newSampleRate, newChannels, bufferSizeSamples)
                && (numChannels == 0 || check (client->GetService (__uuidof (IAudioRenderClient),
                                                                   (uk*) renderClient.resetAndGetPointerAddress())));
    }
    ...
    z0 updateFormatWithType (DestType*)
    {
    ...
    i32 getNumSamplesAvailableToCopy() const
    {
        if (numChannels <= 0)
            return 0;
        ...
        if (! isExclusiveMode (deviceMode))
        {
            ...
            if (check (client->GetCurrentPadding (&padding)))
                return (i32) actualBufferSize - (i32) padding;
        }

        return (i32) actualBufferSize;
    }

    z0 copyBuffers (const f32* const* srcBuffers, i32 numSrcBuffers, i32 bufferSize,
                      WASAPIInputDevice* inputDevice, Thread& thread)
    {
        ...
        while (bufferSize > 0)
        {
            ...
            i32 samplesToDo = jmin (getNumSamplesAvailableToCopy(), bufferSize);
...
private:
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WASAPIOutputDevice)
};
...
public:
    ...
    StringArray getOutputChannelNames() override
    {
        ...
        if (outputDevice != nullptr)
            for (i32 i = 1; i <= outputDevice->maxNumChannels; ++i)
                outChannels.add ("Output channel " + Txt (i));
    ...
    StringArray getInputChannelNames() override
    {
        ...
        if (inputDevice != nullptr)
            for (i32 i = 1; i <= inputDevice->maxNumChannels; ++i)
                inChannels.add ("Input channel " + Txt (i));
    ...
    i32 getDefaultBufferSize() override                     { return defaultBufferSize; }

    i32 getCurrentBufferSizeSamples() override              { return currentBufferSizeSamples; }
    f64 getCurrentSampleRate() override                  { return currentSampleRate; }
    i32 getCurrentBitDepth() override                       { return 32; }
    i32 getOutputLatencyInSamples() override                { return latencyOut; }
    i32 getInputLatencyInSamples() override                 { return latencyIn; }
    ...
    i32 getXRunCount() const noexcept override              { return inputDevice != nullptr ? inputDevice->xruns : -1; }
                 ...
                 f64 sampleRate, i32 bufferSizeSamples) override
    {
        ...
        if (isExclusiveMode (deviceMode))
        {
            ...
            currentBufferSizeSamples = (i32) (outputDevice != nullptr ? outputDevice->actualBufferSize
        ...
        {
            latencyIn = (i32) (inputDevice->latencySamples + currentBufferSizeSamples);
        ...
        {
            latencyOut = (i32) (outputDevice->latencySamples + currentBufferSizeSamples);
    ...
    z0 setMMThreadPriority()
    {
        DynamicLibrary dll ("avrt.dll");
        DRX_LOAD_WINAPI_FUNCTION (dll, AvSetMmThreadCharacteristicsW, avSetMmThreadCharacteristics, HANDLE, (LPCWSTR, LPDWORD))
        DRX_LOAD_WINAPI_FUNCTION (dll, AvSetMmThreadPriority, avSetMmThreadPriority, HANDLE, (HANDLE, AVRT_PRIORITY))
    ...
    z0 run() override
    {
        ...
        AudioBuffer<f32> ins  (jmax (1, numInputBuffers),  bufferSize + 32);
        AudioBuffer<f32> outs (jmax (1, numOutputBuffers), bufferSize + 32);
    ...
    //==============================================================================
    Txt outputDeviceId, inputDeviceId;
    Txt lastError;
...
private:
    ...
    WASAPIDeviceMode deviceMode;
    f64 defaultSampleRate = 0;
    i32 minBufferSize = 0, defaultBufferSize = 0;
    i32 lowLatencyMaxBufferSize = 0, lowLatencyBufferSizeMultiple = 0;
    i32 latencyIn = 0, latencyOut = 0;
    Array<f64> sampleRates;
    Array<i32> bufferSizes;

    // Active state...
    b8 isOpen_ = false, isStarted = false;
    i32 currentBufferSizeSamples = 0;
    f64 currentSampleRate = 0;

    AudioIODeviceCallback* callback = {};
    CriticalSection startStopLock;

    std::atomic<b8> shouldShutdown { false }, deviceSampleRateChanged { false };
    ...
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WASAPIAudioIODevice)
};
...
public:
    ...
    struct Devices
    {
        ...
        b8 operator== (const Devices& other) const { return tie() == other.tie(); }
        b8 operator!= (const Devices& other) const { return tie() != other.tie(); }
    };
...
private:
    ...
    public:
        ...
        DRX_COMRESULT OnDeviceAdded (LPCWSTR)                             override { return notify(); }
        DRX_COMRESULT OnDeviceRemoved (LPCWSTR)                           override { return notify(); }
        DRX_COMRESULT OnDeviceStateChanged (LPCWSTR, DWORD)               override { return notify(); }
        DRX_COMRESULT OnDefaultDeviceChanged (EDataFlow, ERole, LPCWSTR)  override { return notify(); }
        DRX_COMRESULT OnPropertyValueChanged (LPCWSTR, const PROPERTYKEY) override { return notify(); }
    ...
    private:
        ...
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ChangeNotificationClient)
    };

    ComSmartPtr<ChangeNotificationClient> notifyClient;

    //==============================================================================
    static Txt getDefaultEndpoint (IMMDeviceEnumerator* enumerator, b8 forCapture)
    {
        Txt s;
    ...
    //==============================================================================
    static Txt getDeviceTypename (WASAPIDeviceMode mode)
    {
    ...
    //==============================================================================
    DRX_DECLARE_WEAK_REFERENCEABLE (WASAPIAudioIODeviceType)
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WASAPIAudioIODeviceType)
};
...
struct MMDeviceMasterVolume
{
        ...
        if (check (enumerator.CoCreateInstance (__uuidof (MMDeviceEnumerator))))
        {
            ...
            if (check (enumerator->GetDefaultAudioEndpoint (eRender, eConsole, device.resetAndGetPointerAddress())))
                check (device->Activate (__uuidof (IAudioEndpointVolume), CLSCTX_INPROC_SERVER, nullptr,
                                         (uk*) endpointVolume.resetAndGetPointerAddress()));
        }
    }
    ...
    b8 setMuted (b8 shouldMute) const
    {
        return endpointVolume != nullptr
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MMDeviceMasterVolume)
};
...
f32 DRX_CALLTYPE SystemAudioVolume::getGain()              { return WasapiClasses::MMDeviceMasterVolume().getGain(); }
b8  DRX_CALLTYPE SystemAudioVolume::setGain (f32 gain)   { return WasapiClasses::MMDeviceMasterVolume().setGain (gain); }
b8  DRX_CALLTYPE SystemAudioVolume::isMuted()              { return WasapiClasses::MMDeviceMasterVolume().isMuted(); }
b8  DRX_CALLTYPE SystemAudioVolume::setMuted (b8 mute)   { return WasapiClasses::MMDeviceMasterVolume().setMuted (mute); }
