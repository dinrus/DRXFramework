...
/** Holds a set of named var objects.
    ...
    @tags{Core}
*/
class DRX_API  NamedValueSet
{
public:
    //==============================================================================
    /** Structure for a named var object */
    struct DRX_API  NamedValue
    {
        NamedValue() noexcept;
        ~NamedValue() noexcept;
        ...
        b8 operator== (const NamedValue&) const noexcept;
        b8 operator!= (const NamedValue&) const noexcept;
    ...
    */
    b8 operator== (const NamedValueSet&) const noexcept;
    b8 operator!= (const NamedValueSet&) const noexcept;
    ...
    /** Возвращает true, если the set is empty. */
    b8 isEmpty() const noexcept;

    /** Returns the value of a named item.
        If the name isn't found, this will return a z0 variant.
    */
    ...
    */
    b8 set (const Identifier& name, const var& newValue);

    /** Changes or adds a named value.
        @returns    true if a value was changed or added; false if the
                    value was already set the value passed-in.
    */
    b8 set (const Identifier& name, var&& newValue);

    /** Возвращает true, если the set contains an item with the specified name. */
    b8 contains (const Identifier& name) const noexcept;

    /** Removes a value from the set.
        @returns    true if a value was removed; false if there was no value
                    with the name that was given.
    */
    b8 remove (const Identifier& name);

    /** Returns the name of the value at a given index.
        The index must be between 0 and size() - 1.
    */
    Identifier getName (i32 index) const noexcept;
    ...
    */
    ...
    /** Returns the value of the item at a given index.
        The index must be between 0 and size() - 1.
    */
    const var& getValueAt (i32 index) const noexcept;
    ...
    /** Returns the value of the item at a given index.
        ...
        methods are called on the NamedValueSet.
    */
    var* getVarPointerAt (i32 index) noexcept;
    ...
    /** Returns the value of the item at a given index.
        ...
        methods are called on the NamedValueSet.
    */
    const var* getVarPointerAt (i32 index) const noexcept;

    /** Returns the index of the given name, or -1 if it's not found. */
    i32 indexOf (const Identifier& name) const noexcept;
    ...
    z0 setFromXmlAttributes (const XmlElement& xml);

    /** Sets attributes in an XML element corresponding to each of this object's
        properties.
    */
    z0 copyToXmlAttributes (XmlElement& xml) const;
