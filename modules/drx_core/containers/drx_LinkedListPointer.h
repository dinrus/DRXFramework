...
/**
    ...
    i32 numItems = myList.size(); // returns 2
...
public:
    ...
    */
    LinkedListPointer& operator[] (i32 index) noexcept
    {
        auto* l = this;
    ...
    /** Returns the item at a given index in the list.
        ...
        be slow, depending on its size, so you should be careful when using this in algorithms.
    */
    const LinkedListPointer& operator[] (i32 index) const noexcept
    {
        auto* l = this;
    ...
    /** Возвращает true, если the list contains the given item. */
    b8 contains (const ObjectType* const itemToLookFor) const noexcept
    {
        for (auto* i = item; i != nullptr; i = i->nextListItem)
            if (itemToLookFor == i)
                return true;
    ...
    /** Inserts an item into the list, placing it before the item that this pointer
        currently points to.
    */
    z0 insertNext (ObjectType* const newItem)
    {
    ...
    */
    z0 insertAtIndex (i32 index, ObjectType* newItem)
    {
        jassert (newItem != nullptr);
        auto* l = this;
    ...
    */
    ...
    {
        DRX_BEGIN_IGNORE_WARNINGS_MSVC (6011 28182)
        jassert (newItem != nullptr);
        jassert (newItem->nextListItem == nullptr);
    ...
    */
    z0 append (ObjectType* const newItem)
    {
    ...
    */
    z0 addCopyOfList (const LinkedListPointer& other)
    {
    ...
    */
    z0 remove (ObjectType* const itemToRemove)
    {
    ...
    */
    ...
    /** Copies the items in the list to an array.
        ...
        made for this!
    */
    z0 copyToArray (ObjectType** destArray) const noexcept
    {
        DRX_BEGIN_IGNORE_WARNINGS_MSVC (6011)
    ...
    z0 swapWith (LinkedListPointer& other) noexcept
    {
    ...
    */
    ...
    public:
        ...
        */
        ...
        z0 append (ObjectType* const newItem) noexcept
        {
            *endOfList = newItem;
    ...
    private:
        ...
        DRX_DECLARE_NON_COPYABLE (Appender)
    };
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE (LinkedListPointer)
};
