...
public:
    ...
    */
    ...
    /** Returns a pointer to the object at this index in the array.
        ...
        @see getUnchecked
    */
    inline ObjectClassPtr operator[] (i32 index) const noexcept
    {
    ...
    */
    inline ObjectClassPtr getUnchecked (i32 index) const noexcept
    {
    ...
    /** Returns a raw pointer to the object at this index in the array.
        ...
        @see getUnchecked
    */
    inline ObjectClass* getObjectPointer (i32 index) const noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    /** Returns a raw pointer to the object at this index in the array, without checking
        whether the index is in-range.
    */
    inline ObjectClass* getObjectPointerUnchecked (i32 index) const noexcept
    {
        const ScopedLockType lock (getLock());
        return values[index];
    }
    ...
    */
    i32 indexOf (const ObjectClass* objectToLookFor) const noexcept
    {
        const ScopedLockType lock (getLock());
        auto* e = values.begin();
    ...
    /** Finds the index of the first occurrence of an object in the array.
        ...
        @returns                  the index at which the object was found, or -1 if it's not found
    */
    i32 indexOf (const ObjectClassPtr& objectToLookFor) const noexcept      { return indexOf (objectToLookFor.get()); }

    /** Возвращает true, если the array contains a specified object.

        @param objectToLookFor      the object to look for
        @returns                    true if the object is in the array
    */
    b8 contains (const ObjectClass* objectToLookFor) const noexcept
    {
        const ScopedLockType lock (getLock());
        auto* e = values.begin();
        auto* endPointer = values.end();
    ...
    /** Возвращает true, если the array contains a specified object.
        ...
        @returns                    true if the object is in the array
    */
    b8 contains (const ObjectClassPtr& objectToLookFor) const noexcept    { return contains (objectToLookFor.get()); }
    ...
    */
    ObjectClass* insert (i32 indexToInsertAt, ObjectClass* newObject)
    {
    ...
    /** Inserts a new object into the array at the given index.
        ...
        @see add, addSorted, addIfNotAlreadyThere, set
    */
    ObjectClass* insert (i32 indexToInsertAt, const ObjectClassPtr& newObject)      { return insert (indexToInsertAt, newObject.get()); }

    /** Appends a new object at the end of the array as i64 as the array doesn't
        already contain it.
    ...
    */
    b8 addIfNotAlreadyThere (ObjectClass* newObject)
    {
        const ScopedLockType lock (getLock());
    ...
    /** Appends a new object at the end of the array as i64 as the array doesn't
        ...
        @returns           true if the object has been added, false otherwise
    */
    b8 addIfNotAlreadyThere (const ObjectClassPtr& newObject)         { return addIfNotAlreadyThere (newObject.get()); }
    ...
    */
    z0 set (i32 indexToChange, ObjectClass* newObject)
    {
        if (indexToChange >= 0)
        {
            const ScopedLockType lock (getLock());
    ...
    /** Replaces an object in the array with a different one.
        ...
        @see add, insert, remove
    */
    z0 set (i32 indexToChange, const ObjectClassPtr& newObject)       { set (indexToChange, newObject.get()); }
    ...
    /** Adds elements from another array to the end of this array.
        ...
        @see add
    */
    z0 addArray (const ReferenceCountedArray& arrayToAddFrom,
                   i32 startIndex = 0,
                   i32 numElementsToAdd = -1) noexcept
    {
...

        {
            ...
            for (i32 i = 0; i < numElementsAdded; ++i)
                (*(--e))->incReferenceCount();
        }
    }
    ...
    */
    ...
    i32 addSorted (ElementComparator& comparator, ObjectClass* newObject) noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    */
    template <class ElementComparator>
    z0 addOrReplaceSorted (ElementComparator& comparator, ObjectClass* newObject) noexcept
    {
        const ScopedLockType lock (getLock());
        auto index = findInsertIndexInSortedArray (comparator, values.begin(), newObject, 0, values.size());
    ...
    */
    template <class ElementComparator>
    i32 indexOfSorted (ElementComparator& comparator, const ObjectClass* objectToLookFor) const noexcept;
    ...
    */
    ObjectClassPtr removeAndReturn (i32 indexToRemove)
    {
    ...
    */
    z0 removeObject (ObjectClass* objectToRemove)
    {
        const ScopedLockType lock (getLock());
    ...
    /** Removes the first occurrence of a specified object from the array.
        ...
        @see remove, removeRange
    */
    z0 removeObject (const ObjectClassPtr& objectToRemove)    { removeObject (objectToRemove.get()); }
    ...
    */
    z0 swap (i32 index1, i32 index2) noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    */
    b8 operator== (const ReferenceCountedArray& other) const noexcept
    {
    ...
    /** Compares this array to another one.
        ...
        @see operator==
    */
    b8 operator!= (const ReferenceCountedArray<ObjectClass, TypeOfCriticalSectionToUse>& other) const noexcept
    {
    ...
    */
    template <class ElementComparator>
    z0 sort (ElementComparator& comparator, b8 retainOrderOfEquivalentItems = false) noexcept;
    ...
    */
    z0 minimiseStorageOverheads() noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    */
    z0 ensureStorageAllocated (i32k minNumElements)
    {
        const ScopedLockType lock (getLock());
    ...
    */
    ...
    z0 swapWithArray (ReferenceCountedArray& other) noexcept { swapWith (other); }
   #endif
...
private:
    ...
    static z0 releaseObject (ObjectClass* o)
    {
...
template <class ElementComparator>
i32 ReferenceCountedArray<ObjectClass, TypeOfCriticalSectionToUse>::indexOfSorted (
    [[maybe_unused]] ElementComparator& comparator,
    const ObjectClass* objectToLookFor) const noexcept
{
    const ScopedLockType lock (getLock());
    i32 s = 0, e = values.size();
...
template <class ObjectClass, class TypeOfCriticalSectionToUse>
template <class ElementComparator>
z0 ReferenceCountedArray<ObjectClass, TypeOfCriticalSectionToUse>::sort (
    [[maybe_unused]] ElementComparator& comparator,
    b8 retainOrderOfEquivalentItems) noexcept
{
    const ScopedLockType lock (getLock());
