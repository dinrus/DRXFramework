...
public:
    ...
    */
    ...
    z0 clear (b8 deleteObjects = true)
    {
        const ScopedLockType lock (getLock());
    ...
    //==============================================================================
    /** Clears the array, optionally deleting the objects inside it first. */
    z0 clearQuick (b8 deleteObjects)
    {
        const ScopedLockType lock (getLock());
    ...
    */
    ...
    /** Returns a pointer to the object at this index in the array.
        ...
        @see getUnchecked
    */
    inline ObjectClass* operator[] (i32 index) const noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    */
    inline ObjectClass* getUnchecked (i32 index) const noexcept
    {
        const ScopedLockType lock (getLock());
        return values[index];
    }
    ...
    */
    ...
    /** Inserts a new object into the array at the given index.
        ...
        @see add, addSorted, set
    */
    ObjectClass* insert (i32 indexToInsertAt, std::unique_ptr<ObjectClass> newObject)
    {
    ...
    */
    ObjectClass* set (i32 indexToChange, ObjectClass* newObject, b8 deleteOldElement = true)
    {
        if (indexToChange >= 0)
        {
    ...
    /** Replaces an object in the array with a different one.
        ...
        @see add, insert, remove
    */
    ObjectClass* set (i32 indexToChange, std::unique_ptr<ObjectClass> newObject, b8 deleteOldElement = true)
    {
    ...
    */
    ...
    z0 addArray (const std::initializer_list<OtherArrayType>& items)
    {
        const ScopedLockType lock (getLock());
    ...
    */
    template <class OtherArrayType>
    z0 addCopiesOf (const OtherArrayType& arrayToAddFrom,
                      i32 startIndex = 0,
                      i32 numElementsToAdd = -1)
    {
        const typename OtherArrayType::ScopedLockType lock1 (arrayToAddFrom.getLock());
    ...
    */
    z0 remove (i32 indexToRemove, b8 deleteObject = true)
    {
        std::unique_ptr<ObjectClass> toDelete;
    ...
    */
    ObjectClass* removeAndReturn (i32 indexToRemove)
    {
    ...
    */
    z0 removeObject (const ObjectClass* objectToRemove, b8 deleteObject = true)
    {
        const ScopedLockType lock (getLock());
    ...
    */
    z0 removeRange (i32 startIndex, i32 numberToRemove, b8 deleteObjects = true)
    {
        const ScopedLockType lock (getLock());
    ...
    */
    z0 ensureStorageAllocated (i32 minNumElements) noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    */
    ...
    z0 swapWithArray (OwnedArray& other) noexcept { swapWith (other); }
   #endif
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OwnedArray)
};

//==============================================================================
template <class ObjectClass, class TypeOfCriticalSectionToUse>
template <class ElementComparator>
i32 OwnedArray<ObjectClass, TypeOfCriticalSectionToUse>::addSorted (
...
template <class ObjectClass, class TypeOfCriticalSectionToUse>
template <typename ElementComparator>
i32 OwnedArray<ObjectClass, TypeOfCriticalSectionToUse>::indexOfSorted (
    [[maybe_unused]] ElementComparator& comparator,
...
template <class ObjectClass, class TypeOfCriticalSectionToUse>
template <typename ElementComparator>
z0 OwnedArray<ObjectClass, TypeOfCriticalSectionToUse>::sort (
    [[maybe_unused]] ElementComparator& comparator,
