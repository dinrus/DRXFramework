...
template <typename T, typename I, typename = z0>
...
public:
    ...
    [[nodiscard]] constexpr b8 operator== (const EnumerateIterator<OtherIter, OtherInd>& other) const
    {
    ...
    */
    ...
    /** Increments the iterator and the index. */
    constexpr EnumerateIterator operator++ (i32)
    {
        auto copy = *this;
        operator++();
        return copy;
    ...
    */
    template <typename T = Iter, std::enable_if_t<detail::canPreDecrement<T>, i32> = 0>
    constexpr EnumerateIterator& operator--()
    {
        --iterator;
        --index;
    ...
    */
    template <typename I, std::enable_if_t<detail::canAddAssign<Iter&, I>, i32> = 0>
    ...
    */
    template <typename I, std::enable_if_t<detail::canSubAssign<Iter&, I>, i32> = 0>
    constexpr EnumerateIterator& operator-= (I diff)
    {
        iterator -= diff;
        index -= static_cast<Index> (diff);
    ...
    */
    template <typename OtherIter, typename OtherInd, std::enable_if_t<detail::canSub<Iter, OtherIter>, i32> = 0>
    ...
    /** Indexes into this iterator, equivalent to adding an integral value to this iterator and
        ...
        integral values.
    */
    template <typename I, std::enable_if_t<detail::canAdd<EnumerateIterator, I>, i32> = 0>
    ...
    */
    template <typename OtherIter, typename OtherInd, std::enable_if_t<detail::canLessThan<Iter, OtherIter>, i32> = 0>
    [[nodiscard]] constexpr b8 operator< (const EnumerateIterator<OtherIter, OtherInd>& other) const
    {
        return iterator < other.iterator;
    }
    ...
    /** Returns the result of comparing the two wrapped iterators.
        Only participates in overload resolution if the wrapped iterators are comparable.
    */
    template <typename OtherIter, typename OtherInd, std::enable_if_t<detail::canLessThanEqual<Iter, OtherIter>, i32> = 0>
    [[nodiscard]] constexpr b8 operator<= (const EnumerateIterator<OtherIter, OtherInd>& other) const
    {
        return iterator <= other.iterator;
    }
    ...
    /** Returns the result of comparing the two wrapped iterators.
        Only participates in overload resolution if the wrapped iterators are comparable.
    */
    template <typename OtherIter, typename OtherInd, std::enable_if_t<detail::canGreaterThan<Iter, OtherIter>, i32> = 0>
    [[nodiscard]] constexpr b8 operator> (const EnumerateIterator<OtherIter, OtherInd>& other) const
    {
        return iterator > other.iterator;
    }
    ...
    /** Returns the result of comparing the two wrapped iterators.
        Only participates in overload resolution if the wrapped iterators are comparable.
    */
    template <typename OtherIter, typename OtherInd, std::enable_if_t<detail::canGreaterThanEqual<Iter, OtherIter>, i32> = 0>
    [[nodiscard]] constexpr b8 operator>= (const EnumerateIterator<OtherIter, OtherInd>& other) const
    {
        return iterator >= other.iterator;
    }
    ...
    */
    template <typename I, std::enable_if_t<detail::canAddAssign<EnumerateIterator&, I>, i32> = 0>
    ...
    */
    template <typename I, std::enable_if_t<detail::canSubAssign<EnumerateIterator&, I>, i32> = 0>
    constexpr friend auto operator- (EnumerateIterator iter, I ind)
    {
        return iter -= ind;
    }
...
/**
    ...
    @code
    std::list<i32> elements { 10, 20, 30, 40, 50 };
    ...
    In the following snippet, the type of '[index, value]' is 'const Enumerated<ptrdiff_t, i32&>',
    the type of 'index' is 'ptrdiff_t', and the type of 'value' is 'i32&'.

    @code
    std::vector<i32> elements { 10, 20, 30, 40, 50 };
    for (const auto [index, value] : enumerate (elements))
        ...
    @endcode
