...
DRX_BEGIN_IGNORE_WARNINGS_MSVC (4512)
...
public:
    ...
    */
    b8 operator== (const SortedSet<ElementType>& other) const noexcept
    {
    ...
    */
    ...
    /** Возвращает true, если the set is empty, false otherwise. */
    ...
    */
    inline ElementType operator[] (i32k index) const noexcept
    {
        return data [index];
    }
    ...
    */
    inline ElementType getUnchecked (i32k index) const noexcept
    {
    ...
    */
    inline ElementType& getReference (i32k index) noexcept
    {
    ...
    /** Returns a direct reference to one of the elements in the set, without checking the index passed in.
        ...
        @param index    the index of the element being requested (0 is the first element in the array)
    */
    inline const ElementType& getReference (i32k index) const noexcept
    {
        return data.getReference (index);
    }
    ...
    */
    i32 indexOf (const ElementType& elementToLookFor) const noexcept
    {
    ...
    /** Возвращает true, если the set contains at least one occurrence of an object.

        @param elementToLookFor     the value or object to look for
        @returns                    true if the item is found
    */
    b8 contains (const ElementType& elementToLookFor) const noexcept
    {
        return indexOf (elementToLookFor) >= 0;
    }

    //==============================================================================
    /** Adds a new element to the set, (as i64 as it's not already in there).
    ...
    */
    b8 add (const ElementType& newElement) noexcept
    {
        ...
        while (s < e)
        {
            ...
            auto halfway = (s + e) / 2;
            b8 isBeforeHalfway = (newElement < data.getReference (halfway));
    ...
    /** Adds elements from an array to this set.
        ...
        @see add
    */
    z0 addArray (const ElementType* elementsToAdd,
                   i32 numElementsToAdd) noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    */
    ...
    z0 addSet (const OtherSetType& setToAddFrom,
                 i32 startIndex = 0,
    ...
    */
    ElementType remove (i32k indexToRemove) noexcept
    {
    ...
    */
    z0 removeValue (const ElementType& valueToRemove) noexcept
    {
        const ScopedLockType lock (getLock());
    ...
    */
    template <class OtherSetType>
    z0 removeValuesIn (const OtherSetType& otherSet) noexcept
    {
    ...
    */
    template <class OtherSetType>
    z0 removeValuesNotIn (const OtherSetType& otherSet) noexcept
    {
        const typename OtherSetType::ScopedLockType lock1 (otherSet.getLock());
        const ScopedLockType lock2 (getLock());
    ...
    */
    template <class OtherSetType>
    z0 swapWith (OtherSetType& otherSet) noexcept
    {
