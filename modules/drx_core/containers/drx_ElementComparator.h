...
/** This is an internal helper class which converts a drx ElementComparator style
...
struct SortFunctionConverter
{
    ...
    b8 operator() (Type a, Type b)  { return comparator.compareElements (a, b) < 0; }
...
static z0 sortArray (ElementComparator& comparator,
                       ElementType* const array,
                       i32 firstElement,
                       i32 lastElement,
                       const b8 retainOrderOfEquivalentItems)
{
...
*/
template <class ElementType, class ElementComparator>
static i32 findInsertIndexInSortedArray ([[maybe_unused]] ElementComparator& comparator,
                                         ElementType* const array,
                                         ...
                                         i32 lastElement)
{
    ...
    while (firstElement < lastElement)
    {
        ...
        {
            i32k halfway = (firstElement + lastElement) >> 1;
...
/**
    ...
    Example: @code
    Array<i32> myArray;
    DefaultElementComparator<i32> sorter;
    myArray.sort (sorter);
    @endcode
...
public:
    static i32 compareElements (ParameterType first, ParameterType second)
    {
