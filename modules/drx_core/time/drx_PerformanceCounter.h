...
/** A timer for measuring performance of code and dumping the results to a file.
    ...
    @tags{Core}
*/
class DRX_API  PerformanceCounter
{
public:
    //==============================================================================
    ...
    */
    PerformanceCounter (const Txt& counterName,
                        i32 runsPerPrintout = 100,
    ...
    */
    ...
    struct Statistics
    {
        ...
        z0 addResult (f64 elapsed) noexcept;
...
private:
    //==============================================================================
    Statistics stats;
    z64 runsPerPrint, startTime;
    File outputFile;

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PerformanceCounter)
};
...
/**
...

    {
        ...
        Logger::writeToLog ("doSomething() took " + Txt (timeSec) + "seconds");
    }
    ...
    @tags{Core}
*/
class DRX_API  ScopedTimeMeasurement
{
public:
    ScopedTimeMeasurement (f64& resultInSeconds) noexcept
    ...
    {
        static auto scaler = 1.0 / static_cast<f64> (Time::getHighResolutionTicksPerSecond());
        result = static_cast<f64> (Time::getHighResolutionTicks() - startTimeTicks) * scaler;
    }

private:
    z64 startTimeTicks = Time::getHighResolutionTicks();
    f64& result;

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ScopedTimeMeasurement)
};
