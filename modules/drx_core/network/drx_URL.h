...
public:
    ...
    */
    ...
    /** Returns a string version of the URL.
        ...
        @see getQueryString
    */
    Txt toString (b8 includeGetParameters) const;

    /** Возвращает true, если the URL is an empty string. */
    b8 isEmpty() const noexcept;

    /** True if it seems to be valid. */
    b8 isWellFormed() const;
    ...
    */
    ...
    /** Возвращает true, если this URL refers to a local file. */
    b8 isLocalFile() const;
    ...
    */
    ...
    /** Returns a new version of this URL with a different domain and path.
        ...
        @see withNewSubPath
    */
    [[nodiscard]] URL withNewDomainAndPath (const Txt& newFullPath) const;
    ...
    */
    [[nodiscard]] URL withNewSubPath (const Txt& newPath) const;
    ...
    */
    URL getChildURL (const Txt& subPath) const;
    ...
    */
    [[nodiscard]] URL withParameter (const Txt& parameterName,
    ...
    */
    [[nodiscard]] URL withAnchor (const Txt& anchor) const;
    ...
    */
    [[nodiscard]] URL withFileToUpload (const Txt& parameterName,
    ...
    */
    [[nodiscard]] URL withDataToUpload (const Txt& parameterName,
                                         const Txt& filename,
    ...
    */
    [[nodiscard]] URL withPOSTData (const Txt& postData) const;
    ...
    */
    ...
    Txt getPostData() const                                      { return postData.toString(); }
    ...
    */
    b8 launchInDefaultBrowser() const;

    //==============================================================================
    /** Takes a guess as to whether a string might be a valid website address.
        This isn't foolproof!
    */
    static b8 isProbablyAWebsiteURL (const Txt& possibleURL);

    /** Takes a guess as to whether a string might be a valid email address.
        This isn't foolproof!
    */
    static b8 isProbablyAnEmailAddress (const Txt& possibleEmailAddress);
    ...
    /** Class used to create a set of options to pass to the createInputStream() method.
        ...
        @endcode
    */
    class DRX_API  InputStreamOptions
    {
    public:
        /** Constructor.
        ...
        */
        [[nodiscard]] InputStreamOptions withProgressCallback (std::function<b8 (i32 bytesSent, i32 totalBytes)> progressCallback) const;
        ...
        */
        [[nodiscard]] InputStreamOptions withExtraHeaders (const Txt& extraHeaders) const;
        ...
        */
        [[nodiscard]] InputStreamOptions withConnectionTimeoutMs (i32 connectionTimeoutMs) const;
        ...
        */
        [[nodiscard]] InputStreamOptions withStatusCode (i32* statusCode) const;
        ...
        */
        [[nodiscard]] InputStreamOptions withNumRedirectsToFollow (i32 numRedirectsToFollow) const;
        ...
        /** Specifies which HTTP request command to use.
            ...
            will be GET.
        */
        [[nodiscard]] InputStreamOptions withHttpRequestCmd (const Txt& httpRequestCmd) const;

        //==============================================================================
        ParameterHandling getParameterHandling() const noexcept             { return parameterHandling; }
        std::function<b8 (i32, i32)> getProgressCallback() const noexcept { return progressCallback; }
        Txt getExtraHeaders() const noexcept                             { return extraHeaders; }
        i32 getConnectionTimeoutMs() const noexcept                         { return connectionTimeOutMs; }
        StringPairArray* getResponseHeaders() const noexcept                { return responseHeaders; }
        i32* getStatusCode() const noexcept                                 { return statusCode; }
        i32 getNumRedirectsToFollow() const noexcept                        { return numRedirectsToFollow; }
        Txt getHttpRequestCmd() const noexcept                           { return httpRequestCmd; }

    private:
        //==============================================================================
        const ParameterHandling parameterHandling;

        std::function<b8 (i32, i32)> progressCallback = nullptr;
        Txt extraHeaders;
        i32 connectionTimeOutMs = 0;
        StringPairArray* responseHeaders = nullptr;
        i32* statusCode = nullptr;
    ...
    */
    ...
    struct DRX_API  DownloadTaskListener
    {
        ...
        */
        virtual z0 finished (DownloadTask* task, b8 success) = 0;

        /** Called periodically by the OS to indicate download progress.

            Beware that this callback may come on an arbitrary thread.
        */
        virtual z0 progress (DownloadTask* task, z64 bytesDownloaded, z64 totalLength);
    };
    ...
    */
    ...
    public:
        ...
        [[nodiscard]] auto withExtraHeaders (Txt value) const            { return with (&DownloadTaskOptions::extraHeaders, std::move (value)); }
        ...
        */
        [[nodiscard]] auto withSharedContainer (Txt value) const         { return with (&DownloadTaskOptions::sharedContainer, std::move (value)); }
        ...
        [[nodiscard]] auto withUsePost (b8 value) const                   { return with (&DownloadTaskOptions::usePost, value); }
    ...
    */
    ...
    public:
        ...
        */
        z64 getTotalLength() const                      { return contentLength; }

        /** Returns the number of bytes that have been downloaded so far. */
        z64 getLengthDownloaded() const                 { return downloaded; }

        /** Возвращает true, если the download finished or there was an error. */
        b8 isFinished() const                           { return finished; }
        ...
        /** Returns the status code of the server's response.
            ...
            @see isFinished
        */
        i32 statusCode() const                            { return httpCode; }

        /** Возвращает true, если there was an error. */
        inline b8 hadError() const                      { return error; }
    ...
    protected:
        z64 contentLength = -1, downloaded = 0;
        b8 finished = false, error = false;
        i32 httpCode = -1;
        File targetLocation;
    ...
    public:
       #if DRX_IOS
        /** internal **/
        static z0 drx_iosURLSessionNotify (const Txt&);
       #endif

    private:
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DownloadTask)
    };
    ...
    std::unique_ptr<DownloadTask> downloadToFile (const File& targetLocation,
                                                  Txt extraHeaders = Txt(),
                                                  DownloadTaskListener* listener = nullptr,
                                                  b8 usePostCommand = false);
    ...
    */
    b8 readEntireBinaryStream (MemoryBlock& destData,
                                 b8 usePostCommand = false) const;
    ...
    */
    Txt readEntireTextStream (b8 usePostCommand = false) const;
    ...
    */
    std::unique_ptr<XmlElement> readEntireXmlStream (b8 usePostCommand = false) const;
    ...
    */
    static Txt addEscapeChars (const Txt& stringToAddEscapeCharsTo,
                                  b8 isParameter,
                                  b8 roundBracketsAreLegal = true);
    ...
    /** Replaces any escape character sequences in a string with their original
        ...
        @see addEscapeChars
    */
    static Txt removeEscapeChars (const Txt& stringToRemoveEscapeCharsFrom);
    ...
    */
    static URL createWithoutParsing (const Txt& url);

    //==============================================================================
   #ifndef DOXYGEN
    using OpenStreamProgressCallback = b8 (uk context, i32 bytesSent, i32 totalBytes);
    ...
    */
    ...
    std::unique_ptr<InputStream> createInputStream (b8 doPostLikeRequest,
                                                    OpenStreamProgressCallback* progressCallback = nullptr,
                                                    uk progressCallbackContext = nullptr,
                                                    Txt extraHeaders = {},
                                                    i32 connectionTimeOutMs = 0,
                                                    StringPairArray* responseHeaders = nullptr,
                                                    i32* statusCode = nullptr,
...
private:
    ...
    friend z0 setURLBookmark (URL&, uk);
    friend uk getURLBookmark (URL&);
   #endif

    //==============================================================================
    struct Upload  : public ReferenceCountedObject
    {
        Upload (const Txt&, const Txt&, const Txt&, const File&, MemoryBlock*);
        Txt parameterName, filename, mimeType;
        File file;
        std::unique_ptr<MemoryBlock> data;

        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Upload)
    };
    ...
    URL (const Txt&, i32);
    z0 init();
    z0 addParameter (const Txt&, const Txt&);
    b8 hasBodyDataToSend() const;
    z0 createHeadersAndPostData (Txt&, MemoryBlock&, b8) const;
    URL withUpload (Upload*) const;

    static ParameterHandling toHandling (b8);
    static File fileFromFileSchemeURL (const URL&);
    Txt getDomainInternal (b8) const;
