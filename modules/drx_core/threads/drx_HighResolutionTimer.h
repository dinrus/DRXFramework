...
/**
    ...
    @tags{Core}
*/
class DRX_API  HighResolutionTimer
{
protected:
...
public:
    ...
    */
    virtual z0 hiResTimerCallback() = 0;
    ...
    */
    z0 startTimer (i32 intervalInMilliseconds);
    ...
    */
    b8 isTimerRunning() const noexcept;

    /** Returns the timer's interval.
        @returns the timer's interval in milliseconds if it's running, or 0 if it's not.
    */
    i32 getTimerInterval() const noexcept;

private:
    class Impl;
    std::unique_ptr<Impl> impl;

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (HighResolutionTimer)
};
