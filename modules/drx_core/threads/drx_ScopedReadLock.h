...
private:
    ...
    DRX_DECLARE_NON_COPYABLE (ScopedReadLock)
};
...
/**
    ...
    @tags{Core}
*/
class DRX_API  ScopedTryReadLock
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Creates a ScopedTryReadLock.
        ...
        one with the new() operator.
    */
    ScopedTryReadLock (ReadWriteLock& lockIn, b8 acquireLockOnInitialisation) noexcept
    ...
    */
    ...
    b8 retryLock() noexcept                       { return lockWasSuccessful = lock.tryEnterRead(); }
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE (ScopedTryReadLock)
};
