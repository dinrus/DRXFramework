...
private:
    ...
    DRX_DECLARE_NON_COPYABLE (GenericScopedLock)
};
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE (GenericScopedUnlock)
};
...
public:
    ...
    */
    inline explicit GenericScopedTryLock (const LockType& lock, b8 acquireLockOnInitialisation = true) noexcept
    ...
    */
    ...
    b8 retryLock() const noexcept                 { lockWasSuccessful = lock_.tryEnter(); return lockWasSuccessful; }

private:
    //==============================================================================
    const LockType& lock_;
    mutable b8 lockWasSuccessful;

    DRX_DECLARE_NON_COPYABLE (GenericScopedTryLock)
};
