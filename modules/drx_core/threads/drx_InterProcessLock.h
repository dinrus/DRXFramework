...
/**
    ...
    @tags{Core}
*/
class DRX_API  InterProcessLock
{
public:
    //==============================================================================
    ...
    */
    explicit InterProcessLock (const Txt& name);
    ...
    */
    b8 enter (i32 timeOutMillisecs = -1);
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Возвращает true, если the InterProcessLock was successfully locked. */
    ...
    private:
        ...
        DRX_DECLARE_NON_COPYABLE (ScopedLockType)
    };
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE (InterProcessLock)
};
