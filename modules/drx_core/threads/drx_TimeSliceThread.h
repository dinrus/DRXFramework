...
/**
    ...
    @tags{Core}
*/
class DRX_API  TimeSliceThread   : public Thread
{
public:
    //==============================================================================
    /**
        ...
        method to start it.
    */
    explicit TimeSliceThread (const Txt& threadName);
    ...
    */
    z0 addTimeSliceClient (TimeSliceClient* clientToAdd, i32 millisecondsBeforeStarting = 0);
    ...
    */
    ...
    i32 getNumClients() const;

    /** Returns one of the registered clients. */
    TimeSliceClient* getClient (i32 index) const;

    /** Возвращает true, если the client is currently registered. */
    b8 contains (const TimeSliceClient*) const;
...
private:
    ...
    TimeSliceClient* getNextClient (i32 index) const;

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TimeSliceThread)
};
