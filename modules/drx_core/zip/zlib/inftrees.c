...
i32 ZLIB_INTERNAL inflate_table(codetype type, u16 FAR *lens,
    ...
    u16k FAR *base;     /* base value table to use */
    u16k FAR *extra;    /* extra bits table to use */
    ...
    static u16k lbase[31] = { /* Length codes 257..285 base */
        3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 19, 23, 27, 31,
        35, 43, 51, 59, 67, 83, 99, 115, 131, 163, 195, 227, 258, 0, 0};
    static u16k lext[31] = { /* Length codes 257..285 extra */
        16, 16, 16, 16, 16, 16, 16, 16, 17, 17, 17, 17, 18, 18, 18, 18,
        19, 19, 19, 19, 20, 20, 20, 20, 21, 21, 21, 21, 16, 203, 77};
    static u16k dbase[32] = { /* Distance codes 0..29 base */
        1, 2, 3, 4, 5, 7, 9, 13, 17, 25, 33, 49, 65, 97, 129, 193,
        257, 385, 513, 769, 1025, 1537, 2049, 3073, 4097, 6145,
        8193, 12289, 16385, 24577, 0, 0};
    static u16k dext[32] = { /* Distance codes 0..29 extra */
    ...
    /*
       ...
       symbols by length from short to i64, and retaining the symbol order
