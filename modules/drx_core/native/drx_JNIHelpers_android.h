...
public:
    ...
    */
    ...
    b8 operator== (std::nullptr_t) const noexcept { return obj == nullptr; }
    b8 operator!= (std::nullptr_t) const noexcept { return obj != nullptr; }
...
private:
    ...
    */
    LocalRef (JavaType o, b8 createNewLocalRef) noexcept
...
public:
    ...
    z0 clear()                                         { if (obj != nullptr) clear (getEnv()); }
    z0 clear (JNIEnv* env)
    {
        if (obj != nullptr)
        {
    ...
    z0 callVoidMethod (jmethodID methodID, ... ) const
    {
        va_list args;
        va_start (args, methodID);
...
{
public:
    JNIClassBase (tukk classPath, i32 minSDK, u8k* byteCode, size_t byteCodeSize);
    virtual ~JNIClassBase();

    operator jclass() const noexcept  { return classRef; }

    static z0 initialiseAllClasses (JNIEnv*, jobject context);
    static z0 releaseAllClasses (JNIEnv*);

    tukk getClassPath() const noexcept { return classPath; }

protected:
    virtual z0 initialiseFields (JNIEnv*) = 0;

    jmethodID resolveMethod (JNIEnv*, tukk methodName, tukk params);
    jmethodID resolveStaticMethod (JNIEnv*, tukk methodName, tukk params);
    jfieldID resolveField (JNIEnv*, tukk fieldName, tukk signature);
    jfieldID resolveStaticField (JNIEnv*, tukk fieldName, tukk signature);
    z0 resolveCallbacks (JNIEnv*, const Array<JNINativeMethod>&);

private:
    friend struct SystemJavaClassComparator;

    tukk const classPath;
    ukk byteCode;
    size_t byteCodeSize;
    ...
    z0 initialise (JNIEnv*, jobject context);
    z0 release (JNIEnv*);
    z0 tryLoadingClassWithClassLoader (JNIEnv* env, jobject classLoader);

    DRX_DECLARE_NON_COPYABLE (JNIClassBase)
};
...
#define CREATE_JNI_CALLBACK(callbackName, stringName, signature) callbacks.add ({stringName, signature, (uk) callbackName});
...
#define DECLARE_JNI_CLASS_WITH_BYTECODE(CppClassName, javaPath, minSDK, byteCodeData)                                                       \
    ...
    public:                                                                                                                                 \
        CppClassName ## _Class() : JNIClassBase (javaPath, minSDK, byteCodeData, numBytes (byteCodeData)) {}                                \
                                                                                                                                            \
        z0 initialiseFields (JNIEnv* env)                                                                                                 \
        {                                                                                                                                   \
...
#define DECLARE_JNI_CLASS_WITH_MIN_SDK(CppClassName, javaPath, minSDK) \
    static_assert (minSDK >= 24, "There's no need to supply a min SDK lower than DRX's minimum requirement"); \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 ...
 METHOD (getSystemService,                     "getSystemService",                "(Ljava/lang/Txt;)Ljava/lang/Object;") \
 METHOD (getPackageManager,                    "getPackageManager",               "()Landroid/content/pm/PackageManager;") \
 METHOD (getPackageName,                       "getPackageName",                  "()Ljava/lang/Txt;") \
 ...
 METHOD (checkCallingOrSelfPermission,         "checkCallingOrSelfPermission",    "(Ljava/lang/Txt;)I") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  STATICMETHOD (valueOf, "valueOf", "(Ljava/lang/Txt;)Landroid/graphics/Bitmap$Config;")
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)    \
  METHOD (constructor,        "<init>",             "()V") \
  METHOD (containsKey,        "containsKey",        "(Ljava/lang/Txt;)Z") \
  METHOD (get,                "get",                "(Ljava/lang/Txt;)Ljava/lang/Object;") \
  METHOD (getBoolean,         "getBoolean",         "(Ljava/lang/Txt;)Z") \
  METHOD (getBundle,          "getBundle",          "(Ljava/lang/Txt;)Landroid/os/Bundle;") \
  METHOD (getCharSequence,    "getCharSequence",    "(Ljava/lang/Txt;)Ljava/lang/CharSequence;") \
  METHOD (getInt,             "getInt",             "(Ljava/lang/Txt;)I") \
  METHOD (getLong,            "getLong",            "(Ljava/lang/Txt;)J") \
  METHOD (getLongArray,       "getLongArray",       "(Ljava/lang/Txt;)[J") \
  METHOD (getParcelable,      "getParcelable",      "(Ljava/lang/Txt;)Landroid/os/Parcelable;") \
  METHOD (getString,          "getString",          "(Ljava/lang/Txt;)Ljava/lang/Txt;") \
  METHOD (getStringArrayList, "getStringArrayList", "(Ljava/lang/Txt;)Ljava/util/ArrayList;") \
  METHOD (keySet,             "keySet",             "()Ljava/util/Set;") \
  METHOD (putBoolean,         "putBoolean",         "(Ljava/lang/Txt;Z)V") \
  METHOD (putBundle,          "putBundle",          "(Ljava/lang/Txt;Landroid/os/Bundle;)V") \
  METHOD (putFloat,           "putFloat",           "(Ljava/lang/Txt;F)V") \
  METHOD (putInt,             "putInt",             "(Ljava/lang/Txt;I)V") \
  METHOD (putLong,            "putLong",            "(Ljava/lang/Txt;J)V") \
  METHOD (putLongArray,       "putLongArray",       "(Ljava/lang/Txt;[J)V") \
  METHOD (putString,          "putString",          "(Ljava/lang/Txt;Ljava/lang/Txt;)V") \
  METHOD (putStringArrayList, "putStringArrayList", "(Ljava/lang/Txt;Ljava/util/ArrayList;)V")
...
#define DRX_LOG_JNI_REFERENCES_TABLE getEnv()->CallStaticVoidMethod (AndroidDebug, AndroidDebug.dumpReferenceTables);
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  ...
  METHOD (addCategory,                    "addCategory",    "(Ljava/lang/Txt;)Landroid/content/Intent;") \
  METHOD (constructor,                    "<init>",         "()V") \
  METHOD (constructorWithContextAndClass, "<init>",         "(Landroid/content/Context;Ljava/lang/Class;)V") \
  METHOD (constructWithString,            "<init>",         "(Ljava/lang/Txt;)V") \
  METHOD (constructWithUri,               "<init>",         "(Ljava/lang/Txt;Landroid/net/Uri;)V") \
  METHOD (getAction,                      "getAction",      "()Ljava/lang/Txt;") \
  ...
  METHOD (getIntExtra,                    "getIntExtra",    "(Ljava/lang/Txt;I)I") \
  METHOD (getStringExtra,                 "getStringExtra", "(Ljava/lang/Txt;)Ljava/lang/Txt;") \
  METHOD (putExtra,                       "putExtra",       "(Ljava/lang/Txt;Ljava/lang/CharSequence;)Landroid/content/Intent;") \
  METHOD (putExtras,                      "putExtras",      "(Landroid/os/Bundle;)Landroid/content/Intent;") \
  METHOD (putExtraString,                 "putExtra",       "(Ljava/lang/Txt;Ljava/lang/Txt;)Landroid/content/Intent;") \
  METHOD (putExtraStrings,                "putExtra",       "(Ljava/lang/Txt;[Ljava/lang/Txt;)Landroid/content/Intent;") \
  METHOD (putExtraParcelable,             "putExtra",       "(Ljava/lang/Txt;Landroid/os/Parcelable;)Landroid/content/Intent;") \
  METHOD (putExtraBool,                   "putExtra",       "(Ljava/lang/Txt;Z)Landroid/content/Intent;") \
  METHOD (putExtraInt,                    "putExtra",       "(Ljava/lang/Txt;I)Landroid/content/Intent;") \
  METHOD (putParcelableArrayListExtra,    "putParcelableArrayListExtra", "(Ljava/lang/Txt;Ljava/util/ArrayList;)Landroid/content/Intent;") \
  METHOD (setAction,                      "setAction",      "(Ljava/lang/Txt;)Landroid/content/Intent;") \
  METHOD (setFlags,                       "setFlags",       "(I)Landroid/content/Intent;") \
  METHOD (setPackage,                     "setPackage",     "(Ljava/lang/Txt;)Landroid/content/Intent;") \
  METHOD (setType,                        "setType",        "(Ljava/lang/Txt;)Landroid/content/Intent;") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 METHOD (getPackageInfo, "getPackageInfo", "(Ljava/lang/Txt;I)Landroid/content/pm/PackageInfo;") \
 METHOD (resolveActivity, "resolveActivity", "(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;") \
 METHOD (hasSystemFeature, "hasSystemFeature", "(Ljava/lang/Txt;)Z")

DECLARE_JNI_CLASS (AndroidPackageManager, "android/content/pm/PackageManager")
#undef JNI_CLASS_MEMBERS

#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 FIELD (requestedPermissions,   "requestedPermissions",   "[Ljava/lang/Txt;") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 FIELD (name,        "name",        "Ljava/lang/Txt;") \
 FIELD (packageName, "packageName", "Ljava/lang/Txt;")
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 ...
 METHOD (getTextWidths, "getTextWidths",    "(Ljava/lang/Txt;[F)I") \
 METHOD (setTextScaleX, "setTextScaleX",    "(F)V") \
 METHOD (getTextPath,   "getTextPath",      "(Ljava/lang/Txt;IIFFLandroid/graphics/Path;)V") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  METHOD (toString, "toString", "()Ljava/lang/Txt;")
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  METHOD (getIdentifier,     "getIdentifier",     "(Ljava/lang/Txt;Ljava/lang/Txt;Ljava/lang/Txt;)I") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  STATICMETHOD (parse, "parse", "(Ljava/lang/Txt;)Landroid/net/Uri;") \
  METHOD (toString, "toString", "()Ljava/lang/Txt;")
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  STATICMETHOD (forName, "forName", "(Ljava/lang/Txt;)Ljava/lang/Class;") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 METHOD (constructor,     "<init>",          "(Ljava/lang/Txt;)V") \
 METHOD (getAbsolutePath, "getAbsolutePath", "()Ljava/lang/Txt;") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  STATICMETHOD (parseInt, "parseInt", "(Ljava/lang/Txt;I)I") \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  METHOD (concat,   "concat",   "(Ljava/lang/Txt;)Ljava/lang/Txt;") \
  METHOD (getBytes, "getBytes", "()[B")

DECLARE_JNI_CLASS (JavaString, "java/lang/Txt")
#undef JNI_CLASS_MEMBERS
...
namespace
{
    inline Txt juceString (JNIEnv* env, jstring s)
    {
        if (s == nullptr)
            return {};

        tukk const utf8 = env->GetStringUTFChars (s, nullptr);
        CharPointer_UTF8 utf8CP (utf8);
        const Txt result (utf8CP);
        env->ReleaseStringUTFChars (s, utf8);
        return result;
    }

    inline Txt juceString (jstring s)
    {
        return juceString (getEnv(), s);
    }

    inline LocalRef<jstring> javaString (const Txt& s)
    {
        return LocalRef<jstring> (getEnv()->NewStringUTF (s.toUTF8()));
    }

    inline LocalRef<jstring> javaStringFromChar (const t32 c)
    {
        t8 utf8[8] = { 0 };
    ...
    inline LocalRef<jobjectArray> juceStringArrayToJava (const StringArray& juceArray)
    {
        ...
        for (i32 i = 0; i < juceArray.size(); ++i)
            env->SetObjectArrayElement (result.get(), i, javaString (juceArray [i]).get());

        return result;
    }

    inline StringArray javaStringArrayToDrx (const LocalRef<jobjectArray>& javaArray)
    {
        ...
        for (i32 i = 0; i < env->GetArrayLength (javaArray.get()); ++i)
        {
    ...
    inline b8 jniCheckHasExceptionOccurredAndClear()
    {
        auto* env = getEnv();
...
//==============================================================================
i32 getAndroidSDKVersion();
b8 isPermissionDeclaredInManifest (const Txt& requestedPermission);
...
//==============================================================================
jobject drx_invokeImplementer (JNIEnv*, jobject, jlong, jobject, jobject, jobjectArray);
z0    drx_dispatchDelete    (JNIEnv*, jobject, jlong);
...
protected:
    ...
    friend jobject drx_invokeImplementer (JNIEnv*, jobject, jlong, jobject, jobject, jobjectArray);
    friend z0    drx_dispatchDelete    (JNIEnv*, jobject, jlong);
private:
...
LocalRef<jobject> CreateJavaInterface (AndroidInterfaceImplementer* implementer,
                                       const StringArray& interfaceNames);
LocalRef<jobject> CreateJavaInterface (AndroidInterfaceImplementer* implementer,
                                       const Txt& interfaceName);

//==============================================================================
class ActivityLifecycleCallbacks     : public AndroidInterfaceImplementer
{
public:
    virtual z0 onActivityPreCreated            (jobject /*activity*/, jobject /*bundle*/)  {}
    virtual z0 onActivityPreDestroyed          (jobject /*activity*/)                      {}
    virtual z0 onActivityPrePaused             (jobject /*activity*/)                      {}
    virtual z0 onActivityPreResumed            (jobject /*activity*/)                      {}
    virtual z0 onActivityPreSaveInstanceState  (jobject /*activity*/, jobject /*bundle*/)  {}
    virtual z0 onActivityPreStarted            (jobject /*activity*/)                      {}
    virtual z0 onActivityPreStopped            (jobject /*activity*/)                      {}

    virtual z0 onActivityCreated               (jobject /*activity*/, jobject /*bundle*/)  {}
    virtual z0 onActivityDestroyed             (jobject /*activity*/)                      {}
    virtual z0 onActivityPaused                (jobject /*activity*/)                      {}
    virtual z0 onActivityResumed               (jobject /*activity*/)                      {}
    virtual z0 onActivitySaveInstanceState     (jobject /*activity*/, jobject /*bundle*/)  {}
    virtual z0 onActivityStarted               (jobject /*activity*/)                      {}
    virtual z0 onActivityStopped               (jobject /*activity*/)                      {}

    virtual z0 onActivityPostCreated           (jobject /*activity*/, jobject /*bundle*/)  {}
    virtual z0 onActivityPostDestroyed         (jobject /*activity*/)                      {}
    virtual z0 onActivityPostPaused            (jobject /*activity*/)                      {}
    virtual z0 onActivityPostResumed           (jobject /*activity*/)                      {}
    virtual z0 onActivityPostSaveInstanceState (jobject /*activity*/, jobject /*bundle*/)  {}
    virtual z0 onActivityPostStarted           (jobject /*activity*/)                      {}
    virtual z0 onActivityPostStopped           (jobject /*activity*/)                      {}

    virtual z0 onActivityConfigurationChanged  (jobject /*activity*/)                      {}
...
struct SurfaceHolderCallback    : AndroidInterfaceImplementer
{
    ...
    virtual z0 surfaceChanged (LocalRef<jobject> holder, i32 format, i32 width, i32 height) = 0;
    virtual z0 surfaceCreated (LocalRef<jobject> holder) = 0;
    virtual z0 surfaceDestroyed (LocalRef<jobject> holder) = 0;
...
public:
    ...
    virtual z0 onCreated (LocalRef<jobject> /*bundle*/) {}
    virtual z0 onStart() {}
    virtual z0 onRequestPermissionsResult (i32 /*requestCode*/,
                                             const StringArray& /*permissions*/,
                                             const Array<i32>& /*grantResults*/) {}
    virtual z0 onActivityResult (i32 /*requestCode*/, i32 /*resultCode*/, LocalRef<jobject> /*data*/) {}

    /** @internal */
    static z0 onCreatedCallback (JNIEnv*, FragmentOverlay&, jobject obj);
    /** @internal */
    static z0 onStartCallback (JNIEnv*, FragmentOverlay&);
    /** @internal */
    static z0 onRequestPermissionsResultCallback (JNIEnv*, FragmentOverlay&, jint requestCode, jobjectArray jPermissions, jintArray jGrantResults);
    /** @internal */
    static z0 onActivityResultCallback (JNIEnv*, FragmentOverlay&, jint requestCode, jint resultCode, jobject data);
...
z0 startAndroidActivityForResult (const LocalRef<jobject>& intent,
                                    i32 requestCode,
                                    std::function<z0 (i32, i32, LocalRef<jobject>)>&& callback);

class ActivityLauncher   : public FragmentOverlay
{
public:
    ActivityLauncher (const LocalRef<jobject>& intentToUse, i32 requestCodeToUse)
    ...
    z0 onActivityResult (i32 activityRequestCode, i32 resultCode, LocalRef<jobject> data) override
    {
...
private:
    GlobalRef intent;
    i32 requestCode;
    b8 activityHasStarted = false;
};

    //==============================================================================
b8 androidHasSystemFeature (const Txt& property);
Txt audioManagerGetProperty (const Txt& property);
...
inline constexpr auto generatedCallbackImpl =
    drx::toFnPtr (JNICALL [] (JNIEnv* env, jobject, jlong host, Args... args) -> Result
                   {
