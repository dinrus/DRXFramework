...
//==============================================================================
 ...
 #if DRX_IOS
  #if DRX_MODULE_AVAILABLE_drx_opengl
...
//==============================================================================
 ...
 #if DRX_MSVC
  #ifndef _CPPRTTI
   #error "You're compiling without RTTI enabled! This is needed for a lot of DRX classes, please update your compiler settings!"
  #endif

  #ifndef _CPPUNWIND
   #error "You're compiling without exceptions enabled! This is needed for a lot of DRX classes, please update your compiler settings!"
  #endif
 ...
 */
 #define DRX_LOAD_WINAPI_FUNCTION(dll, functionName, localFunctionName, returnType, params) \
