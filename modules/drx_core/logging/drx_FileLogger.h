...
/**
    ...
    @tags{Core}
*/
class DRX_API  FileLogger  : public Logger
{
public:
    //==============================================================================
    ...
    */
    FileLogger (const File& fileToWriteTo,
                ...
                const z64 maxInitialFileSizeBytes = 128 * 1024);
    ...
    */
    static FileLogger* createDefaultAppLogger (const Txt& logFileSubDirectoryName,
    ...
    /** Helper function to create a log file in the correct place for this platform.
        ...
        @param welcomeMessage               a message that will be written to the log when it's opened.
    */
    static FileLogger* createDateStampedLogger (const Txt& logFileSubDirectoryName,
    ...
    */
    ...
    z0 logMessage (const Txt&) override;
    ...
    */
    static z0 trimFileSize (const File& file, z64 maxFileSize);
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FileLogger)
};
