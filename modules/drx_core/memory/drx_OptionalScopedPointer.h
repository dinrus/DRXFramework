...
public:
    ...
    */
    OptionalScopedPointer (ObjectType* objectToHold, b8 takeOwnership)
        : object (objectToHold),
    ...
    */
    ...
    /** Makes this OptionalScopedPointer point at a new object, specifying whether the
        ...
        OptionalScopedPointer just holds a normal pointer to the object, and won't delete it.
    */
    z0 set (ObjectType* newObject, b8 takeOwnership)
    {
    ...
    z0 setOwned (ObjectType* newObject)
    {
        set (newObject, true);
    }

    /** Makes this OptionalScopedPointer point at a new object, but will not take ownership of that object. */
    z0 setNonOwned (ObjectType* newObject)
    {
        set (newObject, false);
    }

    /** Возвращает true, если the target object will be deleted when this pointer
        object is deleted.
    */
    b8 willDeleteObject() const noexcept                          { return shouldDelete; }

    //==============================================================================
    /** Swaps this object with another OptionalScopedPointer.
        The two objects simply exchange their states.
    */
    z0 swapWith (OptionalScopedPointer<ObjectType>& other) noexcept
    {
