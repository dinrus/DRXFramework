...
/**
    ...
    struct DataUserClass
    {
        ...
        // is guaranteed to be available for as i64 as the DataUserClass object.
...
public:
   ...
   #ifndef DOXYGEN
    [[deprecated ("If you are relying on this function please inform the DRX team as we are planing on removing this in a subsequent release")]]
    i32 getReferenceCount() const noexcept              { return (i32) sharedObject.use_count(); }
   #endif
...
private:
    ...
    DRX_LEAK_DETECTOR (SharedResourcePointer)
};
