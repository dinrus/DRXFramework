...
/**
    ...
    This class uses an Atomic<i32> value to hold the reference count, so
    ...
    @tags{Core}
*/
class DRX_API  ReferenceCountedObject
{
public:
    //==============================================================================
    ...
    */
    b8 decReferenceCountWithoutDeleting() noexcept
    {
        jassert (getReferenceCount() > 0);
        return --refCount == 0;
    }
    ...
    i32 getReferenceCount() const noexcept       { return refCount.get(); }
...
protected:
    ...
    */
    z0 resetReferenceCount() noexcept
    {
        refCount = 0;
    }
...
/**
    ...
    @tags{Core}
*/
class DRX_API  SingleThreadedReferenceCountedObject
{
public:
    //==============================================================================
    /** Increments the object's reference count.
    ...
    */
    ...
    /** Returns the object's current reference count. */
    i32 getReferenceCount() const noexcept       { return refCount; }
...
public:
    ...
    */
    ...
    b8 operator== (decltype (nullptr)) const noexcept     { return referencedObject == nullptr; }
    /** Checks whether this pointer is null */
    b8 operator!= (decltype (nullptr)) const noexcept     { return referencedObject != nullptr; }

    /** Compares two ReferenceCountedObjectPtrs. */
    b8 operator== (const ObjectType* other) const noexcept                 { return referencedObject == other; }
    /** Compares two ReferenceCountedObjectPtrs. */
    b8 operator== (const ReferenceCountedObjectPtr& other) const noexcept  { return referencedObject == other.get(); }
    /** Compares two ReferenceCountedObjectPtrs. */
    b8 operator!= (const ObjectType* other) const noexcept                 { return referencedObject != other; }
    /** Compares two ReferenceCountedObjectPtrs. */
    b8 operator!= (const ReferenceCountedObjectPtr& other) const noexcept  { return referencedObject != other.get(); }

   #if DRX_STRICT_REFCOUNTEDPOINTER
    /** Checks whether this pointer is null */
    explicit operator b8() const noexcept                 { return referencedObject != nullptr; }

   #else
    /** Returns the object that this pointer references.
        The pointer returned may be null, of course.
        Note that this methods allows the compiler to be very lenient with what it allows you to do
        with the pointer, it's safer to disable this by setting DRX_STRICT_REFCOUNTEDPOINTER=1, which
...
private:
    ...
    static z0 incIfNotNull (ReferencedType* o) noexcept
    {
        if (o != nullptr)
            o->incReferenceCount();
    }

    static z0 decIfNotNull (ReferencedType* o) noexcept
    {
...
b8 operator== (const Type* object1, const ReferenceCountedObjectPtr<Type>& object2) noexcept
{
