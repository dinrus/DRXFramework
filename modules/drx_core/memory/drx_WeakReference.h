...
/**
    ...
    OR: just use the handy DRX_DECLARE_WEAK_REFERENCEABLE macro to do all this for you.
...
public:
    ...
    */
    b8 wasObjectDeleted() const noexcept                      { return holder != nullptr && holder->get() == nullptr; }
    ...
    */
    ...
    public:
        ...
        z0 clearPointer() noexcept                { owner = nullptr; }

    private:
        ObjectType* owner;

        DRX_DECLARE_NON_COPYABLE (SharedPointer)
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        i32 getNumActiveWeakReferences() const noexcept
        {
    ...
    private:
        ...
        DRX_DECLARE_NON_COPYABLE (Master)
    };
...
/**
     ...
     private:
         DRX_DECLARE_WEAK_REFERENCEABLE (MyObject)
     };
     @endcode

     @see WeakReference, WeakReference::Master
*/
#define DRX_DECLARE_WEAK_REFERENCEABLE(Class) \
    struct WeakRefMaster  : public drx::WeakReference<Class>::Master { ~WeakRefMaster() { this->clear(); } }; \
    WeakRefMaster masterReference; \
    friend class drx::WeakReference<Class>; \
