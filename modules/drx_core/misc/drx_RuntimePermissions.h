...
/**
    ...
    Old code:
        ...
        audioDeviceManager.initialise (2, 2, nullptr, true, Txt(), nullptr);
    ...
    @tags{Core}
*/
class DRX_API  RuntimePermissions
{
public:
    //==============================================================================
    enum PermissionID
    ...
    using Callback = std::function<z0 (b8)>;
    ...
    */
    static z0 request (PermissionID permission, Callback callback);

    /** Returns whether a runtime request is required to obtain the permission
        on the current platform.
    */
    static b8 isRequired (PermissionID permission);

    /** Возвращает true, если the app has been already granted this permission, either
    ...
    */
    static b8 isGranted (PermissionID permission);
};
