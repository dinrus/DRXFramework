...
public:
    ...
    */
    static Result parse (const Txt& text, var& parsedResult);
    ...
    /** Attempts to parse some JSON-formatted text, and returns the result as a var object.
        ...
        any kind of primitive JSON object, use the fromString() method.
    */
    static var parse (const Txt& text);
    ...
    */
    ...
    public:
        ...
        */
        FormatOptions withMaxDecimalPlaces (i32 x) const
        {
        ...
        */
        FormatOptions withIndentLevel (i32 x) const
        {
        ...
        */
        ...
        i32 getMaxDecimalPlaces() const { return maxDecimalPlaces; }

        /** Returns the indent level of this Formatter. */
        i32 getIndentLevel()      const { return indent; }
    ...
    /** Returns a string which contains a JSON-formatted representation of the var object.
        ...
        @see writeToStream
    */
    static Txt toString (const var& objectToFormat,
                            b8 allOnOneLine = false,
                            i32 maximumDecimalPlaces = 15);
    ...
    */
    ...
    /** Writes a JSON-formatted representation of the var object to the given stream.
        ...
        @see toString
    */
    static z0 writeToStream (OutputStream& output,
    ...
    */
    ...
    static Txt escapeString (StringRef);
    ...
    */
    static Result parseQuotedString (Txt::CharPointerType& text, var& result);
