...
/**
    ...
    @tags{Core}
*/
class DRX_API  MemoryMappedFile
{
public:
    ...
    */
    MemoryMappedFile (const File& file, AccessMode mode, b8 exclusive = false);
    ...
    */
    uk getData() const noexcept              { return address; }
    ...
    */
    ...
    Range<z64> getRange() const noexcept      { return range; }
...
private:
   ...
   #if DRX_WINDOWS
    uk fileHandle = nullptr;
   #else
    i32 fileHandle = 0;
   #endif

    z0 openInternal (const File&, AccessMode, b8);

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MemoryMappedFile)
};
