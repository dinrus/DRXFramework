...
public:
    ...
    */
    ...
    /** Sets the file based on an absolute pathname.
        ...
        user home directories.
    */
    File& operator= (const Txt& newAbsolutePath);
    ...
    */
    static Txt descriptionOfSizeInBytes (z64 bytes);
    ...
    */
    const Txt& getFullPathName() const noexcept          { return fullPath; }
    ...
    */
    Txt getRelativePathFrom (const File& directoryToBeRelativeTo) const;
    ...
    */
    b8 hasFileExtension (StringRef extensionToTest) const;
    ...
    */
    Txt getFileNameWithoutExtension() const;
    ...
    */
    ...
    /** Checks whether a file is somewhere inside a directory.
        ...
        Возвращает true, если this file is somewhere inside a subdirectory of the directory
    ...
    */
    b8 isAChildOf (const File& potentialParentDirectory) const;
    ...
    /** Chooses a filename relative to this one that doesn't already exist.
        ...
        @param putNumbersInBrackets     if true, this will create filenames in the
                                        ...
                                        brackets out.
    */
    File getNonexistentChildFile (const Txt& prefix,
                                  const Txt& suffix,
                                  b8 putNumbersInBrackets = true) const;
    ...
    */
    File getNonexistentSibling (b8 putNumbersInBrackets = true) const;

    //==============================================================================
    /** Compares the pathnames for two files. */
    b8 operator== (const File&) const;
    /** Compares the pathnames for two files. */
    b8 operator!= (const File&) const;
    /** Compares the pathnames for two files. */
    b8 operator< (const File&) const;
    ...
    */
    ...
    /** Changes the write-permission of a file or directory.
        ...
        @see hasWriteAccess
    */
    b8 setReadOnly (b8 shouldBeReadOnly,
                      b8 applyRecursively = false) const;
    ...
    /** Changes the execute-permissions of a file.
        ...
        @returns    true if it manages to change the file's permissions.
    */
    b8 setExecutePermission (b8 shouldBeExecutable) const;

    /** Возвращает true, если this file is a hidden or system file.
    ...
    */
    b8 setLastModificationTime (Time newTime) const;
    ...
    */
    b8 setLastAccessTime (Time newTime) const;
    ...
    */
    b8 setCreationTime (Time newTime) const;
    ...
    */
    ...
    /** Deletes a file or directory and all its subdirectories.
        ...
        @see deleteFile
    */
    b8 deleteRecursively (b8 followSymlinks = false) const;
    ...
    */
    b8 moveFileTo (const File& targetLocation) const;
    ...
    /** Copies a file.
        ...
        @returns    true if the operation succeeds
    */
    b8 copyFileTo (const File& targetLocation) const;
    ...
    /** Replaces a file.
        ...
        @returns    true if the operation succeeds
    */
    b8 replaceFileIn (const File& targetLocation) const;
    ...
    */
    b8 copyDirectoryTo (const File& newDirectory) const;
    ...
    */
    i32 findChildFiles (Array<File>& results, i32 whatToLookFor,
                        b8 searchRecursively, const Txt& wildCardPattern = "*",
                        FollowSymlinks followSymlinks = FollowSymlinks::yes) const;
    ...
    */
    i32 getNumberOfChildFiles (i32 whatToLookFor,
                               const Txt& wildCardPattern = "*") const;

    /** Возвращает true, если this file is a directory that contains one or more subdirectories.
        @see isDirectory, findChildFiles
    */
    b8 containsSubDirectories() const;
    ...
    */
    b8 loadFileAsData (MemoryBlock& result) const;
    ...
    */
    b8 appendData (ukk dataToAppend,
    ...
    /** Replaces this file's contents with a given block of data.
        ...
        Возвращает true, если the operation succeeds, or false if it fails.

        @see appendText
    */
    b8 replaceWithData (ukk dataToWrite,
                          size_t numberOfBytes) const;
    ...
    /** Appends a string to the end of the file.
        ...
        @see replaceWithText
    */
    b8 appendText (const Txt& textToAppend,
                     b8 asUnicode = false,
                     b8 writeUnicodeHeaderBytes = false,
                     tukk lineEndings = "\r\n") const;
    ...
    /** Replaces this file's contents with a given text string.
        ...
        @see appendText
    */
    b8 replaceWithText (const Txt& textToWrite,
                          b8 asUnicode = false,
                          b8 writeUnicodeHeaderBytes = false,
                          tukk lineEndings = "\r\n") const;
    ...
    */
    b8 hasIdenticalContentTo (const File& other) const;
    ...
    */
    z64 getBytesFreeOnVolume() const;
    ...
    */
    z64 getVolumeTotalSize() const;

    /** Возвращает true, если this file is on a CD or DVD drive. */
    b8 isOnCDRomDrive() const;

    /** Возвращает true, если this file is on a hard disk.

        This will fail if it's a network drive, but will still be true for
        removable hard-disks.
    */
    b8 isOnHardDisk() const;

    /** Возвращает true, если this file is on a removable disk drive.

        This might be a usb-drive, a CD-rom, or maybe a network drive.
    */
    b8 isOnRemovableDrive() const;
    ...
    /** Launches the file as a process.
        ...
        @see revealToUser
    */
    b8 startAsProcess (const Txt& parameters = Txt()) const;

    /** Opens Finder, Explorer, or whatever the OS uses, to show the user this file's location.
        @see startAsProcess
    */
    z0 revealToUser() const;
    ...
    */
    static File DRX_CALLTYPE getSpecialLocation (const SpecialLocationType type);
    ...
    */
    b8 setAsCurrentWorkingDirectory() const;

    //==============================================================================
    /** The system-specific file separator character.
        On Windows, this will be '\', on Mac/Linux, it'll be '/'
    */
    static t32 getSeparatorChar();
    ...
    */
    static Txt createLegalFileName (const Txt& fileNameToFix);
    ...
    */
    static Txt createLegalPathName (const Txt& pathNameToFix);

    /** Indicates whether filenames are case-sensitive on the current operating system. */
    static b8 areFileNamesCaseSensitive();

    /** Возвращает true, если the string seems to be a fully-specified absolute path. */
    static b8 isAbsolutePath (StringRef path);
    ...
    */
    static File createFileWithoutCheckingPath (const Txt& absolutePath) noexcept;

    /** Adds a separator character to the end of a path if it doesn't already have one. */
    static Txt addTrailingSeparator (const Txt& path);

    //==============================================================================
    /** Tries to create a symbolic link and returns a boolean to indicate success */
    b8 createSymbolicLink (const File& linkFileToCreate, b8 overwriteExisting) const;

    /** Возвращает true, если this file is a link or alias that can be followed using getLinkedTarget(). */
    b8 isSymbolicLink() const;
    ...
    */
    static b8 createSymbolicLink (const File& linkFileToCreate,
                                    const Txt& nativePathOfTarget,
    ...
    Txt getNativeLinkedTarget() const;

   #if DRX_WINDOWS || DOXYGEN
    /** Windows ONLY - Creates a win32 .LNK shortcut file that links to this file. */
    b8 createShortcut (const Txt& description, const File& linkFileToCreate) const;

    /** Windows ONLY - Возвращает true, если this is a win32 .LNK file. */
    b8 isShortcut() const;
   #else
    ...
    /** OSX ONLY - Возвращает true, если this file is actually a bundle. */
    b8 isBundle() const;
   #endif
    ...
    */
    static File getContainerForSecurityApplicationGroupIdentifier (const Txt& appGroup);
   #endif
    ...
    {
        NaturalFileComparator (b8 shouldPutFoldersFirst) noexcept : foldersFirst (shouldPutFoldersFirst) {}

        i32 compareElements (const File& firstFile, const File& secondFile) const
        {
    ...
    /* These static objects are deprecated because it's too easy to accidentally use them indirectly
       ...
       just use File() or {}.
    */
    [[deprecated]] static const t32 separator;
...
private:
    ...
    static Txt parseAbsolutePath (const Txt&);
    Txt getPathUpToLastSlash() const;
    b8 isNonEmptyDirectory() const;

    Result createDirectoryInternal (const Txt&) const;
    b8 copyInternal (const File&) const;
    b8 moveInternal (const File&) const;
    b8 replaceInternal (const File&) const;
    b8 setFileTimesInternal (z64 m, z64 a, z64 c) const;
    z0 getFileTimesInternal (z64& m, z64& a, z64& c) const;
    b8 setFileReadOnlyInternal (b8) const;
    b8 setFileExecutableInternal (b8) const;
};
