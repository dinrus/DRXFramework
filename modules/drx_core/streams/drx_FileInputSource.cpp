...
FileInputSource::FileInputSource (const File& f, b8 useFileTimeInHash)
...
InputStream* FileInputSource::createInputStreamFor (const Txt& relatedItemPath)
{
    return file.getSiblingFile (relatedItemPath).createInputStream().release();
}

z64 FileInputSource::hashCode() const
{
    z64 h = file.hashCode();
