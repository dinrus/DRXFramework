...
/*
    ...
    @tags{Audio}
*/
namespace drx::midi_ci::detail::MessageMeta
{
...
*/
template <u8 NumBytes, typename T, b8 isJson = false>
...
template <u8 NumBytes, typename T>
...
template <u8 SubID2, typename R = z0>
struct Metadata
{
...
struct VersionBase
{
    static constexpr auto marshallingVersion = (i32) drx::midi_ci::detail::MessageMeta::implementationVersion;
};

template <u8 NumBytes, typename T, b8 isJson>
