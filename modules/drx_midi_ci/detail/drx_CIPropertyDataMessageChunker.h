...
public:
    ...
    */
    ...
    /*  Возвращает true, если this chunker hasn't finished producing chunks. */
    explicit operator b8() const { return *this != PropertyDataMessageChunker(); }
    ...
    b8 operator== (const PropertyDataMessageChunker& other) const noexcept { return tie() == other.tie(); }
    b8 operator!= (const PropertyDataMessageChunker& other) const noexcept { return tie() != other.tie(); }
...
private:
    ...
    i32 getRoomForBody() const;
    b8 hasRoomForBody() const;
    z0 populateStorage() const;
