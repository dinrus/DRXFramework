...
public:
    ...
    z0 sendEndpointInquiry (MUID destination, Message::EndpointInquiry endpoint)
    {
        detail::MessageTypeUtils::send (concreteBufferOutput,
                                        options.getFunctionBlock().firstGroup,
                                        destination,
    ...
    z0 sendProfileInquiry (MUID receiver, ChannelInGroup address)
    {
    ...
    z0 sendProfileDetailsInquiry (MUID receiver, ChannelInGroup address, Profile profile, std::byte target)
    {
        if (! supportsProfiles (receiver))
            return;
    ...
    z0 sendProfileSpecificData (MUID receiver, ChannelInGroup address, Profile profile, Span<const std::byte> data)
    {
        if (! supportsProfiles (receiver))
            return;
    ...
    z0 sendProfileEnablement (MUID m, ChannelInGroup address, Profile profile, i32 numChannels)
    {
        ...
        if (numChannels > 0)
        {
            ...
            detail::MessageTypeUtils::send (concreteBufferOutput,
                                            ...
                                            m,
                                            address,
                                            Message::ProfileOn { profile, (u16) channelsToSend });
        }
        else
        {
            detail::MessageTypeUtils::send (concreteBufferOutput,
    ...
    z0 sendPropertyCapabilitiesInquiry (MUID m)
    {
    ...
    std::optional<RequestKey> sendPropertyGetInquiry (MUID m,
                                                      ...
                                                      std::function<z0 (const PropertyExchangeResult&)> onResult)
    {
    ...
    z0 abortPropertyRequest (RequestKey k) override
    {
    ...
    z0 endSubscription (SubscriptionKey key)
    {
    ...
    z0 processMessage (ump::BytesOnGroup msg)
    {
    ...
    std::optional<i32> getNumPropertyExchangeRequestsSupportedForMuid (MUID m) const
    {
        const auto iter = discovered.find (m);
        return iter != discovered.end()
             ? std::optional<i32> ((i32) iter->second.propertyExchangeResponse->numSimultaneousRequestsSupported)
             : std::nullopt;
    }
...
private:
    ...
    public:
        ...
        b8 tryRespond (ResponderOutput& output, const Message::Parsed& message) override
        {
    ...
    private:
        ...
        public:
            ...
            z0 visit (const Message::PropertyExchangeCapabilities& caps)         const override { visitImpl (caps); }
            z0 visit (const Message::PropertyExchangeCapabilitiesResponse& caps) const override { visitImpl (caps); }
            using MessageVisitor::visit;

        private:
            template <typename Body>
            z0 visitImpl (const Body& t) const
            {
    ...
    private:
        ...
        {
        public:
            Visitor (Impl* d, ResponderOutput* o, b8* b)
                : device (d), output (o), handled (b) {}

            z0 visit (const Message::Discovery& x)                            const override { visitImpl (x); }
            z0 visit (const Message::DiscoveryResponse& x)                    const override { visitImpl (x); }
            z0 visit (const Message::InvalidateMUID& x)                       const override { visitImpl (x); }
            z0 visit (const Message::EndpointInquiry& x)                      const override { visitImpl (x); }
            z0 visit (const Message::EndpointInquiryResponse& x)              const override { visitImpl (x); }
            z0 visit (const Message::NAK& x)                                  const override { visitImpl (x); }
            z0 visit (const Message::ProfileInquiryResponse& x)               const override { visitImpl (x); }
            z0 visit (const Message::ProfileAdded& x)                         const override { visitImpl (x); }
            z0 visit (const Message::ProfileRemoved& x)                       const override { visitImpl (x); }
            z0 visit (const Message::ProfileEnabledReport& x)                 const override { visitImpl (x); }
            z0 visit (const Message::ProfileDisabledReport& x)                const override { visitImpl (x); }
            z0 visit (const Message::ProfileDetailsResponse& x)               const override { visitImpl (x); }
            z0 visit (const Message::ProfileSpecificData& x)                  const override { visitImpl (x); }
            z0 visit (const Message::PropertyExchangeCapabilitiesResponse& x) const override { visitImpl (x); }
            z0 visit (const Message::PropertyGetDataResponse& x)              const override { visitImpl (x); }
            z0 visit (const Message::PropertySetDataResponse& x)              const override { visitImpl (x); }
            z0 visit (const Message::PropertySubscribe& x)                    const override { visitImpl (x); }
            z0 visit (const Message::PropertySubscribeResponse& x)            const override { visitImpl (x); }
            z0 visit (const Message::PropertyNotify& x)                       const override { visitImpl (x); }
            using MessageVisitor::visit;
        ...
        private:
            ...
            b8 messageReceived (const Message::Discovery& body) const
            {
                const auto replyPath = u8 (output->getIncomingHeader().version) >= 0x02 ? body.outputPathID : std::byte { 0x00 };
                ...
                detail::MessageTypeUtils::send (*output, Message::DiscoveryResponse
                {
                    ...
                    u32 (device->options.getMaxSysExSize()),
                    replyPath,
            ...
            b8 messageReceived (const Message::DiscoveryResponse& response) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::InvalidateMUID& invalidate) const
            {
            ...
            b8 messageReceived (const Message::EndpointInquiry& endpoint) const
            {
            ...
            b8 messageReceived (const Message::EndpointInquiryResponse& endpoint) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::NAK& nak) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
            ...
            b8 messageReceived (const Message::ProfileInquiryResponse& response) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::ProfileAdded& added) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::ProfileRemoved& removed) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::ProfileEnabledReport& x) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
                ...
                const auto numChannels = jmax ((u16) 1, x.numChannels);
            ...
            b8 messageReceived (const Message::ProfileDisabledReport& x) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::ProfileDetailsResponse& response) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto destination = output->getIncomingHeader().deviceID;
            ...
            b8 messageReceived (const Message::ProfileSpecificData& data) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto destination = output->getIncomingHeader().deviceID;
            ...
            b8 messageReceived (const Message::PropertyExchangeCapabilitiesResponse&) const
            {
            ...
            b8 handlePropertyDataResponse (const Message::DynamicSizePropertyExchange& response) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::PropertyGetDataResponse& response) const
            {
                handlePropertyDataResponse (response);
                return true;
            }

            b8 messageReceived (const Message::PropertySetDataResponse& response) const
            {
            ...
            b8 messageReceived (const Message::PropertySubscribe& subscription) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
            ...
            b8 messageReceived (const Message::PropertySubscribeResponse& response) const
            {
                handlePropertyDataResponse (response);
                return true;
            }

            b8 messageReceived (const Message::PropertyNotify& notify) const
            {
                const auto responderMUID = output->getIncomingHeader().source;
                const auto iter = device->discovered.find (responderMUID);
    ...
    public:
        ...
        b8 hasSentMuid() const { return sentMuid; }
        z0 resetSentMuid() { sentMuid = false; }
    ...
    public:
        ...
        i32 getMaxSysexSizeForMuid (MUID m) const override
        {
            constexpr auto defaultResult = 1 << 16;

            const auto iter = device.discovered.find (m);
            return iter != device.discovered.end() ? jmin (defaultResult, (i32) iter->second.discovery.maximumSysexSize) : defaultResult;
        }
    ...
    public:
        ...
        z0 profileEnablementRequested (MUID x, ProfileAtAddress profileAtAddress, i32 numChannels, b8 enabled) override
        {
    ...
    public:
        ...
        b8 subscriptionStartRequested (MUID m, const PropertySubscriptionHeader& data) override
        {
            if (auto* d = device.options.getPropertyDelegate())
        ...
        z0 subscriptionDidStart (MUID m, const Txt& id, const PropertySubscriptionHeader& data) override
        {
            if (auto* d = device.options.getPropertyDelegate())
                d->subscriptionDidStart (m, id, data);
        }

        z0 subscriptionWillEnd (MUID m, const ci::Subscription& subscription) override
        {
            if (auto* d = device.options.getPropertyDelegate())
    ...
    std::optional<RequestKey> sendPropertySubscribe (MUID m,
                                                     ...
                                                     std::function<z0 (const PropertyExchangeResult&)> onResult) override
    {
        const auto iter = discovered.find (m);
    ...
    z0 propertySubscriptionChanged (SubscriptionKey key, const std::optional<Txt>& subscribeId) override
    {
...
z0 Device::processMessage (ump::BytesOnGroup msg) { pimpl->processMessage (msg); }
z0 Device::sendDiscovery() { pimpl->sendDiscovery(); }
z0 Device::sendEndpointInquiry (MUID destination, Message::EndpointInquiry endpoint) { pimpl->sendEndpointInquiry (destination, endpoint); }
z0 Device::sendProfileInquiry (MUID destination, ChannelInGroup address) { pimpl->sendProfileInquiry (destination, address); }
z0 Device::sendProfileDetailsInquiry (MUID destination, ChannelInGroup address, Profile profile, std::byte target)
{
    pimpl->sendProfileDetailsInquiry (destination, address, profile, target);
}
z0 Device::sendProfileSpecificData (MUID destination, ChannelInGroup address, Profile profile, Span<const std::byte> data)
{
    pimpl->sendProfileSpecificData (destination, address, profile, data);
}
z0 Device::sendProfileEnablement (MUID destination, ChannelInGroup address, Profile profile, i32 numChannels)
{
    pimpl->sendProfileEnablement (destination, address, profile, numChannels);
}
z0 Device::sendPropertyCapabilitiesInquiry (MUID destination)
{
...
z0 Device::abortPropertyRequest (RequestKey key) { pimpl->abortPropertyRequest (key); }
...
z0 Device::endSubscription (SubscriptionKey key) { pimpl->endSubscription (key); }
std::vector<SubscriptionKey> Device::getOngoingSubscriptions() const { return pimpl->getOngoingSubscriptions(); }
std::optional<Txt> Device::getSubscribeIdForKey (SubscriptionKey key) const { return pimpl->getSubscribeIdForKey (key); }
std::optional<Txt> Device::getResourceForKey (SubscriptionKey key) const { return pimpl->getResourceForKey (key); }
b8 Device::sendPendingMessages() { return pimpl->sendPendingMessages(); }

z0 Device::addListener (Listener& l) { pimpl->addListener (l); }
z0 Device::removeListener (Listener& l) { pimpl->removeListener (l); }
...
std::optional<i32> Device::getNumPropertyExchangeRequestsSupportedForMuid (MUID m) const
{
...
public:
    ...
    z0 runTest() override
    {
        ...
        struct GroupOutput
        {
            ...
            b8 operator== (const GroupOutput& other) const
            {
                const auto tie = [] (const auto& x) { return std::tie (x.group, x.bytes); };
                return tie (*this) == tie (other);
            }

            b8 operator!= (const GroupOutput& other) const { return ! operator== (other); }
        };
        ...
        {
            z0 deviceAdded   (MUID x) override { added  .push_back (x); }
            z0 deviceRemoved (MUID x) override { removed.push_back (x); }
        ...
        beginTest ("After receiving an EndpointResponse, the listener is notified");
        {
            ...
            struct EndpointListener : public DeviceListener
            {
                ...
                z0 endpointReceived (MUID, Message::EndpointInquiryResponse) override { called = true; }
        ...
        {
            z0 profileEnablementRequested (MUID, ProfileAtAddress, i32, b8) override {}
        };
        ...
        // Property exchange
        {
            ...
            {
                u8 getNumSimultaneousRequestsSupported() const override { return 1; }
                ...
                b8 subscriptionStartRequested (MUID, const PropertySubscriptionHeader&) override { return true; }
                z0 subscriptionDidStart (MUID, const Txt&, const PropertySubscriptionHeader&) override {}
                z0 subscriptionWillEnd (MUID, const Subscription&) override {}
            };
            ...
            const auto makeStatusHeader = [] (i32 status)
            {
