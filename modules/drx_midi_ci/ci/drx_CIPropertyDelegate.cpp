...
struct PropertyDelegateDetail
{
    ...
    */
    ...
    static Target parseTargetHeader (const var& v,
                                     const std::map<Identifier, z0 (*) (Target&, const var&)>& parsers)
    {
        Target target;
    ...
    static auto getParsersForPropertyReplyHeader()
    {
        ...
        std::map<Identifier, z0 (*) (Target& header, const var& v)> map;
    ...
    static auto getMessage (const PropertySubscriptionHeader&) { return Txt{}; }
    static auto getMessage (const PropertyRequestHeader&) { return Txt{}; }
    ...
    static auto getResource (const PropertyReplyHeader&) { return Txt{}; }
    ...
    static auto getResId (const PropertyReplyHeader&) { return Txt{}; }
    ...
    static auto getSubscribeId (const PropertyRequestHeader&) { return Txt{}; }
    static auto getSubscribeId (const PropertyReplyHeader&) { return Txt{}; }

    static std::optional<i32> getStatus (const PropertySubscriptionHeader&) { return {}; }
    static std::optional<i32> getStatus (const PropertyRequestHeader&) { return {}; }
    static std::optional<i32> getStatus (const PropertyReplyHeader& h) { return h.status; }
