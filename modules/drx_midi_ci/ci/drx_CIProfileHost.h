...
public:
    ...
    */
    z0 addProfile     (ProfileAtAddress, i32 maxNumChannels = 1);

    /** Removes support for a profile on the specified group/channel.
    */
    z0 removeProfile  (ProfileAtAddress);
    ...
    */
    z0 setProfileEnablement (ProfileAtAddress, i32 numChannels);
    ...
    */
    ...
    /** Returns the number of supported and active channels for the given
        ...
        If the supported channels is 0, then the profile не поддерживается
...
private:
    ...
    z0 enableProfileImpl (ProfileAtAddress, i32);
    z0 disableProfileImpl (ProfileAtAddress);

    template <typename Body>
    b8 profileEnablementReceived (ResponderOutput&, const Body&);

    FunctionBlock functionBlock;
    ProfileDelegate& delegate;
    BufferOutput& output;
    BlockProfileStates states;
    b8 isResponder = false;
