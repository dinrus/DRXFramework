...
public:
    ...
    DRX_DECLARE_NON_COPYABLE (Device)
    ...
    */
    z0 processMessage (ump::BytesOnGroup) override;
    ...
    */
    z0 sendProfileInquiry (MUID muid, ChannelInGroup address);
    ...
    */
    z0 sendProfileDetailsInquiry (MUID muid, ChannelInGroup address, Profile profile, std::byte target);

    /** Sends profile data to a particular device. */
    z0 sendProfileSpecificData (MUID muid, ChannelInGroup address, Profile profile, Span<const std::byte>);
    ...
    */
    z0 sendProfileEnablement (MUID muid, ChannelInGroup address, Profile profile, i32 numChannels);
    ...
    /** Sends a property inquiry to a particular device.
        ...
        ResourceList.
    */
    z0 sendPropertyCapabilitiesInquiry (MUID destination);
    ...
    */
    z0 abortPropertyRequest (RequestKey);
