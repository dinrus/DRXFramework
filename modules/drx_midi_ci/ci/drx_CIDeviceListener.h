...
struct DeviceListener
{
    ...
    */
    virtual z0 deviceAdded   ([[maybe_unused]] MUID x) {}
    ...
    */
    virtual z0 deviceRemoved ([[maybe_unused]] MUID x) {}
    ...
    */
    virtual z0 endpointReceived ([[maybe_unused]] MUID x,
    ...
    */
    virtual z0 messageNotAcknowledged ([[maybe_unused]] MUID x,
    ...
    */
    ...
    /** Called to indicate that data for a profile were received.
        ...
        necessary.
    */
    virtual z0 profileSpecificDataReceived ([[maybe_unused]] MUID x,
                                              [[maybe_unused]] ChannelInGroup destination,
                                              [[maybe_unused]] Profile profile,
                                              [[maybe_unused]] Span<const std::byte> data) {}
    ...
    */
    virtual z0 propertyExchangeCapabilitiesReceived ([[maybe_unused]] MUID x) {}
    ...
    */
    virtual z0 propertySubscriptionDataReceived ([[maybe_unused]] MUID x,
    ...
    */
    virtual z0 propertySubscriptionChanged ([[maybe_unused]] SubscriptionKey subscription,
                                              [[maybe_unused]] const std::optional<Txt>& subscribeId) {}
};
