...
LOCAL(z0) transencode_master_selection
	JPP((j_compress_ptr cinfo, jvirt_barray_ptr * coef_arrays));
LOCAL(z0) transencode_coef_controller
	JPP((j_compress_ptr cinfo, jvirt_barray_ptr * coef_arrays));
...
compress_output2 (j_compress_ptr cinfo, JSAMPIMAGE)
{
  ...
  i32 blkn, ci, xindex, yindex, yoffset, blockcnt;
			     ...
			     jvirt_barray_ptr * coef_arrays)
{
  ...
  jzero_far((z0 FAR *) buffer, C_MAX_BLOCKS_IN_MCU * SIZEOF(JBLOCK));
