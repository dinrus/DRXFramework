...
public:
    ...
    */
    ...
    Font (f32 fontHeight, i32 styleFlags = plain);
    ...
    */
    [[deprecated ("Use the constructor that takes a FontOptions argument")]]
    Font (const Txt& typefaceName, f32 fontHeight, i32 styleFlags);
    ...
    */
    [[deprecated ("Use the constructor that takes a FontOptions argument")]]
    Font (const Txt& typefaceName, const Txt& typefaceStyle, f32 fontHeight);
    ...
    */
    ...
    b8 operator== (const Font& other) const noexcept;
    b8 operator!= (const Font& other) const noexcept;
    ...
    */
    z0 setTypefaceName (const Txt& faceName);
    ...
    */
    z0 setPreferredFallbackFamilies (const StringArray& fallbacks);
    ...
    */
    z0 setFallbackEnabled (b8 enabled);

    /** Возвращает true, если fallback is enabled, or false otherwise. */
    b8 getFallbackEnabled() const;
    ...
    */
    static const Txt& getDefaultSansSerifFontName();
    ...
    */
    static const Txt& getSystemUIFontName();
    ...
    */
    static const Txt& getDefaultSerifFontName();
    ...
    */
    static const Txt& getDefaultMonospacedFontName();
    ...
    */
    static const Txt& getDefaultStyle();
    ...
    */
    ...
    [[nodiscard]] Font withHeight (f32 height) const;

    /** Returns a copy of this font with a new height, specified in points. */
    [[nodiscard]] Font withPointHeight (f32 heightInPoints) const;
    ...
    */
    z0 setPointHeight (f32 newHeight);
    ...
    */
    z0 setHeightWithoutChangingWidth (f32 newHeight);
    ...
    */
    i32 getStyleFlags() const noexcept;
    ...
    */
    ...
    /** Возвращает true, если the font is bold. */
    b8 isBold() const noexcept;

    /** Makes the font italic or non-italic. */
    z0 setItalic (b8 shouldBeItalic);
    /** Returns a copy of this font with the italic attribute set. */
    [[nodiscard]] Font italicised() const;
    /** Возвращает true, если the font is italic. */
    b8 isItalic() const noexcept;

    /** Makes the font underlined or non-underlined. */
    z0 setUnderline (b8 shouldBeUnderlined);
    /** Возвращает true, если the font is underlined. */
    b8 isUnderlined() const noexcept;
    ...
    */
    f32 getHorizontalScale() const noexcept;
    ...
    */
    [[nodiscard]] Font withHorizontalScale (f32 scaleFactor) const;

    /** Changes the font's horizontal scale factor.
        @param scaleFactor  a value of 1.0 is the normal scale, less than this will be
                            narrower, greater than 1.0 will be stretched out.
    */
    z0 setHorizontalScale (f32 scaleFactor);
    ...
    */
    static f32 getDefaultMinimumHorizontalScaleFactor() noexcept;
    ...
    */
    static z0 setDefaultMinimumHorizontalScaleFactor (f32 newMinimumScaleFactor) noexcept;
    ...
    */
    f32 getExtraKerningFactor() const noexcept;
    ...
    */
    [[nodiscard]] Font withExtraKerningFactor (f32 extraKerning) const;
    ...
    /** Changes the font's tracking.
        @param extraKerning     a multiple of the font's height that will be added
                                ...
                                negative values make them closer together.
    */
    z0 setExtraKerningFactor (f32 extraKerning);

    /** @see setAscentOverride() */
    std::optional<f32> getAscentOverride() const noexcept;
    ...
    /** This is designed to mirror CSS's ascent-override property.
        ...
        font's em size.
        However, the point size of the font is now found by multiplying the DRX height by the
        height-to-point factor, where this factor is equal to
        (1.0f / (ascent-in-em-units + descent-in-em-units)).
        As an example, if the DRX font height is 14, the ascent override is 0.5f, and the
    ...
    */
    z0 setAscentOverride (std::optional<f32>);

    /** @see setDescentOverride() */
    std::optional<f32> getDescentOverride() const noexcept;
    ...
    /** This is designed to mirror CSS's descent-override property.
        ...
        @see setAscentOverride()
    */
    z0 setDescentOverride (std::optional<f32>);

    //==============================================================================
    /** Changes all the font's characteristics with one call. */
    z0 setSizeAndStyle (f32 newHeight,
                          i32 newStyleFlags,
                          f32 newHorizontalScale,
                          f32 newKerningAmount);
    ...
    */
    ...
    i32 getStringWidth (const Txt& text) const;
    ...
    */
    [[deprecated ("Use GlyphArrangement or TextLayout to compute text layouts")]]
    f32 getStringWidthFloat (const Txt& text) const;
    ...
    */
    static z0 findFonts (Array<Font>& results);
    ...
    */
    ...
    /** Returns a list of all the available typeface font styles.
        ...
        font objects.
    */
    static StringArray findAllTypefaceStyles (const Txt& family);
    ...
    */
    Font findSuitableFontForText (const Txt& text, const Txt& language = {}) const;
    ...
    */
    ...
    /** Recreates a font from its stringified encoding.
        ...
        original font.
    */
    static Font fromString (const Txt& fontDescription);
...
private:
    //==============================================================================
    static b8 compare (const Font&, const Font&) noexcept;

    z0 dupeInternalIfShared();
    f32 getHeightToPointsFactor() const;
