...
struct path_builder_t
{
  ...
  {
    optional_point_t () {}
    optional_point_t (f32 x_, f32 y_) : has_data (true), x (x_), y (y_) {}
    operator b8 () const { return has_data; }
  ...
  /* based on https://github.com/RazrFalcon/ttf-parser/blob/4f32821/src/glyf.rs#L287
     ...
     * Cubic support added. */
  HB_ALWAYS_INLINE
  z0 consume_point (const contour_point_t &point)
  {
    b8 is_on_curve = point.flag & glyf_impl::SimpleGlyph::FLAG_ON_CURVE;
#ifdef HB_NO_CUBIC_GLYF
    b8 is_cubic = false;
#else
    b8 is_cubic = !is_on_curve && (point.flag & glyf_impl::SimpleGlyph::FLAG_CUBIC);
#endif
	...
	draw_session->line_to (first_oncurve.x, first_oncurve.y);
      ...
      {
	f32 x = first_offcurve.x, y = first_offcurve.y;
  ...
  b8 is_consuming_contour_points () { return true; }
