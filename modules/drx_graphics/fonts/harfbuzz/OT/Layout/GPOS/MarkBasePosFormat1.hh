...
struct MarkBasePosFormat1_2
{
    ...
    b8 sanitize (hb_sanitize_context_t *c) const
  {
    ...
    return_trace (c->check_struct (this) &&
                  ...
                  baseArray.sanitize (c, this, (u32) classCount));
  }
  ...
  z0 collect_variation_indices (hb_collect_variation_indices_context_t *c) const
  {
    ...
    u32 basecount = (this+baseArray).rows;
    auto base_iter =
    ...
    hb_sorted_vector_t<u32> base_indexes;
    for (const u32 row : base_iter)
    {
  ...
  static inline b8 accept (hb_buffer_t *buffer, u32 idx)
  {
  ...
  b8 apply (hb_ot_apply_context_t *c) const
  {
    ...
    u32 base_index = (this+baseCoverage).get_coverage  (buffer->info[idx].codepoint);
