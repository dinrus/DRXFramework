...
struct AnchorFormat3
{
  ...
  z0 get_anchor (hb_ot_apply_context_t *c, hb_codepoint_t glyph_id HB_UNUSED,
                   f32 *x, f32 *y) const
  {
  ...
  b8 subset (hb_subset_context_t *c) const
  {
    ...
    u32 x_varidx = xDeviceTable ? (this+xDeviceTable).get_variation_index () : HB_OT_LAYOUT_NO_VARIATIONS_INDEX;
    ...
    u32 y_varidx = yDeviceTable ? (this+yDeviceTable).get_variation_index () : HB_OT_LAYOUT_NO_VARIATIONS_INDEX;
