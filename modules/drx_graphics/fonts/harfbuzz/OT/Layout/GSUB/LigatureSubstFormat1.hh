...
struct LigatureSubstFormat1_2
{
  ...
  {
    u32 index = (this+coverage).get_coverage (c->glyphs[0]);
                  ...
                  hb_array_t<const HBGlyphID16> component_list /* Starting from second for each ligature */)
  {
    ...
    for (u32 i = 0; i < first_glyphs.length; i++)
    {
      u32 ligature_count = ligature_per_first_glyph_count_list[i];
  ...
  b8 subset (hb_subset_context_t *c) const
  {
    ...
    u32 coverage_idx = c->serializer->pop_pack ();
