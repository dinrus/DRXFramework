...
struct ReverseChainSingleSubstFormat1
{
  ...
  b8 serialize_coverage_offset_array (hb_subset_context_t *c, Iterator it) const
  {
  ...
  b8 serialize (hb_subset_context_t *c,
  ...
  b8 subset (hb_subset_context_t *c) const
  {
    ...
    return_trace (b8 (it) && serialize (c, it, backtrack.iter (), lookahead.iter ()));
  }
};
