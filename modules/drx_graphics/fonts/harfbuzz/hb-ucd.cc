...
static i32
_cmp_pair (ukk _key, ukk _item)
{
  zu64& a = * (zu64*) _key;
  zu64 b = (* (zu64*) _item) & HB_CODEPOINT_ENCODE3(0x1FFFFFu, 0x1FFFFFu, 0);

  return a < b ? -1 : a > b ? +1 : 0;
}
static i32
_cmp_pair_11_7_14 (ukk _key, ukk _item)
{
  u32& a = * (u32*) _key;
  u32 b = (* (u32*) _item) & HB_CODEPOINT_ENCODE3_11_7_14(0x1FFFFFu, 0x1FFFFFu, 0);
		...
		uk user_data HB_UNUSED)
{
  ...
  if ((a & 0xFFFFF800u) == 0x0000u && (b & 0xFFFFFF80) == 0x0300u)
  {
     ...
     * by "a,b" pair. */
    u32 k = HB_CODEPOINT_ENCODE3_11_7_14 (a, b, 0);
    u32k *v = hb_bsearch (k,
				    _hb_ucd_dm2_u32_map,
  ...
  else
  {
     ...
     * "a,b" pair. */
    zu64 k = HB_CODEPOINT_ENCODE3 (a, b, 0);
    const zu64 *v = hb_bsearch (k,
				    _hb_ucd_dm2_u64_map,
...
static z0 free_static_ucd_funcs ();
