...
/**
    ...
    @tags{Graphics}
*/
class DRX_API  PositionedGlyph  final
{
public:
    //==============================================================================
    PositionedGlyph() noexcept;

    PositionedGlyph (const Font& font, t32 character, i32 glyphNumber,
                     f32 anchorX, f32 baselineY, f32 width, b8 isWhitespace);

    /** Returns the character the glyph represents. */
    t32 getCharacter() const noexcept    { return character; }
    /** Checks whether the glyph is actually empty. */
    b8 isWhitespace() const noexcept          { return whitespace; }

    /** Returns the position of the glyph's left-hand edge. */
    f32 getLeft() const noexcept              { return x; }
    /** Returns the position of the glyph's right-hand edge. */
    f32 getRight() const noexcept             { return x + w; }
    /** Returns the y position of the glyph's baseline. */
    f32 getBaselineY() const noexcept         { return y; }
    /** Returns the y position of the top of the glyph. */
    f32 getTop() const                        { return y - font.getAscent(); }
    /** Returns the y position of the bottom of the glyph. */
    f32 getBottom() const                     { return y + font.getDescent(); }
    /** Returns the bounds of the glyph. */
    Rectangle<f32> getBounds() const          { return { x, getTop(), w, font.getHeight() }; }

    //==============================================================================
    /** Shifts the glyph's position by a relative amount. */
    z0 moveBy (f32 deltaX, f32 deltaY);

    //==============================================================================
    /** Draws the glyph into a graphics context.
        (Note that this may change the context's currently selected font).
    */
    z0 draw (Graphics& g) const;

    /** Draws the glyph into a graphics context, with an extra transform applied to it.
        (Note that this may change the context's currently selected font).
    */
    z0 draw (Graphics& g, AffineTransform transform) const;

    /** Returns the path for this glyph.
        @param path     the glyph's outline will be appended to this path
    */
    z0 createPath (Path& path) const;

    /** Checks to see if a point lies within this glyph. */
    b8 hitTest (f32 x, f32 y) const;
...
private:
    ...
    DRX_LEAK_DETECTOR (PositionedGlyph)
};
...
/**
    ...
    @tags{Graphics}
*/
class DRX_API  GlyphArrangement  final
{
public:
    //==============================================================================
    ...
    i32 getNumGlyphs() const noexcept                           { return glyphs.size(); }
    ...
    */
    PositionedGlyph& getGlyph (i32 index) noexcept;
    ...
    */
    z0 addLineOfText (const Font& font,
                        const Txt& text,
                        f32 x, f32 y);
    ...
    */
    z0 addCurtailedLineOfText (const Font& font,
                                 const Txt& text,
                                 f32 x, f32 y,
                                 f32 maxWidthPixels,
                                 b8 useEllipsis);
    ...
    */
    z0 addJustifiedText (const Font& font,
                           const Txt& text,
                           f32 x, f32 y,
                           f32 maxLineWidth,
    ...
    */
    z0 addFittedText (const Font& font,
                        const Txt& text,
                        f32 x, f32 y, f32 width, f32 height,
                        Justification layout,
                        i32 maximumLinesToUse,
                        f32 minimumHorizontalScale = 0.0f);

    /** Appends another glyph arrangement to this one. */
    z0 addGlyphArrangement (const GlyphArrangement&);

    /** Appends a custom glyph to the arrangement. */
    z0 addGlyph (const PositionedGlyph&);
    ...
    */
    z0 draw (const Graphics&, AffineTransform) const;
    ...
    */
    i32 findGlyphIndexAt (f32 x, f32 y) const;
    ...
    */
    Rectangle<f32> getBoundingBox (i32 startIndex, i32 numGlyphs, b8 includeWhitespace) const;
    ...
    */
    z0 moveRangeOfGlyphs (i32 startIndex, i32 numGlyphs,
    ...
    */
    z0 removeRangeOfGlyphs (i32 startIndex, i32 numGlyphs);
    ...
    */
    z0 stretchRangeOfGlyphs (i32 startIndex, i32 numGlyphs,
                               f32 horizontalScaleFactor);
    ...
    */
    z0 justifyGlyphs (i32 startIndex, i32 numGlyphs,
                        f32 x, f32 y, f32 width, f32 height,
    ...
    */
    ...
    /** This convenience function adds text to a GlyphArrangement using the specified font
        ...
        next integer.
    */
    static i32 getStringWidthInt (const Font& font, StringRef text)
    {
        return (i32) std::ceil (getStringWidth (font, text));
    }
...
private:
    ...
    z0 spreadOutLine (i32 start, i32 numGlyphs, f32 targetWidth);
    z0 drawGlyphUnderline (const Graphics&, i32, AffineTransform) const;

    DRX_LEAK_DETECTOR (GlyphArrangement)
};
