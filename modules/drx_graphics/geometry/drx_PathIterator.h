...
/**
    ...
    @tags{Graphics}
*/
class DRX_API  PathFlatteningIterator  final
{
public:
    //==============================================================================
    ...
    */
    PathFlatteningIterator (const Path& path,
                            ...
                            f32 tolerance = Path::defaultToleranceForMeasurement);
    ...
    */
    ...
    f32 x1;  /**< The x position of the start of the current line segment. */
    f32 y1;  /**< The y position of the start of the current line segment. */
    f32 x2;  /**< The x position of the end of the current line segment. */
    f32 y2;  /**< The y position of the end of the current line segment. */
    ...
    */
    ...
    /** Возвращает true, если the current segment is the last in the current sub-path. */
    b8 isLastInSubpath() const noexcept;
...
private:
    ...
    const f32* source;
    const f32 toleranceSquared;
    f32 subPathCloseX = 0, subPathCloseY = 0;
    const b8 isIdentityTransform;

    HeapBlock<f32> stackBase { 32 };
    f32* stackPos;
    size_t stackSize = 32;

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PathFlatteningIterator)
};
