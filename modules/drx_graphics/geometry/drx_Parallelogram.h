...
public:
    ...
    */
    ...
    //==============================================================================
    /** Возвращает true, если the parallelogram has an area of zero. */
    b8 isEmpty() const noexcept                                   { return topLeft == topRight || topLeft == bottomLeft || topRight == bottomLeft; }

    /** Возвращает true, если the parallelogram's coordinates are all finite numbers, i.e. not NaN or infinity. */
    inline b8 isFinite() const noexcept                           { return topLeft.isFinite() && topRight.isFinite() && bottomLeft.isFinite(); }
    ...
    //==============================================================================
    /** Возвращает true, если the two parallelograms are identical. */
    b8 operator== (const Parallelogram& other) const noexcept     { return topLeft == other.topLeft && topRight == other.topRight && bottomLeft == other.bottomLeft; }

    /** Возвращает true, если the two parallelograms are not identical. */
    b8 operator!= (const Parallelogram& other) const noexcept     { return ! operator== (other); }
