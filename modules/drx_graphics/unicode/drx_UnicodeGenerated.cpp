...
/* This file was generated with DRX-Utils/Unicode/generate_unicode_blob.py */
namespace drx
{
enum class LineBreakType : u8
{
...
enum class EastAsianWidthType : u8
{
    neutral, narrow, ambiguous, full, half, wide
};

enum class VerticalTransformType : u8
{
    r, u, tr, tu
};

enum class EmojiType : u8
{
    yes, presentation, modifier, modifierBase, component, extended, no
};

enum class BreakOpportunity : u8
{
...
public:
    ...
    static UnicodeEntry getDataForCodepoint (u32 codepoint)
    {
        ...
        return data[(i32) codepoint];
    }

private:
    static constexpr auto    uncompressedSize = 4456444;
    static constexpr u8 compressedData[]
    {
...
public:
    ...
    {
        return (BreakOpportunity) table[(i32) a][(i32) b];
    }

private:
    static constexpr u8 table[44][44]
    {
