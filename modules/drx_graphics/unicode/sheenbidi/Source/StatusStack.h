...
SB_INTERNAL z0 StatusStackInitialize(StatusStackRef stack);
SB_INTERNAL z0 StatusStackFinalize(StatusStackRef stack);
...
SB_INTERNAL z0 StatusStackPop(StatusStackRef stack);
SB_INTERNAL z0 StatusStackSetEmpty(StatusStackRef stack);
