...
#include <drx_graphics/unicode/sheenbidi/Headers/SBBase.h>
#include <drx_graphics/unicode/sheenbidi/Headers/SBBidiType.h>
#include <drx_graphics/unicode/sheenbidi/Headers/SBCodepoint.h>
...
/**
 * A value that indicates an invalid u32 index.
 */
#define SBInvalidIndex  (SBUInteger)(-1)

SB_INTERNAL z0 SBUIntegerNormalizeRange(SBUInteger actualLength,
