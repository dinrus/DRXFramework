...
#include <drx_graphics/unicode/sheenbidi/Headers/SBRun.h>
...
static z0 DisposeLineContext(LineContextRef context)
{
    free(context);
}
...
static z0 SetNewLevel(SBLevel *levels, SBUInteger length, SBLevel newLevel)
{
...
static z0 ResetLevels(LineContextRef context, SBLevel baseLevel, SBUInteger charCount)
{
...
static z0 ReverseRunSequence(SBRun *runs, SBUInteger runCount)
{
...
static z0 ReorderRuns(SBRun *runs, SBUInteger runCount, SBLevel maxLevel)
{
    SBLevel newLevel;
...
z0 SBLineRelease(SBLineRef line)
{
