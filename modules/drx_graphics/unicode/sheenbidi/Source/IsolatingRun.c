...
static z0 ResolveAvailableBracketPairs(IsolatingRunRef isolatingRun);

static z0 AttachLevelRunLinks(IsolatingRunRef isolatingRun)
{
...
static z0 AttachOriginalLinks(IsolatingRunRef isolatingRun)
{
    BidiChainRef chain = isolatingRun->bidiChain;
    LevelRunRef current;
...
static z0 ResolveNeutrals(IsolatingRunRef isolatingRun)
{
    BidiChainRef chain = isolatingRun->bidiChain;
    BidiLink roller = chain->roller;
    BidiLink link;
...
static z0 ResolveImplicitLevels(IsolatingRunRef isolatingRun)
{
    BidiChainRef chain = isolatingRun->bidiChain;
    BidiLink roller = chain->roller;
    BidiLink link;
...
SB_INTERNAL z0 IsolatingRunInitialize(IsolatingRunRef isolatingRun)
{
...
SB_INTERNAL z0 IsolatingRunFinalize(IsolatingRunRef isolatingRun)
{
