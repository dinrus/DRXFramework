...
SBScriptLocatorRef SBScriptLocatorCreate(z0)
{
...
z0 SBScriptLocatorLoadCodepoints(SBScriptLocatorRef locator, const SBCodepointSequence *codepointSequence)
{
...
static z0 ResolveScriptRun(SBScriptLocatorRef locator, SBUInteger offset)
{
...
z0 SBScriptLocatorReset(SBScriptLocatorRef locator)
{
...
z0 SBScriptLocatorRelease(SBScriptLocatorRef locator)
{
