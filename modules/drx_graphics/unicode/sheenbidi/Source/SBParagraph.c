...
static z0 PopulateBidiChain(BidiChainRef chain, const SBBidiType *types, SBUInteger length);
...
static z0 DisposeParagraphContext(ParagraphContextRef context)
{
...
static z0 DisposeParagraph(SBParagraphRef paragraph)
{
    free(paragraph);
}
...
static z0 SaveLevels(BidiChainRef chain, SBLevel *levels, SBLevel baseLevel)
{
    BidiLink roller = chain->roller;
    BidiLink link;
...
z0 SBParagraphRelease(SBParagraphRef paragraph)
{
