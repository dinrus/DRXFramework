...
SBMirrorLocatorRef SBMirrorLocatorCreate(z0)
{
...
z0 SBMirrorLocatorLoadLine(SBMirrorLocatorRef locator, SBLineRef line, uk stringBuffer)
{
...
z0 SBMirrorLocatorReset(SBMirrorLocatorRef locator)
{
    locator->_runIndex = 0;
    locator->_stringIndex = SBInvalidIndex;
...
z0 SBMirrorLocatorRelease(SBMirrorLocatorRef locator)
{
