...
static z0 BracketQueueFinalizePairs(BracketQueueRef queue, BracketQueueListRef list, SBInteger top)
{
    do {
...
SB_INTERNAL z0 BracketQueueInitialize(BracketQueueRef queue)
{
...
SB_INTERNAL z0 BracketQueueReset(BracketQueueRef queue, SBBidiType direction)
{
...
SB_INTERNAL z0 BracketQueueDequeue(BracketQueueRef queue)
{
...
SB_INTERNAL z0 BracketQueueSetStrongType(BracketQueueRef queue, SBBidiType strongType)
{
    BracketQueueListRef list = queue->_rearList;
    SBInteger top = queue->_rearTop;
...
SB_INTERNAL z0 BracketQueueClosePair(BracketQueueRef queue, BidiLink closingLink, SBCodepoint bracket)
{
    BracketQueueListRef list = queue->_rearList;
    SBInteger top = queue->_rearTop;
...
SB_INTERNAL z0 BracketQueueFinalize(BracketQueueRef queue)
{
