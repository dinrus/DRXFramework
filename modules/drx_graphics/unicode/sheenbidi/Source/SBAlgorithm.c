...
static z0 DisposeAlgorithm(SBAlgorithmRef algorithm)
{
    free(algorithm);
}

static z0 DetermineBidiTypes(const SBCodepointSequence *sequence, SBBidiType *types)
{
...
z0 SBAlgorithmGetParagraphBoundary(SBAlgorithmRef algorithm,
...
z0 SBAlgorithmRelease(SBAlgorithmRef algorithm)
{
