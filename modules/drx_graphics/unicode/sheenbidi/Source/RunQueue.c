...
static z0 FindPreviousPartialRun(RunQueueRef queue)
{
...
SB_INTERNAL z0 RunQueueInitialize(RunQueueRef queue)
{
...
SB_INTERNAL z0 RunQueueDequeue(RunQueueRef queue)
{
...
SB_INTERNAL z0 RunQueueFinalize(RunQueueRef queue)
{
