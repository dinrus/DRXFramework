...
/**
 * A type to represent an 8-bit u32 integer.
 */
typedef u8                     SBUInt8;

/**
 * A type to represent a 16-bit u32 integer.
 */
typedef u16                    SBUInt16;

/**
 * A type to represent a 32-bit u32 integer.
 */
typedef u32                    SBUInt32;
...
/**
 * An u32 integer type whose width is equal to the width of the machine word.
 */
