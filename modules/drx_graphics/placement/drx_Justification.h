...
public:
    ...
    Justification (i32 justificationFlags) noexcept   : flags (justificationFlags) {}
    ...
    b8 operator== (const Justification& other) const noexcept     { return flags == other.flags; }
    b8 operator!= (const Justification& other) const noexcept     { return flags != other.flags; }
    ...
    */
    ...
    i32 getOnlyVerticalFlags() const noexcept                   { return flags & (top | bottom | verticallyCentred); }

    /** Returns just the flags from this object that deal with horizontal layout. */
    i32 getOnlyHorizontalFlags() const noexcept                 { return flags & (left | right | horizontallyCentred | horizontallyJustified); }
    ...
    */
    ...
    z0 applyToRectangle (ValueType& x, ValueType& y, ValueType w, ValueType h,
