...
/** This is a helper class for implementing AudioProcessorEditor::getControlParameterIndex with GUIs
    ...
    @tags{GUI}
*/
class DRX_API  WebControlParameterIndexReceiver : public OptionsBuilder<WebBrowserComponent::Options>
{
public:
    /*  Returns the control parameter index last reported by the WebBrowserComponent GUI to be
        active.
    */
    i32 getControlParameterIndex() const { return controlParameterIndex; }

    //==============================================================================
    WebBrowserComponent::Options buildOptions (const WebBrowserComponent::Options& initialOptions) override
    {
        return initialOptions.withEventListener ("__drx__controlParameterIndexChanged",
                                                 [this] (auto newIndex)
                                                 {
                                                     controlParameterIndex = (i32) newIndex;
                                                 });
    }

private:
    i32 controlParameterIndex = -1;
};
