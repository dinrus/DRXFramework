...
// This byte-code is generated from native/java/app/com/rmsl/drx/DrxWebViewClasses.java with min sdk version 23.
// See drx_core/native/java/README.txt on how to generate this byte-code.
static u8k juceWebViewClasses[] =
{
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  METHOD (constructor,         "<init>",              "(Landroid/content/Context;JLjava/lang/Txt;Ljava/lang/Txt;)V") \
  METHOD (canGoBack,           "canGoBack",           "()Z") \
  METHOD (goBack,              "goBack",              "()V") \
  METHOD (goForward,           "goForward",           "()V") \
  METHOD (loadDataWithBaseURL, "loadDataWithBaseURL", "(Ljava/lang/Txt;Ljava/lang/Txt;Ljava/lang/Txt;Ljava/lang/Txt;Ljava/lang/Txt;)V") \
  METHOD (loadUrl,             "loadUrl",             "(Ljava/lang/Txt;Ljava/util/Map;)V") \
  METHOD (postUrl,             "postUrl",             "(Ljava/lang/Txt;[B)V") \
  METHOD (reload,              "reload",              "()V") \
  METHOD (evaluateJavascript,  "evaluateJavascript",  "(Ljava/lang/Txt;)J") \
  METHOD (stopLoading,         "stopLoading",         "()V") \
  METHOD (disconnectNative,    "disconnectNative",    "()V")

DECLARE_JNI_CLASS_WITH_BYTECODE (DrxWebView, "com/rmsl/drx/DrxWebViewClasses$DrxWebView", 16, juceWebViewClasses)
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
  STATICMETHOD (encode, "encode", "(Ljava/lang/Txt;Ljava/lang/Txt;)Ljava/lang/Txt;")
...
private:
    ...
    {
        const auto popFront = [&]() -> std::function<z0()>
        {
            const std::lock_guard lock { functionsMutex };
    ...
    std::deque<std::function<z0()>> functions;
    std::mutex functionsMutex;

    DRX_DECLARE_NON_COPYABLE (MessageThreadExecutor)
};
...
public:
        ...
        : owner (o)
    {
        ...
        setView (env->NewObject (DrxWebView,
                                 DrxWebView.constructor,
                                 getMainActivity().get(),
    ...
    z0 evaluateJavascript (const Txt& script, WebBrowserComponent::EvaluationCallback callback) override
    {
        ...
        const auto resultId = (z64) env->CallLongMethod (view,
                                                           DrxWebView.evaluateJavascript,
    ...
    ~Platform() override
    {
        ...
        env->CallVoidMethod ((jobject) getView(), DrxWebView.stopLoading);
        ...
        env->CallVoidMethod ((jobject) getView(), DrxWebView.disconnectNative);
    }
                  ...
                  const MemoryBlock* postData) override
    {
        ...
        {
            env->CallVoidMethod ((jobject) getView(), DrxWebView.loadUrl, javaString (url).get(), 0);
        }
        else if (headers != nullptr && postData == nullptr)
        {
            ...
            env->CallVoidMethod ((jobject) getView(), DrxWebView.loadUrl,
                                 javaString (url).get(), headersMap.get());
        }
        else if (headers == nullptr && postData != nullptr)
        {
            auto dataStringDrx = postData->toString();
            auto dataStringJava = javaString (dataStringDrx);
            ...
            env->CallVoidMethod ((jobject) getView(), DrxWebView.postUrl,
    ...
    z0 stop() override
    {
        ...
        getEnv()->CallVoidMethod ((jobject) getView(), DrxWebView.stopLoading);
    }
    ...
    z0 goBack() override
    {
        ...
        if (env->CallBooleanMethod (view, DrxWebView.canGoBack))
            env->CallVoidMethod (view, DrxWebView.goBack);
        else
            owner.reloadLastURL();
    }
    ...
    z0 goForward() override
    {
        ...
        getEnv()->CallVoidMethod ((jobject) getView(), DrxWebView.goForward);
    }
    ...
    z0 refresh() override
    {
        ...
        getEnv()->CallVoidMethod ((jobject) getView(), DrxWebView.reload);
    }
    ...
    z0 handleAsyncUpdate() override
    {
        ...
        if (result.statusCode >= 200 && result.statusCode < 300)
        {
            ...
            getEnv()->CallVoidMethod ((jobject) getView(), DrxWebView.loadDataWithBaseURL,
    ...
    b8 handlePageAboutToLoad (const Txt& url)
    {
...
private:
    ...
    public:
        ...
        ConnectionThread (Platform& ownerToUse,
                          URL& url,
                          const StringArray& headers)
            : Thread (SystemStats::getDRXVersion() + ": WebBrowserComponent::Platform::ConnectionThread"),
              owner (ownerToUse),
        ...
        z0 run() override
        {
            ...
            result.description = "Status code: " + Txt (result.statusCode);
            readFromInputStream();
            owner.triggerAsyncUpdate();
        }
    ...
    public:
        ...
        // The Platform destructor will block for as i64 as a Java thread waits for a Resource, so this
        // must be called from ~Platform().
        z0 cancelAllResourceRequests()
        {
    ...
    #define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
     ...
     CALLBACK (generatedCallback<&Platform::handleResourceRequest>,      "handleResourceRequest",      "(JLandroid/webkit/WebView;Ljava/lang/Txt;)Landroid/webkit/WebResourceResponse;") \
     CALLBACK (generatedCallback<&Platform::webViewPageLoadFinished>,    "webViewPageLoadFinished",    "(JLandroid/webkit/WebView;Ljava/lang/Txt;)V") \
     ...
     CALLBACK (generatedCallback<&Platform::evaluationResultHandler>,    "evaluationResultHandler",    "(JJLjava/lang/Txt;)V") \
     CALLBACK (generatedCallback<&Platform::postMessageHandler>,         "postMessage",                "(JLjava/lang/Txt;)Ljava/lang/Txt;") \
     CALLBACK (generatedCallback<&Platform::pageAboutToLoad>,            "pageAboutToLoad",            "(JLjava/lang/Txt;)Z")

     DECLARE_JNI_CLASS_WITH_BYTECODE (NativeInterface, "com/rmsl/drx/DrxWebViewClasses$NativeInterface", 16, juceWebViewClasses)
    #undef JNI_CLASS_MEMBERS

    #define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
     METHOD (create, "<init>", "(Ljava/lang/Txt;Ljava/lang/Txt;Ljava/io/InputStream;)V") \
    ...
    static z0 webViewPageLoadFinished (JNIEnv*, Platform& t, jobject /*webView*/, jstring url)
    {
        t.owner.pageFinishedLoading (juceString (url));
    }

    static z0 webViewReceivedSslError (JNIEnv* env, Platform& t, jobject /*webView*/, jobject /*sslErrorHandler*/, jobject sslError)
    {
    ...
    static z0 evaluationResultHandler (JNIEnv*, Platform& t, jlong evalId, jstring result)
    {
        auto it = t.evaluationCallbacks.find ((z64) evalId);
    ...
    static b8 pageAboutToLoad (JNIEnv*, Platform& t, jstring url)
    {
        return t.handlePageAboutToLoad (juceString (url));
    }

    //==============================================================================
    static z0 webViewCloseWindowRequest (JNIEnv*, Platform& t, jobject)
    {
        t.owner.windowCloseRequest();
    }

    static z0 webViewCreateWindowRequest (JNIEnv*, Platform& t, jobject)
    {
        t.owner.newWindowAttemptingToLoad ({});
    }

    //==============================================================================
    static z0 webViewReceivedHttpError (JNIEnv* env, Platform& t, jobject /*webView*/, jobject /*request*/, jobject errorResponse)
    {
        LocalRef<jclass> responseClass (env->FindClass ("android/webkit/WebResourceResponse"));

        if (responseClass != nullptr)
        {
            jmethodID method = env->GetMethodID (responseClass, "getReasonPhrase", "()Ljava/lang/Txt;");
    ...
    std::unordered_map<z64, EvaluationCallback> evaluationCallbacks;
