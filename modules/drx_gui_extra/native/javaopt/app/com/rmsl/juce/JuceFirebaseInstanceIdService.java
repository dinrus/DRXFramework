...
public final class DrxFirebaseInstanceIdService extends FirebaseInstanceIdService
{
    private native z0 firebaseInstanceIdTokenRefreshed (String token);

    @Override
    public z0 onTokenRefresh()
    {
