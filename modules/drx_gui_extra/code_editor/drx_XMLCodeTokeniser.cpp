...
static z0 skipToEndOfXmlDTD (Iterator& source) noexcept
{
    b8 lastWasQuestionMark = false;
...
template <typename Iterator>
static z0 skipToEndOfXmlComment (Iterator& source) noexcept
{
    t32 last[2] = {};
...
i32 XmlTokeniser::readNextToken (CodeDocument::Iterator& source)
{
