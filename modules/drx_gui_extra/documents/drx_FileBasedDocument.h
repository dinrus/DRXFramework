...
/**
    ...
    @tags{GUI}
*/
class DRX_API FileBasedDocument  : public ChangeBroadcaster
{
public:
    ...
    */
    FileBasedDocument (const Txt& fileExtension,
    ...
    //==============================================================================
    /** Возвращает true, если the changed() method has been called since the file was
    ...
    */
    z0 loadFromAsync (const File& fileToLoadFrom,
                        b8 showMessageOnFailure,
    ...
    */
    ...
    /** Asks the user for a file and tries to load it.
        ...
        @see loadFrom
    */
    z0 loadFromUserSpecifiedFileAsync (b8 showMessageOnFailure, std::function<z0 (Result)> callback);
    ...
    */
    SaveResult save (b8 askUserForFileIfNotSpecified,
                     b8 showMessageOnFailure);
   #endif
    ...
    */
    SaveResult saveAsInteractive (b8 warnAboutOverwritingExistingFiles);
   #endif
...
protected:
    ...
    /** Overload this to return the title of the document.
        ...
        something sensible.
    */
    virtual Txt getDocumentTitle() = 0;
    ...
    */
    virtual z0 loadDocumentAsync (const File& file, std::function<z0 (Result)> callback);
    ...
    */
    virtual z0 saveDocumentAsync (const File& file, std::function<z0 (Result)> callback);
    ...
    */
    ...
    /** This is used for dialog boxes to make them open at the last folder you
        ...
        @see RecentlyOpenedFilesList
    */
    virtual z0 setLastDocumentOpened (const File& file) = 0;
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FileBasedDocument)
};
