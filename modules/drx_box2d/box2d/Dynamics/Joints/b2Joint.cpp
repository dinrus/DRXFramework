...
b2Joint* b2Joint::Create(const b2JointDef* def, b2BlockAllocator* allocator)
{
	...
	case e_distanceJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2DistanceJoint));
	...
	case e_mouseJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2MouseJoint));
	...
	case e_prismaticJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2PrismaticJoint));
	...
	case e_revoluteJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2RevoluteJoint));
	...
	case e_pulleyJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2PulleyJoint));
	...
	case e_gearJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2GearJoint));
	...
	case e_wheelJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2WheelJoint));
	...
	case e_weldJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2WeldJoint));
	...
	case e_frictionJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2FrictionJoint));
	...
	case e_ropeJoint:
		{
			uk mem = allocator->Allocate(sizeof(b2RopeJoint));
...
z0 b2Joint::Destroy(b2Joint* joint, b2BlockAllocator* allocator)
{
	joint->~b2Joint();
	switch (joint->m_type)
	{
