...
z0 b2RevoluteJointDef::Initialize(b2Body* bA, b2Body* bB, const b2Vec2& anchor)
{
	bodyA = bA;
	bodyB = bB;
...
z0 b2RevoluteJoint::InitVelocityConstraints(const b2SolverData& data)
{
...
z0 b2RevoluteJoint::SolveVelocityConstraints(const b2SolverData& data)
{
	b2Vec2 vA = data.velocities[m_indexA].v;
	float32 wA = data.velocities[m_indexA].w;
	b2Vec2 vB = data.velocities[m_indexB].v;
...
b8 b2RevoluteJoint::SolvePositionConstraints(const b2SolverData& data)
{
	...
	b8 fixedRotation = (m_invIA + m_invIB == 0.0f);
...
b8 b2RevoluteJoint::IsMotorEnabled() const
{
	return m_enableMotor;
}

z0 b2RevoluteJoint::EnableMotor(b8 flag)
{
...
z0 b2RevoluteJoint::SetMotorSpeed(float32 speed)
{
	m_bodyA->SetAwake(true);
	m_bodyB->SetAwake(true);
	m_motorSpeed = speed;
...
z0 b2RevoluteJoint::SetMaxMotorTorque(float32 torque)
{
	m_bodyA->SetAwake(true);
	m_bodyB->SetAwake(true);
...
b8 b2RevoluteJoint::IsLimitEnabled() const
{
	return m_enableLimit;
}

z0 b2RevoluteJoint::EnableLimit(b8 flag)
{
...
z0 b2RevoluteJoint::SetLimits(float32 lower, float32 upper)
{
