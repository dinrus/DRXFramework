...
z0 b2GearJoint::InitVelocityConstraints(const b2SolverData& data)
{
...
z0 b2GearJoint::SolveVelocityConstraints(const b2SolverData& data)
{
	b2Vec2 vA = data.velocities[m_indexA].v;
	float32 wA = data.velocities[m_indexA].w;
	b2Vec2 vB = data.velocities[m_indexB].v;
...
b8 b2GearJoint::SolvePositionConstraints(const b2SolverData& data)
{
...
z0 b2GearJoint::SetRatio(float32 ratio)
{
