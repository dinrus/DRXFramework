...
z0 b2ContactSolver::InitializeVelocityConstraints()
{
	for (i32 i = 0; i < m_count; ++i)
	{
		b2ContactVelocityConstraint* vc = m_velocityConstraints + i;
...
z0 b2ContactSolver::SolveVelocityConstraints()
{
	for (i32 i = 0; i < m_count; ++i)
	{
		b2ContactVelocityConstraint* vc = m_velocityConstraints + i;
...
z0 b2ContactSolver::StoreImpulses()
{
	for (i32 i = 0; i < m_count; ++i)
	{
		b2ContactVelocityConstraint* vc = m_velocityConstraints + i;
...
{
	z0 Initialize(b2ContactPositionConstraint* pc, const b2Transform& xfA, const b2Transform& xfB, i32 index)
	{
...
// Sequential solver.
b8 b2ContactSolver::SolvePositionConstraints()
{
...
b8 b2ContactSolver::SolveTOIPositionConstraints(i32 toiIndexA, i32 toiIndexB)
{
	float32 minSeparation = 0.0f;
