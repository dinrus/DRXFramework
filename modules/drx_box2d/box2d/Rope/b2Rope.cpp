...
z0 b2Rope::Initialize(const b2RopeDef* def)
{
	...
	i32 count2 = m_count - 1;
	i32 count3 = m_count - 2;
...
z0 b2Rope::Step(float32 h, i32 iterations)
{
	if (h == 0.0)
	{
		return;
...
z0 b2Rope::SetAngle(float32 angle)
{
	i32 count3 = m_count - 2;
	for (i32 i = 0; i < count3; ++i)
	{
...
z0 b2Rope::Draw(b2Draw* draw) const
{
