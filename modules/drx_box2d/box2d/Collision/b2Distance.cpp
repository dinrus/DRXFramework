...
z0 b2DistanceProxy::Set(const b2Shape* shape, i32 index)
{
...
struct b2Simplex
{
	z0 ReadCache(	const b2SimplexCache* cache,
	...
	z0 WriteCache(b2SimplexCache* cache) const
	{
	...
	z0 GetWitnessPoints(b2Vec2* pA, b2Vec2* pB) const
	{
		switch (m_count)
		{
		case 0:
