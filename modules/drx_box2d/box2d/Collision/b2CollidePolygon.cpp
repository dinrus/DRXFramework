...
static float32 b2EdgeSeparation(const b2PolygonShape* poly1, const b2Transform& xf1, i32 edge1,
							  const b2PolygonShape* poly2, const b2Transform& xf2)
{
	const b2Vec2* vertices1 = poly1->m_vertices;
	const b2Vec2* normals1 = poly1->m_normals;

	i32 count2 = poly2->m_vertexCount;
...
static float32 b2FindMaxSeparation(i32* edgeIndex,
								 const b2PolygonShape* poly1, const b2Transform& xf1,
								 const b2PolygonShape* poly2, const b2Transform& xf2)
{
	i32 count1 = poly1->m_vertexCount;
	const b2Vec2* normals1 = poly1->m_normals;
...
static z0 b2FindIncidentEdge(b2ClipVertex c[2],
							 const b2PolygonShape* poly1, const b2Transform& xf1, i32 edge1,
							 const b2PolygonShape* poly2, const b2Transform& xf2)
{
	const b2Vec2* normals1 = poly1->m_normals;
