...
b2DynamicTree::b2DynamicTree()
{
	...
	memset((uk)m_nodes, 0, m_nodeCapacity * sizeof(b2TreeNode));
...
z0 b2DynamicTree::FreeNode(i32 nodeId)
{
...
// the node pool.
i32 b2DynamicTree::CreateProxy(const b2AABB& aabb, uk userData)
{
...
z0 b2DynamicTree::DestroyProxy(i32 proxyId)
{
...
b8 b2DynamicTree::MoveProxy(i32 proxyId, const b2AABB& aabb, const b2Vec2& displacement)
{
	b2Assert(0 <= proxyId && proxyId < m_nodeCapacity);
...
z0 b2DynamicTree::InsertLeaf(i32 leaf)
{
	++m_insertionCount;
...
z0 b2DynamicTree::RemoveLeaf(i32 leaf)
{
	if (leaf == m_root)
	{
		m_root = b2_nullNode;
...
z0 b2DynamicTree::ValidateStructure(i32 index) const
{
...
z0 b2DynamicTree::ValidateMetrics(i32 index) const
{
	if (index == b2_nullNode)
	{
		return;
...
z0 b2DynamicTree::Validate() const
{
...
z0 b2DynamicTree::RebuildBottomUp()
{
