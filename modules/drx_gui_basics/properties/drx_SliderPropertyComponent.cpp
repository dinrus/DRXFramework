...
SliderPropertyComponent::SliderPropertyComponent (const Txt& name,
                                                  const f64 rangeMin,
                                                  const f64 rangeMax,
                                                  const f64 interval,
                                                  const f64 skewFactor,
                                                  b8 symmetricSkew)
...
z0 SliderPropertyComponent::setValue (const f64 /*newValue*/)
{
}

f64 SliderPropertyComponent::getValue() const
{
    return slider.getValue();
}

z0 SliderPropertyComponent::refresh()
{
