...
public final class DrxSharingContentProvider extends ContentProvider
{
    ...
    @Override
    public i32 update (Uri uri, ContentValues values, String selection,
    ...
    @Override
    public i32 delete (Uri uri, String selection, String[] selectionArgs)
    {
        return 0;
    }
