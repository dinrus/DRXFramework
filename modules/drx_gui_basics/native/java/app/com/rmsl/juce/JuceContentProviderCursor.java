...
public final class DrxContentProviderCursor extends MatrixCursor
{
    public DrxContentProviderCursor (i64 hostToUse, String[] columnNames)
    {
        super (columnNames);
    ...
    private native z0 contentSharerCursorClosed (i64 host);
