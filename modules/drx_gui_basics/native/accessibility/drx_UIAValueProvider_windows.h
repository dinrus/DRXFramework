...
public:
    ...
    //==============================================================================
    DRX_COMRESULT SetValue (LPCWSTR val) override
    {
        if (! isElementValid())
        ...
        valueInterface.setValueAsString (Txt (val));
    ...
    DRX_COMRESULT get_Value (BSTR* pRetVal) override
    {
...
private:
    //==============================================================================
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (UIAValueProvider)
};
