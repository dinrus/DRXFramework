...
i32 AccessibilityNativeHandle::idCounter = 0;
...
public:
    ...
    DRX_COMCALL Scroll (ScrollAmount, ScrollAmount) override { return E_FAIL; }
    DRX_COMCALL SetScrollPercent (f64, f64) override { return E_FAIL; }
    DRX_COMCALL get_HorizontalScrollPercent (f64*) override { return E_FAIL; }
    DRX_COMCALL get_VerticalScrollPercent (f64*) override { return E_FAIL; }
    DRX_COMCALL get_HorizontalViewSize (f64*) override { return E_FAIL; }
    DRX_COMCALL get_VerticalViewSize (f64*) override { return E_FAIL; }
    DRX_COMCALL get_HorizontallyScrollable (BOOL*) override { return E_FAIL; }
    DRX_COMCALL get_VerticallyScrollable (BOOL*) override { return E_FAIL; }

private:
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (UIAScrollProvider)
};
...
public:
    ...
    DRX_COMCALL ScrollIntoView() override
    {
...
private:
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (UIAScrollItemProvider)
};

//==============================================================================
static Txt getAutomationId (const AccessibilityHandler& handler)
{
...
//==============================================================================
DRX_COMRESULT AccessibilityNativeHandle::QueryInterface (REFIID refId, uk* result)
{
    *result = nullptr;
...
//==============================================================================
DRX_COMRESULT AccessibilityNativeHandle::get_HostRawElementProvider (IRawElementProviderSimple** pRetVal)
{
...
DRX_COMRESULT AccessibilityNativeHandle::get_ProviderOptions (ProviderOptions* options)
{
    if (options == nullptr)
        return E_INVALIDARG;
...
DRX_COMRESULT AccessibilityNativeHandle::GetPatternProvider (PATTERNID pId, IUnknown** pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
        *pRetVal = [&]() -> IUnknown*
...
DRX_COMRESULT AccessibilityNativeHandle::GetPropertyValue (PROPERTYID propertyId, VARIANT* pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
        ...
        switch (propertyId)
        {
            ...
            case UIA_FrameworkIdPropertyId:
                VariantHelpers::setString ("DRX", pRetVal);
                break;
            ...
            case UIA_ProcessIdPropertyId:
                VariantHelpers::setInt ((i32) GetCurrentProcessId(), pRetVal);
                break;
            case UIA_NativeWindowHandlePropertyId:
                if (isFragmentRoot())
                    VariantHelpers::setInt ((i32) (pointer_sized_int) accessibilityHandler.getComponent().getWindowHandle(), pRetVal);
...
//==============================================================================
DRX_COMRESULT AccessibilityNativeHandle::Navigate (NavigateDirection direction, IRawElementProviderFragment** pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
...
DRX_COMRESULT AccessibilityNativeHandle::GetRuntimeId (SAFEARRAY** pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
        if (! isFragmentRoot())
...
DRX_COMRESULT AccessibilityNativeHandle::get_BoundingRectangle (UiaRect* pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
...
DRX_COMRESULT AccessibilityNativeHandle::GetEmbeddedFragmentRoots (SAFEARRAY** pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, []
    {
        return S_OK;
...
DRX_COMRESULT AccessibilityNativeHandle::SetFocus()
{
    if (! isElementValid())
        return (HRESULT) UIA_E_ELEMENTNOTAVAILABLE;
...
DRX_COMRESULT AccessibilityNativeHandle::get_FragmentRoot (IRawElementProviderFragmentRoot** pRetVal)
{
...
//==============================================================================
DRX_COMRESULT AccessibilityNativeHandle::ElementProviderFromPoint (f64 x, f64 y, IRawElementProviderFragment** pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
        auto* handler = [&]
        {
            auto logicalScreenPoint = Desktop::getInstance().getDisplays()
                                        .physicalToLogical (Point<i32> (roundToInt (x),
                                                                        roundToInt (y)));
...
DRX_COMRESULT AccessibilityNativeHandle::GetFocus (IRawElementProviderFragment** pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
...
DRX_COMRESULT AccessibilityNativeHandle::GetOverrideProviderForHwnd (HWND hwnd, IRawElementProviderSimple** pRetVal)
{
    return withCheckedComArgs (pRetVal, *this, [&]
    {
...
//==============================================================================
Txt AccessibilityNativeHandle::getElementName() const
{
