...
struct AccessibilityTextHelpers
{
    ...
    */
    ...
    public:
        ...
        constexpr b8 operator== (const CharPtrIteratorAdapter& other) const { return ptr == other.ptr; }
        constexpr b8 operator!= (const CharPtrIteratorAdapter& other) const { return ptr != other.ptr; }
    ...
    */
    ...
    static i32 countDifference (Iter from, Iter to)
    {
        i32 distance = 0;
    ...
    */
    template <typename CharPtr>
    static i32 findNextWordEndOffset (CharPtr beginIn,
                                      CharPtr endIn,
                                      CharPtr ptrIn,
                                      Direction direction,
                                      ...
                                      IncludeWhitespaceAfterWords includeWhitespace)
    {
        ...
        {
            const auto isSpace = [] (t32 c) { return CharacterFunctions::isWhitespace (c); };
    ...
    */
    template <typename CharPtr>
    static i32 findNextLineOffset (CharPtr beginIn,
                                   CharPtr endIn,
                                   CharPtr ptrIn,
                                   Direction direction,
                                   IncludeThisBoundary includeBoundary)
    {
        ...
        const auto findNewline = [] (auto from, auto to) { return std::find (from, to, t32 { '\n' }); };
    ...
    */
    static i32 findTextBoundary (const AccessibilityTextInterface& textInterface,
                                 i32 currentPosition,
    ...
    /*  Adjusts the current text selection range, using an algorithm appropriate for cursor movement
        on Android.
    */
    static Range<i32> findNewSelectionRangeAndroid (const AccessibilityTextInterface& textInterface,
                                                    ...
                                                    Direction direction)
    {
        ...
        return Range<i32>::between (cursorPos, oldPos == start ? end : start);
    }
};
