...
public:
    ...
    static z0 showInWindow (PlatformSpecificHandle* handle, ComponentPeer*)
    {
        auto c = [&]
        {
...
private:
    ...
    static NSCursor* fromHIServices (tukk filename)
    {
        DRX_AUTORELEASEPOOL
        {
            auto cursorPath = Txt ("/System/Library/Frameworks/ApplicationServices.framework/Versions/A/Frameworks/"
            ...
            for (i32 scale = 1; scale <= 4; ++scale)
            {
                NSAffineTransform* scaleTransform = [NSAffineTransform transform];
                [scaleTransform scaleBy: (f32) scale];
            ...
            auto hotspotX = (f32) [[info valueForKey: nsStringLiteral ("hotx")] doubleValue];
            auto hotspotY = (f32) [[info valueForKey: nsStringLiteral ("hoty")] doubleValue];
...
public:
    ...
    static z0 showInWindow (PlatformSpecificHandle*, ComponentPeer*)  {}
};
