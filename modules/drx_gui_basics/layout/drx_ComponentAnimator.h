...
/**
    ...
    @tags{GUI}
*/
class DRX_API  ComponentAnimator  : public ChangeBroadcaster,
                                     private Timer
{
public:
    //==============================================================================
    ...
    /** Starts a component moving from its current position to a specified position.
        ...
        @param animationDurationMilliseconds    how i64 the animation should last, in milliseconds
    ...
    */
    z0 animateComponent (Component* component,
                           const Rectangle<i32>& finalBounds,
                           f32 finalAlpha,
                           i32 animationDurationMilliseconds,
    ...
    */
    z0 cancelAnimation (Component* component,
                          b8 moveComponentToItsFinalPosition);
    ...
    */
    z0 cancelAllAnimations (b8 moveComponentsToTheirFinalPositions);
    ...
    */
    Rectangle<i32> getComponentDestination (Component* component);

    /** Возвращает true, если the specified component is currently being animated. */
    b8 isAnimating (Component* component) const noexcept;

    /** Возвращает true, если any components are currently being animated. */
    b8 isAnimating() const noexcept;
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ComponentAnimator)
};
