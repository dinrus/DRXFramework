...
//==============================================================================
b8 ResizableEdgeComponent::isVertical() const noexcept
{
    return edge == leftEdge || edge == rightEdge;
}

z0 ResizableEdgeComponent::paint (Graphics& g)
{
    getLookAndFeel().drawStretchableLayoutResizerBar (g, getWidth(), getHeight(), isVertical(),
                                                      isMouseOver(), isMouseButtonDown());
}

z0 ResizableEdgeComponent::mouseDown (const MouseEvent& e)
{
...
z0 ResizableEdgeComponent::mouseDrag (const MouseEvent& e)
{
    if (component == nullptr)
    {
        jassertfalse; // You've deleted the component that this resizer was supposed to be using!
...
z0 ResizableEdgeComponent::mouseUp (const MouseEvent&)
{
    if (constrainer != nullptr)
