...
/**
    ...
    @tags{GUI}
*/
class DRX_API  BorderedComponentBoundsConstrainer : public ComponentBoundsConstrainer
{
public:
    /** Default constructor. */
    ...
    */
    ...
    virtual BorderSize<i32> getAdditionalBorder() const = 0;
    ...
    z0 checkBounds (Rectangle<i32>& bounds,
                      ...
                      b8 isStretchingRight) override;

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BorderedComponentBoundsConstrainer)
};
