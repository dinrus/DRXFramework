...
//==============================================================================
z0 StretchableLayoutResizerBar::paint (Graphics& g)
{
...
z0 StretchableLayoutResizerBar::mouseDown (const MouseEvent&)
{
    mouseDownPos = layout->getItemCurrentPosition (itemIndex);
}

z0 StretchableLayoutResizerBar::mouseDrag (const MouseEvent& e)
{
    i32k desiredPos = mouseDownPos + (isVertical ? e.getDistanceFromDragStartX()
...
z0 StretchableLayoutResizerBar::hasBeenMoved()
{
