...
ToggleButton::ToggleButton (const Txt& buttonText)
    : Button (buttonText)
{
    setClickingTogglesState (true);
}
...
z0 ToggleButton::paintButton (Graphics& g, b8 shouldDrawButtonAsHighlighted, b8 shouldDrawButtonAsDown)
{
    getLookAndFeel().drawToggleButton (g, *this, shouldDrawButtonAsHighlighted, shouldDrawButtonAsDown);
}

z0 ToggleButton::changeWidthToFitText()
{
    getLookAndFeel().changeToggleButtonWidthToFitText (*this);
}

z0 ToggleButton::colourChanged()
{
    repaint();
}
