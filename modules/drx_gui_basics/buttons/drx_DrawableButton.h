...
/**
    ...
    @tags{GUI}
*/
class DRX_API  DrawableButton  : public Button
{
public:
    //==============================================================================
    enum ButtonStyle
    ...
    */
    DrawableButton (const Txt& buttonName,
    ...
    */
    z0 setImages (const Drawable* normalImage,
    ...
    /** Changes the button's style.
        @see ButtonStyle
    */
    z0 setButtonStyle (ButtonStyle newStyle);
    ...
    */
    z0 setEdgeIndent (i32 numPixelsIndent);

    /** Returns the current edge indent size. */
    i32 getEdgeIndent() const noexcept          { return edgeIndent; }
    ...
    virtual Rectangle<f32> getImageBounds() const;
    ...
    /** A set of colour IDs to use to change the colour of various aspects of the link.
        ...
        the button colour are TextButton::buttonColorId and TextButton::buttonOnColorId.

        @see Component::setColor, Component::findColor, LookAndFeel::setColor, LookAndFeel::findColor
    */
    enum ColorIds
    {
        textColorId             = 0x1004010,  /**< The colour to use for the button's text label. */
        textColorOnId           = 0x1004013,  /**< The colour to use for the button's text when the button's toggle state is "on". */

        backgroundColorId       = 0x1004011,  /**< The colour used to fill the button's background (when
        ...
        backgroundOnColorId     = 0x1004012,  /**< The colour used to fill the button's background (when
...
private:
    //==============================================================================
    b8 shouldDrawButtonBackground() const  { return style == ImageOnButtonBackground || style == ImageOnButtonBackgroundOriginalSize; }
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DrawableButton)
};
