...
/** Creates and displays a popup-menu.
    ...
    E.g. @code
    z0 MyWidget::mouseDown (const MouseEvent& e)
    {
        PopupMenu m;
        m.addItem (1, "item 1");
        m.addItem (2, "item 2");
...
public:
    ...
    */
    ...
    /** Adds an item that represents one of the commands in a command manager object.
        ...
        @param iconToUse            an optional Drawable object to use as the icon to the left of the item.
                                    ...
                                    delete it later when no longer needed
    */
    z0 addCommandItem (ApplicationCommandManager* commandManager,
                         CommandID commandID,
                         Txt displayName = {},
                         std::unique_ptr<Drawable> iconToUse = {});
    ...
    */
    z0 addColoredItem (i32 itemResultID,
                          Txt itemText,
                          Color itemTextColor,
                          b8 isEnabled = true,
                          b8 isTicked = false,
    ...
    */
    ...
    /** Appends a custom menu item.
        ...
        @see CustomComponent
    */
    z0 addCustomItem (i32 itemResultID,
    ...
    */
    ...
    /** Возвращает true, если the menu contains a command item that triggers the given command. */
    b8 containsCommandItem (i32 commandID) const;

    /** Возвращает true, если the menu contains any items that can be used. */
    b8 containsAnyActiveItems() const noexcept;
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Sets the region of the screen next to which the menu should be displayed.
            ...
            @code
            Rectangle<i32>{}.withPosition (Desktop::getMousePosition())
            @endcode
        ...
        */
        [[nodiscard]] Options withTargetScreenArea (Rectangle<i32> targetArea) const;
        ...
        */
        ...
        [[nodiscard]] Options withMinimumWidth (i32 minWidth) const;

        /** Sets the minimum number of columns in the popup window. */
        [[nodiscard]] Options withMinimumNumColumns (i32 minNumColumns) const;

        /** Sets the maximum number of columns in the popup window. */
        [[nodiscard]] Options withMaximumNumColumns (i32 maxNumColumns) const;

        /** Sets the default height of each item in the popup menu. */
        [[nodiscard]] Options withStandardItemHeight (i32 standardHeight) const;
        ...
        */
        [[nodiscard]] Options withItemThatMustBeVisible (i32 idOfItemToBeVisible) const;
        ...
        */
        ...
        /** Sets an item to select in the menu.
            ...
            it is opened.
        */
        [[nodiscard]] Options withInitiallySelectedItem (i32 idOfItemToBeSelected) const;
        ...
        */
        ...
        /** Возвращает true, если the menu was watching a component, and that component has been deleted, and false otherwise.

            @see withDeletionCheck
        */
        b8 hasWatchedComponentBeenDeleted() const noexcept         { return isWatchingForDeletion && componentToWatchForDeletion == nullptr; }

        /** Gets the target screen area.

            @see withTargetScreenArea
        */
        Rectangle<i32> getTargetScreenArea() const noexcept          { return targetArea; }

        /** Gets the minimum width.

            @see withMinimumWidth
        */
        i32 getMinimumWidth() const noexcept                         { return minWidth; }

        /** Gets the maximum number of columns.

            @see withMaximumNumColumns
        */
        i32 getMaximumNumColumns() const noexcept                    { return maxColumns; }

        /** Gets the minimum number of columns.

            @see withMinimumNumColumns
        */
        i32 getMinimumNumColumns() const noexcept                    { return minColumns; }

        /** Gets the default height of items in the menu.

            @see withStandardItemHeight
        */
        i32 getStandardItemHeight() const noexcept                   { return standardHeight; }

        /** Gets the ID of the item that must be visible when the menu is initially shown.

            @see withItemThatMustBeVisible
        */
        i32 getItemThatMustBeVisible() const noexcept                { return visibleItemID; }
        ...
        */
        ...
        /** Gets the ID of the item that must be selected when the menu is initially shown.
            ...
            @see withItemThatMustBeVisible
        */
        i32 getInitiallySelectedItemId() const noexcept              { return initiallySelectedItemId; }

    private:
        //==============================================================================
        Rectangle<i32> targetArea;
        WeakReference<Component> targetComponent, parentComponent, componentToWatchForDeletion, topLevelTarget;
        i32 visibleItemID = 0, minWidth = 0, minColumns = 1, maxColumns = 0, standardHeight = 0, initiallySelectedItemId = 0;
        b8 isWatchingForDeletion = false;
    ...
    /** Displays the menu and waits for the user to pick something.
        ...
        @param minimumWidth             a minimum width for the menu, in pixels. It may be wider
                                        than this if some items are too i64 to fit.
        ...
        @see showAt
    */
    i32 show (i32 itemIDThatMustBeVisible = 0,
              i32 minimumWidth = 0,
              i32 maximumNumColumns = 0,
              i32 standardItemHeight = 0,
    ...
    /** Displays the menu at a specific location.
        ...
        @see show()
    */
    i32 showAt (Rectangle<i32> screenAreaToAttachTo,
                i32 itemIDThatMustBeVisible = 0,
                i32 minimumWidth = 0,
                i32 maximumNumColumns = 0,
                i32 standardItemHeight = 0,
                ModalComponentManager::Callback* callback = nullptr);
    ...
    */
    i32 showAt (Component* componentToAttachTo,
                i32 itemIDThatMustBeVisible = 0,
                i32 minimumWidth = 0,
                i32 maximumNumColumns = 0,
                i32 standardItemHeight = 0,
    ...
    */
    i32 showMenu (const Options& options);
   #endif

    /** Runs the menu asynchronously. */
    z0 showMenuAsync (const Options& options);
    ...
    */
    static b8 DRX_CALLTYPE dismissAllActiveMenus();
    ...
    */
    enum ColorIds
    {
        backgroundColorId             = 0x1000700,  /**< The colour to fill the menu's background with. */
        textColorId                   = 0x1000600,  /**< The colour for normal menu item text, (unless the
                                                          colour is specified when the item is added). */
        headerTextColorId             = 0x1000601,  /**< The colour for section header item text (see the
                                                          addSectionHeader() method). */
        highlightedBackgroundColorId  = 0x1000900,  /**< The colour to fill the background of the currently
                                                          highlighted menu item. */
        highlightedTextColorId        = 0x1000800,  /**< The colour to use for the text of the currently
                                                          highlighted item. */
    };
    ...
    */
    class DRX_API  MenuItemIterator
    {
    public:
        //==============================================================================
        ...
        */
        MenuItemIterator (const PopupMenu& menu, b8 searchRecursively = false);

        /** Destructor. */
        ~MenuItemIterator();

        /** Возвращает true, если there is another item, and sets up all this object's
    ...
    private:
        ...
        DRX_LEAK_DETECTOR (MenuItemIterator)
    };
    ...
    */
    class DRX_API  CustomComponent  : public Component,
    ...
    public:
        ...
        */
        explicit CustomComponent (b8 isTriggeredAutomatically);
        ...
        */
        virtual z0 getIdealSize (i32& idealWidth, i32& idealHeight) = 0;
        ...
        */
        ...
        /** Возвращает true, если this item should be highlighted because the mouse is over it.
            You can call this method in your paint() method to find out whether
            to draw a highlight.
        */
        b8 isItemHighlighted() const noexcept                 { return isHighlighted; }
        ...
        */
        ...
        /** @internal */
        b8 isTriggeredAutomatically() const noexcept          { return triggeredAutomatically; }
        /** @internal */
        z0 setHighlighted (b8 shouldBeHighlighted);

    private:
        //==============================================================================
        b8 isHighlighted = false, triggeredAutomatically;
        const PopupMenu::Item* item = nullptr;

        friend PopupMenu;

        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CustomComponent)
    };
    ...
    */
    class DRX_API  CustomCallback  : public SingleThreadedReferenceCountedObject
    {
    public:
        CustomCallback();
        ...
        */
        virtual b8 menuItemTriggered() = 0;

    private:
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CustomCallback)
    };
    ...
    */
    struct DRX_API  LookAndFeelMethods
    {
        ...
        virtual z0 drawPopupMenuBackground (Graphics&, i32 width, i32 height);

        /** Fills the background of a popup menu component. */
        virtual z0 drawPopupMenuBackgroundWithOptions (Graphics&,
                                                         i32 width,
                                                         i32 height,
                                                         const Options&) = 0;

        /** Draws one of the items in a popup menu. */
        virtual z0 drawPopupMenuItem (Graphics&, const Rectangle<i32>& area,
                                        b8 isSeparator, b8 isActive, b8 isHighlighted,
                                        b8 isTicked, b8 hasSubMenu,
                                        const Txt& text,
        ...
        /** Draws one of the items in a popup menu. */
        virtual z0 drawPopupMenuItemWithOptions (Graphics&, const Rectangle<i32>& area,
                                                   b8 isHighlighted,
                                                   const Item& item,
                                                   const Options&) = 0;

        virtual z0 drawPopupMenuSectionHeader (Graphics&, const Rectangle<i32>&,
                                                 const Txt&);

        virtual z0 drawPopupMenuSectionHeaderWithOptions (Graphics&, const Rectangle<i32>& area,
        ...
        virtual z0 drawPopupMenuUpDownArrow (Graphics&,
                                               i32 width, i32 height,
                                               b8 isScrollUpArrow);

        virtual z0 drawPopupMenuUpDownArrowWithOptions (Graphics&,
                                                          i32 width, i32 height,
                                                          b8 isScrollUpArrow,
                                                          const Options&) = 0;

        /** Finds the best size for an item in a popup menu. */
        virtual z0 getIdealPopupMenuItemSize (const Txt& text,
                                                b8 isSeparator,
        ...
        /** Finds the best size for an item in a popup menu. */
        virtual z0 getIdealPopupMenuItemSizeWithOptions (const Txt& text,
                                                           b8 isSeparator,
                                                           i32 standardMenuItemHeight,
                                                           i32& idealWidth,
                                                           i32& idealHeight,
        ...
        virtual z0 getIdealPopupMenuSectionHeaderSizeWithOptions (const Txt& text,
                                                                    i32 standardMenuItemHeight,
                                                                    i32& idealWidth,
                                                                    i32& idealHeight,
                                                                    const Options&) = 0;

        virtual i32 getMenuWindowFlags() = 0;

        virtual z0 drawMenuBarBackground (Graphics&, i32 width, i32 height,
                                            b8 isMouseOverBar,
                                            MenuBarComponent&) = 0;

        virtual i32 getDefaultMenuBarHeight() = 0;

        virtual i32 getMenuBarItemWidth (MenuBarComponent&, i32 itemIndex, const Txt& itemText) = 0;

        virtual Font getMenuBarFont (MenuBarComponent&, i32 itemIndex, const Txt& itemText) = 0;

        virtual z0 drawMenuBarItem (Graphics&, i32 width, i32 height,
                                      i32 itemIndex,
                                      const Txt& itemText,
                                      b8 isMouseOverItem,
                                      b8 isMenuOpen,
        ...
        virtual z0 preparePopupMenuWindow (Component& newWindow) = 0;

        /** Return true if you want your popup menus to scale with the target component's AffineTransform
            or scale factor
        */
        virtual b8 shouldPopupMenuScaleWithTargetComponent (const Options& options) = 0;

        virtual i32 getPopupMenuBorderSize();

        virtual i32 getPopupMenuBorderSizeWithOptions (const Options&) = 0;
        ...
        */
        virtual z0 drawPopupMenuColumnSeparatorWithOptions (Graphics& g,
                                                              const Rectangle<i32>& bounds,
                                                              const Options&) = 0;

        /** Return the amount of space that should be left between popup menu columns. */
        virtual i32 getPopupMenuColumnSeparatorWidthWithOptions (const Options&) = 0;
    };

    //==============================================================================
   #ifndef DOXYGEN
    [[deprecated ("Use the new method.")]]
    i32 drawPopupMenuItem (Graphics&, i32, i32, b8, b8, b8, b8, b8, const Txt&, const Txt&, Image*, const Color*) { return 0; }
   #endif

private:
    //==============================================================================
    DRX_PUBLIC_IN_DLL_BUILD (struct HelperClasses)
    class Window;
    ...
    i32 showWithOptionalCallback (const Options&, ModalComponentManager::Callback*, b8);

    static z0 setItem (CustomComponent&, const Item*);

    DRX_LEAK_DETECTOR (PopupMenu)
};
