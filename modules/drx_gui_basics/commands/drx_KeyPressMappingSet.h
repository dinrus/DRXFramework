...
/**
    ...
    @tags{GUI}
*/
class DRX_API  KeyPressMappingSet  : public KeyListener,
...
public:
    ...
    */
    z0 addKeyPress (CommandID commandID,
    ...
    */
    z0 removeKeyPress (CommandID commandID, i32 keyPressIndex);

    /** Removes a keypress from any command that it may be assigned to. */
    z0 removeKeyPress (const KeyPress& keypress);

    /** Возвращает true, если the given command is linked to this key. */
    b8 containsMapping (CommandID commandID, const KeyPress& keyPress) const noexcept;
    ...
    */
    ...
    /** Tries to recreate the mappings from a previously stored state.
        ...
        @see createXml
    */
    b8 restoreFromXml (const XmlElement& xmlVersion);
    ...
    /** Creates an XML representation of the current mappings.
        ...
        @see restoreFromXml
    */
    std::unique_ptr<XmlElement> createXml (b8 saveDifferencesFromDefaultSet) const;

    //==============================================================================
    /** @internal */
    b8 keyPressed (const KeyPress&, Component*) override;
    /** @internal */
    b8 keyStateChanged (b8 isKeyDown, Component*) override;
    /** @internal */
...
private:
    ...
    z0 invokeCommand (CommandID, const KeyPress&, b8 isKeyDown,
                        i32 millisecsSinceKeyPressed, Component* originator) const;

    KeyPressMappingSet& operator= (const KeyPressMappingSet&);
    DRX_LEAK_DETECTOR (KeyPressMappingSet)
};
