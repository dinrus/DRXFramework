...
/**
    ...
    DRXApplication object (which is itself an ApplicationCommandTarget).
    ...
    @tags{GUI}
*/
class DRX_API  ApplicationCommandManager   : private AsyncUpdater,
...
public:
    ...
    */
    z0 registerCommand (const ApplicationCommandInfo& newCommand);
    ...
    */
    z0 commandStatusChanged();

    //==============================================================================
    /** Returns the number of commands that have been registered.
        @see registerCommand
    */
    i32 getNumCommands() const noexcept                                             { return commands.size(); }

    /** Returns the details about one of the registered commands.
        The index is between 0 and (getNumCommands() - 1).
    */
    const ApplicationCommandInfo* getCommandForIndex (i32 index) const noexcept     { return commands [index]; }
    ...
    */
    Txt getNameOfCommand (CommandID commandID) const noexcept;
    ...
    */
    Txt getDescriptionOfCommand (CommandID commandID) const noexcept;
    ...
    */
    Array<CommandID> getCommandsInCategory (const Txt& categoryName) const;
    ...
    */
    ...
    /** Invokes the given command directly, sending it to the default target.
        ...
        structure.
    */
    b8 invokeDirectly (CommandID commandID, b8 asynchronously);
    ...
    */
    b8 invoke (const ApplicationCommandTarget::InvocationInfo& invocationInfo,
                 b8 asynchronously);
    ...
    */
    z0 setFirstCommandTarget (ApplicationCommandTarget* newTarget) noexcept;
    ...
    */
    ...
    z0 addListener (ApplicationCommandManagerListener* listener);

    /** Deregisters a previously-added listener. */
    z0 removeListener (ApplicationCommandManagerListener* listener);
...
private:
    ...
    z0 sendListenerInvokeCallback (const ApplicationCommandTarget::InvocationInfo&);
    ...
    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ApplicationCommandManager)
};
...
/**
    ...
    @tags{GUI}
*/
class DRX_API  ApplicationCommandManagerListener
{
public:
    //==============================================================================
    /** Destructor. */
    ...
    virtual z0 applicationCommandInvoked (const ApplicationCommandTarget::InvocationInfo&) = 0;
    ...
    */
    virtual z0 applicationCommandListChanged() = 0;
};
