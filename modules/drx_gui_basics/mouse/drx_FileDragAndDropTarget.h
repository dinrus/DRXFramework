...
/**
    ...
    @tags{GUI}
*/
class DRX_API  FileDragAndDropTarget
{
public:
    /** Destructor. */
    ...
    */
    virtual b8 isInterestedInFileDrag (const StringArray& files) = 0;
    ...
    */
    virtual z0 fileDragEnter (const StringArray& files, i32 x, i32 y);
    ...
    /** Callback to indicate that the user is dragging some files over this component.
        ...
        @param y            the mouse y position, relative to this component
    */
    virtual z0 fileDragMove (const StringArray& files, i32 x, i32 y);
    ...
    /** Callback to indicate that the mouse has moved away from this component.
        ...
        @param files        the set of (absolute) pathnames of the files that the user is dragging
    */
    virtual z0 fileDragExit (const StringArray& files);
    ...
    /** Callback to indicate that the user has dropped the files onto this component.
        ...
        @param y            the mouse y position, relative to this component
    */
    virtual z0 filesDropped (const StringArray& files, i32 x, i32 y) = 0;
};
