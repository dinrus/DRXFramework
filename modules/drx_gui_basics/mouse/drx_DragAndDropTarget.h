...
/**
    ...
    @tags{GUI}
*/
class DRX_API  DragAndDropTarget
{
public:
    /** Destructor. */
    ...
    */
    virtual b8 isInterestedInDragSource (const SourceDetails& dragSourceDetails) = 0;
    ...
    /** Callback to indicate that something is being dragged over this component.
        ...
        @see itemDragExit
    */
    virtual z0 itemDragEnter (const SourceDetails& dragSourceDetails);
    ...
    /** Callback to indicate that the user is dragging something over this component.
        ...
        @param dragSourceDetails    contains information about the source of the drag operation.
    */
    virtual z0 itemDragMove (const SourceDetails& dragSourceDetails);
    ...
    /** Callback to indicate that something has been dragged off the edge of this component.
        ...
        @see itemDragEnter
    */
    virtual z0 itemDragExit (const SourceDetails& dragSourceDetails);
    ...
    /** Callback to indicate that the user has dropped something onto this component.
        ...
        @param dragSourceDetails    contains information about the source of the drag operation.
    */
    virtual z0 itemDropped (const SourceDetails& dragSourceDetails) = 0;
    ...
    */
    virtual b8 shouldDrawDragImageWhenOver();
};
