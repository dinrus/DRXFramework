...
/**
    ...
    @tags{GUI}
*/
class DRX_API  ToolbarItemPalette    : public Component,
...
private:
    ...
    z0 replaceComponent (ToolbarItemComponent&);
    z0 addComponent (i32 itemId, i32 index);

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ToolbarItemPalette)
};
