...
public:
    ...
    */
    virtual z0 sliderValueChanged (Emitter*) = 0;
    ...
    */
    virtual z0 sliderDragStarted (Emitter*) {}

    /** Called after a drag operation has finished.
        @see sliderDragStarted, Slider::stoppedDragging
    */
    virtual z0 sliderDragEnded (Emitter*) {}
};
...
/**
    ...
    @tags{GUI}
*/
class DRX_API  Slider  : public Component,
...
public:
    ...
    */
    ...
    /** Creates a slider.
        When created, you can set up the slider's style and range with setSliderStyle(), setRange(), etc.
    */
    explicit Slider (const Txt& componentName);
    ...
    */
    ...
    z0 setRotaryParameters (RotaryParameters newParameters) noexcept;

    /** Changes the properties of a rotary slider. */
    z0 setRotaryParameters (f32 startAngleRadians,
                              f32 endAngleRadians,
                              b8 stopAtEnd) noexcept;
    ...
    */
    z0 setMouseDragSensitivity (i32 distanceForFullScaleDrag);

    /** Returns the current sensitivity value set by setMouseDragSensitivity(). */
    i32 getMouseDragSensitivity() const noexcept;
    ...
    */
    z0 setVelocityBasedMode (b8 isVelocityBased);

    /** Возвращает true, если velocity-based mode is active.
        @see setVelocityBasedMode
    */
    b8 getVelocityBasedMode() const noexcept;
    ...
    */
    z0 setVelocityModeParameters (f64 sensitivity = 1.0,
                                    i32 threshold = 1,
                                    f64 offset = 0.0,
                                    b8 userCanPressKeyToSwapMode = true,
    ...
    */
    f64 getVelocitySensitivity() const noexcept;

    /** Returns the velocity threshold setting.
        @see setVelocityModeParameters
    */
    i32 getVelocityThreshold() const noexcept;

    /** Returns the velocity offset setting.
        @see setVelocityModeParameters
    */
    f64 getVelocityOffset() const noexcept;

    /** Returns the velocity user key setting.
        @see setVelocityModeParameters
    */
    b8 getVelocityModeIsSwappable() const noexcept;
    ...
    */
    z0 setSkewFactor (f64 factor, b8 symmetricSkew = false);
     ...
     */
    z0 setSkewFactorFromMidPoint (f64 sliderValueToShowAtMidPoint);
    ...
    */
    f64 getSkewFactor() const noexcept;
     ...
     */
    b8 isSymmetricSkew() const noexcept;
    ...
    */
    ...
    /** Returns the width used for the text-box.
        @see setTextBoxStyle
    */
    i32 getTextBoxWidth() const noexcept;

    /** Returns the height used for the text-box.
        @see setTextBoxStyle
    */
    i32 getTextBoxHeight() const noexcept;
    ...
    */
    ...
    /** Возвращает true, если the text-box is read-only.
        @see setTextBoxStyle
    */
    b8 isTextBoxEditable() const noexcept;
    ...
    */
    z0 setValue (f64 newValue, NotificationType notification = sendNotificationAsync);
    ...
    */
    ...
    /** Sets the limits that the slider's value can take.
        ...
        @param newInterval  the steps in which the value is allowed to increase - if this
                            is not zero, the value will always be (newMinimum + (newInterval * an integer)).
    */
    z0 setRange (Range<f64> newRange, f64 newInterval);

    /** Sets a NormalisableRange to use for the Slider values.

        @param newNormalisableRange     the NormalisableRange to use
    */
    z0 setNormalisableRange (NormalisableRange<f64> newNormalisableRange);

    /** Returns the slider's normalisable range. */
    NormalisableRange<f64> getNormalisableRange() const noexcept;

    /** Returns the slider's range. */
    Range<f64> getRange() const noexcept;

    /** Returns the current maximum value.
        @see setRange, getRange
    */
    f64 getMaximum() const noexcept;

    /** Returns the current minimum value.
        @see setRange, getRange
    */
    f64 getMinimum() const noexcept;

    /** Returns the current step-size for values.
        @see setRange, getRange
    */
    f64 getInterval() const noexcept;
    ...
    */
    z0 setMinValue (f64 newValue,
                      NotificationType notification = sendNotificationAsync,
                      b8 allowNudgingOfOtherValues = false);
    ...
    */
    z0 setMinAndMaxValues (f64 newMinValue, f64 newMaxValue,
                             NotificationType notification = sendNotificationAsync);
    ...
    /** This lets you choose whether f64-clicking or single-clicking with a specified
        ...
        go to when f64-clicked. By default the key modifier is the alt key but you can
        pass in another key modifier, or none to disable this behaviour.

        @see getDoubleClickReturnValue
    */
    z0 setDoubleClickReturnValue (b8 shouldDoubleClickBeEnabled,
                                    f64 valueToSetOnDoubleClick,
    ...
    */
    f64 getDoubleClickReturnValue() const noexcept;

    /** Возвращает true, если f64-clicking to reset to a default value is enabled.
        @see setDoubleClickReturnValue
    */
    b8 isDoubleClickReturnEnabled() const noexcept;
    ...
    /** Tells the slider whether to keep sending change messages while the user
        ...
        held down.
    */
    z0 setChangeNotificationOnlyOnRelease (b8 onlyNotifyOnRelease);
    ...
    /** This lets you change whether the slider thumb jumps to the mouse position
        ...
        sliders.
    */
    z0 setSliderSnapsToMousePosition (b8 shouldSnapToMouse);

    /** Возвращает true, если setSliderSnapsToMousePosition() has been enabled. */
    b8 getSliderSnapsToMousePosition() const noexcept;
    ...
    */
    z0 setPopupDisplayEnabled (b8 shouldShowOnMouseDrag,
                                 b8 shouldShowOnMouseHover,
                                 Component* parentComponentToUse,
                                 i32 hoverTimeout = 2000);
    ...
    */
    z0 setScrollWheelEnabled (b8 enabled);

    /** Возвращает true, если the scroll wheel can move the slider. */
    b8 isScrollWheelEnabled() const noexcept;
    ...
    */
    ...
    /** Subclasses can override this to convert a text string to a value.
        ...
        The default implementation just tries to convert it to a f64.

        @see getTextFromValue
    */
    virtual f64 getValueFromText (const Txt& text);
    ...
    */
    virtual Txt getTextFromValue (f64 value);
    ...
    */
    i32 getNumDecimalPlacesToDisplay() const noexcept;
    ...
    */
    virtual f64 proportionOfLengthToValue (f64 proportion);
    ...
    */
    virtual f64 valueToProportionOfLength (f64 value);
    ...
    */
    virtual f64 snapValue (f64 attemptedValue, DragMode dragMode);
    ...
    */
    enum ColorIds
    {
        backgroundColorId          = 0x1001200,  /**< A colour to use to fill the slider's background. */
        thumbColorId               = 0x1001300,  /**< The colour to draw the thumb with. It's up to the look
                                                       and feel class how this is used. */
        trackColorId               = 0x1001310,  /**< The colour to draw the groove that the thumb moves along. */
        rotarySliderFillColorId    = 0x1001311,  /**< For rotary sliders, this colour fills the outer curve. */
        rotarySliderOutlineColorId = 0x1001312,  /**< For rotary sliders, this colour is used to draw the outer curve's outline. */

        textBoxTextColorId         = 0x1001400,  /**< The colour for the text in the text-editor box used for editing the value. */
        textBoxBackgroundColorId   = 0x1001500,  /**< The background colour for the text-editor box. */
        textBoxHighlightColorId    = 0x1001600,  /**< The text highlight colour for the text-editor box. */
        textBoxOutlineColorId      = 0x1001700   /**< The colour to use for a border around the text-editor box. */
    };
    ...
    struct SliderLayout
    {
        Rectangle<i32> sliderBounds;
        Rectangle<i32> textBoxBounds;
    };
    ...
    /** An RAII class for sending slider listener drag messages.
        ...
        @see Slider::Listener
    */
    class DRX_API  ScopedDragNotification
    {
    public:
    ...
    private:
        ...
        DRX_DECLARE_NON_MOVEABLE (ScopedDragNotification)
        DRX_DECLARE_NON_COPYABLE (ScopedDragNotification)
    };
    ...
    */
    struct DRX_API  LookAndFeelMethods
    {
        ...
        //==============================================================================
        virtual z0 drawLinearSlider (Graphics&,
        ...
        virtual z0 drawLinearSliderBackground (Graphics&,
                                                 i32 x, i32 y, i32 width, i32 height,
                                                 f32 sliderPos,
                                                 f32 minSliderPos,
                                                 f32 maxSliderPos,
        ...
        virtual z0 drawLinearSliderOutline (Graphics&,
                                              i32 x, i32 y, i32 width, i32 height,
                                              Slider::SliderStyle,
                                              Slider&) = 0;

        virtual z0 drawLinearSliderThumb (Graphics&,
                                            i32 x, i32 y, i32 width, i32 height,
                                            f32 sliderPos,
                                            f32 minSliderPos,
                                            f32 maxSliderPos,
        ...
        virtual i32 getSliderThumbRadius (Slider&) = 0;

        virtual z0 drawRotarySlider (Graphics&,
                                       i32 x, i32 y, i32 width, i32 height,
                                       f32 sliderPosProportional,
                                       f32 rotaryStartAngle,
                                       f32 rotaryEndAngle,
                                       Slider&) = 0;

        virtual Button* createSliderButton (Slider&, b8 isIncrement) = 0;
        ...
        virtual i32 getSliderPopupPlacement (Slider&) = 0;
    ...
    /** @internal */
    z0 modifierKeysChanged (const ModifierKeys&) override;
    /** @internal */
    z0 lookAndFeelChanged() override;
    /** @internal */
    z0 enablementChanged() override;
    /** @internal */
    z0 focusOfChildComponentChanged (FocusChangeType) override;
    /** @internal */
    ...
    //==============================================================================
   #ifndef DOXYGEN
    // These methods' b8 parameters have changed: see the new method signature.
    [[deprecated]] z0 setValue (f64, b8);
    [[deprecated]] z0 setValue (f64, b8, b8);
    [[deprecated]] z0 setMinValue (f64, b8, b8, b8);
    [[deprecated]] z0 setMinValue (f64, b8, b8);
    [[deprecated]] z0 setMinValue (f64, b8);
    [[deprecated]] z0 setMaxValue (f64, b8, b8, b8);
    [[deprecated]] z0 setMaxValue (f64, b8, b8);
    [[deprecated]] z0 setMaxValue (f64, b8);
    [[deprecated]] z0 setMinAndMaxValues (f64, f64, b8, b8);
    [[deprecated]] z0 setMinAndMaxValues (f64, f64, b8);
   #endif
...
private:
    ...
    z0 init (SliderStyle, TextEntryBoxPosition);

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Slider)
};
