...
public:
    ...
    */
    virtual z0 paintListBoxItem (i32 rowNumber,
                                   Graphics& g,
    ...
    */
    virtual Component* refreshComponentForRow (i32 rowNumber, b8 isRowSelected,
    ...
    */
    virtual Txt getNameForRow (i32 rowNumber);

    /** This can be overridden to react to the user clicking on a row.
        @see listBoxItemDoubleClicked
    */
    virtual z0 listBoxItemClicked (i32 row, const MouseEvent&);

    /** This can be overridden to react to the user f64-clicking on a row.
        @see listBoxItemClicked
    */
    virtual z0 listBoxItemDoubleClicked (i32 row, const MouseEvent&);
    ...
    */
    virtual var getDragSourceDescription (const SparseSet<i32>& rowsToDescribe);
    ...
    */
    ...
    /** You can override this to provide tool tips for specific rows.
        @see TooltipClient
    */
    virtual Txt getTooltipForRow (i32 row);

    /** You can override this to return a custom mouse cursor for each row. */
    virtual MouseCursor getMouseCursorForRow (i32 row);
...
/**
    ...
    @tags{GUI}
*/
class DRX_API  ListBox  : public Component,
...
public:
    ...
    /** Creates a ListBox.
        ...
        The ListBoxModel instance must stay alive for as i64 as the ListBox
        ...
        the ListBoxModel.
    */
    ListBox (const Txt& componentName = Txt(),
    ...
    /** Changes the current data model to display.
        ...
        the ListBoxModel.
    */
    z0 setModel (ListBoxModel* newModel);
    ...
    */
    z0 setMultipleSelectionEnabled (b8 shouldBeEnabled) noexcept;
    ...
    */
    z0 setClickingTogglesRowSelection (b8 flipRowSelection) noexcept;
    ...
    */
    z0 setRowSelectedOnMouseDown (b8 isSelectedOnMouseDown) noexcept;

    /** Gets whether a row should be selected when the mouse is pressed or released.
        By default this is true, but you may want to turn it off.
    */
    b8 getRowSelectedOnMouseDown() const                  { return selectOnMouseDown; }
    ...
    */
    z0 setMouseMoveSelectsRows (b8 shouldSelect);
    ...
    */
    z0 selectRow (i32 rowNumber,
                    b8 dontScrollToShowThisRow = false,
                    b8 deselectOthersFirst = true);
    ...
    */
    z0 selectRangeOfRows (i32 firstRow,
                            i32 lastRow,
                            b8 dontScrollToShowThisRange = false);

    /** Deselects a row.
        If it's not currently selected, this will do nothing.
        @see selectRow, deselectAllRows
    */
    z0 deselectRow (i32 rowNumber);
    ...
    */
    z0 flipRowSelection (i32 rowNumber);

    /** Returns a sparse set indicating the rows that are currently selected.
        @see setSelectedRows
    */
    SparseSet<i32> getSelectedRows() const;
    ...
    */
    i32 getSelectedRow (i32 index = 0) const;
    ...
    */
    ...
    /** Multiply-selects rows based on the modifier keys.
        ...
        @see selectRow
    */
    z0 selectRowsBasedOnModifierKeys (i32 rowThatWasClickedOn,
    ...
    */
    z0 setVerticalPosition (f64 newProportion);
    ...
    */
    f64 getVerticalPosition() const;

    /** Scrolls if necessary to make sure that a particular row is visible. */
    z0 scrollToEnsureRowIsOnscreen (i32 row);
    ...
    */
    i32 getRowContainingPosition (i32 x, i32 y) const noexcept;
    ...
    /** Finds a row index that would be the most suitable place to insert a new
        ...
        @see getComponentForRowNumber
    */
    i32 getInsertionIndexForPosition (i32 x, i32 y) const noexcept;
    ...
    */
    Rectangle<i32> getRowPosition (i32 rowNumber,
                                   b8 relativeToComponentTopLeft) const noexcept;
    ...
    */
    Component* getComponentForRowNumber (i32 rowNumber) const noexcept;
    ...
    */
    i32 getRowNumberOfComponent (const Component* rowComponent) const noexcept;

    /** Returns the width of a row (which may be less than the width of this component
        if there's a scrollbar).
    */
    i32 getVisibleRowWidth() const noexcept;
    ...
    /** Sets the height of each row in the list.
        ...
        @see getRowHeight
    */
    z0 setRowHeight (i32 newHeight);

    /** Returns the height of a row in the list.
        @see setRowHeight
    */
    i32 getRowHeight() const noexcept                   { return rowHeight; }
    ...
    */
    i32 getNumRowsOnScreen() const noexcept;
    ...
    */
    enum ColorIds
    {
        backgroundColorId      = 0x1002800, /**< The background colour to fill the list with.
                                                  Make this transparent if you don't want the background to be filled. */
        outlineColorId         = 0x1002810, /**< An optional colour to use to draw a border around the list.
                                                  Make this transparent to not have an outline. */
        textColorId            = 0x1002820  /**< The preferred colour to use for drawing text in the listbox. */
    };

    /** Sets the thickness of a border that will be drawn around the box.

        To set the colour of the outline, use @code setColor (ListBox::outlineColorId, colourXYZ); @endcode
        @see outlineColorId
    */
    z0 setOutlineThickness (i32 outlineThickness);

    /** Returns the thickness of outline that will be drawn around the listbox.
        @see setOutlineColor
    */
    i32 getOutlineThickness() const noexcept            { return outlineThickness; }
    ...
    */
    z0 setHeaderComponent (std::unique_ptr<Component> newHeaderComponent);
    ...
    */
    z0 repaintRow (i32 rowNumber) noexcept;
    ...
    */
    virtual ScaledImage createSnapshotOfRows (const SparseSet<i32>& rows, i32& x, i32& y);
    ...
    */
    ...
    /** @internal */
    z0 startDragAndDrop (const MouseEvent&, const SparseSet<i32>& rowsToDrag,
                           const var& dragDescription, b8 allowDraggingToOtherWindows);
    /** @internal */
    std::unique_ptr<AccessibilityHandler> createAccessibilityHandler() override;

    //==============================================================================
   #ifndef DOXYGEN
    [[deprecated ("This method's b8 parameter has changed: see the new method signature.")]]
    z0 setSelectedRows (const SparseSet<i32>&, b8);
   #endif
...
private:
    //==============================================================================
    DRX_PUBLIC_IN_DLL_BUILD (class ListViewport)
    DRX_PUBLIC_IN_DLL_BUILD (class RowComponent)
    ...
    SparseSet<i32> selected;
    i32 totalItems = 0, rowHeight = 22, minimumRowWidth = 0;
    i32 outlineThickness = 0;
    i32 lastRowSelected = -1;
    b8 multipleSelection = false, alwaysFlipSelection = false, hasDoneInitialUpdate = false, selectOnMouseDown = true;

   #if ! DRX_DISABLE_ASSERTIONS
    std::weak_ptr<ListBoxModel::Empty> weakModelPtr;
   #endif

    z0 assignModelPtr (ListBoxModel*);
    z0 checkModelPtrIsValid() const;
    b8 hasAccessibleHeaderComponent() const;
    z0 selectRowInternal (i32 rowNumber, b8 dontScrollToShowThisRow,
                            b8 deselectOthersFirst, b8 isMouseClick);

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ListBox)
};
