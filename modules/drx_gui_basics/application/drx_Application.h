...
/**
    ...
    DRXApplicationBase or DRXApplication, and implement its various pure virtual
    methods.
    ...
    Note that this class is derived from DRXApplicationBase, which contains most
    ...
    your app object directly from DRXApplicationBase if you want to, and by doing so
    can avoid having a dependency on the drx_gui_basics module.
    ...
    @see DRXApplicationBase, START_DRX_APPLICATION

    @tags{GUI}
*/
class DRX_API  DRXApplication  : public DRXApplicationBase,
                                   public ApplicationCommandTarget
{
public:
    //==============================================================================
    /** Constructs a DRX app object.

        If subclasses implement a constructor or destructor, they shouldn't call any
        DRX code in there - put your startup/shutdown code in initialise() and
        shutdown() instead.
    */
    DRXApplication();
    ...
    /** Destructor.
        ...
        shutdown() instead.
    */
    ~DRXApplication() override;

    //==============================================================================
    /** Returns the global instance of the application object being run. */
    static DRXApplication* DRX_CALLTYPE getInstance() noexcept;
    ...
    */
    b8 moreThanOneInstanceAllowed() override;
    ...
    */
    ...
    /** If any unhandled exceptions make it through to the message dispatch loop, this
        ...
        will be null.
    */
    z0 unhandledException (const std::exception* e,
                             const Txt& sourceFilename,
                             i32 lineNumber) override;
...
private:
    b8 initialiseApp() override;

    DRX_DECLARE_NON_COPYABLE (DRXApplication)
};
