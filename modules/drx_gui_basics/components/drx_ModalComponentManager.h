...
/**
    ...
    @tags{GUI}
*/
class DRX_API  ModalComponentManager   : private AsyncUpdater,
...
public:
    ...
    */
    ...
    public:
        ...
        */
        virtual z0 modalStateFinished (i32 returnValue) = 0;
    };

    //==============================================================================
   #ifndef DOXYGEN
    DRX_DECLARE_SINGLETON_SINGLETHREADED_MINIMAL_INLINE (ModalComponentManager)
   #endif
    ...
    */
    i32 getNumModalComponents() const;

    /** Returns one of the components being shown modally.
        An index of 0 is the most recently-shown, topmost component.
    */
    Component* getModalComponent (i32 index) const;

    /** Возвращает true, если the specified component is in a modal state. */
    b8 isModal (const Component* component) const;

    /** Возвращает true, если the specified component is currently the topmost modal component. */
    b8 isFrontModalComponent (const Component* component) const;
    ...
    /** Adds a new callback that will be called when the specified modal component is dismissed.
        ...
        no action is taken.
    */
    z0 attachCallback (Component* component, Callback* callback);

    /** Brings any modal components to the front. */
    z0 bringModalComponentsToFront (b8 topOneShouldGrabFocus = true);
    ...
    */
    i32 runEventLoopForCurrentComponent();
   #endif
    ...
    /** @internal */
    z0 startModal (Key, Component*, b8 autoDelete);

    /** @internal */
    z0 endModal (Key, Component*, i32 returnValue);
...
private:
    ...
    DRX_DECLARE_NON_COPYABLE (ModalComponentManager)
};
...
/**
    ...
    @tags{GUI}
*/
class DRX_API ModalCallbackFunction
{
public:
    ...
    */
    ...
    static ModalComponentManager::Callback* create (CallbackFn&& fn)
    {
        struct Callable  : public ModalComponentManager::Callback
        {
            ...
            z0 modalStateFinished (i32 result) override  { NullCheckedInvocation::invoke (std::move (fn), result); }
    ...
    /** This is a utility function to create a ModalComponentManager::Callback that will
        ...
        The function that you supply must take two parameters - the first being an i32, which is
        ...
        E.g. @code
        static z0 myCallbackFunction (i32 modalResult, f64 customValue)
        {
            if (modalResult == 1)
    ...
    */
    ...
    static ModalComponentManager::Callback* create (z0 (*functionToCall) (i32, ParamType),
                                                    ParamType parameterValue)
    {
        return create ([functionToCall, parameterValue] (i32 r)
        {
    ...
    /** This is a utility function to create a ModalComponentManager::Callback that will
        ...
        The function that you supply must take three parameters - the first being an i32, which is
        ...
        E.g. @code
        static z0 myCallbackFunction (i32 modalResult, f64 customValue1, Txt customValue2)
        {
            if (modalResult == 1)
        ...
        Component* someKindOfComp;
        ...
        someKindOfComp->enterModalState (true, ModalCallbackFunction::create (myCallbackFunction, 3.0, Txt ("xyz")));
        @endcode
        @see ModalComponentManager::Callback
    */
    template <typename ParamType1, typename ParamType2>
    static ModalComponentManager::Callback* withParam (z0 (*functionToCall) (i32, ParamType1, ParamType2),
                                                       ParamType1 parameterValue1,
                                                       ParamType2 parameterValue2)
    {
        return create ([functionToCall, parameterValue1, parameterValue2] (i32 r)
        {
    ...
    /** This is a utility function to create a ModalComponentManager::Callback that will
        ...
        E.g. @code
        static z0 myCallbackFunction (i32 modalResult, Slider* mySlider)
        {
    ...
    */
    ...
    static ModalComponentManager::Callback* forComponent (z0 (*functionToCall) (i32, ComponentType*),
                                                          ComponentType* component)
    {
        return create ([functionToCall, comp = WeakReference<Component> { component }] (i32 r)
        {
    ...
    /** Creates a ModalComponentManager::Callback that will call a static function with a component.
        ...
        E.g. @code
        static z0 myCallbackFunction (i32 modalResult, Slider* mySlider, Txt customParam)
        {
            if (modalResult == 1 && mySlider != nullptr) // (must check that mySlider isn't null in case it was deleted..)
        ...
        Slider* mySlider;
        ...
        someKindOfComp->enterModalState (true, ModalCallbackFunction::forComponent (myCallbackFunction, mySlider, Txt ("hello")));
        @endcode
        @see ModalComponentManager::Callback
    */
    template <class ComponentType, typename ParamType>
    static ModalComponentManager::Callback* forComponent (z0 (*functionToCall) (i32, ComponentType*, ParamType),
                                                          ComponentType* component,
                                                          ParamType param)
    {
        return create ([functionToCall, param, comp = WeakReference<Component> { component }] (i32 r)
        {
