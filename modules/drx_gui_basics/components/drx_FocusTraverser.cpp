...
private:
    ...
    z0 checkComponentProperties (std::function<z0 (Component&)>&& childFn,
                                   std::function<b8 (const Component&, const Component&)>&& testProperty)
    {
        TestComponent parent;
    ...
    z0 checkIgnored (const std::function<z0(Component&)>& makeIgnored)
    {
        TestComponent parent;
