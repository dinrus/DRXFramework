...
/** An abstract interface representing the value of an accessibility element.
    ...
    @tags{Accessibility}
*/
class DRX_API  AccessibilityValueInterface
{
public:
    /** Destructor. */
    virtual ~AccessibilityValueInterface() = default;

    /** Возвращает true, если the value is read-only and cannot be modified by an
    ...
    */
    ...
    /** Returns the current value as a f64. */
    virtual f64 getCurrentValue() const = 0;

    /** Returns the current value as a Txt. */
    virtual Txt getCurrentValueAsString() const = 0;

    /** Sets the current value to a new f64 value. */
    virtual z0 setValue (f64 newValue) = 0;

    /** Sets the current value to a new Txt value. */
    virtual z0 setValueAsString (const Txt& newValue) = 0;
    ...
    /** Represents the range of this value, if supported.
        ...
        @tags{Accessibility}
    */
    class DRX_API  AccessibleValueRange
    {
    public:
        /** Constructor.
        ...
        */
        ...
        struct DRX_API  MinAndMax  { f64 min, max; };
        ...
        /** Constructor.
            ...
            and interval values.
        */
        AccessibleValueRange (MinAndMax valueRange, f64 interval)
            : valid (true),
              range (valueRange),
              stepSize (interval)
        {
        ...
        /** Возвращает true, если this represents a valid range. */
        b8 isValid() const noexcept            { return valid; }

        /** Returns the minimum value for this range. */
        f64 getMinimumValue() const noexcept  { return range.min; }

        /** Returns the maximum value for this range. */
        f64 getMaximumValue() const noexcept  { return range.max; }

        /** Returns the interval for this range. */
        f64 getInterval() const noexcept      { return stepSize; }
...
/** A value interface that represents a text value.
    ...
    @tags{Accessibility}
*/
class DRX_API  AccessibilityTextValueInterface  : public AccessibilityValueInterface
{
public:
    /** Возвращает true, если the value is read-only and cannot be modified by an
        accessibility client.
    ...
    */
    b8 isReadOnly() const override = 0;

    /** Returns the current value. */
    Txt getCurrentValueAsString() const override = 0;

    /** Sets the current value to a new value. */
    z0 setValueAsString (const Txt& newValue) override = 0;

    /** @internal */
    f64 getCurrentValue() const final         { return getCurrentValueAsString().getDoubleValue(); }
    /** @internal */
    z0 setValue (f64 newValue) final        { setValueAsString (Txt (newValue)); }
    /** @internal */
...
/** A value interface that represents a non-ranged numeric value.
    ...
    @tags{Accessibility}
*/
class DRX_API  AccessibilityNumericValueInterface  : public AccessibilityValueInterface
{
public:
    /** Возвращает true, если the value is read-only and cannot be modified by an
        accessibility client.
    ...
    */
    ...
    /** Returns the current value. */
    f64 getCurrentValue() const override = 0;

    /** Sets the current value to a new value. */
    z0 setValue (f64 newValue) override = 0;

    /** @internal */
    Txt getCurrentValueAsString() const final          { return Txt (getCurrentValue()); }
    /** @internal */
    z0 setValueAsString (const Txt& newValue) final  { setValue (newValue.getDoubleValue()); }
    /** @internal */
    AccessibleValueRange getRange() const final           { return {}; }
};
...
/** A value interface that represents a ranged numeric value.
    ...
    @tags{Accessibility}
*/
class DRX_API  AccessibilityRangedNumericValueInterface  : public AccessibilityValueInterface
{
public:
    /** Возвращает true, если the value is read-only and cannot be modified by an
        accessibility client.
