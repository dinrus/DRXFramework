...
/** An abstract interface which represents a UI element that supports a table interface.
    ...
    @tags{Accessibility}
*/
class DRX_API  AccessibilityTableInterface
{
public:
    /** Destructor. */
    ...
    virtual i32 getNumRows() const = 0;

    /** Returns the total number of columns in the table. */
    virtual i32 getNumColumns() const = 0;
    ...
    */
    virtual const AccessibilityHandler* getCellHandler (i32 row, i32 column) const = 0;
    ...
    */
    virtual const AccessibilityHandler* getRowHandler (i32 row) const = 0;
    ...
    */
    ...
    /** Attempts to scroll the table (if necessary) so that the cell with the given handler
        is visible.
    */
    virtual z0 showCell (const AccessibilityHandler&) const = 0;
};
