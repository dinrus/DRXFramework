...
/**
    ...
    You can convert a ValueTree to and from an XmlElement, and as i64 as the XML doesn't
    ...
    @tags{DataStructures}
*/
class DRX_API  ValueTree  final
{
    DRX_PUBLIC_IN_DLL_BUILD (class SharedObject)
...
public:
    ...
    */
    ...
    /** Возвращает true, если both this and the other tree refer to the same underlying structure.
    ...
    */
    b8 operator== (const ValueTree&) const noexcept;

    /** Возвращает true, если this and the other tree refer to different underlying structures.
        Note that this isn't a value comparison - two independently-created trees which
        contain identical data are not considered equal.
    */
    b8 operator!= (const ValueTree&) const noexcept;
    ...
    */
    b8 isEquivalentTo (const ValueTree&) const;

    //==============================================================================
    /** Возвращает true, если this tree refers to some valid data.
        An invalid tree is one that was created with the default constructor.
    */
    b8 isValid() const noexcept                           { return object != nullptr; }
    ...
    */
    z0 copyPropertiesFrom (const ValueTree& source, UndoManager* undoManager);

    /** Replaces all children and properties of this object with copies of those from
        the source object.
        @see copyPropertiesFrom
    */
    z0 copyPropertiesAndChildrenFrom (const ValueTree& source, UndoManager* undoManager);
    ...
    */
    ...
    /** Возвращает true, если the tree has this type.
        The comparison is case-sensitive.
        @see getType
    */
    b8 hasType (const Identifier& typeName) const noexcept;

    //==============================================================================
    /** Returns the value of a named property.
        If no such property has been set, this will return a z0 variant.
    ...
    */
    ...
    /** Returns the value of a named property.
        If no such property has been set, this will return a z0 variant. This is the same as
        calling getProperty().
        @see getProperty
    */
    ...
    */
    ...
    /** Возвращает true, если the tree contains a named property. */
    ...
    */
    ...
    /** Returns the total number of properties that the tree contains.
        @see getProperty.
    */
    i32 getNumProperties() const noexcept;
    ...
    */
    Identifier getPropertyName (i32 index) const noexcept;
    ...
    */
    ValueTree getChild (i32 index) const;
    ...
    */
    z0 addChild (const ValueTree& child, i32 index, UndoManager* undoManager);
    ...
    */
    z0 appendChild (const ValueTree& child, UndoManager* undoManager);

    /** Removes the specified child from this tree's child-list.
        If the undoManager parameter is not nullptr, its UndoManager::perform() method will be used,
        so that this change can be undone. Be very careful not to mix undoable and non-undoable changes!
    */
    z0 removeChild (const ValueTree& child, UndoManager* undoManager);
    ...
    */
    ...
    /** Возвращает true, если this tree is a sub-tree (at any depth) of the given parent.
        This searches recursively, so returns true if it's a sub-tree at any level below the parent.
    */
    b8 isAChildOf (const ValueTree& possibleParent) const noexcept;
    ...
    */
    ...
    /** Returns one of this tree's siblings in its parent's child list.
        ...
        invalid object.
    */
    ValueTree getSibling (i32 delta) const noexcept;
    ...
    */
    struct Iterator
    {
        Iterator (const ValueTree&, b8 isEnd);
        Iterator& operator++();

        b8 operator== (const Iterator&) const;
        b8 operator!= (const Iterator&) const;
    ...
    */
    ...
    /** Tries to recreate a tree from its XML representation.
        ...
        by the createXml() method.
    */
    static ValueTree fromXml (const Txt& xmlText);
    ...
    /** This returns a string containing an XML representation of the tree.
        ...
        @see createXml()
    */
    Txt toXmlString (const XmlElement::TextFormat& format = {}) const;
    ...
    */
    ...
    public:
        ...
        */
        virtual z0 valueTreePropertyChanged (ValueTree& treeWhosePropertyHasChanged,
        ...
        */
        virtual z0 valueTreeChildAdded (ValueTree& parentTree,
        ...
        /** This method is called when a child sub-tree is removed.
            ...
            just check the parentTree parameter to make sure it's the one that you're interested in.
        */
        virtual z0 valueTreeChildRemoved (ValueTree& parentTree,
                                            ValueTree& childWhichHasBeenRemoved,
                                            i32 indexFromWhichChildWasRemoved);
        ...
        */
        virtual z0 valueTreeChildOrderChanged (ValueTree& parentTreeWhoseChildrenHaveMoved,
                                                 i32 oldIndex, i32 newIndex);
        ...
        */
        virtual z0 valueTreeParentChanged (ValueTree& treeWhoseParentHasChanged);
        ...
        /** This method is called when a tree is made to point to a different internal shared object.
            ...
            will be made.
        */
        virtual z0 valueTreeRedirected (ValueTree& treeWhichHasBeenChanged);
    };
    ...
    /** Adds a listener to receive callbacks when this tree is changed in some way.
        ...
        will last for as i64 as you need the listener. In general, you'd never want to add a
    ...
    */
    z0 sendPropertyChangeMessage (const Identifier& property);
    ...
    /** This method uses a comparator object to sort the tree's children into order.
        ...
        @code
        i32 compareElements (const ValueTree& first, const ValueTree& second);
        @endcode
    ...
    */
    ...
    z0 sort (ElementComparator& comparator, UndoManager* undoManager, b8 retainOrderOfEquivalentItems)
    {
        if (object != nullptr)
        {
...
private:
    ...
    struct ComparatorAdapter
    {
        ...
        i32 compareElements (const ValueTree* const first, const ValueTree* const second)
        {
    ...
    private:
        ...
        DRX_DECLARE_NON_COPYABLE (ComparatorAdapter)
    };

    z0 createListOfChildren (OwnedArray<ValueTree>&) const;
    z0 reorderChildren (const OwnedArray<ValueTree>&, UndoManager*);
