...
/**
    ...
    @tags{DataStructures}
*/
class DRX_API  ValueTreePropertyWithDefault  : private Value::Listener
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Creates a ValueTreePropertyWithDefault object for the specified property.
        ...
        it will handle the conversion to/from a delimited Txt that can be written to
        XML format.
    */
    ValueTreePropertyWithDefault (ValueTree& tree,
                                  const Identifier& propertyID,
    ...
    */
    ...
    z0 setDefault (const var& newDefault)  { defaultValue = newDefault; }

    /** Возвращает true, если the property does not exist in the referenced ValueTree. */
    b8 isUsingDefault() const              { return ! targetTree.hasProperty (targetProperty); }

    /** Removes the property from the referenced ValueTree. */
    z0 resetToDefault() noexcept           { targetTree.removeProperty (targetProperty, nullptr); }
    ...
    /** You can assign a lambda to this callback and it will called when the default
        ...
        @see setDefault
    */
    std::function<z0()> onDefaultChange;
    ...
    */
    ...
    /** Sets the property.
        ...
        This will modify the property in the referenced ValueTree.
    */
    z0 setValue (const var& newValue, UndoManager* undoManagerToUse)
    {
...
private:
    ...
    private:
        ...
        DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SynchronousValueSource)
    };

    //==============================================================================
    static Txt varArrayToDelimitedString (const Array<var>& input, StringRef delim)
    {
    ...
    z0 referToWithDefault (ValueTree v,
                             const Identifier& i,
                             UndoManager* um,
    ...
    //==============================================================================
    DRX_LEAK_DETECTOR (ValueTreePropertyWithDefault)
};
