...
/** Wrapper on a file that stores a list of key/value data pairs.
    ...
    @tags{DataStructures}
*/
class DRX_API  PropertiesFile  : public PropertySet,
...
public:
    ...
    */
    ...
    //==============================================================================
    /** Возвращает true, если this file was created from a valid (or non-existent) file.
        If the file failed to load correctly because it was corrupt or had insufficient
        access, this will be false.
    */
    b8 isValidFile() const noexcept               { return loadedOk; }
    ...
    */
    ...
    /** Возвращает true, если the properties have been altered since the last time they were saved.
...
protected:
    /** @internal */
    z0 propertyChanged() override;

private:
    //==============================================================================
    File file;
    Options options;
    b8 loadedOk = false, needsWriting = false;
    ...
    b8 loadAsXml();
    b8 loadAsBinary();
    b8 loadAsBinary (InputStream&);
    b8 writeToStream (OutputStream&);

    DRX_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PropertiesFile)
};
