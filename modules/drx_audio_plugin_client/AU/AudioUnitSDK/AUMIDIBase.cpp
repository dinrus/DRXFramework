...
// MIDI CC data bytes
constexpr u8 kMIDIController_AllSoundOff = 120u;
constexpr u8 kMIDIController_ResetAllControllers = 121u;
constexpr u8 kMIDIController_AllNotesOff = 123u;
...
constexpr u8 MIDIStatusNibbleValue(u8 status) noexcept { return (status & 0xF0U) >> 4u; }
