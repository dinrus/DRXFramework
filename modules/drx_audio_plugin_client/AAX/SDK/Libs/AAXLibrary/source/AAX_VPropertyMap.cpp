...
AAX_VPropertyMap* AAX_VPropertyMap::Create( IACFUnknown * inComponentFactory )
{
	...
	if ( inComponentFactory )
	{
		...
		if ( inComponentFactory->QueryInterface(IID_IACFComponentFactory, (uk *)&pFactory) == ACF_OK )
		{
...
// ******************************************************************************************
z0 AAX_VPropertyMap::InitWithFactory(IACFComponentFactory *inComponentFactory, IACFUnknown* inAuxiliaryUnknown)
{
	if (inComponentFactory)
	{
		// Create the object and get the base interface for it.
		inComponentFactory->CreateComponent(AAXCompID_AAXPropertyMap, 0, IID_IAAXPropertyMapV1, (uk *)&mIACFPropertyMap);
		
		if (mIACFPropertyMap)
		{
			mIACFPropertyMap->QueryInterface(IID_IAAXPropertyMapV2, (uk *)&mIACFPropertyMapV2);
			mIACFPropertyMap->QueryInterface(IID_IAAXPropertyMapV3, (uk *)&mIACFPropertyMapV3);
		}
		...
		{
			inAuxiliaryUnknown->QueryInterface(IID_IAAXDescriptionHostV1, (uk*)&mIACFDescriptionHost);
		}
		if (mIACFDescriptionHost.isNull())
		{
			inComponentFactory->QueryInterface(IID_IAAXDescriptionHostV1, (uk*)&mIACFDescriptionHost);
		}
		if (mIACFPropertyMapV2 && mIACFDescriptionHost.isNull())
		{
			mIACFPropertyMapV2->QueryInterface(IID_IAAXDescriptionHostV1, (uk*)&mIACFDescriptionHost);
		}
		if (mIACFPropertyMapV3 && mIACFDescriptionHost.isNull())
		{
			mIACFPropertyMapV3->QueryInterface(IID_IAAXDescriptionHostV1, (uk*)&mIACFDescriptionHost);
		}
		if (mIACFPropertyMap && mIACFDescriptionHost.isNull())
		{
			mIACFPropertyMap->QueryInterface(IID_IAAXDescriptionHostV1, (uk*)&mIACFDescriptionHost);
		}
	}
}
...
// ******************************************************************************************
z0 AAX_VPropertyMap::InitWithPropertyMap(IACFUnknown *inPropertyMapUnknown, IACFUnknown* inAuxiliaryUnknown)
{
	if (inPropertyMapUnknown)
	{
		inPropertyMapUnknown->QueryInterface(IID_IAAXPropertyMapV1, (uk *)&mIACFPropertyMap);
		inPropertyMapUnknown->QueryInterface(IID_IAAXPropertyMapV2, (uk *)&mIACFPropertyMapV2);
		inPropertyMapUnknown->QueryInterface(IID_IAAXPropertyMapV3, (uk *)&mIACFPropertyMapV3);
		...
		if (mIACFDescriptionHost.isNull())
		{
			inPropertyMapUnknown->QueryInterface(IID_IAAXDescriptionHostV1, (uk*)&mIACFDescriptionHost);
		}
	}
}
...
// METHOD:	~AAX_VPropertyMap
// ******************************************************************************************
AAX_VPropertyMap::~AAX_VPropertyMap(z0)
{
}
...
// METHOD:	GetProperty
// ******************************************************************************************
AAX_CBoolean AAX_VPropertyMap::GetPointerProperty ( AAX_EProperty inProperty, ukk* outValue ) const
{
...
// ******************************************************************************************
AAX_Result AAX_VPropertyMap::AddPointerProperty ( AAX_EProperty inProperty, ukk inValue )
{
...
// METHOD:	AddPointerProperty
// ******************************************************************************************
AAX_Result AAX_VPropertyMap::AddPointerProperty ( AAX_EProperty inProperty, tukk inValue )
{
	return this->AddPointerProperty(inProperty, reinterpret_cast<ukk>(inValue));
}
...
// ******************************************************************************************
AAX_Result AAX_VPropertyMap::AddPropertyWithIDArray ( AAX_EProperty iProperty, const AAX_SPlugInIdentifierTriad* iPluginIDs, u32 iNumPluginIDs)
{
...
// ******************************************************************************************
AAX_CBoolean AAX_VPropertyMap::GetPropertyWithIDArray ( AAX_EProperty iProperty, const AAX_SPlugInIdentifierTriad** oPluginIDs, u32* oNumPluginIDs) const
{
	AAX_CBoolean	result = 0;
