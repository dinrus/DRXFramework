...
AAX_Result AAX_CEffectDirectData::Uninitialize (z0)
{
...
AAX_IController* AAX_CEffectDirectData::Controller(z0)
{
	return mController;
}

AAX_IEffectParameters* AAX_CEffectDirectData::EffectParameters(z0)
{
...
AAX_Result AAX_CEffectDirectData::NotificationReceived( AAX_CTypeID ,ukk  ,u32 )
{
    return AAX_SUCCESS;
}
