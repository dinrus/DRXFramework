	...
	mIACFEffectDescriptorV2( NULL )
{
	if ( mUnkHost )
	{
		...
		if ( pUnkHost->QueryInterface(IID_IACFComponentFactory, (uk *)&pFactory) == ACF_OK )
		{
			...
			pFactory->CreateComponent(AAXCompID_AAXEffectDescriptor, 0, IID_IAAXEffectDescriptorV1, (uk *)&mIACFEffectDescriptor);
            if (mIACFEffectDescriptor)
                mIACFEffectDescriptor->QueryInterface(IID_IAAXEffectDescriptorV2, (uk*)&mIACFEffectDescriptorV2);
		}
	}
}
...
// ******************************************************************************************
IACFUnknown*							
AAX_VEffectDescriptor::GetIUnknown(z0) const
{
...
// METHOD:	AddName
// ******************************************************************************************
AAX_Result AAX_VEffectDescriptor::AddName( const t8 * inPlugInName )
{
	if ( mIACFEffectDescriptor )
...
// METHOD:	AddCategory
// ******************************************************************************************
AAX_Result AAX_VEffectDescriptor::AddCategory( u32 inCategory )
{
	if ( mIACFEffectDescriptor )
...
// ******************************************************************************************
AAX_Result AAX_VEffectDescriptor::AddCategoryBypassParameter ( u32 inCategory, AAX_CParamID inParamID )
{
	if ( mIACFEffectDescriptor )
...
// METHOD:	AddProcPtr
// ******************************************************************************************
AAX_Result AAX_VEffectDescriptor::AddProcPtr( uk  inProcPtr, AAX_CProcPtrID inProcID )
{
	if ( mIACFEffectDescriptor )
...
// ******************************************************************************************
AAX_Result AAX_VEffectDescriptor::AddResourceInfo ( AAX_EResourceType inResourceType, const t8 * inFileName )
{
	if ( mIACFEffectDescriptor )
...
// ******************************************************************************************
AAX_Result AAX_VEffectDescriptor::AddMeterDescription( AAX_CTypeID inMeterID, const t8 * inMeterName, AAX_IPropertyMap * inProperties )
{
	if ( mIACFEffectDescriptor )
	{
...
// ******************************************************************************************
AAX_Result AAX_VEffectDescriptor::AddControlMIDINode ( AAX_CTypeID inNodeID, AAX_EMIDINodeType inNodeType, const t8 inNodeName[], u32 channelMask )
{
