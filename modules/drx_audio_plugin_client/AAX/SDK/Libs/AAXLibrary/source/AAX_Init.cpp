...
AAX_Result AAXRegisterPlugin(IACFUnknown * pUnkHost, IACFPluginDefinition **ppPluginDefinition)
{
	...
	try
	{
		...
		*ppPluginDefinition = 0;
		if ( collection.GetIUnknown()->QueryInterface(IID_IACFPluginDefinition, (uk*)ppPluginDefinition) != ACF_OK )
...
AAX_Result AAXGetClassFactory (IACFUnknown * /*pUnkHost*/, const acfCLSID& /*clsid*/, const acfIID& /*iid*/, uk* ppOut)
{
	*ppOut = NULL;	
