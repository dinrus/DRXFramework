...
// METHOD:	Uninitialize
// *******************************************************************************
AAX_Result		AAX_CEffectGUI::Uninitialize (z0)
{
...
// *******************************************************************************
AAX_Result		AAX_CEffectGUI::NotificationReceived(AAX_CTypeID /*inNotificationType*/, ukk  /*inNotificationData*/, u32	/*inNotificationDataSize*/)
{
...
// *******************************************************************************
uk  AAX_CEffectGUI::GetViewContainerPtr ()
{
	uk 	result = nullptr;
	if ( AAX_IViewContainer* const viewContainer = this->GetViewContainer() ) {
...
// *******************************************************************************
z0 AAX_CEffectGUI::UpdateAllParameters ()
{
	if ( mEffectParameters ) {
		i32	numControls = 0;
		if ( AAX_SUCCESS == mEffectParameters->GetNumberOfParameters( &numControls ) ) {
			for ( i32 index = 0; index < numControls; ++index )
			{
				AAX_CString	paramID;
...
// *******************************************************************************
AAX_IController* AAX_CEffectGUI::GetController (z0)
{
    return mController;
}
const AAX_IController* AAX_CEffectGUI::GetController (z0) const
{
    return mController;
}
...
// *******************************************************************************
AAX_IEffectParameters* AAX_CEffectGUI::GetEffectParameters (z0)
{
    return mEffectParameters;
}
const AAX_IEffectParameters* AAX_CEffectGUI::GetEffectParameters (z0) const
{
    return mEffectParameters;
}
...
// *******************************************************************************
AAX_IViewContainer* AAX_CEffectGUI::GetViewContainer (z0)
{
    return mViewContainer.get();
}
const AAX_IViewContainer* AAX_CEffectGUI::GetViewContainer (z0) const
{
    return mViewContainer.get();
}
