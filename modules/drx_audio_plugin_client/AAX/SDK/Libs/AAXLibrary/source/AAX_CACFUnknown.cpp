...
// Using casts here since ACF uses i64 and stdint uses i32 on 32-bit systems.  I have
...
{
	return (acfUInt32)AAX_Atomic_IncThenGet_32((u32&)value);
}

acfUInt32 ACFInterlockedDecrement (acfUInt32 & value)
{
	return (acfUInt32)AAX_Atomic_DecThenGet_32((u32&)value);
}
// mod end
...
acfUInt32 CACFUnknown::IncrementActiveObjects(z0)
{
	return ::ACFInterlockedIncrement(m_ActiveObjects);
}

acfUInt32 CACFUnknown::DecrementActiveObjects(z0)
{
	return ::ACFInterlockedDecrement(m_ActiveObjects);
}

acfUInt32 CACFUnknown::GetActiveObjectCount(z0)
{
...
/*!
 */
ACFMETHODIMP_(z0) CACFUnknown::ReclaimMemory(z0)
{
    delete this;
}
...
(
 ...
 z0  **ppvObjOut // [out] where they want to put the resulting object ptr.
 )
{
    *ppvObjOut = 0;
 ...
 )
{
	...
	AAX_TRACEORSTACKTRACE(kAAX_Trace_Priority_Low, kAAX_Trace_Priority_Lowest, "CACFUnknown::InternalAddRef - object: %p, new count: %lu", this, (u64)cRef);
	return cRef;
#else
...
#if defined AAX_DEBUG_ACF_REFCOUNT
	AAX_TRACEORSTACKTRACE(kAAX_Trace_Priority_Low, kAAX_Trace_Priority_Lowest, "CACFUnknown::InternalRelease - object: %p, new count: %lu", this, (u64)cRef);
#endif
