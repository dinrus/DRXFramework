...
:	mIPrivateDataAccess(NULL)
{
	if ( pUnknown )
	{
		pUnknown->QueryInterface(IID_IAAXPrivateDataAccessV1, (uk *)&mIPrivateDataAccess);
	}	
}
...
// ******************************************************************************************
AAX_Result AAX_VPrivateDataAccess::ReadPortDirect( AAX_CFieldIndex inFieldIndex, u32k inOffset, u32k inSize, uk outBuffer )
{
...
// ******************************************************************************************
AAX_Result AAX_VPrivateDataAccess::WritePortDirect( AAX_CFieldIndex inFieldIndex, u32k inOffset, u32k inSize, ukk inBuffer )
{
	if ( mIPrivateDataAccess )
