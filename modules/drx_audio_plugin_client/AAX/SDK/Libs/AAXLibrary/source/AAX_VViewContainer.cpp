...
AAX_VViewContainer::AAX_VViewContainer( IACFUnknown* pUnknown )
{
	if ( pUnknown )
	{
		pUnknown->QueryInterface ( IID_IAAXViewContainerV1, (uk *) &mIViewContainer );
		pUnknown->QueryInterface ( IID_IAAXViewContainerV2, (uk *) &mIViewContainerV2 );
		pUnknown->QueryInterface ( IID_IAAXViewContainerV3, (uk *) &mIViewContainerV3 );
	}
}
...
AAX_VViewContainer::~AAX_VViewContainer()
{
	...
	try {
		...
		AAX_TRACE_RELEASE(kAAX_Trace_Priority_High, "AAX_VViewContainer error when detaching mIViewContainer: %d", (i32)r);
	}
	try {
		if (mIViewContainerV2) { mIViewContainerV2.detach(); }
	}
	catch (ACFRESULT r) {
		AAX_TRACE_RELEASE(kAAX_Trace_Priority_High, "AAX_VViewContainer error when detaching mIViewContainerV2: %d", (i32)r);
	}
	try {
		if (mIViewContainerV3) { mIViewContainerV3.detach(); }
	}
	catch (ACFRESULT r) {
		AAX_TRACE_RELEASE(kAAX_Trace_Priority_High, "AAX_VViewContainer error when detaching mIViewContainerV3: %d", (i32)r);
	}
}
...
// METHOD:	GetType
// ******************************************************************************************
i32 AAX_VViewContainer::GetType ()
{
	i32	result = AAX_eViewContainer_Type_NULL;
...
// METHOD:	GetModifiers
// ******************************************************************************************
AAX_Result AAX_VViewContainer::GetModifiers ( u32 * outModifiers )
{
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleParameterMouseDown ( AAX_CParamID inParamID, u32 inModifiers )
{
	AAX_Result	result = AAX_ERROR_UNIMPLEMENTED;
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleParameterMouseDrag ( AAX_CParamID inParamID, u32 inModifiers )
{
	AAX_Result	result = AAX_ERROR_UNIMPLEMENTED;
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleParameterMouseUp ( AAX_CParamID inParamID, u32 inModifiers )
{
	AAX_Result	result = AAX_ERROR_UNIMPLEMENTED;
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleParameterMouseEnter(AAX_CParamID inParamID, u32 inModifiers)
{
	AAX_Result    result = AAX_ERROR_UNIMPLEMENTED;
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleParameterMouseExit(AAX_CParamID inParamID, u32 inModifiers)
{
	AAX_Result    result = AAX_ERROR_UNIMPLEMENTED;
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleMultipleParametersMouseDown ( const AAX_CParamID* inParamIDs, u32 iNumOfParams, u32 inModifiers )
{
	AAX_Result	result = AAX_ERROR_UNIMPLEMENTED;
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleMultipleParametersMouseDrag ( const AAX_CParamID* inParamIDs, u32 iNumOfParams, u32 inModifiers )
{
	AAX_Result	result = AAX_ERROR_UNIMPLEMENTED;
...
// ******************************************************************************************
AAX_Result AAX_VViewContainer::HandleMultipleParametersMouseUp ( const AAX_CParamID* inParamIDs, u32 iNumOfParams, u32 inModifiers )
{
	AAX_Result	result = AAX_ERROR_UNIMPLEMENTED;
