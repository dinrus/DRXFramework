	...
	, mIHostProcessorDelegateV3(NULL)
{
	if ( pUnknown )
	{
		pUnknown->QueryInterface(IID_IAAXHostProcessorDelegateV3, (uk *)&mIHostProcessorDelegateV3);
		if (mIHostProcessorDelegateV3)
		{
			mIHostProcessorDelegate = mIHostProcessorDelegateV2 = mIHostProcessorDelegateV3;
		}
		else {
			pUnknown->QueryInterface(IID_IAAXHostProcessorDelegateV2, (uk *)&mIHostProcessorDelegateV2);
			if (mIHostProcessorDelegateV2)
			{
				mIHostProcessorDelegate = mIHostProcessorDelegateV2;
			}
			else {
				pUnknown->QueryInterface(IID_IAAXHostProcessorDelegateV1, (uk *)&mIHostProcessorDelegate);
			}
		}
	}
}
...
// METHOD:	GetAudio
// ******************************************************************************************
AAX_Result AAX_VHostProcessorDelegate::GetAudio ( const f32 * const inAudioIns [], i32 inAudioInCount, z64 inLocation, i32 * ioNumSamples )
{
...
// ******************************************************************************************
i32 AAX_VHostProcessorDelegate::GetSideChainInputNum ()
{
	i32	result = 0;
	if ( mIHostProcessorDelegate )
