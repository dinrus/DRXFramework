...
public:
	...
	/** @brief	Get a property value from a property map
			...
			Возвращает true, если the selected property is supported, false if it is not
	...
	*/
	 ...
	 */
	virtual AAX_CBoolean		GetPointerProperty ( AAX_EProperty inProperty, ukk* outValue ) const = 0;
	...
	*/
	 ...
	 */
	virtual AAX_Result			AddPointerProperty ( AAX_EProperty inProperty, ukk inValue ) = 0;
	virtual AAX_Result			AddPointerProperty ( AAX_EProperty inProperty, tukk inValue ) = 0; ///< @copydoc AddPointerProperty(AAX_EProperty, ukk)
	...
	*/
	 ...
	 */
    virtual AAX_Result          AddPropertyWithIDArray ( AAX_EProperty inProperty, const AAX_SPlugInIdentifierTriad* inPluginIDs, u32 inNumPluginIDs) = 0;
	 ...
	 */
    virtual AAX_CBoolean        GetPropertyWithIDArray ( AAX_EProperty inProperty, const AAX_SPlugInIdentifierTriad** outPluginIDs, u32* outNumPluginIDs) const = 0;
