...
public:
	...
	AAX_Result	GetAudio ( const f32 * const inAudioIns [], i32 inAudioInCount, z64 inLocation, i32 * ioNumSamples ) AAX_OVERRIDE; ///< \copydoc AAX_IHostProcessorDelegate::GetAudio()
	i32		GetSideChainInputNum () AAX_OVERRIDE; ///< \copydoc AAX_IHostProcessorDelegate::GetSideChainInputNum()
