...
public:
	 ...
	 */
	virtual	AAX_Result			NotificationReceived( /* AAX_ENotificationEvent */ AAX_CTypeID inNotificationType, ukk  inNotificationData, u32	inNotificationDataSize) = 0;
	 ...
	 */
	virtual AAX_Result			GetNumberOfParameters ( i32 * oNumControls )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterNumberOfSteps ( AAX_CParamID iParameterID, i32 * oNumSteps )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterNameOfLength ( AAX_CParamID iParameterID, AAX_IString * oName, i32 iNameLength )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterDefaultNormalizedValue ( AAX_CParamID iParameterID, f64 * oValue )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			SetParameterDefaultNormalizedValue ( AAX_CParamID iParameterID, f64 iValue ) = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterIndex ( AAX_CParamID iParameterID, i32 * oControlIndex )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterIDFromIndex ( i32 iControlIndex, AAX_IString * oParameterIDString )   const = 0;
	/*!
	 ...
	 */
	virtual AAX_Result			GetParameterValueInfo ( AAX_CParamID iParameterID, i32 iSelector, i32* oValue) const = 0;
	 ...
	 *
	 *	This method uses the queried parameter's display delegate and taper to convert a \c tuk
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterValueFromString ( AAX_CParamID iParameterID, f64 * oValue, const AAX_IString & iValueString )   const = 0;
	/*!
	 ...
	 *	normalized value into the corresponding \c tuk value string for its real value.
	 *  
	 ...
	 *
	 */
	virtual	AAX_Result			GetParameterStringFromValue ( AAX_CParamID iParameterID, f64 iValue, AAX_IString * oValueString, i32 iMaxLength )   const = 0;
	/*!
	 ...
	 *	its current value into a corresponding \c tuk value string.
	 *  
	 *	\param[in] iParameterID
	 *		The ID of the parameter that is being queried
	 *	\param[out] oValueString
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterValueString ( AAX_CParamID iParameterID, AAX_IString* oValueString, i32 iMaxLength  )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetParameterNormalizedValue ( AAX_CParamID iParameterID, f64 * oValuePtr )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			SetParameterNormalizedValue ( AAX_CParamID iParameterID, f64 iValue ) = 0;	
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			SetParameterNormalizedRelative ( AAX_CParamID iParameterID, f64 iValue ) = 0;
	 ...
	 *
	 */	
	virtual AAX_Result			UpdateParameterNormalizedValue ( AAX_CParamID iParameterID, f64 iValue, AAX_EUpdateSource iSource ) = 0; 
	/*!
	 ...
	 *		difference.
	 */	
	virtual AAX_Result			UpdateParameterNormalizedRelative ( AAX_CParamID iParameterID, f64 iValue ) = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			ResetFieldData (AAX_CFieldIndex inFieldIndex, uk  oData, u32 inDataSize) const = 0;
	 ...
	 *
	 */	
	virtual AAX_Result			GetNumberOfChunks ( i32 * oNumChunks )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetChunkIDFromIndex ( i32 iIndex, AAX_CTypeID * oChunkID )   const = 0;
	/*!
	 ...
	 *
	 */
	virtual AAX_Result			GetChunkSize ( AAX_CTypeID iChunkID, u32 * oSize )   const = 0;
	/*!
	 ...
	 *		initialization.
	 */
	virtual AAX_Result			GetNumberOfChanges ( i32 * oNumChanges )   const = 0;
	//@}end Chunk methods
	 ...
	 *
	 */
	virtual AAX_Result			GetCurveData( /* AAX_ECurveType */ AAX_CTypeID iCurveType, const f32 * iValues, u32 iNumValues, f32 * oValues ) const = 0;
	 ...
	 */
	virtual AAX_Result			GetCustomData( AAX_CTypeID iDataBlockID, u32 inDataSize, uk oData, u32* oDataWritten) const = 0;
	 ...
	 */
	virtual AAX_Result			SetCustomData( AAX_CTypeID iDataBlockID, u32 inDataSize, ukk iData ) = 0;
...
public:
	 ...
	 *
	 */
	virtual AAX_Result			GetCurveDataMeterIds( /* AAX_ECurveType */ AAX_CTypeID iCurveType, u32 *oXMeterId, u32 *oYMeterId)  const = 0;
	 ...
	 *
	 */
	virtual AAX_Result          GetCurveDataDisplayRange( /* AAX_ECurveType */ AAX_CTypeID iCurveType, f32 *oXMin, f32 *oXMax, f32 *oYMin, f32 *oYMax ) const = 0;
	//@}end Auxiliary UI methods
};
...
public:
	 ...
	 *		Four-t8 type identifier for the table type (e.g. \c 'PgTL', \c 'Av81', etc.)
	 ...
	 *
	 */
	virtual AAX_Result UpdatePageTable(u32 inTableType, i32 inTablePageSize, IACFUnknown* iHostUnknown, IACFUnknown* ioPageTableUnknown) const = 0;
	//@}end Auxiliary UI methods
};
