...
public:
	 ...
	 *	@returns \b false if pending transfers are not complete
 	 */
	virtual i32		AAX_DMA_API		IsTransferComplete() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetSrc( i8 * iSrc ) = 0;
	/**	@brief Gets the address of the source buffer
	 */
	virtual i8 *		AAX_DMA_API		GetSrc() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetDst( i8 * iDst ) = 0;
	/**	@brief Gets the address of the destination buffer
	 */
	virtual i8 *		AAX_DMA_API		GetDst() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetBurstLength( i32 iBurstLengthBytes ) = 0;
	/**	@brief Gets the length of each burst
	 */
	virtual i32			AAX_DMA_API		GetBurstLength() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetNumBursts( i32 iNumBursts ) = 0;
	/**	@brief Gets the number of bursts to perform before giving up priority to other DMA transfers
	 */
	virtual i32			AAX_DMA_API		GetNumBursts() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetTransferSize( i32 iTransferSizeBytes ) = 0;
	/**	@brief Gets the size of the whole transfer, in Bytes
	 */
	virtual i32			AAX_DMA_API		GetTransferSize() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetOffsetTable( const i32 * iOffsetTable ) = 0;
	/**	@brief Gets the offset table for the DMA transfer
	 */
	virtual const i32 *	AAX_DMA_API		GetOffsetTable() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetNumOffsets( i32 iNumOffsets ) = 0;
	/**	@brief Gets the number of offets in the offset table
	 */
	virtual i32			AAX_DMA_API		GetNumOffsets() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetBaseOffset( i32 iBaseOffsetBytes ) = 0;
	/**	@brief Gets the relative base offset into the FIFO where transfers will begin
	 */
	virtual i32			AAX_DMA_API		GetBaseOffset() = 0;
	 ...
	 *
 	 *	@returns \c AAX_SUCCESS on success
	 */
	virtual AAX_Result		AAX_DMA_API		SetFifoSize( i32 iSizeBytes ) = 0;
	/**	@brief Gets the size of the FIFO buffer, in bytes
	 */
	virtual i32			AAX_DMA_API		GetFifoSize() = 0;
