...
typedef ACFRESULT (*ACFCreateObjectProc)(IACFUnknown *, IACFUnknown *, const acfIID& iid, uk* ppOut); 
...
public:
    ...
    static ACFRESULT Create (ACFCreateObjectProc pfnCreate, const acfIID& iid, uk* ppOut);
...
protected:
	...
	// ACFUnknown override
	ACFMETHOD(InternalQueryInterface)(const acfIID & riid, uk *ppv) ACF_OVERRIDE;

public:
	// IACFClassFactory methods 
	ACFMETHOD(CreateInstance)(IACFUnknown * pUnkHost, IACFUnknown * pUnkOuter, const acfIID & riid, uk * ppv) ACF_OVERRIDE;
