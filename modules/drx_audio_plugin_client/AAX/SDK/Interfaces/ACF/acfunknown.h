...
/*!
  ...
  We need the following definition for a b8 type since
  the Win32 used BOOL as an i32 and ActiveX SDK, MacOLE use
  u64 for OLEBOOL.
...
#define DECLARE_ACFINTERFACE_(iface, baseiface)    acfinterface iface : public baseiface
   ...
   #define BEGIN_ACFINTERFACE virtual z0 a() {}
 ...
 */
	virtual ACFRESULT ACFMETHODCALLTYPE QueryInterface (const acfIID & iid, uk * ppOut) = 0;
 ...
 */
	virtual acfUInt32 ACFMETHODCALLTYPE AddRef (z0) = 0;
 ...
 */
	virtual acfUInt32 ACFMETHODCALLTYPE Release (z0) = 0;
};
