...
\n <b> UID Txt: </b> 045d982d-51a2-3393-a0fb-e86ebdec0027
*/	
...
\n <b> UID Txt: </b> 4C95268F-71F6-4c52-B498-A640ABC75A12
*/	
...
\n <b> type: </b> UIDS;  \n <b> method:  </b>CreateComponent; \n <b> context: </b> global \n
\n <b> ACFNamespace name: </b>
\n <b> UID Txt: </b> DBC683A8-40CD-4abd-9ABC-8528C2509F8F
*/	
...
//@{   
  ...
  */ 
	...
	*/
	...
	\n <b> type: </b> UIDS;  \n <b> method:  </b>IAVXParameterDefinition; \n <b> context: </b> global \n
	\n <b> ACFNamespace name: </b> com.avid.component.type.t8
	\n <b> UID Txt: </b> f3f962a3-bb90-3e7d-afe4-8242bc3e4711
	*/
	...
	*/
    ...
    /*! 
		\defgroup GuidStringTypes UIDS: Txt Types 
	\n \note Txt types are null terminated
	*/
	//@{
	...
	*/
	...
	/*! 
	\defgroup PersistentGuidStringTypes UIDS: Private Txt Types 
	\n \note Txt types are null terminated
	*/
	//@{
	...
	*/
	...
	\n <b> type: </b> UIDS;  \n <b> method:  </b>IAVXParameterDefinition; \n <b> context: </b> global \n
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> 5FFF159C-C1F0-4093-B701-02AA4ACE2FD5
	*/
	...
	\n <b> type: </b> UIDS;  \n <b> method:  </b>IAVXParameterDefinition; \n <b> context: </b> global \n
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> E1C94795-A4EB-46a0-8132-9085C235079A
	*/
	...
	\n <b> type: </b> UIDS;  \n <b> method:  </b>IAVXParameterDefinition; \n <b> context: </b> global \n
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> C6B68935-3015-4ecd-B7BA-1750295DE9A8
	*/
    ...
    */
	...
	/*!
	 ...
	 \n <b> UID Txt: </b> ddf6e71d-f596-3b6a-b47b-1de3e6fc1710
	 */
	...
	/*!
	 ...
	 \n <b> type: </b> acfRect  \n <b> method:  </b>IACFValue; \n <b> context: </b> global \n
	 \n <b> UID Txt: </b> 6c64c82c-3941-36c4-a8bb-c6c1caa15313
	 */
	...
	/*!
	 ...
	 \n <b> type: </b> acfSize  \n <b> method:  </b>IACFValue; \n <b> context: </b> global \n
	 \n <b> UID Txt: </b> abc15b28-60fa-371e-a9ea-95edbe1f9ebd
	 */
	...
	/*!
	 ...
	 \n <b> UID Txt: </b> a73f3bf4-1d20-3d0e-a328-024e8d5ad043
	 */
	...
	/*!
	 ...
	 \n <b> UID Txt: </b> 25eff40a-ec3d-319e-8c53-a21debd06ea9
	 */
...
//@{	
 ...
 //@{	
	...
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> 6B8C6DB2-4B6F-497f-AB9B-AF2635CD7538
	*/
	...
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> 04D8E7A8-EE65-4525-BD6D-EF8E9BA28C2A
	*/
	...
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> // 1C1B7D33-793B-4260-891A-A904F13C2735
	*/
	...
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> A3F7AE7E-4DA7-4c20-851E-4736E86E705E
	*/
...
//@{
	...
	\n <b> ACFNamespace name: </b>
	\n <b> UID Txt: </b> {6E10012D-2164-438b-8755-E62EE434040E}
	 */
...
/*!
	...
	\n <b> UID Txt: </b>	1a47fb2d-ef70-338e-b7bf-e824cee15284
 */
...
/*!
	...
	Used to override the display precision for f64 parameters. This is valid to 0 to display f64 parameters as integers.
	...
	\n <b> UID Txt: </b>	83bcd82e-133d-3b08-82b6-cd45ca5f7424
 */
...
/*!	
	...
	\n <b> UID Txt: </b>	27995d37-50aa-36ec-b458-089602dcb96d
 */
...
/*!
	...
	\n <b> UID Txt: </b>	C38E4D31-42A1-4d8f-9580-CA8326597EEA
 */
...
\n <b> type: </b> Boolean  \n <b> method:  </b>IAVXParameterDefinition; \n <b> context: </b> parameter definition \n
\n <b> AVX Namespace name: </b> 
\n <b> UID Txt: </b>	72CFF9FA-4EC9-435c-B82A-BEC4B6452E59
*/
...
/*!
	...
	\n <b> type: </b> Boolean  \n <b> method:  </b>IAVXParameterDefinition; \n <b> context: </b> parameter definition \n
	\n <b> AVX Namespace name: </b>
	\n <b> UID Txt: </b>	B5D3B187-84A9-46EC-B5D3-D77CE2632873
*/
...
/*!
	...
	\n <b> UID Txt: </b> D3306718-7B0A-4af3-85D6-CAE0D4F100F3
 */
...
/*!
	...
	\n <b> UID Txt: </b> 3ce128c3-4efd-32d8-a282-d678b150f419
 */
...
/*!
	...
	\n <b> UID Txt: </b> fc03f25f-39c5-3044-82e7-cbb20245e54e
 */
...
\n <b> type: </b> acfBool;  \n <b> method:  </b>IAVXLayoutDefinition; \n <b> context: </b> layout definition \n
\n <b> UID Txt: </b> 1C0D5318-6035-4b4c-831B-DF71E3BD5152
*/
...
\n <b> type: </b> acfBoolean;  \n <b> method:  </b>IAVXLayoutDefinition; \n <b> context: </b> parameter definition \n
\n <b> UID Txt: </b> 8FFF1ACF-187B-45cb-85D0-CEDC576CC77B
*/
...
/*!
	...
	\n <b> UID Txt: </b> f22bc77f-0e0a-34a7-b0a5-3efae9efa7e1
...
/*!
	...
	\n <b> UID Txt: </b> 9d2fdae5-cbc5-3ee8-b384-1bbbcefe5bd8
*/
...
/*!
	...
	\n <b> UID Txt: </b> 1e2edea8-3314-3a90-b03b-f3c9c211d57a
*/
...
/*!
	...
	\n <b> UID Txt: </b> dff4738b-272c-3f49-88a1-4490cc657297
*/
...
/*!
	...
	\n <b> UID Txt: </b> d238ff99-2cd7-370c-9da6-4fda5fd4b3b7
*/
...
\n <b> UID Txt: </b> 625675dc-eba5-345e-8460-77b262998442
*/
...
\n <b> UID Txt: 1DFFE390-B178-455A-8B3F-08BEEFFF430F</b> 
*/
