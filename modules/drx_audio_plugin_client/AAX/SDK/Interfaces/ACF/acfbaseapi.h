...
typedef ACFAPICALLTYPE ACFRESULT (* ACFGETCLASSFACTORYTYPE) (IACFUnknown *, const acfCLSID&, const acfIID&, uk*);
...
typedef ACFRESULT (ACFAPICALLTYPE * ACFGETCLASSFACTORYTYPE) (IACFUnknown *, const acfCLSID&, const acfIID&, uk*);
