 ...
 */
enum class AAX_TaskCompletionStatus : i32 {
	 None = 0
	,Done = 1
	,Canceled = 2
	,Error = 3
...
public:
	...
	virtual AAX_Result SetProgress(f32 iProgress) = 0; ///< \copydoc AAX_ITask::SetProgress()
	virtual f32 GetProgress() const = 0; ///< \copydoc AAX_ITask::GetProgress()
