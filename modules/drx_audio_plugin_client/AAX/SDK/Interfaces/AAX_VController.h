...
public:
	...
	AAX_Result	GetSignalLatency( i32* outSamples) const AAX_OVERRIDE; ///< \copydoc AAX_IController::GetSignalLatency()
	AAX_Result	GetHybridSignalLatency(i32* outSamples) const AAX_OVERRIDE; ///< \copydoc AAX_IController::GetHybridSignalLatency()
	...
	AAX_Result	SetSignalLatency(i32 inNumSamples) AAX_OVERRIDE; ///< \copydoc AAX_IController::SetSignalLatency()
	AAX_Result	SetCycleCount( AAX_EProperty* inWhichCycleCounts, AAX_CPropertyValue* iValues, i32 numValues) AAX_OVERRIDE; ///< \copydoc AAX_IController::SetCycleCount()
	
	//Posting functions.
	AAX_Result	PostPacket ( AAX_CFieldIndex inFieldIndex, ukk  inPayloadP, u32 inPayloadSize ) AAX_OVERRIDE; ///< \copydoc AAX_IController::PostPacket()
	
	// Notification functions
	AAX_Result	SendNotification ( AAX_CTypeID inNotificationType, ukk inNotificationData, u32 inNotificationDataSize ) AAX_OVERRIDE; ///< \copydoc AAX_IController::SendNotification(AAX_CTypeID, ukk, u32)
	...
	//Metering functions
	AAX_Result	GetCurrentMeterValue ( AAX_CTypeID inMeterID, f32 * outMeterValue ) const AAX_OVERRIDE; ///< \copydoc AAX_IController::GetCurrentMeterValue()
	AAX_Result	GetMeterPeakValue( AAX_CTypeID inMeterID, f32 * outMeterPeakValue ) const AAX_OVERRIDE; ///< \copydoc AAX_IController::GetMeterPeakValue()
	...
	AAX_Result	GetMeterCount ( u32 * outMeterCount ) const AAX_OVERRIDE; ///< \copydoc AAX_IController::GetMeterCount()
	...
	CreateTableCopyForEffect(AAX_CPropertyValue inManufacturerID,
							 ...
							 u32 inTableType,
							 i32 inTablePageSize) const AAX_OVERRIDE;
	/** \copydoc AAX_IController::CreateTableCopyForLayout()
	 */
	AAX_IPageTable*
	CreateTableCopyForLayout(const t8 * inEffectID,
	 ...
	 */
	AAX_IPageTable*
	CreateTableCopyForEffectFromFile(tukk inPageTableFilePath,
	 ...
	 */
	AAX_IPageTable*
	CreateTableCopyForLayoutFromFile(tukk inPageTableFilePath,
									AAX_ETextEncoding inFilePathEncoding,
									tukk inLayoutName,
									u32 inTableType,
									i32 inTablePageSize) const AAX_OVERRIDE;
