...
public: ///////////////////////////////////////////////////////////////////////////// constructor/destructor
	AAX_CTaskAgent (z0) = default;
	~AAX_CTaskAgent (z0) AAX_OVERRIDE;
...
public: ///////////////////////////////////////////////////////////////////////////// AAX_IACFTaskAgent
	...
	AAX_Result Uninitialize (z0) AAX_OVERRIDE; ///< \copydoc AAX_IACFTaskAgent::Uninitialize()
...
public: ///////////////////////////////////////////////////////////////////////////// AAX_CTaskAgent
	 ...
	 */
	AAX_IController* GetController (z0) { return mController; };
	/*!
	 *  \brief Returns a pointer to the plug-in's data model interface
	 */
	AAX_IEffectParameters* GetEffectParameters (z0) { return mEffectParameters; }
