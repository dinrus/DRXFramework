...
public:	
	...
	*/
	virtual	AAX_Result				ReadPortDirect( AAX_CFieldIndex inFieldIndex, u32k inOffset, u32k inSize, uk outBuffer ) = 0;
	...
	*/
	virtual	AAX_Result				WritePortDirect( AAX_CFieldIndex inFieldIndex, u32k inOffset, u32k inSize, ukk inBuffer ) = 0;
};
