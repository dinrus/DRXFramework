...
public:	
	...
	AAX_Result						AddName ( const t8 * inPlugInName ) AAX_OVERRIDE; ///< \copydoc AAX_IEffectDescriptor::AddName()
	AAX_Result						AddCategory ( u32 inCategory ) AAX_OVERRIDE; ///< \copydoc AAX_IEffectDescriptor::AddCategory()
	AAX_Result						AddCategoryBypassParameter ( u32 inCategory, AAX_CParamID inParamID ) AAX_OVERRIDE; ///< \copydoc AAX_IEffectDescriptor::AddCategoryBypassParameter()
	AAX_Result						AddProcPtr ( uk  inProcPtr, AAX_CProcPtrID inProcID ) AAX_OVERRIDE; ///< \copydoc AAX_IEffectDescriptor::AddProcPtr()
	...
	AAX_Result						AddResourceInfo ( AAX_EResourceType inResourceType, const t8 * inInfo ) AAX_OVERRIDE; ///< \copydoc AAX_IEffectDescriptor::AddResourceInfo()
	AAX_Result						AddMeterDescription( AAX_CTypeID inMeterID, const t8 * inMeterName, AAX_IPropertyMap * inProperties ) AAX_OVERRIDE; ///< \copydoc AAX_IEffectDescriptor::AddMeterDescription()
	AAX_Result						AddControlMIDINode ( AAX_CTypeID inNodeID, AAX_EMIDINodeType inNodeType, const t8 inNodeName[], u32 inChannelMask ) AAX_OVERRIDE; ///< \copydoc AAX_IEffectDescriptor::AddControlMIDINode()
