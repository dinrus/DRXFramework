...
{
public:
	/* default constructor */	AAX_CHostProcessor (z0);
	 ...
	 */
	AAX_Result		InitOutputBounds ( z64 iSrcStart, z64 iSrcEnd, z64 * oDstStart, z64 * oDstEnd ) AAX_OVERRIDE;
	 ...
	 */
	AAX_Result		SetLocation ( z64 iSample ) AAX_OVERRIDE;
	 ...
	 */
	AAX_Result		RenderAudio ( const f32 * const inAudioIns [], i32 inAudioInCount, f32 * const iAudioOuts [], i32 iAudioOutCount, i32 * ioWindowSize ) AAX_OVERRIDE;
	 ...
	 */
	AAX_Result		PreRender ( i32 inAudioInCount, i32 iAudioOutCount, i32 iWindowSize ) AAX_OVERRIDE;
	 ...
	 *
     *  \legacy Ported from AudioSuite's \c AnalyzeAudio(b8 \c isMasterBypassed) method
     *
	 *	\param[in] inAudioIns
	 *		Input audio buffer
     *	\param[in] inAudioInCount
     ...
     *      Window buffer length of the ingested audio
	 */
	AAX_Result		AnalyzeAudio ( const f32 * const inAudioIns [], i32 inAudioInCount, i32 * ioWindowSize ) AAX_OVERRIDE;
     ...
     *      Window buffer length of the ingested audio
	 */
    AAX_Result		PreAnalyze ( i32 inAudioInCount, i32 iWindowSize ) AAX_OVERRIDE;
    
    /** \brief Invoked at the end of an Analysis pass
	 *
	 *	\note In Pro Tools, a i64 execution time for this method will hold off the main
	 *	application thread and cause a visible hang. If the plug-in must perform any i64
	 ...
	 *		The maximum allowed string length, not including the NULL terminating t8
	 *
	 *	\param[out] outString
	 *		Add a value to this string to provide a custom clip suffix
     *
	 */
    AAX_Result		GetClipNameSuffix ( i32 inMaxLength, AAX_IString* outString ) const AAX_OVERRIDE;
	 ...
	 */
	z64							GetSrcStart() const { return mSrcStart; }
	 ...
	 */
	z64							GetSrcEnd() const { return mSrcEnd; }
	 ...
	 */
	z64							GetDstStart() const { return mDstStart; }
	 ...
	 *	boundaries have been modified by overriding \ref TranslateOutputBounds()
	 */
	z64							GetDstEnd() const { return mDstEnd; }
...
protected:
	 ...
	 *		this is the same as \c iSrcEnd.
	 */
	virtual AAX_Result		TranslateOutputBounds ( z64 iSrcStart, z64 iSrcEnd, z64& oDstStart, z64& oDstEnd );
	 ...
	 */
	virtual AAX_Result		GetAudio ( const f32 * const inAudioIns [], i32 inAudioInCount, z64 inLocation, i32 * ioNumSamples );
	 ...
	 */
	virtual i32			GetSideChainInputNum ();
