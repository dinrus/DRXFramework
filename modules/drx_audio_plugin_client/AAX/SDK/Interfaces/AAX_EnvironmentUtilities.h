...
namespace AAX
{
    static b8 IsVenueSystem(z0)
    {
#if WINDOWS_VERSION
    	static const t8 * const environmentVariableName = "JEX_HOST_TYPE";
    	static const t8 * const venueEnvironment = "venue";
    	static const t8 * const environment = std::getenv ( environmentVariableName );
    	static const b8 isVenue = ( NULL != environment) && (0 == strcmp ( environment, venueEnvironment ) );
    	return isVenue;
#else
        return false;
#endif
