...
public:
	 ...
	 */
	virtual	AAX_Result	GetCurrentTempo ( f64* TempoBPM ) const = 0;
	 ...
	 */
	virtual	AAX_Result	GetCurrentMeter ( i32* MeterNumerator, i32* MeterDenominator ) const = 0;
	 ...
	 */
	virtual	AAX_Result	IsTransportPlaying ( b8* isPlaying ) const = 0;
	 ...
	 */		
	virtual	AAX_Result	GetCurrentTickPosition ( z64* TickPosition ) const = 0;
	 ...
	 */		
	virtual	AAX_Result	GetCurrentLoopPosition ( b8* bLooping, z64* LoopStartTick, z64* LoopEndTick ) const = 0;
	/*!
	...
	*/
	virtual	AAX_Result	GetCurrentNativeSampleLocation ( z64* SampleLocation ) const = 0;
	...
	*/
	virtual	AAX_Result	GetCustomTickPosition( z64* oTickPosition, z64 iSampleLocation) const = 0;
	...
	*/
	virtual	AAX_Result	GetBarBeatPosition(i32* Bars, i32* Beats, z64* DisplayTicks, z64 SampleLocation) const = 0;
	 ...
	 *	\param[out] ticks
	 */
	virtual	AAX_Result	GetTicksPerQuarter ( u32* ticks ) const = 0;
	 ...
	 *	\param[out] ticks
	 */
	virtual	AAX_Result	GetCurrentTicksPerBeat ( u32* ticks ) const = 0;
	 ...
	 */
	virtual	AAX_Result	GetTimelineSelectionStartPosition ( z64* oSampleLocation ) const = 0;
	 ...
	 *	\param[out] oOffset
	 */
	virtual	AAX_Result	GetTimeCodeInfo( AAX_EFrameRate* oFrameRate, i32* oOffset ) const = 0;
	 ...
	 *	\param[out] oOffset
	 */
	virtual	AAX_Result	GetFeetFramesInfo( AAX_EFeetFramesRate* oFeetFramesRate, z64* oOffset ) const = 0;
	 ...
	 *	\param[out] isEnabled
	 */
	virtual AAX_Result	IsMetronomeEnabled ( i32* isEnabled ) const = 0;
	 ...
	 *	\param[out] oHDOffset
	 */
	virtual	AAX_Result	GetHDTimeCodeInfo( AAX_EFrameRate* oHDFrameRate, z64* oHDOffset ) const = 0;
	 ...
	 *	\param[out] oSampleLocation
	 */
	virtual	AAX_Result	GetTimelineSelectionEndPosition ( z64* oSampleLocation ) const = 0;
	 ...
	 *	\endverbatim
	 */
	virtual AAX_Result GetKeySignature( z64 iSampleLocation, u32* oKeySignature ) const = 0;
};
