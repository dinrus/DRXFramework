...
public:
	...
	/**
	 *	Register a control with the automation system using a tuk based control identifier
	 *
	...
	/**
	 *	Unregister a control with the automation system using a tuk based control identifier
	 *
	 ...
	 *		The requested new parameter value, formatted as a f64 and normalized to [0 1]
	 */
	virtual AAX_Result	PostSetValueRequest ( AAX_CParamID iParameterID, f64 normalizedValue ) const = 0;
	 ...
	 *	\param[in] normalizedValue
	 *		The current parameter value, formatted as a f64 and normalized to [0 1]
	 */
	virtual AAX_Result	PostCurrentValue( AAX_CParamID iParameterID, f64 normalizedValue ) const = 0;
