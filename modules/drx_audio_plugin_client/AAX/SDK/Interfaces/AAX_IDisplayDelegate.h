...
public:
	 ...
	 */
	virtual b8		ValueToString(T value, AAX_CString* valueString) const = 0;
	 ...
	 *	\retval false	The string conversion was unsuccessful
	 */
	virtual b8		ValueToString(T value, i32 maxNumChars, AAX_CString* valueString) const = 0;
	 ...
	 *	\retval false	The string conversion was unsuccessful
	 */
	virtual b8		StringToValue(const AAX_CString& valueString, T* value) const = 0;
};
