...
public:
	...
	AAX_Result			AddReservedField ( AAX_CFieldIndex inFieldIndex, u32 inFieldType ) AAX_OVERRIDE; ///< \copydoc AAX_IComponentDescriptor::AddReservedField()
	...
	AAX_Result			AddDataInPort ( AAX_CFieldIndex inFieldIndex, u32 inPacketSize, AAX_EDataInPortType inPortType ) AAX_OVERRIDE; ///< \copydoc AAX_IComponentDescriptor::AddDataInPort()
	AAX_Result			AddAuxOutputStem ( AAX_CFieldIndex inFieldIndex, i32 inStemFormat, const t8 inNameUTF8[]) AAX_OVERRIDE; ///< \copydoc AAX_IComponentDescriptor::AddAuxOutputStem()
	AAX_Result			AddPrivateData ( AAX_CFieldIndex inFieldIndex, i32 inDataSize, u32 inOptions ) AAX_OVERRIDE; ///< \copydoc AAX_IComponentDescriptor::AddPrivateData()
    AAX_Result          AddTemporaryData( AAX_CFieldIndex inFieldIndex, u32 inDataElementSize) AAX_OVERRIDE; ///< \copydoc AAX_IComponentDescriptor::AddTemporaryData()
	...
	AAX_Result			AddMeters ( AAX_CFieldIndex inFieldIndex, const AAX_CTypeID* inMeterIDs, u32k inMeterCount) AAX_OVERRIDE; ///< \copydoc AAX_IComponentDescriptor::AddMeters()
	AAX_Result			AddMIDINode ( AAX_CFieldIndex inFieldIndex, AAX_EMIDINodeType inNodeType, const t8 inNodeName[], u32 channelMask ) AAX_OVERRIDE; ///< \copydoc AAX_IComponentDescriptor::AddMIDINode()
	...
	virtual AAX_Result AddProcessProc (
		...
		i32 inProcIDsSize = 0) AAX_OVERRIDE;


	IACFUnknown*				GetIUnknown(z0) const;
