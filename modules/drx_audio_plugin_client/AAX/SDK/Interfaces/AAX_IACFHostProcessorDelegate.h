...
{
public:
	virtual AAX_Result	GetAudio ( const f32 * const inAudioIns [], i32 inAudioInCount, z64 inLocation, i32 * ioNumSamples ) = 0;	///< \copydoc AAX_IHostProcessorDelegate::GetAudio()
	virtual i32		GetSideChainInputNum () = 0;	///< \copydoc AAX_IHostProcessorDelegate::GetSideChainInputNum()
};
