...
public:
	...
	AAX_Result				AddEffect ( const t8 * inEffectID, AAX_IEffectDescriptor * inEffectDescriptor ) AAX_OVERRIDE; ///< \copydoc AAX_ICollection::AddEffect()
	AAX_Result				SetManufacturerName( tukk inPackageName ) AAX_OVERRIDE; ///< \copydoc AAX_ICollection::SetManufacturerName()
	AAX_Result				AddPackageName( const t8 *inPackageName ) AAX_OVERRIDE; ///< \copydoc AAX_ICollection::AddPackageName()
	AAX_Result				SetPackageVersion( u32 inVersion ) AAX_OVERRIDE; ///< \copydoc AAX_ICollection::SetPackageVersion()
	...
	AAX_Result 				GetHostVersion(u32* outVersion) const AAX_OVERRIDE; ///< \copydoc AAX_ICollection::GetHostVersion()
