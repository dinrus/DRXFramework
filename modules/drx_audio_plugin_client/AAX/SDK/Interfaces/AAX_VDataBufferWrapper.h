...
public:
	...
	AAX_Result Size(i32 * oSize) const AAX_OVERRIDE; ///< \copydoc AAX_IDataBuffer::Size
	AAX_Result Data(z0 const ** oBuffer) const AAX_OVERRIDE; ///< \copydoc AAX_IDataBuffer::Data
