...
public: ///////////////////////////////////////////////////////////////////////////// AAX_CEffectGUI
	...
	AAX_CEffectGUI(z0);
	~AAX_CEffectGUI(z0) AAX_OVERRIDE;
...
public: ///////////////////////////////////////////////////////////////////////////// AAX_IEffectGUI
	 ...
	 */
	AAX_Result	NotificationReceived(AAX_CTypeID inNotificationType, ukk  inNotificationData, u32 inNotificationDataSize) AAX_OVERRIDE;
	...
	AAX_Result TimerWakeup (z0) AAX_OVERRIDE
	{
		return AAX_SUCCESS;
	}
...
protected: ///////////////////////////////////////////////////////////////////////////// AAX_CEffectGUI
	 ...
	 */
	virtual z0 CreateViewContents (z0) = 0;
	/*!
	 ...
	 *	window is present
	 */
	virtual z0 CreateViewContainer (z0) = 0;
	/*!
	 ...
	 */
	virtual z0 DeleteViewContainer (z0) = 0;
	 ...
	 */
	virtual z0 UpdateAllParameters (z0);
	//@}end Helper methods
...
public:  //These accessors are public here as they are often needed by contained views.
	...
	const AAX_IController* GetController (z0) const;
	...
	const AAX_IEffectParameters* GetEffectParameters (z0) const;
    
	/*!
	 *  \brief Retrieves a reference to the plug-in's view container interface
	 *
	 */
    AAX_IViewContainer* GetViewContainer (z0);
	const AAX_IViewContainer* GetViewContainer (z0) const;
