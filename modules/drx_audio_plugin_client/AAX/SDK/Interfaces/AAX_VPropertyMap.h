...
private:
	AAX_VPropertyMap ();
	z0 InitWithFactory (IACFComponentFactory* inComponentFactory, IACFUnknown* inAuxiliaryUnknown); ///< \p inAuxiliaryUnknown should support at least \ref IID_IAAXDescriptionHostV1 (may be NULL)
	z0 InitWithPropertyMap (IACFUnknown* inPropertyMapUnknown, IACFUnknown* inAuxiliaryUnknown); ///< \p inAuxiliaryUnknown should support at least \ref IID_IAAXDescriptionHostV1 (may be NULL)
	
public:
	~AAX_VPropertyMap(z0) AAX_OVERRIDE;
	...
	AAX_CBoolean		GetPointerProperty ( AAX_EProperty inProperty, ukk* outValue ) const AAX_OVERRIDE; ///< \copydoc AAX_IPropertyMap::GetPointerProperty()
	...
	AAX_Result			AddPointerProperty ( AAX_EProperty inProperty, ukk inValue ) AAX_OVERRIDE; ///< \copydoc AAX_IPropertyMap::AddPointerProperty(AAX_EProperty, ukk)
	AAX_Result			AddPointerProperty ( AAX_EProperty inProperty, tukk inValue ) AAX_OVERRIDE; ///< \copydoc AAX_IPropertyMap::AddPointerProperty(AAX_EProperty, tukk)
	AAX_Result			RemoveProperty ( AAX_EProperty inProperty ) AAX_OVERRIDE; ///< \copydoc AAX_IPropertyMap::RemoveProperty()
    AAX_Result          AddPropertyWithIDArray ( AAX_EProperty inProperty, const AAX_SPlugInIdentifierTriad* inPluginIDs, u32 inNumPluginIDs) AAX_OVERRIDE; ///< \copydoc AAX_IPropertyMap::AddPropertyWithIDArray()
    AAX_CBoolean        GetPropertyWithIDArray ( AAX_EProperty inProperty, const AAX_SPlugInIdentifierTriad** outPluginIDs, u32* outNumPluginIDs) const AAX_OVERRIDE; ///< \copydoc AAX_IPropertyMap::GetPropertyWithIDArray()
...
private:
	...
	std::map<AAX_EProperty, ukk> mLocalPointerPropertyCache;
};
