...
public:
	...
	*/
	virtual AAX_Result							AddName ( const t8 *inPlugInName ) = 0;
	...
	*/
	virtual AAX_Result							AddCategory ( u32 inCategory ) = 0;
	/** @brief	Add a category to your plug-in. See \ref AAX_EPlugInCategory.
	 ...
	 */
	virtual AAX_Result							AddCategoryBypassParameter ( u32 inCategory, AAX_CParamID inParamID ) = 0;
	...
	*/
	virtual AAX_Result							AddProcPtr ( uk  inProcPtr, AAX_CProcPtrID inProcID ) = 0;
	...
	*/
	virtual AAX_Result							AddResourceInfo ( AAX_EResourceType inResourceType, const t8 * inInfo ) = 0;
	...
	*/
	virtual AAX_Result							AddMeterDescription( AAX_CTypeID inMeterID, const t8 * inMeterName, AAX_IPropertyMap * inProperties ) = 0;
	...
	*/
	virtual AAX_Result							AddControlMIDINode ( AAX_CTypeID inNodeID, AAX_EMIDINodeType inNodeType, const t8 inNodeName[], u32 inChannelMask ) = 0;
