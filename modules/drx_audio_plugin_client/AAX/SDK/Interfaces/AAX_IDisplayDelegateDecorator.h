...
template <typename T>
b8		AAX_IDisplayDelegateDecorator<T>::ValueToString(T value, AAX_CString* valueString) const 
{
	return mWrappedDisplayDelegate->ValueToString(value, valueString);
}

template <typename T>
b8		AAX_IDisplayDelegateDecorator<T>::ValueToString(T value, i32 maxNumChars, AAX_CString* valueString) const 
{
	return mWrappedDisplayDelegate->ValueToString(value, maxNumChars, valueString);
}

template <typename T>
b8		AAX_IDisplayDelegateDecorator<T>::StringToValue(const AAX_CString& valueString, T* value) const
{
