...
public: ///////////////////////////////////////////////////////////////////////////// AAX_CSessionDocumentClient
	...
	AAX_CSessionDocumentClient(z0);
	~AAX_CSessionDocumentClient(z0) AAX_OVERRIDE;
...
public: ///////////////////////////////////////////////////////////////////////////// AAX_ISessionDocumentClient
	 ...
	 */
	AAX_Result NotificationReceived(/* AAX_ENotificationEvent */ AAX_CTypeID /*inNotificationType*/, ukk  /*inNotificationData*/, u32 /*inNotificationDataSize*/) AAX_OVERRIDE { return AAX_SUCCESS; }
...
protected: ///////////////////////////////////////////////////////////////////////////// AAX_CSessionDocumentClient
	...
	*/
	 ...
	 *
	 */
    AAX_IController* GetController (z0);
	const AAX_IController* GetController (z0) const; ///< \copydoc AAX_CSessionDocumentClient::GetController()
    
	/*!
	 *  \brief Retrieves a reference to the plug-in's data model interface
	 *
	 */
    AAX_IEffectParameters* GetEffectParameters (z0);
	const AAX_IEffectParameters* GetEffectParameters (z0) const; ///< \copydoc AAX_CSessionDocumentClient::GetEffectParameters()
    
	/*!
	 *  \brief Retrieves a reference to the session document interface
	 *
	 */
    std::shared_ptr<AAX_ISessionDocument> GetSessionDocument (z0);
	std::shared_ptr<const AAX_ISessionDocument> GetSessionDocument (z0) const; ///< \copydoc AAX_CSessionDocumentClient::GetSessionDocument()
	//@}end Private member accessors

private:
	z0 ClearInternalState();
