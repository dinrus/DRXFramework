...
public: ///////////////////////////////////////////////////////////////////////////// constructor/destructor
	AAX_CEffectParameters (z0);
	~AAX_CEffectParameters (z0) AAX_OVERRIDE;
...
public: ///////////////////////////////////////////////////////////////////////////// AAX_IEffectParameters
	...
	AAX_Result Uninitialize (z0) AAX_OVERRIDE;
	//@}end Initialization and uninitialization
	
	/** @name %AAX host and plug-in event notification
	 */
	//@{
	AAX_Result NotificationReceived( /* AAX_ENotificationEvent */ AAX_CTypeID inNotificationType, ukk  inNotificationData, u32	inNotificationDataSize) AAX_OVERRIDE;
	 ...
	 */
	//@{
	AAX_Result GetNumberOfParameters (i32 * oNumControls)  const AAX_OVERRIDE;
	...
	AAX_Result GetParameterNumberOfSteps (AAX_CParamID iParameterID, i32 * oNumSteps )  const AAX_OVERRIDE;
	AAX_Result GetParameterName (AAX_CParamID iParameterID, AAX_IString * oName )  const AAX_OVERRIDE;
	AAX_Result GetParameterNameOfLength (AAX_CParamID iParameterID, AAX_IString * oName, i32 iNameLength )  const AAX_OVERRIDE;
	AAX_Result GetParameterDefaultNormalizedValue (AAX_CParamID iParameterID, f64 * oValue )  const AAX_OVERRIDE;
	AAX_Result SetParameterDefaultNormalizedValue (AAX_CParamID iParameterID, f64 iValue ) AAX_OVERRIDE;
	...
	AAX_Result GetParameterIndex (AAX_CParamID iParameterID, i32 * oControlIndex )  const AAX_OVERRIDE;
	AAX_Result GetParameterIDFromIndex (i32 iControlIndex, AAX_IString * oParameterIDString )  const AAX_OVERRIDE;
	AAX_Result GetParameterValueInfo ( AAX_CParamID iParameterID, i32 iSelector, i32* oValue) const AAX_OVERRIDE;
	 ...
	 */
	//@{
	AAX_Result GetParameterValueFromString (AAX_CParamID iParameterID, f64 * oValue, const AAX_IString & iValueString )  const AAX_OVERRIDE;
	AAX_Result GetParameterStringFromValue (AAX_CParamID iParameterID, f64 iValue, AAX_IString * oValueString, i32 iMaxLength )  const AAX_OVERRIDE;
	AAX_Result GetParameterValueString (AAX_CParamID iParameterID, AAX_IString * oValueString, i32 iMaxLength)  const AAX_OVERRIDE;
	AAX_Result GetParameterNormalizedValue (AAX_CParamID iParameterID, f64 * oValuePtr )  const AAX_OVERRIDE;
	AAX_Result SetParameterNormalizedValue (AAX_CParamID iParameterID, f64 iValue ) AAX_OVERRIDE;
	AAX_Result SetParameterNormalizedRelative (AAX_CParamID iParameterID, f64 iValue ) AAX_OVERRIDE;
	 ...
	 */
	//@{
	AAX_Result UpdateParameterNormalizedValue (AAX_CParamID iParameterID, f64 iValue, AAX_EUpdateSource iSource ) AAX_OVERRIDE;
	AAX_Result UpdateParameterNormalizedRelative (AAX_CParamID iParameterID, f64 iValue ) AAX_OVERRIDE;
	AAX_Result GenerateCoefficients(z0) AAX_OVERRIDE;
	//@}end Asynchronous parameter update methods

	/** @name State reset handlers
	 */
	//@{
	AAX_Result ResetFieldData (AAX_CFieldIndex inFieldIndex, uk  oData, u32 inDataSize) const AAX_OVERRIDE;
	 ...
	 */
	//@{
	AAX_Result GetNumberOfChunks (i32 * oNumChunks )  const AAX_OVERRIDE;
	AAX_Result GetChunkIDFromIndex (i32 iIndex, AAX_CTypeID * oChunkID )  const AAX_OVERRIDE;
	AAX_Result GetChunkSize (AAX_CTypeID iChunkID, u32 * oSize )  const AAX_OVERRIDE;
	...
	AAX_Result GetNumberOfChanges (i32 * oNumChanges )  const AAX_OVERRIDE;
	//@}end Chunk methods
	 ...
	 */
	//@{	
	AAX_Result GetCurveData( /* AAX_ECurveType */ AAX_CTypeID iCurveType, const f32 * iValues, u32 iNumValues, f32 * oValues ) const AAX_OVERRIDE;
	AAX_Result GetCurveDataMeterIds( /* AAX_ECurveType */ AAX_CTypeID iCurveType, u32 *oXMeterId, u32 *oYMeterId)  const AAX_OVERRIDE;
	AAX_Result GetCurveDataDisplayRange( /* AAX_ECurveType */ AAX_CTypeID iCurveType, f32 *oXMin, f32 *oXMax, f32 *oYMin, f32 *oYMax ) const AAX_OVERRIDE;
	
	/** @copydoc AAX_IEffectParameters::UpdatePageTable()
	 
	 \note For convenience, do not override this method. Instead, override the
	 \ref AAX_CEffectParameters::UpdatePageTable(u32, i32, AAX_IPageTable&) const "protected overload"
	 which provides a prepared copy of the relevant \ref AAX_IPageTable host interface.
	 */
	AAX_Result UpdatePageTable(u32 inTableType, i32 inTablePageSize, IACFUnknown* iHostUnknown, IACFUnknown* ioPageTableUnknown) const AAX_OVERRIDE AAX_FINAL;
	 ...
	 *  Using these, the GUI can query any data through GetCustomData() with a plug-in defined \c typeID, \c uk and size.  This has an advantage
	 ...
	 */
	//@{
	AAX_Result			GetCustomData( AAX_CTypeID iDataBlockID, u32 inDataSize, uk oData, u32* oDataWritten) const AAX_OVERRIDE;
	AAX_Result			SetCustomData( AAX_CTypeID iDataBlockID, u32 inDataSize, ukk iData ) AAX_OVERRIDE;
...
protected:
	 ...
	 */
	//@{
	AAX_Result			SetTaperDelegate ( AAX_CParamID iParameterID, AAX_ITaperDelegateBase & iTaperDelegate, b8 iPreserveValue );
	AAX_Result			SetDisplayDelegate ( AAX_CParamID iParameterID, AAX_IDisplayDelegateBase & iDisplayDelegate );
	b8				IsParameterTouched ( AAX_CParamID iParameterID ) const;
	b8				IsParameterLinkReady ( AAX_CParamID inParameterID, AAX_EUpdateSource inSource ) const;
	 ...
	 */
	virtual AAX_Result	EffectInit(z0) { return AAX_SUCCESS; };
	
	/*! Protected overload of \ref AAX_CEffectParameters::UpdatePageTable(u32, i32, IACFUnknown*, IACFUnknown*) const "UpdatePageTable()"
	 
	 Override this version of the method for convenience. This allows the default
	 \ref AAX_CEffectParameters::UpdatePageTable(u32, i32, IACFUnknown*, IACFUnknown*) const "UpdatePageTable()"
	 ...
	 */
	virtual AAX_Result UpdatePageTable(u32 /*inTableType*/, i32 /*inTablePageSize*/, AAX_IPageTable& /*ioPageTable*/) const { return AAX_ERROR_UNIMPLEMENTED; }
	 ...
	 */
	z0 FilterParameterIDOnSave(AAX_CParamID controlID);
     ...
     *
     */
	z0 BuildChunkData (z0) const;
	
protected:
	i32							mNumPlugInChanges;	
    mutable i32					mChunkSize;				//this old behavior isn't const friendly yet.  Consider this a temp variable.			
	mutable AAX_CChunkDataParser	mChunkParser;           //this old behavior isn't const friendly yet.  Consider this a temp variable.
    i32							mNumChunkedParameters;
...
// Convenience functions since many legacy plug-ins had internal i32 value representations.
extern i32 NormalizedToInt32 (f64 normalizedValue );
extern f64 Int32ToNormalized (i32 value );
extern f64 BoolToNormalized (b8 value );
