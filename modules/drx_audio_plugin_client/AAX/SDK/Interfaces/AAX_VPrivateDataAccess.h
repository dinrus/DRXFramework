...
public:
	...
	AAX_Result	ReadPortDirect( AAX_CFieldIndex inFieldIndex, u32k inOffset, u32k inSize, uk outBuffer ) AAX_OVERRIDE; ///< \copydoc AAX_IPrivateDataAccess::ReadPortDirect()
	AAX_Result	WritePortDirect( AAX_CFieldIndex inFieldIndex, u32k inOffset, u32k inSize, ukk inBuffer ) AAX_OVERRIDE; ///< \copydoc AAX_IPrivateDataAccess::WritePortDirect()
