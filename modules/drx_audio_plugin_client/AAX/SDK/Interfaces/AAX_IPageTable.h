...
public:
	 ...
	 */
	virtual AAX_Result GetNumPages(i32& oNumPages) const = 0;
	 ...
	 */
	virtual AAX_Result InsertPage(i32 iPage) = 0;
	 ...
	 */
	virtual AAX_Result RemovePage(i32 iPage) = 0;
	 ...
	 */
	virtual AAX_Result GetNumMappedParameterIDs(i32 iPage, i32& oNumParameterIdentifiers) const = 0;
	 ...
	 */
	virtual AAX_Result ClearMappedParameter(i32 iPage, i32 iIndex) = 0;
	 ...
	 */
	virtual AAX_Result GetMappedParameterID(i32 iPage, i32 iIndex, AAX_IString& oParameterIdentifier) const = 0;
	...
	/** \brief Map a parameter to this table
	 ...
	 \param[in] iIndex
		The target parameter slot index within the target page
	 */
	virtual AAX_Result MapParameterID(AAX_CPageTableParamID iParameterIdentifier, i32 iPage, i32 iIndex) = 0;
	 ...
	 */
	virtual AAX_Result GetNumParametersWithNameVariations(i32& oNumParameterIdentifiers) const = 0;
	 ...
	 */
	virtual AAX_Result GetNameVariationParameterIDAtIndex(i32 iIndex, AAX_IString& oParameterIdentifier) const = 0;
	 ...
	 */
	virtual AAX_Result GetNumNameVariationsForParameter(AAX_CPageTableParamID iParameterIdentifier, i32& oNumVariations) const = 0;
	 ...
	 */
	virtual AAX_Result GetParameterNameVariationAtIndex(AAX_CPageTableParamID iParameterIdentifier, i32 iIndex, AAX_IString& oNameVariation, i32& oLength) const = 0;
	 ...
	 */
	virtual AAX_Result GetParameterNameVariationOfLength(AAX_CPageTableParamID iParameterIdentifier, i32 iLength, AAX_IString& oNameVariation) const = 0;
	 ...
	 */
	virtual AAX_Result SetParameterNameVariation(AAX_CPageTableParamID iParameterIdentifier, const AAX_IString& iNameVariation, i32 iLength) = 0;
};
