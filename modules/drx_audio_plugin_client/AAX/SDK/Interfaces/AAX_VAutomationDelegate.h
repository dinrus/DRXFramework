...
public:
	...
	AAX_Result		PostSetValueRequest ( AAX_CParamID iParameterID, f64 iNormalizedValue ) const AAX_OVERRIDE;
	AAX_Result		PostCurrentValue ( AAX_CParamID iParameterID, f64 iNormalizedValue ) const AAX_OVERRIDE;
