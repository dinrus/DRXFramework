...
public:	
	 ...
	 */
	virtual AAX_Result	GetModifiers ( u32 * outModifiers ) = 0;
	 ...
	 */
	virtual AAX_Result	HandleParameterMouseDown ( AAX_CParamID inParamID, u32 inModifiers ) = 0;
	/**	\brief Alert the host to a mouse drag event
		...
		\param[in] inModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleParameterMouseDrag ( AAX_CParamID inParamID, u32 inModifiers ) = 0;
	/**	\brief Alert the host to a mouse up event
		...
		\param[in] inModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleParameterMouseUp ( AAX_CParamID inParamID, u32 inModifiers ) = 0;
	 ...
	 */
	virtual AAX_Result	HandleParameterMouseEnter ( AAX_CParamID inParamID, u32 inModifiers ) = 0;
	...
	/** \brief Alert the host to a mouse exit event from the parameter's control
		...
		\brief Returns AAX_SUCCESS if event was processed successfully, otherwise an AAX_ERROR code
	 */
	virtual AAX_Result	HandleParameterMouseExit( AAX_CParamID inParamID, u32 inModifiers ) = 0;
	...
	/**	\brief Alert the host to a mouse down event
		...
		\param[in] inModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleMultipleParametersMouseDown ( const AAX_CParamID* inParamIDs, u32 inNumOfParams, u32 inModifiers ) = 0;
	/**	\brief Alert the host to a mouse drag event
		...
		\param[in] inModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleMultipleParametersMouseDrag ( const AAX_CParamID* inParamIDs, u32 inNumOfParams, u32 inModifiers ) = 0;
	/**	\brief Alert the host to a mouse up event
		...
		\param[in] inModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleMultipleParametersMouseUp   ( const AAX_CParamID* inParamIDs, u32 inNumOfParams, u32 inModifiers ) = 0;
