...
public:	
		 ...
		 */
		virtual	AAX_Result	SendNotification (/* AAX_ENotificationEvent */ AAX_CTypeID inNotificationType, ukk inNotificationData, u32 inNotificationDataSize) = 0;
		/*!
		 ...
		 *   \ref AAX_IController::SendNotification(AAX_CTypeID, ukk, u32) with a null payload.
		 *
		 *	\param[in] inNotificationType
		 *		Type of notification to send
		 */
		 ...
		 */
		virtual AAX_Result	GetCurrentMeterValue ( AAX_CTypeID inMeterID, f32 * outMeterValue ) const = 0;
		/*!
		 ...
		 */
		virtual AAX_Result	GetMeterPeakValue ( AAX_CTypeID inMeterID, f32 * outMeterPeakValue ) const = 0;
		/*!
		 ...
		 */
		virtual AAX_Result	GetMeterCount ( u32 * outMeterCount ) const = 0;
		/*!
		...
		*/
         ...
         */
        virtual
        AAX_Result GetHybridSignalLatency(i32* outSamples) const = 0;
        /*!
		 ...
		 *		Four-t8 type identifier for the requested table type (e.g. \c 'PgTL', \c 'Av81', etc.)
