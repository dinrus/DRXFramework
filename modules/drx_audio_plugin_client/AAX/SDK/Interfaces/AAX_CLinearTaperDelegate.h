 ...
 */
template <typename T, i32 RealPrecision=0>
...
T	AAX_CLinearTaperDelegate<T, RealPrecision>::Round(f64 iValue) const
{
...
template <typename T, i32 RealPrecision>
T		AAX_CLinearTaperDelegate<T, RealPrecision>::NormalizedToReal(f64 normalizedValue) const
{
	f64 doubleRealValue = normalizedValue * (f64(mMaxValue) - f64(mMinValue)) + f64(mMinValue);
...
template <typename T, i32 RealPrecision>
f64	AAX_CLinearTaperDelegate<T, RealPrecision>::RealToNormalized(T realValue) const
{
	realValue = ConstrainRealValue(realValue);
	f64 normalizedValue = (mMaxValue == mMinValue) ? 0.5 : (f64(realValue) - f64(mMinValue)) / (f64(mMaxValue) - f64(mMinValue));
