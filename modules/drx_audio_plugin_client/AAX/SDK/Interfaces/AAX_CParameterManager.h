...
public:
	 ...
	 */	
	z0			Initialize(AAX_IAutomationDelegate* iAutomationDelegateUnknown);
	
	/*!
	 *  \brief Returns the number of parameters in this instance of the parameter manager
	 *
	 */	
	i32		NumParameters()	const;	
	 ...
	 */	
	z0			RemoveParameterByID(AAX_CParamID identifier);
	 ...
	 */
	AAX_IParameter*			GetParameterByName(tukk  name);
	 ...
	 *		ID of the parameter that will be retrieved
	 */
	const AAX_IParameter*	GetParameterByName(tukk  name) const;
	 ...
	 */	
	AAX_IParameter*			GetParameter(i32 index);
	 ...
	 *		Index of the parameter that will be retrieved
	 */	
	const AAX_IParameter*	GetParameter(i32 index) const;
	 ...
	 *		ID of the parameter that will be retrieved
	 */	
	i32					GetParameterIndex(AAX_CParamID identifier) const;
	 ...
	 */	
	z0					AddParameter(AAX_IParameter*	param);
	 ...
	 */	
	z0					RemoveParameter(AAX_IParameter*	param);
