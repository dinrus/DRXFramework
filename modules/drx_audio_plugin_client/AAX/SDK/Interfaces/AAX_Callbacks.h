...
typedef IACFUnknown* (AAX_CALLBACK *AAXCreateObjectProc)(z0);
...
class AAX_Component
{
	public:
		...
		typedef i32
		(AAX_CALLBACK *CBackgroundProc) ( z0 );
 ...
 */
typedef AAX_Component <z0>::CProcessProc			AAX_CProcessProc;
 ...
 */
typedef AAX_Component <z0>::CPacketAllocator		AAX_CPacketAllocator;
 ...
 */
typedef AAX_Component <z0>::CInstanceInitProc		AAX_CInstanceInitProc;
 ...
 */
typedef AAX_Component <z0>::CBackgroundProc		AAX_CBackgroundProc;
 ...
 */
typedef AAX_Component <z0>::CInitPrivateDataProc	AAX_CInitPrivateDataProc;	///< \deprecated
