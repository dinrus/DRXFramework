...
template <typename T>
b8		AAX_CUnitDisplayDelegateDecorator<T>::ValueToString(T value, AAX_CString* valueString) const 
{
...
template <typename T>
b8		AAX_CUnitDisplayDelegateDecorator<T>::ValueToString(T value, i32 maxNumChars, AAX_CString* valueString) const
{
...
template <typename T>
b8		AAX_CUnitDisplayDelegateDecorator<T>::StringToValue(const AAX_CString& valueString, T* value) const
{
