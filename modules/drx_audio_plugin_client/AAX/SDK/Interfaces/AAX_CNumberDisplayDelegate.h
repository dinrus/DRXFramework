 ...
 */
template <typename T, u32 Precision=2, u32 SpaceAfter=0>
...
template <typename T, u32 Precision, u32 SpaceAfter>
...
template <typename T, u32 Precision, u32 SpaceAfter>
b8	AAX_CNumberDisplayDelegate<T,Precision,SpaceAfter>::ValueToString(T value, AAX_CString* valueString) const
{
	valueString->Clear();
...
template <typename T, u32 Precision, u32 SpaceAfter>
b8	AAX_CNumberDisplayDelegate<T,Precision,SpaceAfter>::ValueToString(T value, i32 maxNumChars, AAX_CString* valueString) const
{
	valueString->Clear();
	valueString->AppendNumber(value, Precision);
...
template <typename T, u32 Precision, u32 SpaceAfter>
b8	AAX_CNumberDisplayDelegate<T,Precision,SpaceAfter>::StringToValue(const AAX_CString& valueString, T* value) const
{
	f64 dValue;
