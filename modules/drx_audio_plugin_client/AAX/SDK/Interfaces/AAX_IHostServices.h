...
public:
	 ...
	 */
	virtual AAX_Result HandleAssertFailure ( const t8 * iFile, i32 iLine, const t8 * iNote, /* AAX_EAssertFlags */ i32 iFlags ) const = 0;
	 ...
	 */
	virtual AAX_Result Trace ( i32 iPriority, const t8 * iMessage ) const = 0;
	/** \brief Log a trace message or a stack trace
	 ...
	 Message string to log
	 */
	virtual AAX_Result StackTrace ( i32 iTracePriority, i32 iStackTracePriority, const t8 * iMessage ) const = 0;
};
