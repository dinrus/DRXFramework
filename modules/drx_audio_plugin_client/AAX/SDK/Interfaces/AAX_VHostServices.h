...
public:
	...
	AAX_Result HandleAssertFailure ( const t8 * iFile, i32 iLine, const t8 * iNote, /* AAX_EAssertFlags */ i32 iFlags ) const AAX_OVERRIDE; ///< \copydoc AAX_IHostServices::HandleAssertFailure()
	AAX_Result Trace ( i32 iPriority, const t8 * iMessage ) const AAX_OVERRIDE; ///< \copydoc AAX_IHostServices::Trace()
	AAX_Result StackTrace ( i32 iTracePriority, i32 iStackTracePriority, const t8 * iMessage ) const AAX_OVERRIDE; ///< \copydoc AAX_IHostServices::StackTrace()
